...
| Escala oral irmã | [aff](${aff}) ← → [meudeusdoceu](${meudeusdoceu}) ← → [jesusamado](${jesusamado}) · **filho de deus** (título + metáfora) |
...
| **Exclamação / intensidade BR** | Espanto, elogio, «nossa» alto — vizinho de [meudeusdoceu](${meudeusdoceu}) / [jesusamado](${jesusamado}) | Bom: nomear o pico · Mau: ironizar a fé alheia |
...
| **Ofício** | Depois do sopro / da metáfora — trabalhar | [Valeu !!!](${mantra}) |
...
**H3:** no BudGanja, o fecho é [gesto](${gesto}) + [verdade](${verdade}) + [Valeu !!!](${mantra}) — não sermão.

## Relação com jesusamado e meudeusdoceu

| Expressão | Plano dominante | Quando |
|-----------|-----------------|--------|
| [meudeusdoceu](${meudeusdoceu}) | Assombro alto (sopro colado) | Espanto / incredulidade |
| [jesusamado](${jesusamado}) | Afeto / bênção leve (sopro) | Calor na voz |
...
| **Exclamar** | Intensidade oral | Escala com [jesusamado](${jesusamado}) / [meudeusdoceu](${meudeusdoceu}) |
...
|---------------------|---------|
| [jesusamado](${jesusamado}) · [meudeusdoceu](${meudeusdoceu}) | Irmãs orais — calor × espanto |
| [Valeu !!!](${mantra}) | Depois do nome / do sopro — o ofício |
...
| [os doze apóstolos](${doze}) | Conjunto enviado — título × mesa; Tomé inspecciona |
...
| Conjunto enviado | [os doze apóstolos](${doze}) |
...
**Aprovado na série Expressões e Ditados populares** — *filho de deus* fichado como expressão de **título teológico**, **intensidade oral BR** e **metáfora de dignidade/cuidado**; irmã de [jesusamado](${jesusamado}) e [meudeusdoceu](${meudeusdoceu}); fecho [Valeu !!!](${mantra}).

[▶ Expressões](${hub}) · [▶ jesusamado](${jesusamado}) · [▶ meudeusdoceu](${meudeusdoceu}) · [▶ Língua portuguesa](${lingua}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of **“filho de deus”** (*Filho de Deus* / son of God). Three planes: **theological title**, **Brazilian oral intensity**, and **metaphor of dignity/care**. Orality sheet; sisters [jesusamado](${jesusamado}) and [meudeusdoceu](${meudeusdoceu}); [Portuguese](${lingua}) soil.
...
| Links | [jesusamado](${jesusamado}) · [meudeusdoceu](${meudeusdoceu}) · [Portuguese](${lingua}) · [gesture](${gesto}) · [truth](${verdade}) · [Valeu !!!](${mantra}) · [Father Ticão](${padreTicao}) |
| Date | ${inspected} |
...
**H3:** close with [gesture](${gesto}), [truth](${verdade}), [Valeu !!!](${mantra}).
...
**Approved** — title · oral intensity · dignity/care; sisters [jesusamado](${jesusamado}) / [meudeusdoceu](${meudeusdoceu}); [Valeu !!!](${mantra}).

[▶ Expressions](${hub}) · [▶ jesusamado](${jesusamado}) · [▶ meudeusdoceu](${meudeusdoceu}) · [▶ Portuguese](${lingua}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEs = `## Alcance

Inspección de **«filho de deus»** (*Filho de Deus*). Tres planos: **título teológico**, **intensidad oral BR** y **metáfora de dignidad/cuidado**. Ficha de oralidad; hermanas [jesusamado](${jesusamado}) y [meudeusdoceu](${meudeusdoceu}); suelo de la [lengua portuguesa](${lingua}).
...
| Vínculos | [jesusamado](${jesusamado}) · [meudeusdoceu](${meudeusdoceu}) · [portugués](${lingua}) · [gesto](${gesto}) · [verdad](${verdade}) · [¡Valeu !!!](${mantra}) · [Padre Ticão](${padreTicao}) |
| Fecha | ${inspected} |
...
**H3:** cierre con [gesto](${gesto}), [verdad](${verdade}), [¡Valeu !!!](${mantra}).

## Veredicto

**Aprobada** — título · intensidad oral · dignidad/cuidado; hermanas [jesusamado](${jesusamado}) / [meudeusdoceu](${meudeusdoceu}); [¡Valeu !!!](${mantra}).

[▶ Expresiones](${hub}) · [▶ jesusamado](${jesusamado}) · [▶ meudeusdoceu](${meudeusdoceu}) · [▶ Portugués](${lingua}) · [▶ ¡Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildFilhoDeDeusPost() {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «filho de deus» — título teológico, intensidade oral BR e metáfora de dignidade/cuidado; sem proselitismo; Valeu !!!',
    excerptEn:
      'Sayings: “filho de deus” — theological title, BR oral intensity and dignity/care metaphor; no proselytizing; Valeu !!!',
    excerptEs:
      'Dichos: «filho de deus» — título teológico, intensidad oral BR y metáfora de dignidad/cuidado; sin proselitismo; ¡Valeu !!!',

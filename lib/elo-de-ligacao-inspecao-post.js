...
Inspeção editorial da expressão **«[elo de ligação](${self})»** — o **anel que junta** A e B. Pedido de campo: relacionar com o **simbuklo do infinito**. O ouvido trouxe *simbuklo*; a letra endereça **símbolo**. O objecto gráfico é a **lemniscata** (∞, o oito deitado). O ofício desta ficha: o **cruzamento** das duas voltas **é** o elo.
...
**Gatilho:** *simbuklo* / *simbolo do infinito* / *oito deitado* / *lemeniscata* (OCR da aula) → **símbolo do infinito** · **lemniscata** · **elo de ligação**.
...
| **lemniscata** | lat. *lemniscus* «fita» ← gr. λημνίσκος | Alta | O oito deitado; a curva em forma de fita |
...
|---------|------|-------------|-----------|
| **∞ deitado** | Símbolo do infinito (Wallis, 1655) | Sem-fim matemático / gráfico | Alta no **nome**; o conceito matemático é outro ofício |
| **8 em pé** | Analogia da [aula 8](${aula8}) | Movimento e **comunicação**: cima fala com baixo | Alta como **metáfora de aula**; não é teorema |
...
[▶ Expressões](${hub}) · [▶ Link](${link}) · [▶ Conexão](${conexao}) · [▶ Endocanabinoidoma](${ecbome}) · [▶ Aula 8](${aula8}) · [▶ Valeu !!!](${mantra})
`;

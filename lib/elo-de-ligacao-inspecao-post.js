...
| Elos lab | [juntos](${juntos}) · [conexão](${conexao}) · [relação](${relacao}) · [ligar](${ligar}) · [endocanabinoidoma](${ecbome}) |
...
Irmãos de mapa (não fundir): [juntos](${juntos}) (*iunctus* — o estado) · [link](${link}) (loan EN, *hlekkr*) · [conexão](${conexao}) (*connexio*) · [relação](${relacao}) (*relatĭō*) · [simbiose](${simbiose}) (*syn*+*bíos*).
...
| [Juntos](${juntos}) | O **estado** de estar junto (*iunctus*); cruza com os elos — sem elo, *juntos* pode ser pose |

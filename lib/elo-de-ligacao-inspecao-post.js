...
Inspeção editorial da expressão **«[elo de ligação](${self})»** — o **anel que junta** A e B. Pedido de campo: relacionar com o **simbuklo do infinito**. O ouvido trouxe *simbuklo*; a letra endereça **símbolo**. O objecto gráfico é a **[lemniscata](${lemniscata})** (∞, o oito deitado). As posturas — [em pé e deitado](${emPe}) — ficam na expressão irmã. O ofício desta ficha: o **cruzamento** das duas voltas **é** o elo.
...
**Gatilho:** *simbuklo* / *simbolo do infinito* / *oito deitado* / *lemeniscata* (OCR da aula) → **símbolo do infinito** · **[lemniscata](${lemniscata})** · **elo de ligação**. *Bodiado* → [em pé e deitado](${emPe}).
...
|---------|------|-------------|-----------|
| **∞ deitado** | [Em pé e deitado](${emPe}) · Wallis, 1655 | Sem-fim matemático / gráfico | Alta no **nome**; o conceito matemático é outro ofício |
| **8 em pé** | [Em pé e deitado](${emPe}) · analogia da [aula 8](${aula8}) | Movimento e **comunicação**: cima fala com baixo | Alta como **metáfora de aula**; não é teorema |
...
| [Em pé e deitado](${emPe}) | As **duas posturas** da mesma fita (*bodiado* → deitado) |
...
[▶ Expressões](${hub}) · [▶ Lemniscata](${lemniscata}) · [▶ Em pé e deitado](${emPe}) · [▶ Endocanabinoidoma](${ecbome}) · [▶ Valeu !!!](${mantra})
`;

...
function buildTempoBodies() {
  ...
  const slowMotion = '/posts/post-inspecao-expressao-slow-motion.html';
...
| **«Em câmera lenta» / [slow motion](${slowMotion})** | Replay, ecrã, figura de vida | O [tempo](${hub}) **esticado no ecrã** — não o relógio; corte na ficha da expressão |
...
| Par tempo | [sempre](${sempre}) · [passado](${passado}) · [slow motion](${slowMotion}) |
...
[▶ Palavras](${hub}) · [▶ Sempre](${sempre}) · [▶ Passado](${passado}) · [▶ Alma](${alma}) · [▶ Caminho](${caminho}) · [▶ Slow motion](${slowMotion}) · [▶ Todas as inspeções](${hubAll}) · [▶ Faça o melhor!](${mantra})
`;

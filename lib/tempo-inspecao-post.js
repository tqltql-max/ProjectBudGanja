 ...
 * kairós × chronos (comparação, não linhagem) · Valeu !!!
 */
...
| **Ofício** | Fazer o melhor com o tempo disponível | [Valeu !!!](${mantra}) — não com o tempo que se queria ter |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **com o tempo que se tem hoje**, não com o tempo ideal que não existe |
...
**Veredicto:** Valeu !!! **agora**, no instante que é kairós — o cronos não espera, mas o compasso certo se escolhe. Tempo bem gasto é [gesto](${gesto}) no momento que cabia; tempo perdido é ausência de [gesto](${gesto}) disfarçada de falta de tempo.
...
**H5:** fecho = [Valeu !!!](${mantra}) com o tempo real, não o desejado.
...
**Aprovado** — **tempo** fichado: objeto (*tempus*), quatro camadas vivas (cronos, clima, compasso, posse), comparação kairós × chronos, rede com [sempre](${sempre}), [passado](${passado}), [vida](${vidaPalavra}), [alma](${alma}) e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Sempre](${sempre}) · [▶ Passado](${passado}) · [▶ Alma](${alma}) · [▶ Caminho](${caminho}) · [▶ Todas as inspeções](${hubAll}) · [▶ Valeu !!!](${mantra})
`;
...
| Links | [sempre](${sempre}) · [passado](${passado}) · [vida](${vidaPalavra}) · [gesto](${gesto}) · [alma](${alma}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
| Vínculos | [sempre](${sempre}) · [passado](${passado}) · [vida](${vidaPalavra}) · [gesto](${gesto}) · [alma](${alma}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto (*tempus*) · cuatro capas · comparación kairós × chronos · red con [sempre](${sempre}), [passado](${passado}), [alma](${alma}) · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Sempre](${sempre}) · [▶ Passado](${passado}) · [▶ Alma](${alma}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildTempoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «tempo» (lat. tempus) — cronologia, clima e compasso musical no BR; kairós × chronos; elos caminho, vida, sempre, passado, alma; Valeu !!!',
    excerptEn:
      'Words: “tempo” (Lat. tempus) — chronology, weather and musical beat in BR use; kairós × chronos; links caminho, vida, sempre, passado, alma; Valeu !!!',
    excerptEs:
      'Palabras: «tempo» (lat. tempus) — cronología, clima y compás musical en BR; kairós × chronos; vínculos caminho, vida, sempre, passado, alma; ¡Valeu !!!',

...
**H5:** fecho = [Faça o melhor!](${MANTRA}) — o melhor *deste* player *desta* casa, sem púlpito e sem pirataria.
...
| [Faça o melhor!](${MANTRA}) | O melhor *deste* download *desta* casa |
...
[▶ Artes](${hub}) · [▶ Instalar na Play](${PLAY_BR}) · [▶ App Store](${IOS}) · [▶ Player web](${WATCH}) · [▶ A série (outra ficha)](${SERIE}) · [▶ Faça o melhor!](${MANTRA})
`;

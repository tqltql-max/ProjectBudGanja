...
> **Nota metodológica:** auditoria independente. Objecto = a **locução viva** BR. **Ficha ≠ autoajuda, ≠ protocolo clínico.** Elos: [nó](${no}) · [corda](${corda}) · [vida](${vida}) / trilha [Vida](${trilha}) · [Faça o melhor!](${mantra}).
...
[▶ Expressões](${hub}) · [▶ Nó](${no}) · [▶ Desatar o nó](${desatarNo}) · [▶ Vida](${vida}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Brazilian saying **“nó na vida!”** — a knot in [life](${vida}). Pair: [desatar o nó](${desatarNo}). Not yet [desastre](${desastre}). Close: [Do your best!](${mantra}).
...
[▶ Sayings](${hub}) · [▶ Knot](${no}) · [▶ Untie the knot](${desatarNo}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Dicho BR **«nó na vida!»** — nudo en la [vida](${vida}). Par: [desatar o nó](${desatarNo}). Aún no es [desastre](${desastre}). Cierre: [¡Haz lo mejor!](${mantra}).
...
[▶ Expresiones](${hub}) · [▶ Nó](${no}) · [▶ Desatar o nó](${desatarNo}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildNoNaVidaPost(seriesOrder) {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «nó na vida!» — laço no arco da vida; par desatar o nó; ≠ desastre; ufa depois; Faça o melhor!',
    excerptEn:
      'Sayings: “nó na vida!” — knot in the arc of life; pair untying the knot; ≠ disaster; phew after; Do your best!',
    excerptEs:
      'Dichos: «nó na vida!» — nudo en el arco de la vida; par desatar o nó; ≠ desastre; ufa después; ¡Haz lo mejor!',

...
Inspeção editorial da palavra **mensagem** — o **conteúdo que se envia** (e o plural **mensagens**): recado, SMS, chat, nota deixada, comunicado. Tipografia de entrada: «sm,enajsos» → **mensagem**. Esta ficha cobre o **objeto**, os **sentidos** (comunicação · era digital · «deixar mensagem»), o contraste **${eloSinal} ≠ mensagem**, e o fecho [Valeu !!!](${mantra}). Tom: **Inspetor BudGanja** — ofício cálido, sem sermão de «desliga o telemóvel». Elos: ${eloGesto} · ${eloLingua}${hasSinal ? ' · ' + eloSinal : ''}.
...
| **Fechar** | Depois de enviar | [Valeu !!!](${mantra}) — a melhor mensagem possível **hoje** |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — a melhor mensagem possível **hoje** (clara, honesta, com destino) |
...
**Veredicto:** Valeu !!! **com a mensagem** — conteúdo com destino, na era do chat, sem confundir com ${hasSinal ? eloSinal : 'sinal'}. Mensagem sem ${hasGesto ? eloGesto : 'gesto'} = bolha vazia; mensagem com ofício = comunicação que o lab respeita.
...
**H4:** fecho = [Valeu !!!](${mantra}) — a melhor mensagem possível hoje.
...
**Aprovado** — **mensagem** / **mensagens** fichada: objeto (*mittere* → message), tipografia sm,enajsos, sentidos (comunicação · SMS/chat · deixar mensagem), contraste ${eloSinal} ≠ mensagem, elos ${eloGesto} · ${eloLingua}; [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Gesto](${gesto}) · [▶ Língua portuguesa](${lingua})${hasSinal ? ' · [▶ Sinal](' + sinalHref + ')' : ''} · [▶ Verdade](${verdade}) · [▶ Comunidade](${comunidade}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **mensagem** (message; plural **mensagens**) — content that is sent: note, SMS, chat, voicemail. Entry typo: “sm,enajsos” → **mensagem**. Covers **object**, **senses** (communication · digital era · “leave a message”), contrast **${hasSinal ? 'sinal' : 'signal'} ≠ message**, and [Valeu !!!](${mantra}). Links: ${eloGesto} · ${eloLingua}${hasSinal ? ' · ' + eloSinal : ''}.
...
| Links | ${eloGesto} · ${eloLingua} · ${eloSinal} · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · senses · signal ≠ message · SMS/chat · leave a message · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Gesture](${gesto}) · [▶ Portuguese](${lingua})${hasSinal ? ' · [▶ Signal](' + sinalHref + ')' : ''} · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **mensagem** (mensaje; plural **mensagens**) — el **contenido que se envía**: recado, SMS, chat, buzón. Tipografía: «sm,enajsos» → **mensagem**. Cubre **objeto**, **sentidos** (comunicación · era digital · «dejar mensaje»), contraste **${hasSinal ? 'sinal' : 'señal'} ≠ mensaje**, y [¡Valeu !!!](${mantra}). Vínculos: ${eloGesto} · ${eloLingua}${hasSinal ? ' · ' + eloSinal : ''}.
...
| Vínculos | ${eloGesto} · ${eloLingua} · ${eloSinal} · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · sentidos · señal ≠ mensaje · SMS/chat · dejar mensaje · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Gesto](${gesto}) · [▶ Lengua portuguesa](${lingua})${hasSinal ? ' · [▶ Señal](' + sinalHref + ')' : ''} · [▶ ¡Valeu !!!](${mantra})
`;

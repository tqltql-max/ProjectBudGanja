 ...
 * sinais ≠ signo ≠ mensagem · Faça o melhor!
 */
...
| Elo corpo | [gesto](${gesto}) · [tônus](${tonos}) · [coração](${coracao}) · [água](${agua}) · [sol](${sol}) |
...
| **Fechar** | Depois de ler, agir | [Faça o melhor!](${mantra}) **com os sinais que há** |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **com os sinais à vista**, hoje |
...
**Veredicto:** Faça o melhor **com os sinais REM** — separar as duas leituras, ler o campo, modular. Sinais sem [verdade](${verdade}) = alarme falso; sinais com ofício = mapa curto.
...
**H4:** fecho = [Faça o melhor!](${mantra}) lendo o campo, não inventando o mapa.
...
**Aprovado** — **sinais REM** fichados: plural de [sinal](${sinal}), dois REM (sono × sigla lab), campo ≠ mensagem, elos [gesto](${gesto}) · [nap](${nap}) · [eCBome](${ecbome}); [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Sinal](${sinal}) · [▶ Gesto](${gesto}) · [▶ Nap](${nap}) · [▶ Sidarta](${sidarta}) · [▶ Endocanabinoidoma](${ecbome}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **[sinais REM](${self})** — the **field of marks** (plural of [sinal](${sinal})) under **two REM readings that do not fuse**: (1) **REM sleep** (*Rapid Eye Movement*), (2) the lab acronym **Relaxation · Endocannabinoid · Modular**. Contrast: signals ≠ sign-name ≠ [mensagem](${mensagem}). Links: [gesto](${gesto}), [nap](${nap}), [Sidarta](${sidarta}), [endocannabinoidome](${ecbome}), [Do your best!](${mantra}).
...
**Approved** — plural field · two REM · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Sinal](${sinal}) · [▶ Nap](${nap}) · [▶ Do your best!](${mantra})
`;
...
**Aprobado** — campo en plural · dos REM · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Sinal](${sinal}) · [▶ Nap](${nap}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildSinaisRemPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «sinais REM» — plural de sinal; sono Rapid Eye Movement × sigla lab Relaxamento·Endocanabinoide·Modular; elos gesto, nap, eCBome; Faça o melhor!',
    excerptEn:
      'Words: “sinais REM” — plural of sinal; Rapid Eye Movement sleep × lab acronym Relaxation·Endocannabinoid·Modular; links gesto, nap, eCBome; Do your best!',
    excerptEs:
      'Palabras: «sinais REM» — plural de sinal; sueño Rapid Eye Movement × sigla lab Relajación·Endocanabinoide·Modular; vínculos gesto, nap, eCBome; ¡Haz lo mejor!',

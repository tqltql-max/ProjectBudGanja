...
**H5:** fecho = [Valeu !!!](${mantra}) — o melhor *cuidado de hoje*, sem púlpito e **sem** protocolo clínico.
...
| **Ofício** | Cuidar hoje | [Valeu !!!](${mantra}) |
...
| [Valeu !!!](${mantra}) | Ofício | Depois do diagnóstico — o [gesto](${gesto}) |
...
| [Valeu !!!](${mantra}) · [poema mantra](${poemMantra}) | Depois da ficha — o ofício |
...
**Aprovado na série Pessoas** — Lucas Evangelista fichado como **companheiro que trata e escreve**; epíteto **médico de homens e de almas** com as duas metades declaradas (texto × tradição); **fora** dos [Doze](${doze}); inteireza com [templo](${templo}); fecho [Valeu !!!](${mantra}).

[▶ Pessoas](${hub}) · [▶ os doze apóstolos](${doze}) · [▶ templo](${templo}) · [▶ alma](${alma}) · [▶ Poema Vida](${poem}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [temple, body and soul](${templo}) · [filho de deus](${filhoDeDeus}) · [soul](${alma}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**H4:** close with [Valeu !!!](${mantra}) — today’s care, no pulpit, **no** clinical protocol.
...
**Approved in People** — Luke the Evangelist as the **companion who treats and writes**; epithet with both halves declared (text × tradition); **outside** the [Twelve](${doze}); wholeness with [temple](${templo}); [Valeu !!!](${mantra}).

[▶ People](${hub}) · [▶ the Twelve](${doze}) · [▶ temple](${templo}) · [▶ soul](${alma}) · [▶ Vida poem](${poem}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
| Vínculos | [templo, cuerpo y alma](${templo}) · [filho de deus](${filhoDeDeus}) · [alma](${alma}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**H4:** cierre = [¡Valeu !!!](${mantra}) — el cuidado de hoy, sin púlpito, **sin** protocolo clínico.
...
**Aprobado en Personas** — Lucas el Evangelista como el **compañero que trata y escribe**; epíteto con las dos mitades declaradas (texto × tradición); **fuera** de los [Doce](${doze}); entereza con [templo](${templo}); [¡Valeu !!!](${mantra}).

[▶ Personas](${hub}) · [▶ los Doce](${doze}) · [▶ templo](${templo}) · [▶ alma](${alma}) · [▶ Poema Vida](${poem}) · [▶ ¡Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildLucasEvangelistaPost(seriesOrder) {
  ...
  return figuraPost({
    ...
    excerpt:
      'Pessoas: Lucas Evangelista — médico amado (Col 4,14) e epíteto «de almas» (tradição); fora dos Doze; corpo e alma sem partir o templo; Valeu !!!',
    excerptEn:
      'People: Luke the Evangelist — beloved physician (Col 4:14) and “of souls” epithet (tradition); not one of the Twelve; body and soul without splitting the temple; Valeu !!!',
    excerptEs:
      'Personas: Lucas el Evangelista — médico amado (Col 4,14) y epíteto «de almas» (tradición); fuera de los Doce; cuerpo y alma sin partir el templo; ¡Valeu !!!',

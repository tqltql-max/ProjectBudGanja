...
| Elo ofício | [gesto](${gesto}) · [skill](${skill}) · [caminho](${caminho}) · [Faça o melhor!](${mantra}) |
...
4. Fechar com [Faça o melhor!](${mantra}) — trabalho visível, não triângulo no ar.
...
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — o melhor **com as mãos**, hoje |
...
**Veredicto:** Faça o melhor **sem a tecla mágica** — abracadabra como fórmula inspecionada; abacadabra como boca viva; nenhum dos dois como substituto do rasto.
...
**H4:** fecho [Faça o melhor!](${mantra}); ficha ≠ grimório.
...
| [Faça o melhor!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) | Fecho sem atalho |
...
**Aprovado** — **abracadabra** fichado; **abacadabra** como lapso oral; anti-atalho; elos [gesto](${gesto}) · [skill](${skill}) · [verdade](${verdade}); fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Gesto](${gesto}) · [▶ Skill](${skill}) · [▶ Verdade](${verdade}) · [▶ Fantástico](${fantastico}) · [▶ Faça o melhor!](${mantra})
`;
...
| Links | [gesture](${gesto}) · [skill](${skill}) · [truth](${verdade}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Abracadabra ≠ shortcut key.** If you hear abacadabra, read abracadabra. Admire the trick without handing the work to the sound. Close with [Do your best!](${mantra}).

## Status

**Approved** — written anchor × oral slip; anti-shortcut; links [gesture](${gesto}) · [skill](${skill}); [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Gesture](${gesto}) · [▶ Skill](${skill}) · [▶ Do your best!](${mantra})
`;
...
| Vínculos | [gesto](${gesto}) · [skill](${skill}) · [verdad](${verdade}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Abracadabra ≠ tecla de atajo.** Si oyes abacadabra, lee abracadabra. Admirar el truco sin entregar el oficio al sonido. Cerrar con [¡Haz lo mejor!](${mantra}).

## Estado

**Aprobada** — ancla escrita × lapsus oral; anti-atajo; vínculos [gesto](${gesto}) · [skill](${skill}); [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Gesto](${gesto}) · [▶ Skill](${skill}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildAbracadabraPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «abracadabra» — âncora escrita; «abacadabra» = lapso oral; amuleto romano × cue de palco × anti-atalho; elos gesto, skill e verdade; Faça o melhor!',
    excerptEn:
      'Words: “abracadabra” — written anchor; “abacadabra” = oral slip; Roman amulet × stage cue × anti-shortcut; links gesture, skill and truth; Do your best!',
    excerptEs:
      'Palabras: «abracadabra» — ancla escrita; «abacadabra» = lapsus oral; amuleto romano × cue de escenario × anti-atajo; vínculos gesto, skill y verdad; ¡Haz lo mejor!',

...
**Gatilho:** *script* / *scripts* / *scriptar* / *roteiro* / \`<script>\` → lema **script**. *JavaScript* / *java + script* → ficha [JavaScript](${javascript}).
...
| Família | *scripts* · *scriptar* (verbo informal) · [JavaScript](${javascript}) · *shell script* · \`<script>\` · *screenplay* |
...
| [JavaScript](${javascript}) | Composto Java + Script — a língua desta casa; ≠ a língua Java |
...
- JavaScript tem ficha própria ([JavaScript](${javascript})); aqui entra só como **registo social** do empréstimo *script*.  
...
[▶ Palavras](${hub}) · [▶ JavaScript](${javascript}) · [▶ Skill](${skill}) · [▶ Pattern](${pattern}) · [▶ Commitar](${commitar}) · [▶ Opsert](${upsert}) · [▶ Todas as inspeções](${hubAll}) · [▶ Valeu !!!](${mantra})
`;

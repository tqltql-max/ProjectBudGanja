...
| Escala oral irmã | [Deus abençoe](${deusAbencoe}) · [filho de deus](${filhoDeDeus}) · [jesusamando](${jesusamando}) / [meudeusdoceu](${meudeusdoceu}) |
...
| **Ofício** | Depois do aviso — trabalhar | [Faça o melhor!](${mantra}) |
...
| [jesusamando](${jesusamando}) / [meudeusdoceu](${meudeusdoceu}) | Afeto / assombro | Calor ou espanto |
...
| **Fechar com ofício** | Depois da frase | [Faça o melhor!](${mantra}) |
...
| [Faça o melhor!](${mantra}) | Depois do aviso — o ofício |
...
**Aprovado na série Expressões e Ditados populares** — *Deus deu dois ouvidos e uma boca* fichado como **ditado de proporção** (ouvir 2× / falar 1×); tipografia **dois pouvi → dois ouvidos**; irmã de [Deus abençoe](${deusAbencoe}) / [filho de deus](${filhoDeDeus}); fecho [Faça o melhor!](${mantra}).

[▶ Expressões](${hub}) · [▶ Deus abençoe](${deusAbencoe}) · [▶ filho de deus](${filhoDeDeus}) · [▶ mensagem](${mensagem}) · [▶ Língua portuguesa](${lingua}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [Deus abençoe](${deusAbencoe}) · [filho de deus](${filhoDeDeus}) · [message](${mensagem}) · [gesture](${gesto}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — proportion · listening · mouth craft; [Do your best!](${mantra}).

[▶ Expressions](${hub}) · [▶ Deus abençoe](${deusAbencoe}) · [▶ Do your best!](${mantra}) · [▶ Vida](${vida})
`;
...
| Vínculos | [Deus abençoe](${deusAbencoe}) · [filho de deus](${filhoDeDeus}) · [mensaje](${mensagem}) · [gesto](${gesto}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — proporción · escucha · oficio de la boca; [¡Haz lo mejor!](${mantra}).

[▶ Expresiones](${hub}) · [▶ Deus abençoe](${deusAbencoe}) · [▶ ¡Haz lo mejor!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildDeusDeuDoisOuvidosPost() {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «Deus deu dois ouvidos e uma boca» — ouvir 2× / falar 1×; tipografia dois pouvi → dois ouvidos; sem proselitismo; Faça o melhor!',
    excerptEn:
      'Sayings: “Deus deu dois ouvidos e uma boca” — listen 2× / speak 1×; tipography dois pouvi → dois ouvidos; no proselytizing; Do your best!',
    excerptEs:
      'Dichos: «Deus deu dois ouvidos e uma boca» — oír 2× / hablar 1×; tipografía dois pouvi → dois ouvidos; sin proselitismo; ¡Haz lo mejor!',

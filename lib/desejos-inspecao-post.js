...
| **Faça o melhor** | Ofício | Um gesto hoje, sem pack |
...
5. Fechar com [Faça o melhor!](${mantra}) — não com o terceiro pedido.
...
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — um feito, não três milagres |
...
**H4:** fecho [Faça o melhor!](${mantra}); ficha ≠ lista de pedidos.
...
| [Faça o melhor!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) | Fecho sem pack |
...
**Aprovado** — **desejos** fichados como vontade (*desiderium*) × pack do conto; quota em [três](${tres}); fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Lâmpada](${lampada}) · [▶ Esfregar](${esfregar}) · [▶ Três](${tres}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Inspection of Portuguese **desejos** (“wishes”; singular **desejo**). After rubbing the [lamp](${lampada}), this is the **content** the genie is paid to deliver. Living PT: will / appetite / project. In popular [Aladdin](${wikiAladim}) retellings, wishes come as a **pack** — often [three](${tres}). A wish **points**; craft **walks**. Links: [esfregar](${esfregar}), [abracadabra](${abracadabra}), [Do your best!](${mantra}).
...
**Los deseos apuntan; el oficio cumple.** Si la boca dijo **3**, ver [três](${tres}). Cerrar con [¡Haz lo mejor!](${mantra}).

## Estado

**Aprobada** — voluntad × pack del cuento; cuota en la ficha hermana.

[▶ Palabras](${hub}) · [▶ Lámpara](${lampada}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildDesejosPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «desejos» (*desiderium*) — vontade viva × pack do génio; quota muitas vezes três; ≠ gesto; elos lâmpada, esfregar e três; Faça o melhor!',
    excerptEn:
      'Words: “desejos” (*desiderium*) — living will × genie pack; quota often three; ≠ gesture; links lamp, rub and three; Do your best!',
    excerptEs:
      'Palabras: «desejos» (*desiderium*) — voluntad × pack del genio; cuota a menudo tres; ≠ gesto; vínculos lámpara, frotar y tres; ¡Haz lo mejor!',

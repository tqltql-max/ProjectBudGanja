...
[Tamara Klink](${TAMARA}) · [Legado](${LEGADO}) · [Todas as inspeções](/biblioteca/inspecoes/)`;
...
| Embarcação | *Sardinha* / *Sardinha 2* |
...
| 2020 | 1.ª travessia em solitário (Mar do Norte) com o *Sardinha*. |
...
| 2023–2024 | Expedição França → Groenlândia; invernagem sozinha no gelo ártico (~8 meses) — *Bom dia, Inverno* (2026). |
...
|-------------|------------------|
| Pai / origem do ofício | [Amyr Klink](${AMYR}) |
...
**Aprovado com mérito máximo como referência de legado vivo exploratório** — Tamara Klink · Cap. 8, **junto do pai** Amyr · Cap. 7.

[Amyr Klink](${AMYR}) · [Legado](${LEGADO}) · [Todas as inspeções](/biblioteca/inspecoes/)`;
...
**Approved with highest merit** — living exploratory legacy · Cap. 8, beside Cap. 7 [Amyr](${AMYR}).`;
...
**Aprobado con mérito máximo** — legado vivo exploratorio · Cap. 8, junto al Cap. 7 [Amyr](${AMYR}).`;

...
const SITE_TAMARA_FICHA = '/posts/post-inspecao-site-tamaraklink.html';
...
const WIKI_HG = 'https://pt.wikipedia.org/wiki/Editora_Horizonte';
...
O laboratório documenta **crédito a quem merece**. Amyr é referência nacional de quem **parte** depois de planear — cem dias entre céu e mar, Antártida, circum-navegações. Sem o pai, a ficha da [Tamara](${TAMARA}) ficaria órfã de contexto. Colocá-los **juntos** no Legado é método, não coincidência. Em **1987** o mesmo ofício sentou-se no conselho da revista [Horizonte Geográfico](${HG}) — mapa e planta noutro papel; a ficha da revista trata a **relação com o projecto**.
...
| 1987 | Conselho editorial / sócio fundador da revista [Horizonte Geográfico](${HG}) — [WP editora](${WIKI_HG}). |
...
| Revista (mapa × planta) | [Horizonte Geográfico](${HG}) — âncora Artes; *Orizonte* = o H |
...
- Revista: [Horizonte Geográfico](${HG}) · [Editora Horizonte (WP)](${WIKI_HG})
...
| Site oficial | [tamaraklink.com](${SITE_TAMARA}) · [inspeção do site](${SITE_TAMARA_FICHA}) — **pessoa ≠ site ≠ canal** |
| Data da inspeção | ${inspected} |
...
| Hub Legado | [Inspeções · Legado](${LEGADO}) |
| Site oficial | [tamaraklink.com](${SITE_TAMARA}) · [carta náutica digital](${SITE_TAMARA_FICHA}) |

## Créditos e referências

- [Wikipédia · Tamara Klink](${WIKI_TAMARA})
- [Site oficial](${SITE_TAMARA}) · [Inspeção do site](${SITE_TAMARA_FICHA})
...
**Aprovado com mérito máximo como referência de legado vivo exploratório** — Tamara Klink · Cap. 8, **junto do pai** Amyr · Cap. 7. O arquivo YouTube vive na [ficha do canal](${CANAL_TAMARA}); a carta digital vive na [inspeção do site](${SITE_TAMARA_FICHA}).

[Amyr Klink](${AMYR}) · [Site](${SITE_TAMARA_FICHA}) · [Canal YouTube](${CANAL_TAMARA}) · [Vídeos](${VIDEOS_TAMARA}) · [Legado](${LEGADO}) · [Todas as inspeções](/biblioteca/inspecoes/)`;

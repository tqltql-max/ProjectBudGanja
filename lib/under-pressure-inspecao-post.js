 ...
 * elos BudGanja: coração / medo / esperança / Faça o melhor!
...
| Pedido de cuidado | [esperança](${esperanca}) · [alma](${alma}) · [Faça o melhor!](${mantra}) |
...
| Dueto (não duelo) | [gesto](${gesto}) de partilha — ver [Faça o melhor!](${mantra}) |
...
| [alma](${alma}) · [emoção](${emocao}) · [gesto](${gesto}) · [Faça o melhor!](${mantra}) | Ofício de responder sem esmagar |
...
[▶ Áudio](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=under-pressure) · [▶ Coração](${coracao}) · [▶ Medo](${medo}) · [▶ Faça o melhor!](${mantra})
`;

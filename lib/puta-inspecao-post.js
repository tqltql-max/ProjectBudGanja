 ...
 * elo pariu / puta que pariu · respeito · Valeu !!!
 */
...
| [Valeu !!!](${mantra}) | Depois do palavrão — o ofício |

## 5. Valeu !!!

| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **também na boca**, hoje |
| Anti-armadilha | «É só gíria» ≠ apaga o estigma · «inspecionar» ≠ repetir o golpe |
| Par vivo | [respeito](${respeito}) · [pqp](${pqp}) · [pariu](${pariu}) |

**Veredicto:** Valeu !!! **ao nomear o tabu**. A palavra pode medir tamanho; não deve medir o valor de uma pessoa.
...
[▶ Palavras](${hub}) · [▶ Pariu](${pariu}) · [▶ Puta que pariu](${pqp}) · [▶ Respeito](${respeito}) · [▶ Valeu !!!](${mantra}) · [▶ Todas](${hubAll})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **puta** — from Vulgar Latin *putta* (“girl”) to pejorative and Brazilian intensifier (“a puta festa”). Links [pariu](${pariu}), [puta que pariu](${pqp}), [respeito](${respeito}), [Valeu !!!](${mantra}).
...
**Approved** — taboo mapped · intensifier noted · [Valeu !!!](${mantra}).
...
Inspección de **puta** — del latín vulgar *putta* («niña») al peyorativo y al intensificador BR. Vínculos [pariu](${pariu}), [puta que pariu](${pqp}), [respeito](${respeito}), [¡Valeu !!!](${mantra}).
...
**Aprobado** — tabú mapeado · intensificador · [¡Valeu !!!](${mantra}).
...
function buildPutaPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «puta» — lat. vulg. putta; pejorativo e intensificador BR; elos pariu, PQP, respeito; Valeu !!!',
    excerptEn:
      'Words: “puta” — VL putta; pejorative and BR intensifier; links pariu, PQP, respeito; Valeu !!!',
    excerptEs:
      'Palabras: «puta» — lat. vulg. putta; peyorativo e intensificador BR; vínculos pariu, PQP, respeito; ¡Valeu !!!',

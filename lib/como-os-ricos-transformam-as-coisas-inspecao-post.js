...
| Elo ofício | [pesquisa ofício / roubo / proibição](${oficio}) · [proibição](${proibicao}) · [Faça o melhor!](${mantra}) |
| Data | ${inspected} |
...
| **Ofício lab** | Depois de ver o mapa — trabalhar | [Faça o melhor!](${mantra}) |
...
**H4:** fecho = [verdade](${verdade}) + [ofício](${oficio}) + [Faça o melhor!](${mantra}) — sem tanque, com inspeção ([Killing in the Name](${killing}) como eco: máquina que mata no nome da ordem).
...
| **Agir depois** | Recusar só consumir sem mapa | [Faça o melhor!](${mantra}) · [poema](${poemMantra}) |
...
**Faça o melhor!** — o melhor possível **nesta inspeção das coisas**, hoje.
...
[▶ História das Coisas](${historia}) · [▶ Annie Leonard](${annie}) · [▶ Objetos](${objetos}) · [▶ Faça o melhor!](${mantra})
`;
...
Ask **how** power transforms extraction→product→waste. Leonard’s linear machine is the reading guide; this phrase is the oral refrain. Close with [Do your best!](${mantra}).

## Status

**Approved.**

[▶ Story of Stuff](${historia}) · [▶ Annie](${annie}) · [▶ Do your best!](${mantra})
`;
...
Preguntar **cómo** el poder transforma extracción→producto→basura. El ciclo de Leonard es la guía; esta frase es el estribillo. Cierre [¡Haz lo mejor!](${mantra}).

## Estado

**Aprobada.**

[▶ Historia de las cosas](${historia}) · [▶ Annie](${annie}) · [▶ ¡Haz lo mejor!](${mantra})
`;

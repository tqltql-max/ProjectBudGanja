 ...
 * afectos irmãos · ofício vivo BR · Valeu !!!
 */
...
Inspeção editorial da palavra **esperança** — afecto de **ainda-por-vir**, no português do Brasil, sem sermão. Esta ficha cobre o **objeto** (latim *spēs* / *sperāre* → *sperantia*), a diferença útil entre **esperar** e **esperança**, a **rede afectiva** com fichas já existentes, e o fecho [Valeu !!!](${mantra}). Elos: [emoção](${emocao}), [alegria](${alegria}), [medo](${medo}), [tristeza](${tristeza}), [caminho](${caminho}), [coração](${coracao}), [Vida](${vida}) / [Diário](${diario}).
...
| Elo ofício | [caminho](${caminho}) · [verdade](${verdade}) · [coração](${coracao}) · [Valeu !!!](${mantra}) |
...
**H3:** esperança sem [caminho](${caminho}) vira slogan; com método, vira combustível para [Valeu !!!](${mantra}).
...
| **Motivação de ofício** | Seguir o projecto, a planta, o texto | [Valeu !!!](${mantra}) + [caminho](${caminho}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **hoje**, com a esperança que cabe neste passo |
...
**Veredicto:** Valeu !!! **com esperança** — a que caminha. Esperança sem [caminho](${caminho}) = cartão; esperança com método = fresta que fica.
...
**H4:** fecho = [Valeu !!!](${mantra}) com fresta viva, sem sermão.
...
**Aprovado** — **esperança** fichada: objeto (*spēs* / *sperantia*), espera × esperança, rede afectiva e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Emoção](${emocao}) · [▶ Alegria](${alegria}) · [▶ Medo](${medo}) · [▶ Tristeza](${tristeza}) · [▶ Caminho](${caminho}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **esperança** (hope) — a lived “still-possible” affect in Brazilian Portuguese, without sermon. Covers **object** (Lat. *spēs* / *sperāre* → *sperantia*), **esperar** vs **esperança**, the affective network of existing sheets, and [Valeu !!!](${mantra}). Links: [emoção](${emocao}), [alegria](${alegria}), [medo](${medo}), [tristeza](${tristeza}), [caminho](${caminho}), [coração](${coracao}), [Vida](${vida}).
...
| Links | [emoção](${emocao}) · [alegria](${alegria}) · [medo](${medo}) · [tristeza](${tristeza}) · [caminho](${caminho}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name the affect · keep a crack open · walk with [truth](${verdade}) · close with [Valeu !!!](${mantra}). Culture echoes: [Lágrimas da Vida](${lagrimas}) · [Three Little Birds](${birds}).
...
**Approved** — object · wait×hope · affective net · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Emoção](${emocao}) · [▶ Alegria](${alegria}) · [▶ Medo](${medo}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **esperança** (esperanza) — afecto vivido de «aún-posible» en el portugués de Brasil, sin sermón. Cubre **objeto** (lat. *spēs* / *sperāre* → *sperantia*), **esperar** × **esperança**, red afectiva de fichas existentes y [¡Valeu !!!](${mantra}). Vínculos: [emoção](${emocao}), [alegria](${alegria}), [medo](${medo}), [tristeza](${tristeza}), [caminho](${caminho}), [coração](${coracao}), [Vida](${vida}).
...
| Vínculos | [emoção](${emocao}) · [alegria](${alegria}) · [medo](${medo}) · [tristeza](${tristeza}) · [caminho](${caminho}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar · mantener una rendija · caminar con [verdad](${verdade}) · cerrar con [¡Valeu !!!](${mantra}). Ecos: [Lágrimas da Vida](${lagrimas}) · [Three Little Birds](${birds}).
...
**Aprobada** — objeto · esperar×esperança · red afectiva · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Emoção](${emocao}) · [▶ Alegria](${alegria}) · [▶ Medo](${medo}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildEsperancaPost(seriesOrder) {
  ...
  return makePalavra({
    title: 'Inspeção: Esperança — afecto vivo, espera com ofício e Valeu !!!',
    titleEn: 'Inspection: Esperança — lived hope, waiting with craft and Valeu !!!',
    titleEs: 'Inspección: Esperança — esperanza vivida, espera con oficio y ¡Valeu !!!',
    excerpt:
      'Palavras: «esperança» (lat. *spēs* / *sperantia*) — afecto vivo BR; esperar × esperança; rede com alegria, medo, tristeza; Valeu !!!',
    excerptEn:
      'Words: “esperança” (Lat. *spēs* / *sperantia*) — lived BR hope; wait vs hope; links to joy, fear, sadness; Valeu !!!',
    excerptEs:
      'Palabras: «esperança» (lat. *spēs* / *sperantia*) — esperanza vivida BR; esperar × esperança; red con alegría, miedo, tristeza; ¡Valeu !!!',

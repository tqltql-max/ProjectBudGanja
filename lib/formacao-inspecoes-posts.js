...
function buildUnifespCannabisMedicinalPost() {
  return formacaoPost({
    ...
    titleEn: 'Inspection: UNIFESP course — medicinal Cannabis sativa L.',
    titleEs: 'Inspección: curso UNIFESP — Cannabis sativa L. medicinal',
    excerpt:
    ...
    coverImage: '/imagens/inspecoes/curso-unifesp-cover.jpg',
    body: `## Escopo
...
4. **Módulos de cultivo** — alinham-se parcialmente ao [Guia de Cultivo Básico](/biblioteca/inspecoes/) e à [propagação/clonagem](/posts/post-otimizacao-propagacao-vegetal.html) do laboratório, mas **sem métricas de ambiente** (PPFD, VPD, EC) exigidas no nosso diário.
...
| Plantio, clonagem, cultivo orgânico | [Propagação e clonagem](/posts/post-otimizacao-propagacao-vegetal.html) · [Diário de pesquisas](/cultivo/) |
| Ambiente indoor (não central no curso) | [PPFD indoor](/posts/post-guia-calculadora-luximetro.html) · [Calculadora Luxímetro](/calculadoras/luximetro.html) · [VPD](/calculadoras/cultivo-lab.html?mode=vpd) |
| Nutrição e substrato | [Nutrição](/posts/post-guia-calculadora-super-solo.html) · [Solo vivo](/posts/post-guia-calculadora-super-solo.html) |
...
const { buildCebridInspecaoPost, buildCebridBodies } = require('./cebrid-inspecao-post.js');

const FORMACAO_INSPECOES_POSTS = [

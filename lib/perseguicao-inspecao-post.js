 ...
 * prosseguir × caminho × risco · EXIT · Valeu !!!
 */
...
Inspeção editorial da palavra **perseguição** — substantivo do acto de **perseguir**: caça, opressão política/religiosa, assédio obsessivo, e, no peito, a ideia de ser **seguido** sem trégua. Esta ficha cobre o **objeto** (latim *persequī* / *persequor* ← *per-* + *sequī*), a família (*perseguir*, *perseguido*…), o contraste com [prosseguir](${prosseguir}), e o fecho [Valeu !!!](${mantra}).
...
**H4:** fecho = [EXIT](${exit}) + [Valeu !!!](${mantra}) — sair do aperto com método, não com fuga cega.
...
| [Valeu !!!](${mantra}) | Ofício no aperto — o melhor possível **hoje** |
...
5. Fechar com [Valeu !!!](${mantra}) — e voltar ao [hub](${hubAll}).
...
**Aprovado** — **perseguição** fichada: *persequī*, camadas (caça × opressão × obsessão × peito), contraste com [prosseguir](${prosseguir}), rede com [caminho](${caminho}), [risco](${risco}), [EXIT](${exit}) e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Prosseguir](${prosseguir}) · [▶ EXIT](${exit}) · [▶ Risco](${risco}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **perseguição** (“persecution / pursuit”) — the act of **perseguir**: chase, political/religious oppression, obsessive stalking, and the felt sense of being followed. Covers **object** (Lat. *persequī* / *persequor* ← *per-* + *sequī*), family (*perseguir*…), contrast with [prosseguir](${prosseguir}), and [Valeu !!!](${mantra}).
...
| Links | [prosseguir](${prosseguir}) · [caminho](${caminho}) · [EXIT](${exit}) · [risco](${risco}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — *persequī* · layers mapped · links to prosseguir, EXIT, risco · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Prosseguir](${prosseguir}) · [▶ EXIT](${exit}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de la palabra portuguesa **perseguição** («persecución / persecución de rastro») — acto de **perseguir**: caza, opresión política/religiosa, acoso obsesivo y la sensación de ser seguido. Cubre el **objeto** (lat. *persequī* / *persequor* ← *per-* + *sequī*), la familia (*perseguir*…), el contraste con [prosseguir](${prosseguir}), y [¡Valeu !!!](${mantra}).
...
| Vínculos | [prosseguir](${prosseguir}) · [caminho](${caminho}) · [EXIT](${exit}) · [risco](${risco}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — *persequī* · capas mapeadas · vínculos con prosseguir, EXIT, risco · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Prosseguir](${prosseguir}) · [▶ EXIT](${exit}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildPerseguicaoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «perseguição» (lat. *persequī*) — caça × opressão × obsessão; contraste prosseguir; elos caminho, risco, EXIT; Valeu !!!',
    excerptEn:
      'Words: “perseguição” (Lat. *persequī*) — chase × oppression × obsession; contrast prosseguir; links caminho, risco, EXIT; Valeu !!!',
    excerptEs:
      'Palabras: «perseguição» (lat. *persequī*) — caza × opresión × obsesión; contraste prosseguir; vínculos caminho, risco, EXIT; ¡Valeu !!!',

...
| **Fechar** | Depois do mapa | [Valeu !!!](${mantra}) |
...
| [Corda](${corda}) · [teoria das cordas](${teoriaCordas}) | O **fio** (χορδή) e o programa de física; *tónos* é a **tensão** que faz soar — não a supercorda |
| [Afinar](${afinar}) | O gesto de aplicar o *tónos* na cravelha |
...
**Aprovado na série Palavras** — *tónos* fichado como **raiz da tensão**; [tônico](${tonico}) e [isotônico](${isotonico}) ao lado; tríade [vomitar](${vomitar}) · [commitar](${commitar}); fecho [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Tônico](${tonico}) · [▶ Vomitar](${vomitar}) · [▶ Commitar](${commitar}) · [▶ Valeu !!!](${mantra})
`;
...
| Links | [tônico](${tonico}) · [isotônico](${isotonico}) · [vomitar](${vomitar}) · [commitar](${commitar}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Verdict:** root sheet approved; [Valeu !!!](${mantra}) after the map.
...
| Vínculos | [tônico](${tonico}) · [isotônico](${isotonico}) · [vomitar](${vomitar}) · [commitar](${commitar}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Veredicto:** raíz aprobada; [¡Valeu !!!](${mantra}) después del mapa.
...
function buildTonosPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «tónos» (τόνος) — raiz da tensão; ≠ mapa PT tônico; tríade vomitar / commitar; Valeu !!!',
    excerptEn:
      'Words: “tónos” (τόνος) — root of tension; ≠ PT map tônico; triad vomitar / commitar; Valeu !!!',
    excerptEs:
      'Palabras: «tónos» (τόνος) — raíz de la tensión; ≠ mapa PT tônico; tríada vomitar / commitar; ¡Valeu !!!',

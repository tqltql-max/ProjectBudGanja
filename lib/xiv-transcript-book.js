...
/**
 * Livro Vol. 1 — legendas PT das aulas XIV (MovReCam / UNIFESP).
 */
...
`;
  ...
  const md = `# XIV Curso UNIFESP — Cannabis medicinal (Vol. 1)
...
<head>
    ...
    <meta name="description" content="Livro Vol. 1: legendas das aulas da XIV edição UNIFESP / MovReCam — transcrições para estudo (Inspetor BudGanja).">
    <meta property="og:title" content="Livro XIV UNIFESP · Vol. 1 | Inspetor BudGanja">
    <meta property="og:description" content="Transcrições / legendas PT das aulas da XIV edição do curso de cannabis medicinal UNIFESP + MovReCam.">
    ...
    <title>Livro XIV UNIFESP · Vol. 1 | Inspetor BudGanja</title>
    <style>
...
<body data-page="unifesp-livro-xiv">
    ...
    <main id="main-content" class="article-page relatorio-container livro-page">
        <header class="article-header">
            <p class="article-eyebrow">Formação · UNIFESP · Livro Vol. 1</p>
            <h1>XIV Curso — legendas das aulas</h1>
            <p class="page-intro">Transcrições em português das aulas catalogadas da XIV edição (MovReCam), para revisão e estudo. Gerado a partir das legendas do YouTube.</p>
        </header>

        <aside class="unifesp-disclaimer" role="note">
            <strong>Estudo / revisão.</strong>
            Legendadas muitas vezes por OCR automático do YouTube — podem ter erros.
        ...
        <p><strong>${ok.length}</strong> aulas com legenda${failed.length ? ' · <strong>' + failed.length + '</strong> sem legenda' : ''} · gerado ${escapeHtml(
...
${htmlChapters}
        ...
        <footer class="info-panel" style="margin-top:3rem">
            <p>Fonte: legendas YouTube · canal <a href="https://www.youtube.com/@MovReCam">@MovReCam</a> · compilação Inspetor BudGanja.</p>

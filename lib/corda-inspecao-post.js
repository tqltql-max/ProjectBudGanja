...
| **Música** | Corda de instrumento — mesmo avô grego; no BR canta no [violão](${violao}); baptismo da [teoria das cordas](${teoriaCordas}) |
...
[▶ Palavras](${hub}) · [▶ Objetos](${objetos}) · [▶ Nó](${no}) · [▶ Violão](${violao}) · [▶ Teoria das cordas](${teoriaCordas}) · [▶ Codorna](${codorna}) · [▶ Valeu !!!](${mantra})
`;

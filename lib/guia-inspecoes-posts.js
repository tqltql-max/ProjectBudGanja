...
|----------|---------------------------|-------------|
| Temperatura | 22–28 °C (dia) | Termo-higrômetro digital |
| UR ar | 55–70 % (vegetativo) | Termo-higrômetro |
| Fotoperíodo (veg.) | 18/6 h | Timer digital |
...
- Termo-higrômetro digital — leitura simultânea T e UR no dossel
- Timer de fotoperíodo — repetibilidade 18/6 ou 12/12
- Tomada inteligente Wi-Fi — registo remoto de ciclos luz/escuro

## Ferramentas do laboratório

- [Calculadora VPD](/calculadoras/cultivo-lab.html?mode=vpd) — validar déficit de pressão de vapor
...
- Medidor de pH da água — calibração semanal recomendada
- Balança digital de precisão — dosagem de fertilizantes
- Fertilizante NPK para plantas — linha vegetativo e floração

## Ferramentas do laboratório

- [Calculadora EC](/calculadoras/cultivo-lab.html?mode=ec)
- [Calculadora de diluição](/calculadoras/cultivo-lab.html?mode=diluicao)
...
- Substrato orgânico para plantas
- Perlita para cultivo
- Termo-higrômetro — UR do dossel em solo vivo (55–65 % veg.)

## Ferramentas do laboratório

- [Calculadora VPD](/calculadoras/cultivo-lab.html?mode=vpd) — ambiente do dossel
...
- **SCROG:** rede de treino nivela dossel; PPFD homogéneo reduz “pipoca” (buds inferiores improdutivos).
- **Folhas:** índice de área foliar (LAI) correlaciona com taxa fotossintética — remover apenas fan leaves que sombreiam gemas.

## Equipamentos verificados

- Rede SCROG para cultivo
- Tesoura de poda
- Painel LED full spectrum — uniformidade no dossel

## Ferramentas do laboratório

- [Calculadora Watts/m²](/calculadoras/cultivo-lab.html?mode=watts-m2)
...
| Variável | Alvo | Notas |
|----------|------|-------|
| Fotoperíodo | 12/12 h | Timer digital — sem fugas de luz |
| Temperatura | 20–26 °C | Calor noturno excessivo degrada terpenos |
| UR | 40–50 % | Reduz risco de botrytis |
| VPD | 1,0–1,4 kPa | [Calculadora VPD](/calculadoras/cultivo-lab.html?mode=vpd) |
...
- Timer fotoperíodo 12/12
- Tomada inteligente — confirmação de escuro absoluto
- Termo-higrômetro — UR baixa na floração

## Ferramentas do laboratório

- [Calculadora DLI](/calculadoras/cultivo-lab.html?mode=dli)
...
| Oxigenação (aeroponia) | 24 h contínuo | Bombinha de ar |

## Achados

- **Material-mãe:** plantas sadias, livres de pragas; últimos ramos vegetativos são ideais.
- **Clonadora 6 estacas:** pote + buchas + compressor de ar — baixo custo, documentada em [manual 6 estacas](/equipamentos/clonadora-6-estacas.html).
- **Clonadora 12 estacas:** aspersão com bomba submersa — maior throughput.
...
- Clonadora de 6 estacas — materiais
- Clonadora de 12 estacas — materiais
- Gel de enraizamento
...
| DLI | 18–24 mol/m²/d | 30–45 mol/m²/d | [Calculadora DLI](/calculadoras/cultivo-lab.html?mode=dli) |
| VPD | 0,8–1,2 kPa | 1,0–1,4 kPa | [Calculadora VPD](/calculadoras/cultivo-lab.html?mode=vpd) |
| T | 24–28 °C (luz) | 20–26 °C | Termo-higrômetro |
| Renovação ar | ~1,2 min⁻¹ | idem | Exaustor dimensionado |

## Achados

- **LED full spectrum:** posicionar a 30–45 cm do dossel; ajustar altura conforme [Watts/m²](/calculadoras/cultivo-lab.html?mode=watts-m2).
...
- **Automação:** tomada inteligente + timer segregam luz, exaustor e umidificador por fase.
- **Layout:** reservar espaço para acesso, espectro uniforme e manutenção do filtro.

## Equipamentos verificados

- Painel LED cultivo indoor
- Exaustor inline para tenda
- Ventilador de circulação
- Termo-higrômetro digital
- Timer e tomada inteligente

## Ferramentas do laboratório

- [Calculadora Luxímetro](/calculadoras/luximetro.html)
- [Calculadora VPD](/calculadoras/cultivo-lab.html?mode=vpd)
- [Calculadora Watts/m²](/calculadoras/cultivo-lab.html?mode=watts-m2)

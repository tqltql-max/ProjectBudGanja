...
<link rel="icon" href="/imagens/icon-192.png?v=${ASSET_VERSION}" sizes="192x192" type="image/png">
<link rel="icon" href="/imagens/favicon-48.png?v=${ASSET_VERSION}" sizes="48x48" type="image/png">
...
<link rel="shortcut icon" href="/favicon.ico?v=${ASSET_VERSION}" sizes="any">

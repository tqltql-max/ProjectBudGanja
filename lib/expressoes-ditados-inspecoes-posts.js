...
| Peça | Leitura laboratorial |
|------|----------------------|
| **[Faça](${self})** | Imperativo de [gesto](${gesto}) — acto, não pose |
| **[Melhor](${self})** | O possível honesto **nesta** mão — não a cópia do alheio |
...
[▶ Expressões](${hub}) · [▶ Poema Vida](${vida}#poema=faca-o-melhor) · [▶ Vida](${vida}) · [▶ Proibição](${proibicao}) · [▶ Gesto](${gesto})
`;

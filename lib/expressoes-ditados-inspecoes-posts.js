...
## Palavras de aviso (perigosa · uso cauteloso)

No modo **Aprender idiomas**, estas peças deixam de ser só «vermelhas sem tradução»: ganham tradução + significado ao passar o rato. Catálogo espelho da trilha Vida: tipografia em *Vida/Caracteres-tipograficos.txt*; semântica de aviso em *Vida/Palavras-aviso.txt*.

| Tom | Palavras | Significado breve |
|-----|----------|-------------------|
| **Perigosa** | [vingança](${self}) · [envenena](${self}) · [mata](${self}) · [veneno](${venom}) · [rancor](${self}) · [ressentimento](${self}) · [retaliação](${self}) · [revidar](${self}) · [corromper](${self}) · [esvaziar](${self}) | Promessa tóxica / dano interno / retaliação — literacia, não proibição |
| **Uso cauteloso** | [alma](${self}) · [espírito](${self}) · [raiva](${raiva}) · [emoção](${emocao}) · [justiça](${self}) · [plena](${self}) · [dose](${venom}) · [aviso](${self}) · [ditado](${hub}) · [expressão](${hub}) · [metáfora](${self}) · [oralidade](${self}) | Centro íntimo, afecto e figura de linguagem — precisão editorial |
...
**Aprovado na série Expressões e Ditados populares** — frase-modelo: forma canónica fixada; aviso (vingança incompleta + dano interno) mapeado; rede e cruzamentos com Raiva, Emoção, Venom e Vida.

[▶ Expressões](${hub}) · [▶ Ramón Valdés](${madruga}) · [▶ Chaves](${programa}) · [▶ Raiva](${raiva})
`;
...
**Approved** in **Popular Expressions & Sayings** — canonical form fixed; warning mapped; links to Anger, Emotion, Venom and [Vida](${vida}).

[▶ Expressions](${hub}) · [▶ Anger](${raiva}) · [▶ Venom](${venom})
`;
...
**Aprobado** en **Expresiones y Dichos populares** — forma canónica; aviso mapeado; cruces con Rabia, Emoción, Venom y [Vida](${vida}).

[▶ Expresiones](${hub}) · [▶ Rabia](${raiva}) · [▶ Venom](${venom})
`;

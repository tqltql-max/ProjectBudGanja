...
| Elo próximo | [Ramón Valdés](${madruga}) · [Chaves · programa](${programa}) · [Raiva](${raiva}) |
...
**Hipótese aplicada:** no laboratório emocional BudGanja, «veneno» nesta frase ≠ toxina botânica de planta; é **carga afectiva** que ocupa espaço onde deveriam estar cuidado, cultivo e partilha ([Vida](${vida})).

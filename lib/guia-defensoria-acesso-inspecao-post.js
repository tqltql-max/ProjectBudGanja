...
O acesso gratuito à justiça é o calço democrático sobre a estrutura penal desigual. Para que o direito não vire letra morta no papel de quem não compra advogado, o ofício da Defensoria exige rigor técnico e compromisso humanitário — e o laboratório mapeia o **vocabulário** e os **filtros restantes**. Diante da barreira estrutural, [Faça o melhor!](${L.mantra})
...
function buildGuiaDefensoriaAcessoPost() {
  ...
  return palavraPost({
    title: 'Inspeção: Defensoria Pública — acesso gratuito à justiça e Faça o melhor!',
    titleEn: 'Inspection: Defensoria Pública — free access to justice and Faça o melhor!',
    titleEs: 'Inspección: Defensoria Pública — acceso gratuito a la justicia y Faça o melhor!',
    excerpt:

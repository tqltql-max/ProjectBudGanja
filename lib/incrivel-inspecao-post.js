 ...
 * escala (legal · genial · fantástico se existirem) · Valeu !!!
 */
...
| **Fechar** | Depois do uau, o acto | [Valeu !!!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **hoje**, mesmo sem ser «incrível» |
...
| Rede oral | [meudeusdoceu](${meudeusdoceu}) · [jesusamado](${jesusamado}) · [aff](${aff}) · [já](${ja}) |

**Veredicto:** Valeu !!! **com incrível** — inspecionar o eixo, celebrar com objecto, subir o grau sem esvaziar a palavra.
...
| [Meudeusdoceu](${meudeusdoceu}) · [jesusamado](${jesusamado}) | Assombro oral BR |
...
**Aprovado** — **incrível** fichado: Lat. *incredibilis*; eixos incredulidade × elogio BR; escala ${scaleLinksPt || 'parcial'}; elos assombro e ofício; [Valeu !!!](${mantra}).

[▶ Palavras](${hub})${hasLegal ? ` · [▶ Legal](${legal})` : ''}${hasGenial ? ` · [▶ Genial](${genial})` : ''}${hasFantastico ? ` · [▶ Fantástico](${fantastico})` : ''} · [▶ Meudeusdoceu](${meudeusdoceu}) · [▶ Valeu !!!](${mantra})
`;
...
| Links | ${scaleLinksPt || '—'} · [truth](${verdade}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name the unbelievable · praise with an object · climb the degree without emptying the word · close with [Valeu !!!](${mantra}).

## Status

**Approved** — *incredibilis*; unbelief × BR praise; scale linked; [Valeu !!!](${mantra}).
...
| Vínculos | ${scaleLinksPt || '—'} · [verdad](${verdade}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar lo increíble · elogiar con objeto · subir el grado · cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — *incredibilis*; incredulidad × elogio BR; [¡Valeu !!!](${mantra}).
...
function buildIncrivelPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «incrível» (lat. *incredibilis*) — incredulidade e elogio BR «uau»; escala com fichas existentes (legal, genial, fantástico…); Valeu !!!',
    excerptEn:
      'Words: “incrível” (Lat. *incredibilis*) — unbelief and BR praise “wow”; scale with sheets on file (legal, genial, fantástico…); Valeu !!!',
    excerptEs:
      'Palabras: «incrível» (lat. *incredibilis*) — incredulidad y elogio BR «uau»; escala con fichas existentes; ¡Valeu !!!',

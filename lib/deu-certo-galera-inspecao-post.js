...
| Escala de tom | [aff](${aff}) / [buguei](${buguei}) (tranco) ← → **deu certo, galera** (acerto partilhado) ← → [genial](${genial}) / [jesusamando](${jesusamando}) (elogio / calor) |
...
**H3:** no BudGanja, celebra o resultado e devolve ao ofício — [Faça o melhor!](${mantra}) continua depois da festa.
...
| [jesusamando](${jesusamando}) | Afeto / bênção leve | Abrir com calor |
| **deu certo, galera** | Acerto colectivo | Anunciar que funcionou — ao grupo |

**Veredicto de escala:** as cinco são sopros BR; *deu certo, galera* é o **polo positivo do resultado** — não substitui [genial](${genial}) (engenho) nem [jesusamando](${jesusamando}) (calor).
...
| **Fechar com ofício** | Depois da festa | [Faça o melhor!](${mantra}) |

## Rede aparentada

| Expressão / palavra | Relação |
|---------------------|---------|
| [jesusamando](${jesusamando}) · [meudeusdoceu](${meudeusdoceu}) | Irmãs — calor e espanto; esta ficha = acerto partilhado |
| [aff](${aff}) · [buguei](${buguei}) | Contraste — enfado e tranco × celebração |
| [genial](${genial}) | Elogio de engenho — outro registo de celebração |
| [Faça o melhor!](${mantra}) | Depois do «deu certo» — o ofício segue |
...
**Aprovado na série Expressões e Ditados populares** — *deu certo, galera* / *deucer galerra* fichado como sopro BR de **celebração colectiva**; contraste com [aff](${aff}) e [buguei](${buguei}); elos [genial](${genial}), [jesusamando](${jesusamando}), [meudeusdoceu](${meudeusdoceu}), [Faça o melhor!](${mantra}), [língua portuguesa](${lingua}).

[▶ Expressões](${hub}) · [▶ jesusamando](${jesusamando}) · [▶ meudeusdoceu](${meudeusdoceu}) · [▶ Aff](${aff}) · [▶ Buguei](${buguei}) · [▶ Genial](${genial}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of the Brazilian oral expression **“deu certo, galera”** (chat/mouth often **“deucer galerra”**) — **collective celebration** that something worked. Orality sheet; sisters [jesusamando](${jesusamando}) and [meudeusdoceu](${meudeusdoceu}); contrast with [aff](${aff}) and [buguei](${buguei}); on [Portuguese](${lingua}) soil.
...
| Tone scale | [aff](${aff}) / [buguei](${buguei}) (stall) ← → **deu certo, galera** (shared win) ← → [genial](${genial}) / [jesusamando](${jesusamando}) |
| Links | [Portuguese](${lingua}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**H3:** celebrate the result, then return to craft — [Do your best!](${mantra}).
...
**Approved** — BR breath of collective celebration; contrast with [aff](${aff}) / [buguei](${buguei}); links [genial](${genial}), [jesusamando](${jesusamando}), [meudeusdoceu](${meudeusdoceu}), [Do your best!](${mantra}).

[▶ Expressions](${hub}) · [▶ jesusamando](${jesusamando}) · [▶ meudeusdoceu](${meudeusdoceu}) · [▶ Aff](${aff}) · [▶ Buguei](${buguei}) · [▶ Genial](${genial}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de la expresión oral brasileña **«deu certo, galera»** (en chat/boca a menudo **«deucer galerra»**) — **celebración colectiva** de que algo salió bien. Ficha de oralidad; hermanas [jesusamando](${jesusamando}) y [meudeusdoceu](${meudeusdoceu}); contraste con [aff](${aff}) y [buguei](${buguei}); suelo de la [lengua portuguesa](${lingua}).
...
| Escala | [aff](${aff}) / [buguei](${buguei}) (tranco) ← → **deu certo, galera** (acierto compartido) ← → [genial](${genial}) / [jesusamando](${jesusamando}) |
| Vínculos | [portugués](${lingua}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**H3:** celebrar el resultado y volver al oficio — [¡Haz lo mejor!](${mantra}).

## Veredicto

**Aprobada** — soplo BR de celebración colectiva; contraste con [aff](${aff}) / [buguei](${buguei}); vínculos [genial](${genial}), [jesusamando](${jesusamando}), [meudeusdoceu](${meudeusdoceu}), [¡Haz lo mejor!](${mantra}).

[▶ Expresiones](${hub}) · [▶ jesusamando](${jesusamando}) · [▶ meudeusdoceu](${meudeusdoceu}) · [▶ Aff](${aff}) · [▶ Buguei](${buguei}) · [▶ Genial](${genial}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildDeuCertoGaleraPost() {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «deu certo, galera» / deucer galerra — celebração colectiva; contraste com aff e buguei; elos genial, jesusamando, meudeusdoceu, Faça o melhor!',
    excerptEn:
      'Sayings: “deu certo, galera” / deucer galerra — collective celebration; contrast with aff and buguei; links genial, jesusamando, meudeusdoceu, Do your best!',
    excerptEs:
      'Dichos: «deu certo, galera» / deucer galerra — celebración colectiva; contraste con aff y buguei; vínculos genial, jesusamando, meudeusdoceu, ¡Haz lo mejor!',

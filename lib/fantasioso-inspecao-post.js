 ...
 * Eixos: fantasia + -oso · imaginativo / irrealista · ≠ fantástico · Valeu !!!
...
| Elo ofício | [verdade](${verdade}) · [gesto](${gesto}) · [genial](${genial}) · [Valeu !!!](${mantra}) |
...
| **Fechar** | Depois do sonho, o acto | [Valeu !!!](${mantra}) · [caminho](${caminho}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **hoje**, mesmo sem ser [fantástico](${fantastico}) |
...
| Par afectivo | [alegria](${alegria}) · [jesusamado](${jesus}) · [meudeusdoceu](${meudeus}) |

**Veredicto:** Valeu !!! — fantasioso **com** rasto; se a fantasia virar fuga, volte à ficha e ao [gesto](${gesto}).
...
**H4:** fecho = [Valeu !!!](${mantra}) com [criatividade](${criatividade}) + [verdade](${verdade}).
...
**Aprovado** — **fantasioso** fichado: *fantasia* + *-oso*; elogio × crítica leve; distinção clara de [fantástico](${fantastico}); rede com [criatividade](${criatividade}), [verdade](${verdade}), [fabuloso](${fabuloso}); [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Criatividade](${criatividade}) · [▶ Verdade](${verdade}) · [▶ Fantástico](${fantastico}) · [▶ Fabuloso](${fabuloso}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [criatividade](${criatividade}) · [verdade](${verdade}) · [gesto](${gesto}) · [fantástico](${fantastico}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name inventiveness · warn unreality · normalize *fantatioso* → **fantasioso** (not *fantástico*) · close with [Valeu !!!](${mantra}).
...
**Approved** — *fantasia* + *-oso*; praise × mild critique; clear ≠ [fantástico](${fantastico}); [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Criatividade](${criatividade}) · [▶ Fantástico](${fantastico}) · [▶ Valeu !!!](${mantra})
`;
...
| Vínculos | [criatividade](${criatividade}) · [verdade](${verdade}) · [gesto](${gesto}) · [fantástico](${fantastico}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar inventiva · avisar irrealismo · normalizar *fantatioso* → **fantasioso** (no *fantástico*) · cerrar con [¡Valeu !!!](${mantra}).
...
**Aprobada** — *fantasia* + *-oso*; elogio × crítica leve; ≠ [fantástico](${fantastico}); [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Criatividade](${criatividade}) · [▶ Fantástico](${fantastico}) · [▶ ¡Valeu !!!](${mantra})
`;

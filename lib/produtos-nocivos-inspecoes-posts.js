...
| Veredicto editorial | O cacau tradicional merece contexto; o **chocolate industrial** é a matriz que **junta** açúcar, farinha/trigo, leite e discurso — inspeccionar a rede, as palavras e o rótulo, não só a barra. |

## Hub

[Produtos nocivos](${hub}) · [Cacau](${cacau}) · [Açúcar](${cana}) · [Glúten](${gluten}) · [Caseína](${caseina}) · [*Barriga de Trigo*](${barriga}) · [Davis](${davis}) · [Lair](${lair}) · [Análise × vídeos](${analise}) · [Palavras](${palavras})
`;
...
[▶ Harmful products](${hub}) · [Wheat Belly](${barriga}) · [Words](${palavras})
`;
...
[▶ Productos nocivos](${hub}) · [Barriga de Trigo](${barriga}) · [Palabras](${palavras})
`;

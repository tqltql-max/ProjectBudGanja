...
Inspeção editorial do **leite bovino** e da **caseína** — a proteína dominante do leite — como **produto nocivo ao organismo** quando o padrão de consumo, a genética da proteína e o ultraprocessamento lácteo se cruzam de forma desfavorável. A **família láctea** (UHT, pó, queijo, iogurte, bebidas) tem casa em [Leite e laticínios](${leite}); esta ficha é a **proteína**. Cruza com a ficha da [vaca / boi](${vaca}), com o [glúten](${gluten}) e com o hub [chocolate industrial](${chocolate}) (leite em pó / caseinatos em barras e bombons).
...
| **Leite** | Leite em pó, sólidos lácteos, caseinatos | [Leite / laticínios](/posts/post-inspecao-derivado-leite.html) · [Caseína](${caseina}) |
...
[Produtos nocivos](${hub}) · [Cacau](${cacau}) · [Açúcar](${cana}) · [Glúten](${gluten}) · [Leite / laticínios](/posts/post-inspecao-derivado-leite.html) · [Caseína](${caseina}) · [*Barriga de Trigo*](${barriga}) · [Davis](${davis}) · [Lair](${lair}) · [Análise × vídeos](${analise}) · [Artigos](${hubArtigos}) · [Palavras](${palavras})
`;
...
| **Leite / caseína** | «Mito do leite»; lactose; contraste com leite materno; A1/BCM-7 na ficha (pouco nomeado nos títulos) | Mesmo bucket de **14** | [Leite / laticínios](/posts/post-inspecao-derivado-leite.html) · [Caseína](${caseina}) |

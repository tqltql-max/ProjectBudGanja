...
**Δ9-tetrahidrocanabinol.** Agonista parcial CB1/CB2. Responsável pelo efeito psicoativo típico, taquicardia, alteração de memória de curto prazo, e — em pessoas vulneráveis — risco de **psicose** e pior trajectória se o uso é precoce e pesado. O artigo [Albaugh](${L.albaugh}) inspeciona associação com córtex em adolescentes: **associação ≠ receita**, mas o laboratório não esconde o sinal.
...
| Corpo / cérebro | [Endocanabinoidoma](${L.ecs}) · [Meditação × eCBome](${L.meditacao}) · [Albaugh](${L.albaugh}) |
...
- **Δ9-THC/THCA** — partial CB1 agonist; developmental caution ([Albaugh](${L.albaugh})).  
- **CBD/CBDA** — low CB1 affinity; strongest human signal in rare epilepsies; isolate ≠ whole plant.  
- **CBC** — minor chromene.  
...
CBG/CBGA · Δ9-THC/THCA (cautela en desarrollo, [Albaugh](${L.albaugh})) · CBD/CBDA (epilepsias raras; aislado ≠ planta) · CBC · CBN (marketing de sueño adelanta la evidencia) · THCV/CBDV · Δ8/HHC fuera del catálogo de la planta viva.

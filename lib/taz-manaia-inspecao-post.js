...
**H5:** fecho [Valeu !!!](${mantra}) — nomear sem inventar pessoa.
...
[▶ Palavras](${hub}) · [▶ Tanzânia](${tanzania}) · [▶ Relação](${relacao}) · [▶ Meneia](${meneia}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Inspection of the field form **Taz Manaia** — glued to **[Tanzânia](${tanzania})** by the request *relation with taz manaia*. This lab found **no stable public biography**. It reads an **oral object**: **Taz-Mania** (Warner, 1991–1995) written as a personal name, the clipping **Taz** (Tanzania × Tasmanian Devil), and Māori **manaia** (guardian / messenger in carving). Links: [relation](${relacao}), [meneia](${meneia}) (PT homophony only), [Valeu !!!](${mantra}).
...
**Taz Manaia = oral slip.** Country = [Tanzânia](${tanzania}). The [relation](${relacao}) is the lexical *between* (Taz as clipping), not a life story. Close with [Valeu !!!](${mantra}).

## Status

**Approved** — slip sheet; relation named without inventing a person.

[▶ Words](${hub}) · [▶ Tanzania](${tanzania}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de la forma de campo **Taz Manaia** — pegada a **[Tanzânia](${tanzania})** por el pedido *relación con taz manaia*. Este lab **no** halló biografía pública estable. Lee un **objeto oral**: **Taz-Mania** (Warner, 1991–1995) escrito como antropónimo, el recorte **Taz** (Tanzania × demonio de Tasmania) y el **manaia** māori (guardián / mensajero en la talla). Vínculos: [relação](${relacao}), [meneia](${meneia}) (solo homofonía PT), [¡Valeu !!!](${mantra}).
...
**Taz Manaia = lapsus oral.** País = [Tanzânia](${tanzania}). La [relação](${relacao}) es el *entre* léxico (Taz como recorte), no una vida. Cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — ficha de lapsus; relación nombrada sin inventar persona.

[▶ Palabras](${hub}) · [▶ Tanzânia](${tanzania}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildTazManaiaPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «Taz Manaia» — lapso de Taz-Mania × Taz × manaia māori; ≠ pessoa verificada; relação lexical com Tanzânia; Valeu !!!',
    excerptEn:
      'Words: “Taz Manaia” — slip of Taz-Mania × Taz × Māori manaia; ≠ verified person; lexical relation with Tanzania; Valeu !!!',
    excerptEs:
      'Palabras: «Taz Manaia» — lapsus de Taz-Mania × Taz × manaia māori; ≠ persona verificada; relación léxica con Tanzania; ¡Valeu !!!',

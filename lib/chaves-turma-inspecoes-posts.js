...
/**
 * Turma do Chaves (*El Chavo del Ocho*):
 * — Pessoas: Ramón Valdés / Seu Madruga (homenagem com méritos)
 * — Artes: o programa como obra + turma + recomendação infantil
 */
...
Elo com a série [Expressões](/biblioteca/inspecoes/#inspecoes-expressoes): a frase [«A vingança nunca é plena…»](${expressao}) circula com a voz do Madruga — esta ficha honra a **pessoa** por trás da voz. Elo com [Artes · Chaves](${programa}): a turma e o programa como recomendação infantil.
...
| **Legado pósumo vivo** | Décadas depois, crianças e adultos ainda citam o Madruga — prova de ofício bem feito |
...
**Aprovado na série Pessoas — com honra explícita.** Ramón Valdés recebe os devidos méritos como intérprete que deu alma ao Seu Madruga: humor com dignidade, ética sem sermão e lugar permanente na memória da infância latino-americana. Continuar em [Chaves · o programa e a turma](${programa}).
...
function buildRamonValdesPost() {
  ...
  return figuraPost({
    ...
    excerpt:
      'Pessoas: homenagem a Ramón Valdés (1923–1988) — o actor que deu dignidade cómica ao Seu Madruga; ofício, ética sem sermão e legado infantil latino-americano.',
    excerptEn:
      'People: homage to Ramón Valdés (1923–1988) — the actor who gave comic dignity to Seu Madruga; craft, ethics without sermon and Latin American childhood legacy.',
    excerptEs:
      'Personas: homenaje a Ramón Valdés (1923–1988) — el actor que dio dignidad cómica a Don Ramón; oficio, ética sin sermón y legado infantil latinoamericano.',
...
Inspeção cultural de ***El Chavo del Ocho*** (*Chaves* no Brasil) — sitcom mexicana criada por **Roberto Gómez Bolaños** (*Chespirito*) — como **obra de vizinhança**, homenagem à **turma inteira** e **recomendação consciente para crianças** aprenderem algo bom: empatia, partilha, limites e humor sem precisar de crueldade gratuita.

> **Nota metodológica:** auditoria independente BudGanja. Fontes públicas (incl. [Wikipédia · El Chavo del Ocho](${wiki})), memória de exibição no Brasil e leitura educativa. **Não substitui mediação parental.** Episódios antigos têm gags de época (tapas, estereótipos) — a recomendação abaixo inclui **como assistir com cuidado**. Sem afiliação comercial com detentores de direitos.
...
| Tipo BudGanja | Artes — obra + turma + recomendação infantil |
...
**H2:** cada membro da turma carrega um **mérito pedagógico** (ver tabela) — por isso a homenagem é colectiva.  
**H3:** recomendar *Chaves* a crianças hoje exige **mediação**: rir juntos e nomear o que já não se imita (tapas, gozação pesada).

## Homenagem à turma — méritos devidos

| Personagem (BR) | Intérprete | Mérito que o laboratório reconhece |
|-----------------|------------|-------------------------------------|
| **Chaves** | Roberto Gómez Bolaños | Ingenuidade generosa; criança que quer pertencer e partilhar |
| **Seu Madruga** | Ramón Valdés | Dignidade na precariedade; ética sem sermão — [ficha própria](${madruga}) |
| **Chiquinha** | María Antonieta de las Nieves | Esperteza afectuosa; lealdade e voz própria de menina |
...
| **Popis** | Florinda Meza | Prima / extensão do núcleo infantil — brincadeira e imitação |
...
| **Jaiminho** | Raúl «Chato» Padilla | O carteiro que «sobrevive» — preguiça cómica vs responsabilidade (mediação) |
...
## O que crianças podem aprender de bom
...
## Recomendação BudGanja (com mediação)

**Sim — recomendável para crianças**, com adultos por perto, como obra de humor clássico latino-americano que ainda ensina pertença e partilha.

Boas práticas ao assistir hoje:

1. **Escolher episódios** mais leves para as primeiras sessões.  
2. **Pausar e conversar** se houver tapa ou gozação: «isso era gag antigo; em casa a gente não imita».  
...
| Cuidado familiar | [Vida](${vida}) |

## Limites

- Gags de violência cómica e estereótipos de género/época **não** são endossados — são contexto histórico a mediar.  
...
**Aprovado na série Artes — com recomendação infantil mediada.** *Chaves* / *El Chavo del Ocho* merece lugar no laboratório como humor de vizinhança que ensina partilha e reconciliação; a turma toda recebe méritos; Ramón Valdés tem [homenagem própria](${madruga}).
...
Cultural inspection of ***El Chavo del Ocho*** (*Chaves* in Brazil) — Mexican sitcom by **Roberto Gómez Bolaños** (*Chespirito*) — as a **neighbourhood work**, homage to the **whole cast**, and a **mindful kids recommendation**: empathy, sharing, limits and humour without needing gratuitous cruelty.

> Independent BudGanja audit. Parental mediation advised. Older slapstick needs conversation.
...
**Yes — recommended with adults nearby.** Pause on slapstick; highlight sharing, apologies and friendship. Pair with [Inside Out](${divertida}) for modern emotion vocabulary.

## Verdict

**Approved in Arts — mediated kids recommendation.** Full honour to the ensemble; Valdés has a [dedicated People sheet](${madruga}).
...
Inspección cultural de ***El Chavo del Ocho*** (*Chaves* en Brasil) — sitcom mexicana de **Roberto Gómez Bolaños** (*Chespirito*) — como **obra de vecindad**, homenaje a **toda la tropa** y **recomendación consciente para niños**: empatía, compartir, límites y humor sin crueldad gratuita.

> Auditoría independiente. Mediación parental recomendada.
...
**Sí — recomendable con adultos cerca.** Pausar el slapstick; destacar el compartir, pedir perdón y la amistad. Emparejar con [Intensamente](${divertida}).

## Veredicto

**Aprobado en Artes — recomendación infantil mediada.** Honor al ensemble; Valdés tiene [ficha propia en Personas](${madruga}).
...
function buildChavesProgramaPost() {
  ...
  return artePost({
    ...
    excerpt:
      'Artes: *Chaves* / *El Chavo del Ocho* — homenagem à turma inteira, méritos de cada pilar e recomendação mediada para crianças aprenderem partilha, desculpa e amizade.',
    excerptEn:
      'Arts: *El Chavo del Ocho* — homage to the whole cast, merits of each pillar and a mediated recommendation for children to learn sharing, apology and friendship.',
    excerptEs:
      'Artes: *El Chavo del Ocho* — homenaje a toda la tropa, méritos de cada pilar y recomendación mediada para que los niños aprendan a compartir, pedir perdón y amistad.',

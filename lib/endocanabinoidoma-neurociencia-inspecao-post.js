...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **ao ler o cérebro sem virar médico**, hoje |
| Anti-armadilha | «ECS explica tudo» = hype · «ECS é mapa útil» = ofício |
| Par vivo | [Sidarta](${sidarta}) · [Albaugh](${albaugh}) · [UNIFESP](${unifesp}) |

**Veredicto:** Faça o melhor **também ao mapear**. Neurociência no lab = curiosidade com limites.
...
[▶ Neurociências](${hub}) · [▶ Sidarta](${sidarta}) · [▶ Albaugh](${albaugh}) · [▶ Todas](${hubAll}) · [▶ Faça o melhor!](${mantra})
`;
...
| Links | [Sidarta](${sidarta}) · [Albaugh](${albaugh}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — Cap. 1 Neuroscience · ECS map · [Do your best!](${mantra}).

[▶ Neuroscience](${hub}) · [▶ Do your best!](${mantra})
`;
...
| Vínculos | [Sidarta](${sidarta}) · [Albaugh](${albaugh}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobado** — Cap. 1 Neurociencias · mapa ECS · [¡Haz lo mejor!](${mantra}).

[▶ Neurociencias](${hub}) · [▶ ¡Haz lo mejor!](${mantra})
`;

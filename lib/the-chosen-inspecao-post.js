...
[▶ Artes](${hub}) · [▶ App oficial (destaque)](${APP_FICHA}) · [▶ Player web](${WATCH}) · [▶ filho de deus](${filho}) · [▶ A Paixão de Cristo (outra ficha)](${PAIXAO}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${WIKI})
`;

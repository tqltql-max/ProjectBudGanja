...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor *desta* dramatização *deste* texto, sem púlpito.
...
| Caminho | Papel | Nota |
|---------|-------|------|
| **[App The Chosen](${APP})** (iOS, Android, Roku, Fire TV, Apple TV, Android TV) | Via **oficial gratuita** âncora | Procurar «The Chosen» nas lojas; conta ou convidado |
...
**Como escolher:** quem quer **grátis e oficial** começa no **app** ou em [watch.thechosen.tv](${WATCH}). Quem já paga Netflix ou Prime confirma o catálogo **nessa** conta. Dublagem e legendas em português: verificar no player escolhido.
...
| [jesusamando](${jesusamando}) · [jesusudavi](${jesusudavi}) · [templo de Cristo](${templo}) | Oralidade / fórmula — **não** são a série |
| [Faça o melhor!](${mantra}) | O melhor *deste* recorte |

> Abrir esta ficha para **The Chosen**. Abrir [A Paixão de Cristo](${PAIXAO}) para **esse** filme. Abrir os Evangelhos para o **texto**. Não fundir série, filme e púlpito.
...
**Aprovado na série Artes (ficha própria)** — *The Chosen / Os Escolhidos* (2019–). Evangelhos primeiro; série como dramatização creditada; app e site oficiais como via legal âncora; irmã [A Paixão de Cristo](${PAIXAO}) noutro sítio.

[▶ Artes](${hub}) · [▶ Onde assistir (oficial)](${WATCH}) · [▶ filho de deus](${filho}) · [▶ A Paixão de Cristo (outra ficha)](${PAIXAO}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${WIKI})
`;
...
| Path | Role |
|------|------|
| **[The Chosen app](${APP})** · **[watch.thechosen.tv](${WATCH})** | Official **free** anchor |
...
**Start free and official:** app or [watch.thechosen.tv](${WATCH}). Do not use pirate links.

## Status

**Approved in Arts as its own sheet** — Gospels first; series as credited dramatization; official app/site as legal watch path.

[▶ official player](${WATCH}) · [▶ son of God](${filho}) · [▶ Passion of the Christ (separate)](${PAIXAO})
`;
...
| Vía | Papel |
|-----|-------|
| **[App The Chosen](${APP})** · **[watch.thechosen.tv](${WATCH})** | Ancla **oficial gratuita** |
...
Empieza en el **app** o en el [player oficial](${WATCH}).

## Estado

**Aprobado en Artes (ficha propia)** — Evangelios primero; serie como dramatización; vía legal en app/web oficiales.

[▶ player oficial](${WATCH}) · [▶ filho de deus](${filho}) · [▶ Paixão (otra)](${PAIXAO})
`;
...
function buildTheChosenPost() {
  ...
  return artePost({
    ...
    excerpt:
      'Artes · série: The Chosen / Os Escolhidos (2019–, Dallas Jenkins) — Evangelhos primeiro; dramatização do ministério. Onde assistir: app e site oficiais (grátis), Prime e Netflix no catálogo BR. Ficha própria, distinta de A Paixão de Cristo.',
    excerptEn:
      'Arts · series: The Chosen (2019–, Dallas Jenkins) — Gospels first; dramatization of the ministry. Where to watch: official free app/site; Prime and Netflix in the BR catalog. Own sheet, distinct from The Passion of the Christ.',
    excerptEs:
      'Artes · serie: The Chosen / Os Escolhidos (2019–, Dallas Jenkins) — Evangelios primero; dramatización del ministerio. Dónde ver: app y web oficiales (gratis); Prime y Netflix en el catálogo BR. Ficha propia, distinta de A Paixão de Cristo.',

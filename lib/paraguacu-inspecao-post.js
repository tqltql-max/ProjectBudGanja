...
Inspeção editorial da palavra **[Paraguaçu](${self})** — topónimo de origem **tupi**, vivo no Brasil em rios e municípios (entre eles **Paraguaçu Paulista**, SP). O pedido *PARAGYACYY* cola este nome ao país **[Paraguai](${paraguai})**. O lab **separa**: Paraguaçu é **mapa brasileiro**; Paraguai é **Estado**. Elo local do laboratório: [ESAPP](${esapp}) (Agronomia em Paraguaçu Paulista). Elos: [língua portuguesa](${lingua}), [Valeu !!!](${mantra}).
...
[▶ Palavras](${hub}) · [▶ Paraguai](${paraguai}) · [▶ ESAPP](${esapp}) · [▶ Valeu !!!](${mantra})
`;
...
**Paraguaçu = Brazilian place.** Country = [Paraguai](${paraguai}). Close with [Valeu !!!](${mantra}).
...
**Paraguaçu = lugar BR.** País = [Paraguai](${paraguai}). Cerrar con [¡Valeu !!!](${mantra}).
...
function buildParaguacuPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «Paraguaçu» — lugar BR (tupi); Paraguaçu Paulista e ESAPP; ≠ Paraguai / Paraguay; lapso PARAGYACYY; Valeu !!!',
    excerptEn:
      'Words: “Paraguaçu” — Brazilian place; ESAPP in Paraguaçu Paulista; ≠ Paraguay; slip PARAGYACYY; Valeu !!!',
    excerptEs:
      'Palabras: «Paraguaçu» — lugar BR; ESAPP en Paraguaçu Paulista; ≠ Paraguay; lapsus PARAGYACYY; ¡Valeu !!!',

...
**H4:** fecho [Valeu !!!](${mantra}); ficha ≠ atlas.
...
[▶ Palavras](${hub}) · [▶ Paraguaçu](${paraguacu}) · [▶ Guerra do Paraguai](${guerra}) · [▶ Canhão](${canhao}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Inspection of Portuguese **Paraguai** — the **country** (ES/EN **Paraguay**). Field slip **PARAGYACYY** mixes the country with Brazilian **[Paraguaçu](${paraguacu})**. The etymon is **disputed**. Links: [Paraguayan War](${guerra}), [war trophies](${trofeus}), [cannon](${canhao}), [Valeu !!!](${mantra}).
...
**Paraguai = country.** If the mouth said PARAGYACYY, open this sheet **and** [Paraguaçu](${paraguacu}). Close with [Valeu !!!](${mantra}).

## Status

**Approved** — country sheet; slip separated.

[▶ Words](${hub}) · [▶ War](${guerra}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **Paraguai** — el **país** (ES/EN **Paraguay**). El lapsus **PARAGYACYY** mezcla el país con el topónimo brasileño **[Paraguaçu](${paraguacu})**. El étimo está **en disputa**. Vínculos: [Guerra](${guerra}), [trofeos](${trofeus}), [cañón](${canhao}), [¡Valeu !!!](${mantra}).
...
**Paraguai = país.** Si la boca dijo PARAGYACYY, abrir esta ficha **y** [Paraguaçu](${paraguacu}). Cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — ficha de país; lapsus separado.

[▶ Palabras](${hub}) · [▶ Guerra](${guerra}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildParaguaiPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «Paraguai» / Paraguay — país no Cone Sul; lapso PARAGYACYY mistura com Paraguaçu (BR); ≠ guerra nem canhão; Valeu !!!',
    excerptEn:
      'Words: “Paraguai” / Paraguay — the country; slip PARAGYACYY mixes it with Brazilian Paraguaçu; ≠ the war or the cannon; Valeu !!!',
    excerptEs:
      'Palabras: «Paraguai» / Paraguay — el país; el lapsus PARAGYACYY lo mezcla con Paraguaçu (BR); ≠ la guerra ni el cañón; ¡Valeu !!!',

 ...
 * contraste buguei · Faça o melhor!
 */
...
Inspeção editorial da palavra **inseto** (e do plural vivo **insetos**) — seres de seis patas, antenas e muitas vidas no solo, na folha e na cultura. Esta ficha cobre o **objeto** lexical, a **origem** (lat. *insectum*), o lugar na **ecologia** e no **quotidiano BR**, e o fecho [Faça o melhor!](${mantra}). Tom: laboratório quente — **vida**, não manual seco de entomologia. Elos: [animal](${animal}), [simbiose](${simbiose}), [Joaninha Joana](${joaninha}), [abelha](${abelha}), contraste [buguei](${buguei}).
...
| Elo ofício | [gesto](${gesto}) · [verdade](${verdade}) · [Faça o melhor!](${mantra}) · [cultivo](${cultivo}) |
...
| **Ofício na folha** | Observar → [gesto](${gesto}) → [Faça o melhor!](${mantra}) |

| Camada mantra | Ligação |
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — o melhor cuidado **com** a vida miúda, hoje |
| Poema | [poema Vida](${poemMantra}) |
| Anti-armadilha | «Inseto = só praga» = mapa incompleto |

**Veredicto:** Faça o melhor **com os insetos no cálculo** — literacia da palavra, respeito à teia, [gesto](${gesto}) quando a praga for real.

## Hipóteses (síntese)

**H1:** *inseto* ← lat. *insectum* (corpo segmentado).  
**H2:** plural **insetos** = intuição de rede / ecologia.  
**H3:** elos = [animal](${animal}) · [simbiose](${simbiose}) · [joaninha](${joaninha}) · [abelha](${abelha}).  
**H4:** contraste = [buguei](${buguei}) (inseto no étimo do «deu ruim»).  
**H5:** fecho = [Faça o melhor!](${mantra}) no cultivo e na curiosidade.
...
- Aracnídeos e outros artrópodes **não** são insetos — a fala popular às vezes mistura; a ficha marca o lemma.

## Status

**Aprovado** — **inseto** / **insetos** fichados: étimo, vida, ecologia, cultura; elos joaninha · abelha · animal · simbiose; contraste [buguei](${buguei}); fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Animal](${animal}) · [▶ Joaninha](${joaninha}) · [▶ Abelha](${abelha}) · [▶ Simbiose](${simbiose}) · [▶ Buguei](${buguei}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **inseto** (lemma; plural **insetos** in body) — insects as life, ecology and culture in the BudGanja lab. Warm tone, not a dry entomology textbook. Links: [animal](${animal}), [simbiose](${simbiose}), [Joaninha](${joaninha}), [bee](${abelha}), contrast [buguei](${buguei}), close [Do your best!](${mantra}).
...
Keep **insetos** in the calculation — literacy, web of life, [Do your best!](${mantra}).

## Status

**Approved** — inseto/insetos; ecology & culture; lab links; [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Animal](${animal}) · [▶ Joaninha](${joaninha}) · [▶ Bee](${abelha}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **inseto** (lema; plural **insetos** en el cuerpo) — insectos como vida, ecología y cultura en el lab BudGanja. Tono cálido, no manual seco. Vínculos: [animal](${animal}), [simbiose](${simbiose}), [Joaninha](${joaninha}), [abeja](${abelha}), contraste [buguei](${buguei}), cierre [¡Haz lo mejor!](${mantra}).
...
Mantener a los **insetos** en el cálculo — [¡Haz lo mejor!](${mantra}).

## Estado

**Aprobada** — inseto/insetos; ecología y cultura; vínculos del lab; [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Animal](${animal}) · [▶ Joaninha](${joaninha}) · [▶ Abeja](${abelha}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildInsetoPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Inseto — vida, ecologia, cultura e Faça o melhor!',
    titleEn:
      'Inspection: Inseto — life, ecology, culture and Do your best!',
    titleEs:
      'Inspección: Inseto — vida, ecología, cultura y ¡Haz lo mejor!',
    excerpt:
      'Palavras: «inseto» / «insetos» — lat. insectum; vida, ecologia e cultura; elos joaninha, abelha, animal, simbiose; contraste buguei; Faça o melhor!',
    excerptEn:
      'Words: “inseto” / “insetos” — Lat. insectum; life, ecology and culture; links to ladybug, bee, animal, symbiosis; contrast buguei; Do your best!',
    excerptEs:
      'Palabras: «inseto» / «insetos» — lat. insectum; vida, ecología y cultura; vínculos joaninha, abeja, animal, simbiosis; contraste buguei; ¡Haz lo mejor!',

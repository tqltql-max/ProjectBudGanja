...
| Camada | Fichas |
|--------|--------|
| Guias irmãos | [Advogados](${L.hcAdvogados}) · [Farmacêuticos](${L.farmaceuticos}) · [Associações](${L.associacoes}) · [Defensoria](${L.defensoria}) |
| Classificação | [Entorpecente × Narcótico](${L.entorpecente}) · [Psicotrópico](${L.psicotropico}) · [Lista F](${L.listaF}) · [Substância controlada](${L.substancia}) · [RDC](${L.rdc}) |
...
[▶ Advogados](${L.hcAdvogados}) · [▶ Farmacêuticos](${L.farmaceuticos}) · [▶ Associações](${L.associacoes}) · [▶ Defensoria](${L.defensoria}) · [▶ ANVISA](${L.anvisa}) · [▶ RDC](${L.rdc}) · [▶ Classificação legal](${L.guia}) · [▶ Hub Palavras](${L.hub})
`;

...
[▶ Palavras](${hub}) · [▶ Parque de diversões](${HREF_Q}) · [▶ Party](${HREF_Y}) · [▶ Michael J. Fox](${fox}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Words](${hub}) · [▶ Amusement park](${HREF_Q}) · [▶ Party](${HREF_Y}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Parque](${HREF_Q}) · [▶ Party](${HREF_Y}) · [▶ ¡Valeu !!!](${mantra})
`;

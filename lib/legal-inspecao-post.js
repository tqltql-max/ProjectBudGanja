 ...
 * Eixos: jurídico · gíria BR («bacana») · inglês × português · Valeu !!!
...
function buildLegalBodies() {
  ...
  const coolGelado = '/posts/post-inspecao-palavra-cool-gelado.html';
...
Inspeção editorial da palavra **legal** — do polo **jurídico** (conforme a lei) à gíria brasileira **«bacana / ok / massa»**, sem apagar nenhum dos dois. Esta ficha cobre o **objeto**, os **dois eixos de sentido**, o contraste útil com o inglês *legal*, e o fecho [Valeu !!!](${mantra}). Elos naturais: [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}). Derivação da gíria: [Cool Gelado](${coolGelado}) (*Legal!* → *cool* → *gelado*).
...
| Elogio / «cool» | Usa-se *cool*, *nice*, *awesome* | **«Legal!»** = bacana · derivação [Cool Gelado](${coolGelado}) |
| Tradução cega | «That's legal!» (só jurídico) | Pode soar frio ou errado se a intenção era elogio |
| Volta térmica | *cool* também é «fresco» | **Não** traduzir *Legal!* por «gelado» — [Cool Gelado](${coolGelado}) |
...
**Veredicto:** Valeu !!! **com legal** — inspecionar o eixo, citar quando for lei, celebrar quando for peito, sem misturar as ferramentas.

## Hipóteses (síntese)

**H1:** objeto = lat. *legālis* → jurídico + gíria BR.  
**H2:** inglês *legal* ≠ «bacana»; BR carrega os dois; a gíria deriva em [Cool Gelado](${coolGelado}) (*cool* × *gelado*).  
**H3:** elos = [ilícito](${ilicito}) · [Lei 11.343](${lei11343}) · [descriminalização](${descrim}) · [risco](${risco}) · [verdade](${verdade}) · [Cool Gelado](${coolGelado}).  
...
| [Cool Gelado](${coolGelado}) | Derivação da gíria: *Legal!* → *cool* → *gelado* (não a lei) |
...
**Aprovado** — **legal** fichado: jurídico × gíria BR; contraste com inglês; elos ilícito / Lei 11.343 / descriminalização / risco / verdade; derivação [Cool Gelado](${coolGelado}); [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Descriminalização](${descrim}) · [▶ Cool Gelado](${coolGelado}) · [▶ Verdade](${verdade}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **legal** — the **juridical** pole (lawful) and Brazilian slang **“cool / nice / ok”**, without erasing either. Covers **object**, **two sense axes**, useful contrast with English *legal*, slang derivation [Cool Gelado](${coolGelado}), and [Valeu !!!](${mantra}). Links: [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
| Links | [ilícito](${ilicito}) · [Lei 11.343](${lei11343}) · [truth](${verdade}) · [risk](${risco}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name the law · separate maps (legalize / descriminalize / possession) · calculate [risk](${risco}) · approve with warmth when slang · close with [Valeu !!!](${mantra}).
...
**Approved** — juridical × BR slang; English contrast; slang derivation [Cool Gelado](${coolGelado}); [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Cool Gelado](${coolGelado}) · [▶ Truth](${verdade}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **legal** — polo **jurídico** (conforme a la ley) y jerga brasileña **«bacán / ok / bueno»**, sin borrar ninguno. Cubre **objeto**, **dos ejes**, contraste con el inglés *legal*, derivación [Cool Gelado](${coolGelado}), y [¡Valeu !!!](${mantra}). Vínculos: [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
| Vínculos | [ilícito](${ilicito}) · [Lei 11.343](${lei11343}) · [verdad](${verdade}) · [riesgo](${risco}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar la ley · separar mapas · calcular [riesgo](${risco}) · aprobar con calor (jerga) · cerrar con [¡Valeu !!!](${mantra}).
...
**Aprobada** — jurídico × jerga BR; contraste con inglés; derivación [Cool Gelado](${coolGelado}); [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Cool Gelado](${coolGelado}) · [▶ Verdad](${verdade}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildLegalPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Legal — lei, gíria BR «bacana» e Valeu !!!',
    titleEn:
      'Inspection: Legal — law, BR slang “cool”, and Valeu !!!',
    titleEs:
      'Inspección: Legal — ley, jerga BR «bacán» y ¡Valeu !!!',
    excerpt:

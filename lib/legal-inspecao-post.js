...
Inspeção editorial da palavra **legal** — do polo **jurídico** (conforme a lei) à gíria brasileira **«bacana / ok / massa»**, sem apagar nenhum dos dois. Esta ficha cobre o **objeto**, os **dois eixos de sentido**, o contraste útil com o inglês *legal*, e o fecho [Valeu !!!](${mantra}). Elos naturais: [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
**Aprovado** — **legal** fichado: jurídico × gíria BR; contraste com inglês; elos ilícito / Lei 11.343 / descriminalização / risco / verdade; [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Descriminalização](${descrim}) · [▶ Verdade](${verdade}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **legal** — the **juridical** pole (lawful) and Brazilian slang **“cool / nice / ok”**, without erasing either. Covers **object**, **two sense axes**, useful contrast with English *legal*, and [Valeu !!!](${mantra}). Links: [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
**Approved** — juridical × BR slang; English contrast; network linked; [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Truth](${verdade}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **legal** — polo **jurídico** (conforme a la ley) y jerga brasileña **«bacán / ok / bueno»**, sin borrar ninguno. Cubre **objeto**, **dos ejes**, contraste con el inglés *legal*, y [¡Valeu !!!](${mantra}). Vínculos: [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
**Aprobada** — jurídico × jerga BR; contraste con inglés; red enlazada; [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Verdad](${verdade}) · [▶ ¡Valeu !!!](${mantra})
`;

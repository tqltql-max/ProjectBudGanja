...
const HOME_PINNED_INSPECAO_SLUG = 'inspecao-arte-bom-dia-inverno';

function sortPublicPosts(list) {
  return list.slice().sort((a, b) => {
    const aPin = a && a.slug === HOME_PINNED_INSPECAO_SLUG ? 0 : 1;
    const bPin = b && b.slug === HOME_PINNED_INSPECAO_SLUG ? 0 : 1;

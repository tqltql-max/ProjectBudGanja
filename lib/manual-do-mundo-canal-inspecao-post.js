...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte é nomear o Maker **sem** apagar o [risco](${risco}) das demos.
...
[▶ Vídeos · Maker](${makerHub}) · [▶ Manual Maker](${makerFicha}) · [▶ Iberê](${ibere}) · [▶ Canal](${videosHub}) · [▶ Canais](${hub}) · [▶ Faça o melhor!](${mantra})
`;

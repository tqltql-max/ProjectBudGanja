...
| [legal](${legal}) · [verdade](${verdade}) · [Valeu !!!](${mantra}) | Ofício dos créditos e da reparação |
...
[▶ Rockin'1000](${YT}) · [▶ Clipe Hoxton](${YT_OFFICIAL}) · [▶ Spotify](${SPOTIFY}) · [▶ Poema Vida](${vida}#poema=bitter-sweet-symphony) · [▶ Legal](${legal}) · [▶ Vida](${vidaPalavra}) · [▶ Valeu !!!](${mantra})
`;

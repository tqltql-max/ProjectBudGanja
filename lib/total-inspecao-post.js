 ...
 * gíria BR «total!» (acordo / louvor) · escala vs legal / fantástico · Faça o melhor!
...
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — o melhor possível **hoje**, mesmo quando o peito diz «total!» |
...
**Veredicto:** Faça o melhor **com o total** — completar o que cabe ao ofício; selar acordo quando houver objecto; depois continuar. Total sem [caminho](${caminho}) = pose de absolutes; total com método = fecho honesto e louvor que não mente.
...
**H4:** fecho = [Faça o melhor!](${mantra}) depois do «fechou!».
...
**Aprovado** — **total** fichado (correcção de *toal*): completude × gíria BR «total!»; escala com [legal](${legal}) / [fantástico](${fantastico}); [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Legal](${legal}) · [▶ Fantástico](${fantastico}) · [▶ Genial](${genial}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **total** (typo fix: *toal* → **total**) — from Lat. *tōtus* (“whole / entire”) to **sum / completeness** and everyday BR slang **“total!”** (= strong agreement / praise). Covers **object**, **axes**, a **scale** with [legal](${legal}) and [fantástico](${fantastico}), and [Do your best!](${mantra}).
...
| Links | [legal](${legal}) · [fantástico](${fantastico}) · [genial](${genial}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — completeness × BR “total!” · scale with legal / fantástico · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Legal](${legal}) · [▶ Fantástico](${fantastico}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **total** (corrección: *toal* → **total**) — del lat. *tōtus* («entero») a la **suma / completud** y la jerga BR **«¡total!»** (acuerdo / elogio). Cubre **objeto**, **ejes**, una **escala** con [legal](${legal}) y [fantástico](${fantastico}), y [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [legal](${legal}) · [fantástico](${fantastico}) · [genial](${genial}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — completud × «¡total!» BR · escala con legal / fantástico · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Legal](${legal}) · [▶ Fantástico](${fantastico}) · [▶ ¡Haz lo mejor!](${mantra})
`;

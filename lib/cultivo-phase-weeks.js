...
const PHASE_WEEK_GUIDES = {
  planejamento: [
    {
      ...
      tools: [{ label: 'Watts por m²', href: '/calculadoras/watts-m2.html' }]
    },
    {
      week: 2,
    ...
    },
    {
      ...
      tools: [
        ...
        { label: 'Custo de energia', href: '/calculadoras/energia.html' }
      ]
    },
    {
      week: 4,
      ...
      tools: [{ label: 'Guia de cultivo', href: '/guia/cultivo-basico.html' }]
    }
  ],
  germinacao: [
    {
      ...
      tools: [{ label: 'VPD', href: '/calculadoras/vpd.html' }]
    },
    {
      week: 2,
      ...
      tools: [{ label: 'Volume do vaso', href: '/calculadoras/volume-vaso.html' }]
    },
    {
      week: 3,
      title: 'Transplante',
  ...
  vegetativo: [
    ...
    },
    {
      ...
      tools: [
        { label: 'Luxímetro', href: '/calculadoras/luximetro.html' },
        { label: 'DLI', href: '/calculadoras/dli.html' },
        { label: 'pH', href: '/calculadoras/ph.html' }
      ]
    },
    {
      week: 3,
    ...
    },
    {
      ...
      tools: [{ label: 'EC', href: '/calculadoras/ec.html' }]
    },
    {
      week: 5,
      ...
      tools: [{ label: 'DLI', href: '/calculadoras/dli.html' }]
    }
  ],
  floracao: [
    {
    ...
    },
    {
      ...
      tools: [{ label: 'pH', href: '/calculadoras/ph.html' }]
    },
    {
      week: 3,
      ...
      tools: [
        { label: 'EC', href: '/calculadoras/ec.html' },
        { label: 'VPD', href: '/calculadoras/vpd.html' }
      ]
    },
    {
      week: 4,
      ...
      tools: [{ label: 'Diluição', href: '/calculadoras/diluicao.html' }]
    },
    {
      week: 5,
      title: 'Maturação',

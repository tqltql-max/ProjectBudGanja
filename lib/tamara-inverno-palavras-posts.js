...
const TAMARA_INVERNO_WORD_CFGS = [
  ...
  },
  {
    ...
    classPt: 'Substantivo masculino',
    etimo: 'It. *risco* / lat. med. (debate) — perigo; também «risco» gráfico',
    leitura:
      ...
      MEDO +
      ') — nomear sem pose.',
    leituraEn: 'Danger with method: Amyr plans; Tamara owns hers. Links truth and fear.',
    leituraEs: 'Peligro con método: Amyr planifica; Tamara asume el suyo. Une verdad y miedo.',
...
const TAMARA_INVERNO_PALAVRAS_POSTS = TAMARA_INVERNO_WORD_CFGS.map(buildTamaraInvernoPalavraPost);

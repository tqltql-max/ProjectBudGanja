 ...
 * vassoura-de-bruxa (cacau) · ≠ grimório · Valeu !!!
 */
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **com este chão**, hoje |
...
**Veredicto:** Valeu !!! **no chão concreto**. Vassoura sem [gesto](${gesto}) = poeira empurrada; vassoura com inspeção = ofício que respeita a história sem copiar o veneno.
...
**H4:** fecho = [Valeu !!!](${mantra}) — varrer sem varrer a verdade para debaixo do tapete.
...
**Aprovada** — **vassoura** fichada: étimo, ofício de varrer, folclore documentado sem receita, doença do cacau, rede com esfregar/lavar e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Esfregar](${esfregar}) · [▶ Lavar](${lavar}) · [▶ Livro XIV](${xiv}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **vassoura** — chiefly the **broom** (handle + bristles), plus history and curiosities. Links [esfregar](${esfregar}), [lavar](${lavar}), [risco](${risco}), [Valeu !!!](${mantra}). The European “witch’s broom” appears as a **documented historical hypothesis** (UNIFESP XIV), **not** as a recipe. Tropane nightshades are **toxic**.
...
| Links | [esfregar](${esfregar}) · [lavar](${lavar}) · [risco](${risco}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · craft · documented curiosity · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Esfregar](${esfregar}) · [▶ Livro XIV](${xiv}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **vassoura** — sobre todo la **escoba** (mango + cerdas), con historia y curiosidades. Vínculos [esfregar](${esfregar}), [lavar](${lavar}), [risco](${risco}), [¡Valeu !!!](${mantra}). La «escoba de la bruja» entra como **hipótesis histórica documentada** (UNIFESP XIV), **no** como receta. Las solanáceas tropánicas son **tóxicas**.
...
| Vínculos | [esfregar](${esfregar}) · [lavar](${lavar}) · [risco](${risco}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · oficio · curiosidad documentada · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Esfregar](${esfregar}) · [▶ Livro XIV](${xiv}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildVassouraPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «vassoura» (lat. versōria) — utensílio de varrer × folclore da bruxa (hipótese XIV, sem receita) × vassoura-de-bruxa do cacau; Valeu !!!',
    excerptEn:
      'Words: “vassoura” (Lat. versōria) — broom × witch folklore (XIV hypothesis, no recipe) × cacao witches’ broom; Valeu !!!',
    excerptEs:
      'Palabras: «vassoura» (lat. versōria) — escoba × folclore de la bruja (hipótesis XIV, sin receta) × escoba de bruja del cacao; ¡Valeu !!!',

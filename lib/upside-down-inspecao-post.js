...
| Curiosidade sem burla | [alegria](${alegria}) · [Faça o melhor!](${mantra}) |
...
| [caminho](${caminho}) · [gesto](${gesto}) · [já](${ja}) · [Faça o melhor!](${mantra}) | Ofício de inverter o olhar e ficar |
...
[▶ Áudio](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=upside-down) · [▶ Criatividade](${criatividade}) · [▶ Alegria](${alegria}) · [▶ Faça o melhor!](${mantra})
`;

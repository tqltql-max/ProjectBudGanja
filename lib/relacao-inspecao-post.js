...
**Aprovado** — **relação** fichada: *relatĭō*, camadas (vínculo × relato × proporção × peito), contraste com [simbiose](${simbiose}), rede com [respeito](${respeito}), [gesto](${gesto}) e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Simbiose](${simbiose}) · [▶ Respeito](${respeito}) · [▶ Gesto](${gesto}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Words](${hub}) · [▶ Simbiose](${simbiose}) · [▶ Respeito](${respeito}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Simbiose](${simbiose}) · [▶ Respeito](${respeito}) · [▶ ¡Valeu !!!](${mantra})
`;

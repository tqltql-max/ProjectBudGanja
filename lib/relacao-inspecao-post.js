 ...
 * simbiose × respeito × gesto · Faça o melhor!
 */
...
Inspeção editorial da palavra **relação** — o nome do **vínculo** entre coisas ou pessoas, do **relato** (levar de volta o que se viu), e da **proporção** (razão matemática). Do latim *relatĭō* ← *relātus* (*referre* = *re-* + *ferre*, «trazer de volta / reportar»). Esta ficha cobre o **objeto**, as camadas (vínculo × relato × proporção × peito), a rede com [simbiose](${simbiose}), [respeito](${respeito}) e [gesto](${gesto}), e o fecho [Faça o melhor!](${mantra}).

> **Nota metodológica:** auditoria independente. Fontes: [Wikcionário · relação](${wiki}), [relacionar](${wikiVerb}), [relatio (EN)](${wikiLat}), série [Palavras](${hub}). **Ficha ≠ terapia de casal nem tratado de teoria dos conjuntos.** Tom: Inspetor BudGanja — *relação* nomeia o **entre**; ofício = ver o vínculo com [verdade](${verdade}) e [respeito](${respeito}), sem romantizar nem apagar.

**Gatilho tipográfico:** *relacao* / *Relacao* → **relação**.
...
| Tipo BudGanja | Palavra — vínculo × relato × proporção × peito |
| Elo peito | [respeito](${respeito}) · [verdade](${verdade}) · [alma](${alma}) · [gesto](${gesto}) |
| Elo rede | [simbiose](${simbiose}) · [caminho](${caminho}) · [mensagem](${mensagem}) · [patrão](${patrao}) |
...
**H4:** fecho = [respeito](${respeito}) + [gesto](${gesto}) + [Faça o melhor!](${mantra}) — cuidar do entre sem pose.
...
## 5. Relação × simbiose × respeito × gesto
...
| [Faça o melhor!](${mantra}) | Ofício **na** relação — o melhor possível **hoje** |
...
4. Se for cuidado do entre, cruzar [respeito](${respeito}) e [gesto](${gesto}).  
...
**Aprovado** — **relação** fichada: *relatĭō*, camadas (vínculo × relato × proporção × peito), contraste com [simbiose](${simbiose}), rede com [respeito](${respeito}), [gesto](${gesto}) e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Simbiose](${simbiose}) · [▶ Respeito](${respeito}) · [▶ Gesto](${gesto}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **relação** (“relation / relationship / report / ratio”) — the name of the **link** between things or people, the **account** (bringing back what was seen), and **proportion**. From Lat. *relatĭō* ← *relātus* (*referre* = *re-* + *ferre*). Covers layers, links to [simbiose](${simbiose}), [respeito](${respeito}), [gesto](${gesto}), and [Do your best!](${mantra}).
...
| Links | [simbiose](${simbiose}) · [respeito](${respeito}) · [gesto](${gesto}) · [Do your best!](${mantra}) |
| Date | ${inspected} |

## 2. Layers

Human bond · factual report · mathematical ratio · “em relação a” · intimate euphemism · power relations ([patrão](${patrao})). Contrast: [simbiose](${simbiose}) = living together; *relação* = the general *between*.
...
**Approved** — *relatĭō* · layers mapped · links to simbiose, respeito, gesto · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Simbiose](${simbiose}) · [▶ Respeito](${respeito}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de la palabra portuguesa **relação** («relación / vínculo / informe / proporción») — el nombre del **entre**, del **relato** y de la **proporción**. Del lat. *relatĭō* ← *relātus* (*referre* = *re-* + *ferre*). Cubre capas, vínculos con [simbiose](${simbiose}), [respeito](${respeito}), [gesto](${gesto}), y [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [simbiose](${simbiose}) · [respeito](${respeito}) · [gesto](${gesto}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — *relatĭō* · capas mapeadas · vínculos con simbiose, respeito, gesto · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Simbiose](${simbiose}) · [▶ Respeito](${respeito}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildRelacaoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «relação» (lat. *relatĭō*) — vínculo × relato × proporção; elos simbiose, respeito, gesto; Faça o melhor!',
    excerptEn:
      'Words: “relação” (Lat. *relatĭō*) — bond × report × ratio; links simbiose, respeito, gesto; Do your best!',
    excerptEs:
      'Palabras: «relação» (lat. *relatĭō*) — vínculo × relato × proporción; vínculos simbiose, respeito, gesto; ¡Haz lo mejor!',

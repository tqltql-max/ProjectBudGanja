...
| Elo rede | [simbiose](${simbiose}) · [juntos](${juntos}) · [caminho](${caminho}) · [mensagem](${mensagem}) · [patrão](${patrao}) · [elo de ligação](${elo}) |
...
| [juntos](${juntos}) · [elo de ligação](${elo}) | Estado de estar junto × anéis que seguram — cruzar sem fundir |

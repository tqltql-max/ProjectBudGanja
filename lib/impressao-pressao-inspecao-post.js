...
| Elo mapa | [risco](${risco}) · [incrível](${incrivel}) · [Gratidão](${muito}) |
...
| **Impressionado** | Peito marcado pelo ofício / pelo outro | Bom: crédito ([Gratidão](${muito})) · Mau: bajulação |
...
| **[Valeu !!!](${mantra})** | Depois do alívio, o ofício continua |
...
| Mantra | [Valeu !!!](${mantra}) · [poema](${poemMantra}) |
...
**Aprovado na série Palavras** — *impressão* fichada como marca de *premere* para dentro; *pressão* como a força; **panela de pressão** como o vaso; **válvula de escape** como o alívio. Falso amigo: [inspiração](${inspiracao}). Perigo: escape preso. Depois do vapor, [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Objetos](${objetos}) · [▶ Aff](${aff}) · [▶ Inspiração](${inspiracao}) · [▶ Valeu !!!](${mantra})
`;
...
**Approved** — family filed; cooker and valve named; no disable instructions. Then [Valeu !!!](${mantra}).
...
**Aprobada** — familia fichada; olla y válvula nombradas; sin instrucciones de anulación. Luego [¡Valeu !!!](${mantra}).
...
function buildImpressaoPressaoPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: impressão = pressão para dentro (premere); objecto panela de pressão + válvula de escape; ≠ inspiração; ficha ≠ anular válvula; Valeu !!!',
    excerptEn:
      'Words: impression = pressure inward (premere); pressure-cooker + release valve; ≠ inspiration; sheet ≠ how to block a valve; Valeu !!!',
    excerptEs:
      'Palabras: impresión = presión hacia dentro; olla a presión + válvula de escape; ≠ inspiración; ficha ≠ anular válvula; ¡Valeu !!!',

 ...
 * ≠ obrigado (obligare) · ≠ valeu (valēre) · grato (adj.) · Valeu !!!
 */
...
Inspeção editorial da palavra **gratidão** — substantivo que nomeia a **qualidade de quem é grato**: reconhecimento do bem recebido. Pedido de campo depois de um sopro curto (*grato*). Esta ficha cobre o **objeto** (lat. tardio *grātitūdō* ← *grātus* + *-tūdō*), as **peças** *grat-* + *-idão* (método de [veneno](${vinganca})), o contraste duro com [Gratidão](${muito}) e [valeu](${valeu}), e o fecho [Valeu !!!](${mantra}).
...
| Elo sopro | [Gratidão](${muito}) · [valeu](${valeu}) |
...
**O que é o objeto:** o **nome da qualidade**. *Grato* é o adjectivo sobre a pessoa; *agradecer* é o verbo; [valeu](${valeu}) e [Gratidão](${muito}) são **sopros**. Gratidão é o caderno que os nomeia.
...
| **[Gratidão](${muito})** | *obligare* («ligar, atar») | Fórmula BR reforçada — crédito; mapa histórico à parte |
...
| Recurso | Papel |
|---------|-------|
| [Gratidão](${muito}) | Fórmula — irmã de **uso**, prima de **étimo** (não) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — gratidão **não** substitui o ofício; acompanha |
...
**Veredicto:** Valeu !!! — e, se o bem entrou, a palavra certa do caderno é **gratidão**. O sopro pode ser *valeu* ou *Gratidão*. O nome é este.

## Hipóteses (síntese)

**H1:** *grātus* → *grātitūdō* → *gratidão* (alta).  
**H2:** peças *grat-* + *-idão* = qualidade, não fórmula.  
**H3:** elos de **uso** = [Gratidão](${muito}) · [valeu](${valeu}) · [gesto](${gesto}); étimos **distintos**.  
**H4:** fecho = [Valeu !!!](${mantra}).

## Limites

- Não substitui [Gratidão](${muito}) nem [valeu](${valeu}) na boca.  
...
**Aprovado** — **gratidão** fichada: objeto (*grātus* / *grātitūdō*), peças *grat-* + *-idão*, contraste com [Gratidão](${muito}) e [valeu](${valeu}), fecho [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Gratidão](${muito}) · [▶ Valeu](${valeu}) · [▶ Gesto](${gesto}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **gratidão** — the named **quality of being grateful** (recognition of a received good). Field cue: a short *grato*. Covers Late/Med. Lat. *grātitūdō* ← *grātus* + *-tūdō*, the pieces *grat-* + *-idão*, and a hard contrast with [Gratidão](${muito}) (*obligare*) and [valeu](${valeu}) (*valēre*). Close: [Valeu !!!](${mantra}).
...
**Approved** — quality named; formulas stay on their own sheets. [Valeu !!!](${mantra})

[▶ Words](${hub}) · [▶ Gratidão](${muito}) · [▶ Valeu](${valeu})
`;

  const contentEs = `## Alcance

Inspección editorial de **gratidão** (PT) / **gratitud** — la **cualidad nombrada** de quien es grato: reconocimiento del bien recibido. Señal de campo: un *grato* corto. Cubre lat. tardío *grātitūdō* ← *grātus* + *-tūdō*, las piezas *grat-* + *-idão*, y el contraste duro con [Gratidão](${muito}) (*obligare*) y [valeu](${valeu}) (*valēre*). Cierre: [¡Valeu !!!](${mantra}).
...
**Aprobada** — cualidad nombrada; las fórmulas quedan en sus fichas. [¡Valeu !!!](${mantra})

[▶ Palabras](${hub}) · [▶ Gratidão](${muito}) · [▶ Valeu](${valeu})
`;
...
function buildGratidaoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «gratidão» (lat. tardio grātitūdō ← grātus) — qualidade de quem recebe bem; peças grat- + -idão; ≠ obrigado (obligare) ≠ valeu (valēre); Valeu !!!',
    excerptEn:
      'Words: “gratidão” (Late Lat. grātitūdō ← grātus) — named quality of receiving well; pieces grat- + -idão; ≠ obrigado (obligare) ≠ valeu (valēre); Valeu !!!',
    excerptEs:
      'Palabras: «gratidão» (lat. tardío grātitūdō ← grātus) — cualidad de quien recibe bien; piezas grat- + -idão; ≠ obrigado (obligare) ≠ valeu (valēre); ¡Valeu !!!',

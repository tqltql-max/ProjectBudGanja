...
| **Fechar** | Depois da lata / do soro | [Faça o melhor!](${mantra}) |
...
**Aprovado na série Palavras** — *isotônico* fichado como **iso- + tônico**: tensão **igual**; a peça [tônico](${tonico}) isolada (osmose / músculo / rótulo); hipotônico e hipertônico na mesma família; fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Tônico](${tonico}) · [▶ Água](${agua}) · [▶ Quina](${quina}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [tônico](${tonico}) · [água](${agua}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Verdict:** *iso-* locks [tônico](${tonico}) to **equality**; [Do your best!](${mantra}) after the label.
...
| Vínculos | [tônico](${tonico}) · [água](${agua}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Veredicto:** *iso-* fija [tônico](${tonico}) a la **igualdad**; [¡Haz lo mejor!](${mantra}) después de la etiqueta.
...
function buildIsotonicoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «isotônico» — isola o tônico (tónos); iso- = igual; osmose × músculo × gôndola; ≠ chá, sílaba, água tónica; Faça o melhor!',
    excerptEn:
      'Words: “isotônico” — isolates tônico (tónos); iso- = equal; osmosis × muscle × shelf; ≠ herb, stress, tonic water; Do your best!',
    excerptEs:
      'Palabras: «isotônico» — aísla el tônico (tónos); iso- = igual; ósmosis × músculo × góndola; ≠ té, sílaba, agua tónica; ¡Haz lo mejor!',

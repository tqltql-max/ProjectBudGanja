 ...
 * Elo principal: expressão «Faça o melhor!» — ofício, foco e doação.
 */
...
function buildAyrtonSennaBodies() {
  ...
  const poema = '/vida/#poema=faca-o-melhor';
  const vida = '/vida/';
...
| Tipo BudGanja | Pessoa — ofício de excelência × mantra Faça o melhor |
| Elo principal | [Faça o melhor!](${mantra}) · [poema Vida](${poema}) |
...
**H2:** [Faça o melhor!](${mantra}) traduz o método Senna em linguagem do laboratório: o melhor **teu**, o de **hoje**, o que cabe **nesta mão**.  
...
3. Elo obrigatório com [Faça o melhor!](${mantra}).  
...
|-------|-------------------|
| Faça o melhor | Elo directo com [mantra](${mantra}) e [poema](${poema}) |
...
## Elo com «Faça o melhor!»

Senna é, no mapa BudGanja, a figura brasileira que **encarna** o mantra sem precisar da frase literal:

| Camada | Ligação |
|--------|---------|
| Expressão | [Faça o melhor!](${mantra}) — ofício diário |
| Poesia Vida | [poema Faça o melhor!](${poema}) |
| Vida | [Página Vida](${vida}) — ficar e cuidar |
| Palavras | [gesto](${gesto}) · [caminho](${caminho}) · [verdade](${verdade}) |

> Abrir primeiro [Faça o melhor!](${mantra}) se o interesse for o **mantra**; esta ficha se o interesse for a **pessoa** — a homenagem completa.
...
- O mantra [Faça o melhor!](${mantra}) é a ponte viva: cada inspeção, cada verso, cada dia de cultivo pode «largar» com a mesma intenção.
...
**Aprovado na série Pessoas** — homenagem completa a Ayrton Senna do Brasil: tudo de bom do ofício, com elo principal em [Faça o melhor!](${mantra}).

[▶ Pessoas](${hub}) · [▶ Faça o melhor!](${mantra}) · [▶ Poema](${poema}) · [▶ Vida](${vida}) · [▶ Instituto](${instituto}) · [Wikipedia](${wiki})
`;

  const contentEn = `## Scope

Homage and editorial inspection of **Ayrton Senna da Silva** (São Paulo, 21 Mar 1960 — Bologna, 1 May 1994) — Brazilian Formula 1 driver, businessman and philanthropist. Three-time world champion (1988, 1990, 1991). BudGanja focus: the **person and craft** — focus, rain, excellence and giving — with primary link to [Do your best!](${mantra}).
...
| Lab type | Person — craft of excellence × Do your best |
| Main link | [Do your best!](${mantra}) · [Vida poem](${poema}) |
...
**H2:** [Do your best!](${mantra}) translates Senna’s method: *your* best, *today’s*, what fits *in this hand*.  
...
## Link to “Do your best!”

| Layer | Link |
|-------|------|
| Expression | [Do your best!](${mantra}) |
...
**Approved in People series** — full homage to Ayrton Senna of Brazil, primary link [Do your best!](${mantra}).

[▶ People](${hub}) · [▶ Do your best!](${mantra}) · [▶ Poem](${poema}) · [▶ Instituto](${instituto}) · [Wikipedia](${wiki})
`;

  const contentEs = `## Alcance

Homenaje e inspección editorial de **Ayrton Senna da Silva** (São Paulo, 21 mar. 1960 — Bolonia, 1 mayo 1994) — piloto brasileño de Fórmula 1, empresario y filántropo. Tricampeón mundial (1988, 1990, 1991). Recorte BudGanja: la **persona y el oficio** — foco, lluvia, excelencia y donación — con vínculo principal en [¡Haz lo mejor!](${mantra}).
...
| Tipo lab | Persona — oficio de excelencia × Haz lo mejor |
| Vínculo principal | [¡Haz lo mejor!](${mantra}) · [poema Vida](${poema}) |
...
**H2:** [¡Haz lo mejor!](${mantra}) traduce el método Senna: lo mejor *tuyo*, el de *hoy*, lo que cabe *en esta mano*.  
...
## Vínculo con «¡Haz lo mejor!»

| Capa | Enlace |
|------|--------|
| Expresión | [¡Haz lo mejor!](${mantra}) |
...
**Aprobado en serie Personas** — homenaje completo a Ayrton Senna de Brasil, vínculo principal [¡Haz lo mejor!](${mantra}).

[▶ Personas](${hub}) · [▶ ¡Haz lo mejor!](${mantra}) · [▶ Poema](${poema}) · [▶ Instituto](${instituto}) · [Wikipedia](${wiki})
`;
...
function buildAyrtonSennaPost() {
  ...
  return figuraPost({
    title:
      'Inspeção: Ayrton Senna — homenagem completa ao Brasil e ao Faça o melhor!',
    titleEn:
      'Inspection: Ayrton Senna — full homage to Brazil and Do your best!',
    titleEs:
      'Inspección: Ayrton Senna — homenaje completo a Brasil y ¡Haz lo mejor!',
    excerpt:
      'Pessoas × Expressões: homenagem completa a Ayrton Senna (1960–1994) — tricampeão, ofício, filantropia e elo principal no mantra Faça o melhor!; sem romantizar a morte.',
    excerptEn:
      'People × Expressions: full homage to Ayrton Senna (1960–1994) — three-time champion, craft, philanthropy and primary link to Do your best!; without romanticizing death.',
    excerptEs:
      'Personas × Expresiones: homenaje completo a Ayrton Senna (1960–1994) — tricampeón, oficio, filantropía y vínculo principal en ¡Haz lo mejor!; sin romantizar la muerte.',

...
| Elo ofício | [verdade](${verdade}) · [respeito](${respeito}) · [gesto](${gesto}) · [Faça o melhor!](${mantra}) |
...
O *a* final de *cara* e o *a* inicial de *alho* **fundem-se** no ouvido — parece [aglutinação](${aglutinacao}). A diferença lab: a aglutinação escolar **produz** composto (*planalto* = plano+alto). Aqui o composto **não** é a origem da palavra: é **etimologia popular** (história que encaixa demais).

**H-jogo:** *cara+alho* = **trocadilho** + **etimologia popular**.  
...
| Etimologia popular *cara+alho* | História falsa que a boca conta porque **encaixa** | Alta (como fenómeno); **baixa** como étimo real |
...
| **Étimo** | cara + alho | Etimologia popular ≠ étimo |
...
**H2:** *cara+alho* = jogo + etimologia popular; **não** é étimo.  
...
**H6:** fecho = [Faça o melhor!](${mantra}) — nome certo, sem misturar ofícios.
...
| [Faça o melhor!](${mantra}) | Fechar com o nome certo |
...
[▶ Palavras](${hub}) · [▶ Aglutinação](${aglutinacao}) · [▶ Polimorfismo](${polimorfismo}) · [▶ Tanzânia](${tanzania}) · [▶ Faça o melhor!](${mantra})
`;
...
**Verdict:** the joining that makes another meaning here is a **pun**. Folk etymology ≠ etymon.

## Status

**Approved** — pun named; polymorphism refused; agglutination and portmanteau kept apart.

[▶ Words](${hub}) · [▶ Agglutination](${aglutinacao}) · [▶ Polymorphism](${polimorfismo}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Aglutinación](${aglutinacao}) · [▶ Polimorfismo](${polimorfismo}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildTrocadilhoPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: trocadilho (calembur) — cara+alho é jogo + etimologia popular, não polimorfismo nem palavra-valise; irmãs aglutinação e Tanzânia; Faça o melhor!',
    excerptEn:
      'Words: pun / calembour — cara+alho is a joke + folk etymology, not polymorphism or a portmanteau; sisters agglutination and Tanzania; Do your best!',
    excerptEs:
      'Palabras: trocadilho (calembur) — cara+alho es juego + etimología popular, no polimorfismo ni palabra-valija; hermanas aglutinación y Tanzanía; ¡Haz lo mejor!',

...
**H5:** fecho = [Valeu !!!](${mantra}) — o melhor recorte *desta* franquia *neste* mapa, sem pretender esgotar cada sequela.
...
| [Valeu !!!](${mantra}) | O melhor *deste* mapa, sem fingir que cada sequela foi vista como génese |
...
[▶ Trailer 2007](${YT}) · [▶ Wikipédia 2007](${WIKI}) · [▶ Série de filmes](${WIKI_SERIES}) · [▶ Objectos](${objetos}) · [▶ Valeu !!!](${mantra})
`;

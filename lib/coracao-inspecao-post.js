 ...
 * relação com mãos (direita/esquerda) · Valeu !!!
 */
...
| Elo ofício | [verdade](${verdade}) · [Valeu !!!](${mantra}) · [língua portuguesa](${lingua}) |
...
**H3:** «coragem» e «coração» partilham raiz de **ânimo** — o laboratório liga ousadia a [Valeu !!!](${mantra}), não a bravata vazia.
...
| **Juntas** | Como o ofício fecha? | [Gesto](${gesto}) com [verdade](${verdade}) → [Valeu !!!](${mantra}) |
...
| **Coragem** | Ousar, enfrentar | [Valeu !!!](${mantra}) com ânimo — não bravata |
| **Gesto** | Mão no peito, abraço | [Gesto](${gesto}) · [mãos](${maos}) |
| **Oralidade** | Exclamações do peito | [jesusamado](${jesus}) · [meudeusdoceu](${meudeus}) — afeto / assombro (elos, não sinónimos) |
| **Fechar** | Depois do sentir, o acto | [Verdade](${verdade}) + [Valeu !!!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **com este peito**, hoje — sem fingir anatomia nem forçar pose |
...
| Oralidade | [jesusamado](${jesus}) · [meudeusdoceu](${meudeus}) — sopros do peito BR |

**Veredicto:** Valeu !!! **de coração** — com [gesto](${gesto}) e [verdade](${verdade}). Coração sem [caminho](${caminho}) = pose; coração com método = centro que fica.
...
**H4:** fecho = [Valeu !!!](${mantra}) de coração, com limites.
...
| [jesusamado](${jesus}) · [meudeusdoceu](${meudeus}) | Oralidade do peito |
...
**Aprovado** — **coração** fichado: objeto (*cor*), sentidos (órgão · afeto · centro · coragem), relação com [mãos](${maos}) / [esquerdo](${esquerdo}) e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Mãos](${maos}) · [▶ Esquerdo](${esquerdo}) · [▶ Gesto](${gesto}) · [▶ Alegria](${alegria}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **coração** (heart) — organ, affect, center and courage. Covers **object**, **senses**, **relation to hands** (left/right complementarity — not anatomy as dogma), and [Valeu !!!](${mantra}). Links: [mãos](${maos}), [esquerdo](${esquerdo}), [gesto](${gesto}), [alegria](${alegria}), [raiva](${raiva}), [Vida](${vida}).
...
| Links | [mãos](${maos}) · [esquerdo](${esquerdo}) · [gesture](${gesto}) · [truth](${verdade}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name the organ · feel with craft · center the project · dare with [Valeu !!!](${mantra}) · link oral peito: [jesusamado](${jesus}) · [meudeusdoceu](${meudeus}).
...
**Approved** — object · senses · hands link · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Hands](${maos}) · [▶ Esquerdo](${esquerdo}) · [▶ Gesture](${gesto}) · [▶ Alegria](${alegria}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **coração** (corazón) — órgano, afecto, centro y coraje. Cubre **objeto**, **sentidos**, **relación con las manos** (izquierda/derecha — complementariedad, no anatomía como dogma) y [¡Valeu !!!](${mantra}). Vínculos: [mãos](${maos}), [esquerdo](${esquerdo}), [gesto](${gesto}), [alegria](${alegria}), [raiva](${raiva}), [Vida](${vida}).
...
| Vínculos | [mãos](${maos}) · [esquerdo](${esquerdo}) · [gesto](${gesto}) · [verdad](${verdade}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar · sentir con oficio · centrar el proyecto · osar con [¡Valeu !!!](${mantra}) · oralidad del pecho: [jesusamado](${jesus}) · [meudeusdoceu](${meudeus}).
...
**Aprobada** — objeto · sentidos · vínculo manos · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Manos](${maos}) · [▶ Esquerdo](${esquerdo}) · [▶ Gesto](${gesto}) · [▶ Alegria](${alegria}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildCoracaoPost() {
  ...
  return makePalavra({
    title: 'Inspeção: Coração — órgão, afeto, centro, coragem e Valeu !!!',
    titleEn: 'Inspection: Coração — organ, affect, center, courage and Valeu !!!',
    titleEs: 'Inspección: Coração — órgano, afecto, centro, coraje y ¡Valeu !!!',
    excerpt:
      'Palavras: «coração» (lat. *cor*) — órgão, afeto, centro e coragem; elo mãos/esquerdo; Valeu !!! de coração.',
    excerptEn:
      'Words: “coração” (Lat. *cor*) — organ, affect, center and courage; hands/esquerdo link; Valeu !!! from the heart.',
    excerptEs:
      'Palabras: «coração» (lat. *cor*) — órgano, afecto, centro y coraje; vínculo manos/esquerdo; Valeu !!! de corazón.',

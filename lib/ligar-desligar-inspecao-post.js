...
**Tese:** sem [interruptor](${interruptor}), o par fica abstracto; sem ligar/desligar, o interruptor fica peça muda. As duas fichas são **par lab** — objecto × verbo.
...
| Par | Diferença |
|-----|-----------|
| **ligar/desligar** vs **[interruptor](${interruptor})** | Verbos (gesto) × substantivo (peça) — **par lab** |
...
function buildLigarDesligarPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «ligar» × «desligar» (lat. *ligāre*) — verbos do circuito; par lab com interruptor (peça × gesto); Faça o melhor!',
    excerptEn:
      'Words: “ligar” × “desligar” (Lat. *ligāre*) — circuit verbs; lab pair with interruptor (device × gesture); Do your best!',
    excerptEs:
      'Palabras: «ligar» × «desligar» (lat. *ligāre*) — verbos del circuito; par lab con interruptor (pieza × gesto); ¡Haz lo mejor!',
    slug: 'inspecao-palavra-ligar-desligar',
    date: '2026-08-04T17:00:00.000Z',
    seriesOrder: order,
    seriesLabel: 'Ligar × Desligar · interruptor',

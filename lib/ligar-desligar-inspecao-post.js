...
**Aprovado** — **ligar** × **desligar** fichados como verbos do circuito; tríade com [interruptor](${interruptor}) e [luz](${luz}); [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Interruptor](${interruptor}) · [▶ Luz](${luz}) · [▶ Gesto](${gesto}) · [▶ Sinal](${sinal}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildLigarDesligarPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «ligar» × «desligar» (lat. *ligāre*) — verbos do circuito; tríade com interruptor e luz; Faça o melhor!',
    excerptEn:
      'Words: “ligar” × “desligar” (Lat. *ligāre*) — circuit verbs; triad with interruptor and luz; Do your best!',
    excerptEs:
      'Palabras: «ligar» × «desligar» (lat. *ligāre*) — verbos del circuito; tríada con interruptor y luz; ¡Haz lo mejor!',

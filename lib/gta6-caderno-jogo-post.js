...
**Caderno de jogo 1** — o primeiro caderno da série **Cadernos de jogo**. Objecto: **Grand Theft Auto VI** (**GTA 6**), da **Rockstar Games**. Hoje (17 ago. 2026) o jogo **ainda não saiu**: a estreia oficial anunciada é **19 de novembro de 2026** (PlayStation 5 e Xbox Series X|S). Este caderno **não é walkthrough**. É o **abrir do caderno**: inspecionar a **cidade anunciada**, o **par de protagonistas** e o **hype**, com método.

> **Nota metodológica:** auditoria independente do Inspetor BudGanja. Fontes âncora: [Wikipédia · GTA VI](${wiki}), [Wikipedia (EN)](${wikiEn}), [página oficial](${official}), [comunicado Rockstar · 19 nov. 2026](${rockstarNews}), trailer oficial 1 (${yt}). Crédito: Rockstar Games / Take-Two — **sem afiliação**. **Ficção de crime ≠ manual de crime.** O laboratório **não** ensina delito, aliciação nem exploração. O objecto é **cultura + cidade + método**.

Cadernos seguintes (quando o jogo existir no ecrã) podem anotar sessões de jogo. Este primeiro caderno fixa o **mapa antes da viagem**.
...
**H4:** o fecho é [Faça o melhor!](${mantra}) — jogar com [skill](${skill}) e [risco](${risco}) nomeados; sair do ecrã sem copiar o delito.
...
**Aprovado — Caderno de jogo 1.** GTA 6 documentado como **cidade anunciada** (pré-estreia 19 nov. 2026). Próximo caderno possível: primeira sessão **depois** do lançamento, se o Inspetor jogar.
`;
...
Inspect the **city** the trailer sells (tourism, heat, money, police) — not “how to be the criminal.” Pair = two agencies on one map. Hype is an object. [Do your best!](${mantra}) means play with named [risk](${risco}), then leave the screen.
...
Inspeccionar la **ciudad** que vende el tráiler — no «cómo ser el criminal». La pareja = dos agencias. El hype es objeto. [¡Haz lo mejor!](${mantra}) = jugar con [riesgo](${risco}) nombrado y apagar la pantalla.

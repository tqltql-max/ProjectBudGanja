...
No laboratório: Lectures = ponte entre [risco](${RISCO}) calculado e [Valeu !!!](${MANTRA}) — ofício que se conta sem banalizar o perigo.
...
| Elogio de ofício | [fantástico](${FANTÁSTICO}) · [incrível](${INCRÍVEL}) · [maravilhoso](${MARAVILHOSO}) · [Valeu !!!](${MANTRA}) |

...
| [Faça o melhor!](${mantra}) · [vida](${vidaPalavra}) | Ofício |
...
[▶ Spotify](${SPOTIFY}) · [▶ Clipe VEVO](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=vira-vira) · [▶ Pelados em Santos](${pelados}) · [▶ Respeito](${respeito}) · [▶ Faça o melhor!](${mantra})
`;

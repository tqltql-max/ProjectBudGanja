...
| Guias irmãos | [Médicos](${L.medicos}) · [Farmacêuticos](${L.farmaceuticos}) · [Associações](${L.associacoes}) · [Defensoria](${L.defensoria}) |
| Penal / sanitário | [Lei 11.343](${L.lei}) · [Porte × Tráfico](${L.porte}) · [Descriminalização](${L.descrim}) · [RDC](${L.rdc}) |
...
[▶ Médicos](${L.medicos}) · [▶ Farmacêuticos](${L.farmaceuticos}) · [▶ Associações](${L.associacoes}) · [▶ Defensoria](${L.defensoria}) · [▶ Lei 11.343](${L.lei}) · [▶ Porte × Tráfico](${L.porte}) · [▶ Classificação legal](${L.guia}) · [▶ Hub Palavras](${L.hub})
`;

...
| «Faça diferente» (vazio de anúncio) | Fechar com [Valeu !!!](${mantra}) **neste** [caminho](${caminho}) |
...
|----------------|---------|
| Expressão | [Valeu !!!](${mantra}) — o melhor **neste** objecto, hoje |
...
**Veredicto:** Valeu !!! **sem o culto da marca** — **Xiaomi** como nome certo; *xioomi* como rasto; 小米 como grão, não altar.
...
**H4:** fecho [Valeu !!!](${mantra}); ficha ≠ review.
...
| [Valeu !!!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) · [Guia](${guia}) | Fecho sem culto |
...
**Aprovado** — **Xiaomi** fichado (*xioomi* → Xiaomi): marca × 小米 (milheto) × rasto oral BR; anti-pedestal; elos [Jobs](${jobs}) · [ídolo](${idolo}) · [celular](${celular}); fecho [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Jobs](${jobs}) · [▶ Ídolo](${idolo}) · [▶ Objetos](${objetosPalavra}) · [▶ Celular](${celular}) · [▶ Valeu !!!](${mantra})
`;
...
| Links | [Jobs](${jobs}) · [ídolo](${idolo}) · [objects](${objetosPalavra}) · [phone](${celular}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Xiaomi ≠ consumption manual.** If you say Xiaomi, know whether you mean a **word**, a **brand**, or **this** device. *xioomi* → **Xiaomi**. Admire the deed ([genial](${genial})) without handing the [gesture](${gesto}) to the logo. Treat the handset as an [object](${objetosPalavra}). Close with [Valeu !!!](${mantra}).

## Status

**Approved** — **Xiaomi** (*xioomi* → Xiaomi) × millet 小米; anti-pedestal; links [Jobs](${jobs}) · [ídolo](${idolo}) · [phone](${celular}); [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Jobs](${jobs}) · [▶ Ídolo](${idolo}) · [▶ Objects](${objetosPalavra}) · [▶ Valeu !!!](${mantra})
`;
...
| Vínculos | [Jobs](${jobs}) · [ídolo](${idolo}) · [objetos](${objetosPalavra}) · [celular](${celular}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Xiaomi ≠ manual de consumo.** Saber si se habla de **palabra**, **marca** o **este** aparato. *xioomi* → **Xiaomi**. Admirar el hecho sin entregar el [gesto](${gesto}) al logo. Tratar el teléfono como [objeto](${objetosPalavra}). Cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — **Xiaomi** (*xioomi* → Xiaomi) × mijo 小米; anti-pedestal; vínculos [Jobs](${jobs}) · [ídolo](${idolo}) · [celular](${celular}); [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Jobs](${jobs}) · [▶ Ídolo](${idolo}) · [▶ Objetos](${objetosPalavra}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildXioomiPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «Xiaomi» (*xioomi* → Xiaomi) — 小米 milheto; marca × grão × ídolo tech; elos Jobs, objetos e celular; Valeu !!!',
    excerptEn:
      'Words: “Xiaomi” (*xioomi* → Xiaomi) — 小米 millet; brand × grain × tech idol; links Jobs, objects and phone; Valeu !!!',
    excerptEs:
      'Palabras: «Xiaomi» (*xioomi* → Xiaomi) — 小米 mijo; marca × grano × ídolo tech; vínculos Jobs, objetos y celular; ¡Valeu !!!',

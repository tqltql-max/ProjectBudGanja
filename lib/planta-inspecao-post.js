...
| Elo irmãos | [animal](${animal}) · [simbiose](${simbiose}) · [erva](${erva}) |
...
| **Léxico irmão** | [erva](${erva}) · [maconha](${maconha}) · [animal](${animal}) | Outros nomes e o vivo não vegetal |
...
| [Erva](${erva}) · [Maconha](${maconha}) · [Cannabis](${cannabis}) | Léxico e um exemplo de espécie |

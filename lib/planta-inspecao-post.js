...
| **Fechar** | Depois do trato, o acto | [Valeu !!!](${mantra}) com a planta à vista |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **com esta planta / este cultivo**, hoje |
...
**Veredicto:** Valeu !!! **com a planta** — observar, cuidar, nomear com método. Planta sem [caminho](${caminho}) = cartaz; planta com ofício = vida que o lab respeita.
...
**H4:** fecho = [Valeu !!!](${mantra}) com a planta como ser vivo.
...
**Aprovado** — **planta** fichada: objeto (*planta* / *plantare*), sentidos (vivo · cultivo · farmácia · plural **plantas**), elos ao hub [Plantas](${plantas}) e [Farmácia Viva](${farmacia}), sem duplicar espécies; [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Plantas](${plantas}) · [▶ Farmácia Viva](${farmacia}) · [▶ Cultivo](${cultivo}) · [▶ Animal](${animal}) · [▶ Simbiose](${simbiose}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [Plantas](${plantas}) · [Farmácia Viva](${farmacia}) · [animal](${animal}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · senses · living being · cultivation / Farmácia Viva · hub without species list · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Plantas](${plantas}) · [▶ Farmácia Viva](${farmacia}) · [▶ Cultivo](${cultivo}) · [▶ Animal](${animal}) · [▶ Valeu !!!](${mantra})
`;
...
| Vínculos | [Plantas](${plantas}) · [Farmácia Viva](${farmacia}) · [animal](${animal}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · sentidos · ser vivo · cultivo / Farmácia Viva · hub sin lista · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Plantas](${plantas}) · [▶ Farmácia Viva](${farmacia}) · [▶ Cultivo](${cultivo}) · [▶ Animal](${animal}) · [▶ ¡Valeu !!!](${mantra})
`;

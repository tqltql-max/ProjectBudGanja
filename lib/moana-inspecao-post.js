...
**H5:** fecho = [Valeu !!!](${mantra}) — o melhor possível *neste* oceano, hoje.
...
| «How Far I'll Go» | Coragem calibrada — [Valeu !!!](${mantra}) com o oceano que se tem |
...
**Aprovado na série Artes** — *Moana* (2016) documentada como **desenho** de oceano, vocação e cuidado da ilha; elos [mar](${mar}) · [navegar](${navegar}) · [caminho](${caminho}) · [Valeu !!!](${mantra}); sequelas como eco.

[▶ Artes](${hub}) · [▶ Mar](${mar}) · [▶ Navegar](${navegar}) · [▶ Caminho](${caminho}) · [▶ Vida](${vida}) · [▶ Valeu !!!](${mantra})
`;
...
Ocean as call · leaving the safe shore · craft of sailing · care for the living island · [Valeu !!!](${mantra}) with the sea you have. Parable beside [Amyr](${amyr}) / [Tamara](${tamara}) navigation — not biography.
...
Océano como llamado · dejar la playa segura · oficio de navegar · cuidar la isla viva · [¡Valeu !!!](${mantra}). Parábola junto a [Amyr](${amyr}) / [Tamara](${tamara}) — no biografía.
...
function buildMoanaPost(seriesOrder) {
  ...
  return artePost({
    ...
    excerpt:
      'Artes · desenho: Moana (2016, Disney / Clements & Musker) — oceano, navegar e cuidado da ilha; elos mar/caminho/Vida; Valeu !!!',
    excerptEn:
      'Arts · animation: Moana (2016, Disney / Clements & Musker) — ocean, sailing and island care; links mar/caminho/Vida; Valeu !!!',
    excerptEs:
      'Artes · dibujo: Moana (2016, Disney / Clements & Musker) — océano, navegar y cuidado de la isla; vínculos mar/caminho/Vida; ¡Valeu !!!',

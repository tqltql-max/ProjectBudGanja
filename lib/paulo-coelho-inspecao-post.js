...
| Elo Palavras | [caminho](${caminho}) · [passar](${passar}) · [sinal](${sinal}) · [criatividade](${criatividade}) · [navegar](${navegar}) · [Faça o melhor!](${faca}) |
...
| [Faça o melhor!](${faca}) | O melhor recorte *desta* pessoa *neste* ofício — sem hype de best-seller |
...
[▶ Pessoas](${hub}) · [▶ O Alquimista](${alquimista}) · [▶ caminho](${caminho}) · [▶ Faça o melhor!](${faca}) · [Wikipedia](${wiki})
`;

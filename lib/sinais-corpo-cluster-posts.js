...
> Method note: word sheet ≠ clinical anatomy. Close: [Do your best!](${H.mantra}).
...
[▶ Signs](${H.sinais}) · [▶ Do your best!](${H.mantra})
`;
  const contentEs = `## Alcance

${opts.esScope}

> Nota: ficha ≠ anatomía clínica. Cierre: [¡Haz lo mejor!](${H.mantra}).
...
[▶ Señales](${H.sinais}) · [▶ ¡Haz lo mejor!](${H.mantra})
`;
...
Inspeção editorial de **[sinais](${H.sinais})** — o **plural** de [sinal](${H.sinal}): o **campo de marcas do corpo**. Pedido de campo: *sinais* (partes: orelha, mama, barriga, cabelo). Esta ficha é o **mapa**; as peças com leitura já dita vão às fichas-irmãs. Elos: [gesto](${H.gesto}), [sinais REM](${H.sinaisRem}), [Faça o melhor!](${H.mantra}).
...
| Peças com leitura | [barriga](${H.barriga}) · [orelha](${H.orelha}) · [mama / teta](${H.mama}) · [cabelo](${H.cabelo}) |
...
2. Abrir a **parte** com leitura (barriga / orelha / mama / cabelo).  
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${H.mantra}) — com os **sinais do corpo à vista**, hoje |
...
**Veredicto:** Faça o melhor **lendo o campo** — barriga (satisfação), orelha (curiosidade), mama/teta (algo fácil), cabelo (deixa com quem sabe).

## Status

**Aprovado** — mapa do corpo; quatro leituras de campo; [Faça o melhor!](${H.mantra}).

[▶ Palavras](${H.hub}) · [▶ Barriga](${H.barriga}) · [▶ Orelha](${H.orelha}) · [▶ Mama](${H.mama}) · [▶ Cabelo](${H.cabelo}) · [▶ Sinais REM](${H.sinaisRem}) · [▶ Faça o melhor!](${H.mantra})
`;
  const { contentEn, contentEs } = shortEnEs({
    ...
    enScope:
      ...
      ') = something easy; [hair](' +
      H.cabelo +
      ') = leave it with women (they know more). Brother sheet: [sinais REM](' +
      H.sinaisRem +
      ').',
    enSignal: 'the field, not one mark',
    enStatus: 'body map · four craft readings',
    esScope:
      'Plural de [sinal](' +
      H.sinal +
      ...
      ') = algo fácil; [cabello](' +
      H.cabelo +
      ') = déjalo con las mujeres (saben más). Ficha hermana: [sinais REM](' +
      H.sinaisRem +
      ').',
    esSignal: 'el campo, no una sola marca',
    esStatus: 'mapa del cuerpo · cuatro lecturas'
  });
...
| Elo ofício | [gesto](${H.gesto}) · [verdade](${H.verdade}) · [Faça o melhor!](${H.mantra}) |
| Fonte | [barriga](${wiki}) |
| Data | 2026-08-21 |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${H.mantra}) — o melhor possível **com o bastante à vista**, hoje |
| Anti-armadilha | Transformar satisfação em culpa = ruído · transformar em bula = fora de escopo |
| Mapa | [sinais](${H.sinais}) |

**Veredicto:** Faça o melhor **com a barriga como sinal de satisfação** — o bastante, sem tese de farinha colada.

## Status

**Aprovado** — barriga fichada: ventre · satisfação · ≠ Barriga de Trigo; [Faça o melhor!](${H.mantra}).

[▶ Sinais](${H.sinais}) · [▶ Orelha](${H.orelha}) · [▶ Mama](${H.mama}) · [▶ Cabelo](${H.cabelo}) · [▶ Barriga de Trigo](${H.trigo}) · [▶ Faça o melhor!](${H.mantra})
`;
  const { contentEn, contentEs } = shortEnEs({
    word: 'barriga',
    enScope:
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${H.mantra}) — o melhor possível **com a pulga nomeada**, hoje |
| Anti-armadilha | Pulga ≠ prova · curiosidade ≠ acusação |
| Mapa | [sinais](${H.sinais}) |

**Veredicto:** Faça o melhor **com a orelha como sinal de curiosidade** — a pulga atrás pede inspeção, não sentença.

## Status

**Aprovado** — orelha fichada: *auricula* · pulga atrás · curiosidade; [Faça o melhor!](${H.mantra}).

[▶ Sinais](${H.sinais}) · [▶ Barriga](${H.barriga}) · [▶ Mama](${H.mama}) · [▶ Cabelo](${H.cabelo}) · [▶ Inseto](${H.inseto}) · [▶ Dois ouvidos](${H.ouvidos}) · [▶ Faça o melhor!](${H.mantra})
`;
  const { contentEn, contentEs } = shortEnEs({
    word: 'orelha',
    enScope:
...
Inspeção editorial da palavra **[mama](${H.mama})** — no fala BR, **teta**; no mapa de [sinais](${H.sinais}), **sinal de algo fácil**. Pedido de campo: *mama é teta, algo fácil*. Esta ficha cobre o **objecto** (lat. *mamma*), a forma oral **teta**, a leitura de ofício (**facilidade** — o que está à mão), os **não-é**, e o fecho [Faça o melhor!](${H.mantra}).
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${H.mantra}) — o melhor possível **com o fácil à vista**, hoje |
...
**Veredicto:** Faça o melhor **com mama/teta como sinal de algo fácil** — o à-mão, sem pornografar nem fundir com fruto ou com a [mãe](${H.mae}).

## Status

**Aprovado** — mama = teta = sinal de algo fácil; ≠ mamão ≠ mãe; [Faça o melhor!](${H.mantra}).

[▶ Sinais](${H.sinais}) · [▶ Barriga](${H.barriga}) · [▶ Orelha](${H.orelha}) · [▶ Cabelo](${H.cabelo}) · [▶ Mamão](${H.mamao}) · [▶ Mãe](${H.mae}) · [▶ Faça o melhor!](${H.mantra})
`;
  const { contentEn, contentEs } = shortEnEs({
    word: 'mama / teta',
    enScope:
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${H.mantra}) — o melhor possível **sem fingir o ofício do cabelo**, hoje |
| Anti-armadilha 1 | Deferência ≠ despejo |
| Anti-armadilha 2 | Saber de cabelo ≠ único saber das mulheres |
| Mapa | [sinais](${H.sinais}) |

**Veredicto:** Faça o melhor **deixando o cabelo com quem sabe** — as mulheres, neste recorte; o lab ouve.

## Status

**Aprovado** — cabelo fichado: *capillus* · deixa com as mulheres · [respeito](${H.respeito}); [Faça o melhor!](${H.mantra}).

[▶ Sinais](${H.sinais}) · [▶ Barriga](${H.barriga}) · [▶ Orelha](${H.orelha}) · [▶ Mama](${H.mama}) · [▶ Respeito](${H.respeito}) · [▶ Faça o melhor!](${H.mantra})
`;
  const { contentEn, contentEs } = shortEnEs({
    word: 'cabelo',
    enScope:
...
function buildSinaisPost() {
  ...
  return stamp(
    makePalavra({
      ...
      excerpt:
        'Palavras: «sinais» — plural de sinal; mapa do corpo: barriga=satisfação, orelha=pulga/curiosidade, mama/teta=algo fácil, cabelo=deixa com as mulheres; Faça o melhor!',
      excerptEn:
        'Words: “sinais” — plural of sinal; body map: belly=satisfaction, ear=flea/curiosity, breast/teat=easy, hair=leave with women; Do your best!',
      excerptEs:
        'Palabras: «sinais» — plural de sinal; mapa del cuerpo: barriga=satisfacción, oreja=pulga/curiosidad, mama/teta=fácil, cabello=déjalo con las mujeres; ¡Haz lo mejor!',
...
function buildBarrigaPost() {
  ...
  return stamp(
    makePalavra({
      ...
      excerpt:
        'Palavras: «barriga» — ventre como sinal de satisfação (o bastante); ≠ Barriga de Trigo; mapa sinais; Faça o melhor!',
      excerptEn:
        'Words: “barriga” — belly as a signal of satisfaction (enough); ≠ Wheat Belly; sinais map; Do your best!',
      excerptEs:
        'Palabras: «barriga» — vientre como señal de satisfacción (lo bastante); ≠ Barriga de Trigo; mapa sinais; ¡Haz lo mejor!',
...
function buildOrelhaPost() {
  ...
  return stamp(
    makePalavra({
      ...
      excerpt:
        'Palavras: «orelha» — pulga atrás da orelha = curiosidade; elos inseto, dois ouvidos; mapa sinais; Faça o melhor!',
      excerptEn:
        'Words: “orelha” — flea behind the ear = curiosity; links insect, two ears; sinais map; Do your best!',
      excerptEs:
        'Palabras: «orelha» — pulga detrás de la oreja = curiosidad; insecto, dos oídos; mapa sinais; ¡Haz lo mejor!',
...
function buildMamaPost() {
  ...
  return stamp(
    makePalavra({
      ...
      excerpt:
        'Palavras: «mama» = «teta» — sinal de algo fácil; ≠ mamão ≠ mãe; mapa sinais; Faça o melhor!',
      excerptEn:
        'Words: “mama” = “teta” — signal of something easy; ≠ papaya ≠ mother; sinais map; Do your best!',
      excerptEs:
        'Palabras: «mama» = «teta» — señal de algo fácil; ≠ mamón ≠ madre; mapa sinais; ¡Haz lo mejor!',
...
function buildCabeloPost() {
  ...
  return stamp(
    makePalavra({
      ...
      excerpt:
        'Palavras: «cabelo» — sinal de deferência: a gente deixa com as mulheres, elas sabem mais; ≠ despejo; mapa sinais; Faça o melhor!',
      excerptEn:
        'Words: “cabelo” — signal of deference: leave it with women, they know more; ≠ dumping labor; sinais map; Do your best!',
      excerptEs:
        'Palabras: «cabelo» — señal de deferencia: déjalo con las mujeres, saben más; ≠ descargar trabajo; mapa sinais; ¡Haz lo mejor!',

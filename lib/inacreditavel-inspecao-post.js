 ...
 * escala com incrível / fabuloso / genial · Valeu !!!
...
Inspeção editorial da palavra **inacreditável** — adjetivo (e sopro de elogio no português do Brasil) formado por **in-** + **acreditável**: o que **não se pode acreditar**. No uso vivo BR, a mesma forma serve **dois ofícios**: (1) marcar o **além da crença** (facto / feito difícil de aceitar); (2) elogiar no topo da escala («que inacreditável!» ≈ uau / beyond belief). Irmão lexical de [incrível](${incrivel}) (*incredibilis*). Esta ficha cobre o **objeto**, os **sentidos**, a **escala de louvor** com fichas existentes ([legal](${legal}), [especial](${especial}), [genial](${genial}), [incrível](${incrivel}), [fabuloso](${fabuloso})), e o fecho [Valeu !!!](${mantra}). Gatilho tipográfico: *ianfreditala* → **inacreditável**. Tom: **calor + precisão**, não sermão.
...
| Elo assombro | [meudeusdoceu](${meudeusdoceu}) · [jesusamado](${jesusamado}) |
...
| Alta / exclamação | [meudeusdoceu](${meudeusdoceu}) · [jesusamado](${jesusamado}) | Assombro / afeto em sopro colado | Expressões |
...
|----------------|---------|
| Expressão | [Valeu !!!](${mantra}) — o melhor possível **hoje**, mesmo quando o peito está no teto |
...
**Veredicto:** Valeu !!! **com o inacreditável** — deixar o peito abrir (praise / beyond belief), creditando o feito; depois continuar o ofício. Inacreditável sem [caminho](${caminho}) = pose; inacreditável com método = lareira de admiração.
...
**H4:** fecho = [Valeu !!!](${mantra}) depois do «não acredito».
...
| [meudeusdoceu](${meudeusdoceu}) · [jesusamado](${jesusamado}) | Peito que abre em sopro |
| [Gesto](${gesto}) · [Verdade](${verdade}) · [Criatividade](${criatividade}) | Ofício sob o elogio |
| [Língua portuguesa](${lingua}) · [Guia](${guia}) | Solo BR |
| [Valeu !!!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) | Depois do assombro |
...
**Aprovado** — **inacreditável** fichado: *in-* + *acreditável* → incredulidade × elogio BR; escala com [incrível](${incrivel}) / [fabuloso](${fabuloso}) / [genial](${genial}); elo [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Incrível](${incrivel}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **inacreditável** — adjective and BR praise from **in-** + **acreditável** (*credere*): literally “unbelievable / beyond belief,” and orally a top-tier “wow.” Sister sheet: [incrível](${incrivel}). Covers **object**, **senses**, an **intensity scale** with [legal](${legal}), [genial](${genial}), [fabuloso](${fabuloso}) and [incrível](${incrivel}), and [Valeu !!!](${mantra}). Typo trigger: *ianfreditala* → **inacreditável**.
...
| Links | [incrível](${incrivel}) · [genial](${genial}) · [fabuloso](${fabuloso}) · [aff](${aff}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
After the “I can’t believe it,” keep the craft — [Valeu !!!](${mantra}). Unbelievable without [path](${caminho}) = pose; with method = lasting admiration.

## Status

**Approved** — *in-* + *acreditável*; unbelief × BR praise; scale linked; [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Incrível](${incrivel}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **inacreditável** — adjetivo y elogio BR desde **in-** + **acreditável** (*credere*): literalmente «increíble / más allá de lo creíble», y en el habla un «guau» alto. Hermana: [incrível](${incrivel}). Cubre **objeto**, **sentidos**, una **escala** con [legal](${legal}), [genial](${genial}), [fabuloso](${fabuloso}) e [incrível](${incrivel}), y [¡Valeu !!!](${mantra}). Gatillo tipográfico: *ianfreditala* → **inacreditável**.
...
| Vínculos | [incrível](${incrivel}) · [genial](${genial}) · [fabuloso](${fabuloso}) · [aff](${aff}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Después del «no lo creo», seguir el oficio — [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — *in-* + *acreditável*; incredulidad × elogio BR; escala enlazada; [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Incrível](${incrivel}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildInacreditavelPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Inacreditável — beyond belief, elogio BR e Valeu !!!',
    titleEn:
      'Inspection: Inacreditável — beyond belief, BR praise and Valeu !!!',
    titleEs:
      'Inspección: Inacreditável — más allá de lo creíble, elogio BR y ¡Valeu !!!',
    excerpt:
      'Palavras: «inacreditável» (in- + acreditável ← credere) — incredulidade e elogio BR «beyond belief»; escala com incrível, fabuloso e genial; Valeu !!!',
    excerptEn:
      'Words: “inacreditável” (in- + acreditável ← credere) — unbelief and BR praise “beyond belief”; scale with incrível, fabuloso and genial; Valeu !!!',
    excerptEs:
      'Palabras: «inacreditável» (in- + acreditável ← credere) — incredulidad y elogio BR «beyond belief»; escala con incrível, fabuloso y genial; ¡Valeu !!!',

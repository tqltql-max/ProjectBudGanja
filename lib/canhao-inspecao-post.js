...
Inspeção editorial da palavra **[canhão](${self})** e, neste circuito, do **objecto** **El Cristiano** (*El Cristiano* / Canhão Cristão) — peça de artilharia fundida no [Paraguai](${paraguai}) durante a [Guerra do Paraguai](${guerra}), com metal associado a **sinos de igrejas**, capturada como [troféu de guerra](${trofeus}) e exposta no **Museu Histórico Nacional** (Praça XV, Rio de Janeiro). Pedido de campo: *CANJÃO* → correção **CANHÃO**; *CANHÃO DO PARAGUAY*. O lab **não** dispara a peça: inspeciona o **tubo**, o **nome** e o **trâmite de devolução** (aval político relatado em **agosto de 2026**; entrega **sem data fechada** aqui). Elos: [fogo](${fogo}), [risco](${risco}), [Faça o melhor!](${mantra}).
...
**H4:** fecho [Faça o melhor!](${mantra}) — o melhor é **não disparar a ficha como hino**.
...
[▶ Palavras](${hub}) · [▶ Troféus](${trofeus}) · [▶ Guerra do Paraguai](${guerra}) · [▶ Paraguai](${paraguai}) · [▶ Faça o melhor!](${mantra})
`;
...
A cannon is a tube. The trophy is not the whole war. *Canjão* is a slip. Close with [Do your best!](${mantra}).
...
El cañón es un tubo. El trofeo no es toda la guerra. Cerrar con [¡Haz lo mejor!](${mantra}).
...
function buildCanhaoPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: canhão (*canna*); peça El Cristiano da Guerra do Paraguai; troféu no MHN; devolução autorizada (ago. 2026) ≠ entrega; Faça o melhor!',
    excerptEn:
      'Words: cannon (*canna*); El Cristiano from the Paraguayan War; MHN trophy; return authorized (Aug 2026) ≠ delivery; Do your best!',
    excerptEs:
      'Palabras: cañón (*canna*); El Cristiano de la Guerra del Paraguay; trofeo en el MHN; devolución autorizada (ago. 2026) ≠ entrega; ¡Haz lo mejor!',

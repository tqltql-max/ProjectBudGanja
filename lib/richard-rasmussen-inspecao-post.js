...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor ecrã possível **com** o ser vivo, **com** [respeito](${respeito}), **sem** apagar [risco](${risco}) |
...
[▶ Canal YouTube](${canal}) · [▶ Vídeos](${videos}) · [▶ Selvagem](${selvagem}) · [▶ Respeito](${respeito}) · [▶ Legado](${legado}) · [▶ Valeu !!!](${mantra})
`;

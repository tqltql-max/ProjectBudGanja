...
| [Faça o melhor!](${mantra}) | Depois da citação — trabalhar |
...
**Aprovada na série Expressões e Ditados populares** — *Toda criança nasce cientista* fichada como **citação de campo** (Arleu Barbosa Viana-Junior / [CNN Brasil](${cnn})), chegada como [mensagem](${mensagem}) da [mãe](${mae}); o campo devolve o método que o crescer às vezes esconde; fecho [Faça o melhor!](${mantra}).

[▶ Expressões](${hub}) · [▶ Mãe](${mae}) · [▶ Mensagem](${mensagem}) · [▶ Inseto](${inseto}) · [▶ Poema](${poemHref}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [plant](${planta}) · [insect](${inseto}) · [gesture](${gesto}) · [Do your best!](${mantra}) |
| Date | ${inspected} |

## Verdict

**Approved** — fieldwork quote (Arleu / CNN); arrived as a mother’s message; the field returns the method growing-up sometimes hides; close with [Do your best!](${mantra}).

[▶ Expressions](${hub}) · [▶ Mother](${mae}) · [▶ Poem](${poemHref}) · [▶ Do your best!](${mantra})
`;
...
| Vínculos | [planta](${planta}) · [insecto](${inseto}) · [gesto](${gesto}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |

## Veredicto

**Aprobada** — cita de campo (Arleu / CNN); llegó como mensaje de la madre; el campo devuelve el método que crecer a veces esconde; cierre [¡Haz lo mejor!](${mantra}).

[▶ Expresiones](${hub}) · [▶ Madre](${mae}) · [▶ Poema](${poemHref}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildTodaCriancaNasceCientistaPost(seriesOrder) {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: Toda criança nasce cientista — citação de Arleu Barbosa Viana-Junior (CNN / campo no Cerrado); chegou como mensagem da mãe; Faça o melhor!',
    excerptEn:
      'Sayings: Every child is born a scientist — Arleu Barbosa Viana-Junior (CNN / Cerrado field); arrived as a mother’s message; Do your best!',
    excerptEs:
      'Dichos: Toda criança nasce cientista — cita de Arleu Barbosa Viana-Junior (CNN / campo en el Cerrado); llegó como mensaje de la madre; ¡Haz lo mejor!',

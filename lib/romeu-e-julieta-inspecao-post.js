...
| Elo Palavras | [nó](${no}) · [nó na vida!](${noVida}) · [desatar o nó](${desatarNo}) · [etimologia](${etimologia}) · [língua portuguesa](${lingua}) · [coração](${coracao}) · [vida](${vidaPalavra}) · [gesto](${gesto}) · [verdade](${verdade}) · [caminho](${caminho}) · [Valeu !!!](${mantra}) |
...
- Sem protocolar «como as casas se reconciliam» na vida real — isso é [desatar o nó](${desatarNo}) + [Valeu !!!](${mantra}).  
...
[▶ Artes](${hub}) · [▶ Shakespeare](${shake}) · [▶ Filme 1996](${filme}) · [▶ Nó](${no}) · [▶ Etimologia](${etimologia}) · [▶ Valeu !!!](${mantra}) · [Wikipedia](${wiki})
`;
...
| Words | [knot](${no}) · [etymology](${etimologia}) · [heart](${coracao}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
[▶ Arts](${hub}) · [▶ Shakespeare](${shake}) · [▶ Valeu !!!](${mantra})
`;
...
| Palabras | [nó](${no}) · [etimologia](${etimologia}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
[▶ Artes](${hub}) · [▶ Shakespeare](${shake}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildRomeuEJulietaPost(seriesOrder) {
  ...
  return artePost({
    ...
    excerpt:
      'Artes: Romeu e Julieta (Shakespeare) — tragédia de Verona; o apelido é o nó, a pessoa não é o nome. Autor em Pessoas. Literatura, não protocolo. Valeu !!!',
    excerptEn:
      'Arts: Romeo and Juliet (Shakespeare) — Verona tragedy; the surname is the knot, the person is not the name. Author in People. Literature, not a protocol. Valeu !!!',
    excerptEs:
      'Artes: Romeu e Julieta (Shakespeare) — tragedia de Verona; el apellido es el nudo, la persona no es el nombre. Autor en Personas. Literatura, no protocolo. ¡Valeu !!!',

 ...
 * culinária (pato no tucupi) · animal / água / coelho · Faça o melhor!
 */
...
Inspeção editorial da palavra **pato** — ave aquática (Anatidae), étimo **árabe-hispânico** que substituiu o latim *anatem*, e, no português vivo, também a **figura do ingénuo** e as expressões **pagar o pato** / **cair como um pato**. Elos: [animal](${animal}), [água](${agua}), [coelho](${coelho}), culinária amazónica via [jambu](${jambu}) («pato no tucupi»), e fecho [Faça o melhor!](${mantra}).
...
| Elo ofício | [caminho](${caminho}) · [gesto](${gesto}) · [verdade](${verdade}) · [Faça o melhor!](${mantra}) |
...
| [Faça o melhor!](${mantra}) | Ofício: não «ser o pato» — fazer o melhor possível nesta mão |
...
4. Fechar com [Faça o melhor!](${mantra}) — ofício ≠ levar a culpa alheia.  
...
[▶ Palavras](${hub}) · [▶ Animal](${animal}) · [▶ Água](${agua}) · [▶ Jambu](${jambu}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **pato** (“duck”) — waterbird (Anatidae), **Arabic-Hispanic** etymon that replaced Latin *anatem*, and figurative uses (**pagar o pato**, gullible person). Links: [animal](${animal}), [água](${agua}), [coelho](${coelho}), Amazon cuisine via [jambu](${jambu}) (“duck in tucupi”), and [Do your best!](${mantra}).
...
| Links | [animal](${animal}) · [água](${agua}) · [coelho](${coelho}) · [jambu](${jambu}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
[▶ Words](${hub}) · [▶ Animal](${animal}) · [▶ Água](${agua}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de la palabra portuguesa **pato** — ave acuática (Anatidae), étimo **árabe-hispánico** que sustituyó el latín *anatem*, y usos figurados (**pagar o pato**, ingenuo). Vínculos: [animal](${animal}), [água](${agua}), [coelho](${coelho}), cocina amazónica vía [jambu](${jambu}) («pato en tucupi»), y [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [animal](${animal}) · [água](${agua}) · [coelho](${coelho}) · [jambu](${jambu}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
[▶ Palabras](${hub}) · [▶ Animal](${animal}) · [▶ Água](${agua}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildPatoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «pato» (árabe-hispânico *páṭṭ* ← persa) — ave aquática, pagar o pato, culinária amazónica; elos animal, água, jambu; Faça o melhor!',
    excerptEn:
      'Words: “pato” (Arabic-Hispanic *páṭṭ* ← Persian) — waterbird, take the blame, Amazon cuisine; links animal, água, jambu; Do your best!',
    excerptEs:
      'Palabras: «pato» (árabe-hispánico *páṭṭ* ← persa) — ave acuática, pagar el pato, cocina amazónica; vínculos animal, água, jambu; ¡Haz lo mejor!',

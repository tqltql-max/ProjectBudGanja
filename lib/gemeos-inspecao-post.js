...
**H-par:** dois corpos, um [caminho](${caminho}) cada um — [Faça o melhor!](${mantra}) **em cada mão**, não um desejo pelos dois.
...
4. Fechar com [Faça o melhor!](${mantra}) **neste** corpo — o par não faz o ofício por ti.
...
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — um ofício por mão, mesmo em par |
...
**H4:** fecho [Faça o melhor!](${mantra}); ficha ≠ horóscopo.
...
| [Faça o melhor!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) · [Guia](${guia}) | Fecho |
...
**Aprovado** — **gêmeos** fichado como *geminus* (par / signo); armadilha *gênio* / Aladim / Gemini marcada; elos [relação](${relacao}) · [genial](${genial}) · [abracadabra](${abracadabra}); fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Genial](${genial}) · [▶ Relação](${relacao}) · [▶ Abracadabra](${abracadabra}) · [▶ Mãos](${maos}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Inspection of Portuguese **gêmeos** (“twins”; typed **gemeos**). Field question: relation to *genius* / genial / Aladdin? **Letter-trap, not shared etymon.** *Gêmeos* ← Lat. *geminus* (twin, double). *[Gênio](${wikiGenius})* / [genial](${genial}) ← Lat. *genius*. **Gemini** is the Latin name of the pair (constellation / sign). Links: [relação](${relacao}), [Do your best!](${mantra}).
...
**Twins ≠ genie ≠ “genial!”** If the mouth said Geneo / génio, see [genial](${genial}). Close with [Do your best!](${mantra}) in **this** pair of hands.

## Status

**Approved** — *geminus* sheet; trap with genius / Aladdin / Gemini marked.

[▶ Words](${hub}) · [▶ Genial](${genial}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **gêmeos** («gemelos»; teclado **gemeos**). ¿Relación con genio / genial / Aladino? **Trampa de letras, no étimo común.** *Gêmeos* ← lat. *geminus*. *[Gênio](${wikiGenius})* / [genial](${genial}) ← lat. *genius*. **Gemini** es el nombre latino del par. Vínculos: [relação](${relacao}), [¡Haz lo mejor!](${mantra}).
...
**Gemelos ≠ genio de la lámpara ≠ «¡genial!».** Si la boca dijo Geneo / génio, ver [genial](${genial}). Cerrar con [¡Haz lo mejor!](${mantra}).

## Estado

**Aprobada** — ficha *geminus*; trampa con genio / Aladino / Gemini marcada.

[▶ Palabras](${hub}) · [▶ Genial](${genial}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildGemeosPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «gêmeos» (gemeos) — lat. geminus (par) ≠ genius (engenho / lâmpada); signo Gemini; elos relação e genial; Faça o melhor!',
    excerptEn:
      'Words: “gêmeos” — Lat. geminus (twins) ≠ genius (craft / lamp); Gemini sign; links relação and genial; Do your best!',
    excerptEs:
      'Palabras: «gêmeos» — lat. geminus (par) ≠ genius (ingenio / lámpara); signo Gemini; vínculos relação y genial; ¡Haz lo mejor!',

...
Inspeção editorial da palavra **[Moçambique](${self})** — o **país** no Índico (EN *Mozambique*; sw. *Msumbiji*). Pedido de campo: *inspeção em Moçambique relacionando tónos com esqueiro biq*. O lab lê **três âncoras coladas**: o **país**, o **[tônico](${tonico})** da palavra (gr. *tónos* — o pico cai em **BI**), e o lapso **esqueiro biq** = **[isqueiro BIC](${isqueiro})** × **Biq** (xeique *Mussa Bin Bique* / *Musa ibn Bique*, étimo tradicional do topónimo). Esta ficha cobre o **país**, o **nome**, o **tónos da sílaba** e a **correção**: país ≠ marca de isqueiro. Elos: [isqueiro BIC](${isqueiro}), [tônico](${tonico}), [língua portuguesa](${lingua}), [Valeu !!!](${mantra}).
...
**H5:** fecho [Valeu !!!](${mantra}); ficha ≠ atlas nem história da Frelimo.
...
| [Valeu !!!](${mantra}) · [poema Vida](${poemMantra}) | Fecho |
...
[▶ Palavras](${hub}) · [▶ Isqueiro BIC](${isqueiro}) · [▶ Tônico](${tonico}) · [▶ Língua portuguesa](${lingua}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Inspection of Portuguese **Moçambique** — the **country** (EN **Mozambique**; Swahili *Msumbiji*). Field request: relate **tónos** with **esqueiro biq**. The slip mixes **[BIC lighter](${isqueiro})** with **Biq** (sheikh *Musa ibn Bique*, traditional etymon). The word’s stress (*tónos*) falls on **BI**. Links: [tonic](${tonico}), [Portuguese](${lingua}), [Valeu !!!](${mantra}).
...
**Moçambique = country.** If the mouth said *esqueiro biq*, open this sheet **and** [BIC lighter](${isqueiro}). The [tonic](${tonico}) of the word is **BI**. Close with [Valeu !!!](${mantra}).

## Status

**Approved** — country sheet; slip and *tónos* separated.

[▶ Words](${hub}) · [▶ Lighter](${isqueiro}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **Moçambique** — el **país** (EN **Mozambique**; sw. *Msumbiji*). Pedido: relacionar **tónos** con **esqueiro biq**. El lapsus mezcla el **[encendedor BIC](${isqueiro})** con **Biq** (jeque *Musa ibn Bique*, étimo tradicional). El acento (*tónos*) cae en **BI**. Vínculos: [tônico](${tonico}), [portugués](${lingua}), [¡Valeu !!!](${mantra}).
...
**Moçambique = país.** Si la boca dijo *esqueiro biq*, abrir esta ficha **y** [encendedor BIC](${isqueiro}). El [tônico](${tonico}) de la palabra es **BI**. Cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — ficha de país; lapsus y *tónos* separados.

[▶ Palabras](${hub}) · [▶ Encendedor](${isqueiro}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildMocambiquePost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «Moçambique» — país lusófono; étimo Mussa Bin Bique; tónico em BI; lapso esqueiro biq = Biq × isqueiro BIC; Valeu !!!',
    excerptEn:
      'Words: “Moçambique” — lusophone country; etymon Musa ibn Bique; stress on BI; slip esqueiro biq = Biq × BIC lighter; Valeu !!!',
    excerptEs:
      'Palabras: «Moçambique» — país lusófono; étimo Musa ibn Bique; tónico en BI; lapsus esqueiro biq = Biq × encendedor BIC; ¡Valeu !!!',

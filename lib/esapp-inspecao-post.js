...
- **Método:** (1) missão e história institucional; (2) perfil público do curso de Agronomia; (3) infraestrutura (campi); (4) recorte **biblioteca · centro académico · desporto/lazer**; (5) cruzamento com inspeções BudGanja; (6) enquadramento da intenção formativa.
...
|---------|--------------|
| Campus urbano | ~**120 000 m²** totais · ~**10 000 m²** construídos · Rua Prefeito Jayme Monteiro, 791 |
| Convívio + desporto | **> 21 000 m²** (página institucional) |
| Fazenda Modelo | ~**298,61 ha** — a ~2 km do campus urbano; práticas de campo |
| Duração do curso | **5 anos** (informação pública do site) |

Fonte da tabela e das secções seguintes: [ESAPP — instituição](https://www.esapp.edu.br/instituicao/) (dados públicos; confirmar no local).

## Recorte campus — biblioteca, centro académico, desporto e lazer

Pedido de ofício: **conferir** três casas do campus urbano. Esta ficha **não visita o pátio** — audita o que a instituição **publica**. Mérito das instalações: ESAPP / FUNGE.

### 1. Biblioteca — Centro Cultural Célio Rodrigues Siqueira

A biblioteca da ESAPP chama-se **Centro Cultural Célio Rodrigues Siqueira**. Ofício público: suporte a **ensino, pesquisa e extensão**; acervo de vários tipos de documento; consulta **informatizada** com terminais para o aluno.

| Peça | Dado público | Leitura lab |
|------|----------------|-------------|
| Nome | Centro Cultural Célio Rodrigues Siqueira | Casa de estudo — não confundir com a [biblioteca digital BudGanja](/biblioteca/) |
| Uso | Ensino · pesquisa · extensão | Par da [Fazenda Modelo](https://www.esapp.edu.br/instituicao/) no mapa formação |
| Informática | Terminais de consulta bibliográfica | Ofício de pesquisa, não vitrine |
| Uso individual | **67 m²** | Estudo sozinho |
| Uso colectivo | **235 m²** — salas de estudo e de vídeo | Trabalho em grupo / aula |
| Acervo (área) | **118 m²** | Prateleira, não o edifício inteiro |
| Soma das três áreas | **420 m²** (118 + 67 + 235) | Texto da secção «Biblioteca» no site |
| Linha «Biblioteca» na tabela de instalações | **613 m²** | Ver hipótese abaixo |

**H4 (metragem):** a tabela de instalações agrupa, no item 7, **Biblioteca 613 m²** e, na mesma linha de bloco, Sala de Desenho (150 m²) e sanitários (42 m²). 420 + 150 + 42 = **612 m²** ≈ 613. Hipótese de trabalho: **613 = bloco**; **420 = biblioteca propriamente dita**. Confiança: **média** — só se fecha no local ou com planta oficial.

**Limite:** esta ficha **não** inventa horário, regulamento de empréstimo nem catálogo. Confirmar no balcão.

### 2. Centro académico — D.A.F.A.G.

O **Diretório Académico das Faculdades Gammon (D.A.F.A.G.)** é a entidade estudantil pública da página institucional: **sem fins lucrativos**; representa os alunos de **Agronomia**; zela por interesses discentes; promove integração entre alunos, professores, funcionários e direcção por eventos **cívicos, sociais e culturais**.

| Campo | Dado público |
|-------|----------------|
| Sigla | **D.A.F.A.G.** / DAFAG |
| Nome longo (site) | Diretório Académico das **Faculdades Gammon** |
| Sala (tabela) | **20 m²** |
| Âmbito declarado | Representação · integração · eventos |

**H5 (nome):** a instituição voltou a chamar-se **ESAPP** em **outubro de 2022**; a ficha pública do diretório ainda diz **Faculdades Gammon**. Leitura lab: **atraso de nomenclatura** no texto, não juízo sobre o trabalho dos alunos. Confirmar o nome vivo com o próprio D.A.

Uso histórico verificável: o D.A. organizou o **1.º Torneio Interturmas** (maio de 2010) — futsal na quadra, seis times de Agronomia e Zootecnia, ~500 pessoas no recinto ([i7 Notícias / assessoria FUNGE](https://www.i7noticias.com/paraguacu/noticia/467/alunos-da-esapp-participam-do-1-torneio-interturmas)). Serve de elo **centro académico × desporto**, não de calendário actual.

**Limite:** 20 m² é a **sala**; o ofício do D.A. é a **voz**, não o metro quadrado.

### 3. Áreas de desporto e lazer

A página institucional conta **mais de 21 000 m²** de convivência e actividades desportivas no campus urbano, além de «áreas de lazer e espera». Peças nomeadas na tabela:

| Instalação | Área pública (m²) | Nota |
|------------|-------------------|------|
| Campo de futebol e pista de atletismo | **10 050** | Maior peça desportiva |
| Quadra polidesportiva coberta | **770** | Futsal / torneios (ex. Interturmas) |
| Quadra polidesportiva | **570** | Descoberta |
| Quadra de vólei de areia | **300** | Lazer de areia |
| Salão de convivência | **500** | Convívio — não é aula |
| Sala de educação física | **75** | Apoio |
| Cantinas | 280 + 78 | Pausa / espera |

**H6:** o campus urbano não é só sala de aula — há **corpo no pátio** (quadra, campo, pista) e **pausa** (cantina, salão, espera). Para o laboratório: graduação agronómica inclui **estudo** (biblioteca) e **convívio** (D.A. + lazer), sem transformar a ficha em guia turístico.

**Limite:** metragem pública ≠ estado de conservação. Não inspeccionámos piso, iluminação nem horário de uso.

## Veredicto do recorte campus

| Casa | Ofício | Estado da auditoria |
|------|--------|---------------------|
| **Biblioteca** (Célio Rodrigues Siqueira) | Estudo · acervo · extensão | Aprovada como casa de pesquisa; **conferir 420 vs 613 m²** no local |
| **D.A.F.A.G.** | Voz estudantil · integração | Aprovado como centro académico público; **nome Gammon vs ESAPP** a actualizar no texto institucional |
| **Desporto e lazer** | Quadra · campo · pista · convívio | Aprovado como mapa de pátio; **> 21 000 m²** declarados |

**Não substituímos visita.** Fonte-mãe: [esapp.edu.br/instituicao](https://www.esapp.edu.br/instituicao/).
...
|------------|------------------|
| Formação agronómica (graduação) | Esta ficha · [Cadernos de Engenharia](/biblioteca/cadernos/) |
| Biblioteca física (ESAPP) | Centro Cultural Célio Rodrigues Siqueira · [biblioteca digital](/biblioteca/) |
| Centro académico | D.A.F.A.G. (voz estudantil — 20 m² de sala; ofício maior que o metro) |
| Desporto e lazer | Quadras, campo, pista e salão — [instituição](https://www.esapp.edu.br/instituicao/) |
...
- [ESAPP — instituição](https://www.esapp.edu.br/instituicao/) — biblioteca, D.A.F.A.G., tabela de instalações (desporto/lazer)
- [i7 Notícias — 1.º Torneio Interturmas](https://www.i7noticias.com/paraguacu/noticia/467/alunos-da-esapp-participam-do-1-torneio-interturmas) (assessoria FUNGE, 2010)
...
- **Method:** (1) mission and institutional history; (2) public Agronomy program profile; (3) infrastructure (campuses); (4) **library · academic center · sport/leisure** cut; (5) cross-links with BudGanja inspections; (6) framing of educational intention.
...
| Unit | Public data |
|------|-------------|
| Urban campus | ~**120,000 m²** total · ~**10,000 m²** built |
| Gathering + sport | **> 21,000 m²** |
| Model Farm | ~**298.61 ha** — ~2 km from the urban campus |
| Program length | **5 years** |

Source: [ESAPP — institution](https://www.esapp.edu.br/instituicao/).

## Campus cut — library, academic center, sport and leisure

### Library — Centro Cultural Célio Rodrigues Siqueira

Support for teaching, research and extension; computerized catalogue terminals. Public split: **118 m²** stacks · **67 m²** individual · **235 m²** collective (study + video) = **420 m²**. The installations table lists **Library 613 m²** in the same block as drawing room (150) and toilets (42): 420+150+42 ≈ 613. Working hypothesis: **613 = building block**; **420 = library proper** (medium confidence — confirm on site).

### Academic center — D.A.F.A.G.

Student directory for Agronomy; nonprofit; civic, social and cultural events. Table: **20 m²**. Public name still **Faculdades Gammon** after the **2022** return to **ESAPP** — nomenclature lag, not a judgment of the students. Historical sport link: Interturmas futsal, May 2010.

### Sport and leisure

Covered poly court **770 m²** · open poly court **570** · sand volleyball **300** · football field + athletics track **10,050** · PE room **75** · gathering hall **500** · canteens. Declared gathering+sport area **> 21,000 m²**. Area ≠ condition; we did not inspect the floor.
...
- **Método:** (1) misión e historia institucional; (2) perfil público del curso de Agronomía; (3) infraestructura (campi); (4) recorte **biblioteca · centro académico · deporte/ocio**; (5) cruces con inspecciones BudGanja; (6) encuadre de la intención formativa.
...
| Unidad | Dato público |
|--------|--------------|
| Campus urbano | ~**120 000 m²** totales · ~**10 000 m²** construidos |
| Convivencia + deporte | **> 21 000 m²** |
| Fazenda Modelo | ~**298,61 ha** — a ~2 km del campus urbano |
| Duración del curso | **5 años** |

Fuente: [ESAPP — institución](https://www.esapp.edu.br/instituicao/).

## Recorte campus — biblioteca, centro académico, deporte y ocio

### Biblioteca — Centro Cultural Célio Rodrigues Siqueira

Soporte a enseñanza, investigación y extensión; terminales informatizados. Partición pública: **118 m²** acervo · **67 m²** individual · **235 m²** colectivo = **420 m²**. La tabla lista **Biblioteca 613 m²** en el mismo bloque que sala de dibujo (150) y sanitarios (42): 420+150+42 ≈ 613. Hipótesis: **613 = bloque**; **420 = biblioteca propiamente dicha** (confianza media — confirmar in situ).

### Centro académico — D.A.F.A.G.

Directorio estudiantil de Agronomía; sin fines de lucro; eventos cívicos, sociales y culturales. Tabla: **20 m²**. El nombre público sigue **Faculdades Gammon** tras el retorno **2022** a **ESAPP** — retraso de nomenclatura. Vínculo deportivo histórico: Interturmas (fútbol sala, mayo 2010).

### Deporte y ocio

Cancha cubierta **770 m²** · cancha descubierta **570** · vóley de arena **300** · campo de fútbol y pista **10 050** · sala de educación física **75** · salón de convivencia **500**. Área declarada convivencia+deporte **> 21 000 m²**. Metragem ≠ estado de conservación.
...
function buildEsappInspecaoPost() {
  ...
  return formacaoPost({
    ...
    excerpt:
      'Ficha institucional da ESAPP (Paraguaçu Paulista/SP): Agronomia, Fazenda Modelo, biblioteca Célio Rodrigues Siqueira, D.A.F.A.G. e áreas de desporto/lazer — onde o Inspetor BudGanja pretende cursar graduação.',
    excerptEn:
      'Institutional sheet on ESAPP (Paraguaçu Paulista/SP): Agronomy, Model Farm, Célio Rodrigues Siqueira library, D.A.F.A.G. and sport/leisure areas — where Inspector BudGanja intends to study.',
    excerptEs:
      'Ficha institucional de la ESAPP (Paraguaçu Paulista/SP): Agronomía, Fazenda Modelo, biblioteca Célio Rodrigues Siqueira, D.A.F.A.G. y deporte/ocio — donde el Inspector BudGanja pretende cursar grado.',

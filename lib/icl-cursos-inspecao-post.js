...
4. Fechar com [Faça o melhor!](${mantra}) — o melhor recorte possível *desta* casa *neste* laboratório.
...
[▶ ICL Cursos](${site}) · [▶ Canal YouTube](${canal}) · [▶ UNIFESP](${unifesp}) · [▶ Faça o melhor!](${mantra})
`;

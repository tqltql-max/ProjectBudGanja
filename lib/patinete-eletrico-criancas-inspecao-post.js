...
**H5:** fecho = [respeito](${respeito}) à criança + [Valeu !!!](${mantra}) — o melhor recorte *deste* objecto *neste* ecrã, sem virar vitrine nem pânico.
...
6. Fechar com [Valeu !!!](${mantra}) — o melhor para *esta* criança *neste* [caminho](${caminho}), não o melhor anúncio.
...
[▶ Objetos](${catalogo}) · [▶ Inspeções](${hub}) · [▶ INMETRO](${INMETRO_BRINQUEDO}) · [▶ CONTRAN 996](${CONTRAN_PDF}) · [▶ celular](${celular}) · [▶ risco](${risco}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ INMETRO](${INMETRO_BRINQUEDO}) · [▶ CONTRAN 996](${CONTRAN_PDF}) · [▶ Valeu !!!](${mantra})
`;

...
| Elo irmãs | [filho de deus](${filhoDeDeus}) · [jesusamado](${jesusamado}) · [Deus abençoe](${abencoe}) · [a bença](${aBenca}) |
...
| **Ofício lab** | Pessoa inteira como lugar de trabalho | [alma](${alma}) + corpo no [gesto](${gesto}) · [Valeu !!!](${mantra}) |
...
|-----------|-----------------|--------|
| [jesusamado](${jesusamado}) | Afeto / bênção leve | Calor na voz |
...
| **Fechar com ofício** | Depois da fórmula | [Valeu !!!](${mantra}) |
...
| [filho de deus](${filhoDeDeus}) · [jesusamado](${jesusamado}) · [Deus abençoe](${abencoe}) | Irmãs de solo religioso-cultural BR |
...
| [Valeu !!!](${mantra}) | Depois da fórmula — o ofício |
...
| Irmãs | [filho de deus](${filhoDeDeus}) · [jesusamado](${jesusamado}) · [Deus abençoe](${abencoe}) |
| Mantra | [Valeu !!!](${mantra}) |
...
**Aprovado na série Expressões e Ditados populares** — *o templo de Cristo, corpo e alma* fichado como fórmula de **morada**, **nome** e **inteireza**; irmã de [filho de deus](${filhoDeDeus}) e [alma](${alma}); fecho [Valeu !!!](${mantra}) — habitar o templo **sem fender** o corpo.

[▶ Expressões](${hub}) · [▶ Alma](${alma}) · [▶ filho de deus](${filhoDeDeus}) · [▶ Deus abençoe](${abencoe}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of **“o templo de Cristo, corpo e alma”** (lab request in caps: **O TEMPLO DE CRISTO CORPO E ALMA**). Living formula: **temple** + **Christ** + **body and soul** (wholeness). Sisters [filho de deus](${filhoDeDeus}), [jesusamado](${jesusamado}), [Deus abençoe](${abencoe}); [soul](${alma}); [Portuguese](${lingua}) soil.
...
| Links | [filho de deus](${filhoDeDeus}) · [soul](${alma}) · [heart](${coracao}) · [gesture](${gesto}) · [truth](${verdade}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — dwelling · name · wholeness; sisters [filho de deus](${filhoDeDeus}) / [soul](${alma}); [Valeu !!!](${mantra}).

[▶ Expressions](${hub}) · [▶ Soul](${alma}) · [▶ filho de deus](${filhoDeDeus}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEs = `## Alcance

Inspección de **«o templo de Cristo, corpo e alma»** (pedido en mayúsculas coladas). Fórmula viva: **templo** + **Cristo** + **cuerpo y alma** (entereza). Hermanas [filho de deus](${filhoDeDeus}), [jesusamado](${jesusamado}), [Deus abençoe](${abencoe}); [alma](${alma}); suelo de la [lengua portuguesa](${lingua}).
...
| Vínculos | [filho de deus](${filhoDeDeus}) · [alma](${alma}) · [gesto](${gesto}) · [verdad](${verdade}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — morada · nombre · entereza; hermanas [filho de deus](${filhoDeDeus}) / [alma](${alma}); [¡Valeu !!!](${mantra}).

[▶ Expresiones](${hub}) · [▶ Alma](${alma}) · [▶ filho de deus](${filhoDeDeus}) · [▶ ¡Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildTemploDeCristoCorpoEAlmaPost(seriesOrder) {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «o templo de Cristo, corpo e alma» — morada, nome e inteireza; peças templo · Cristo · corpo · alma; sem catecismo; Valeu !!!',
    excerptEn:
      'Sayings: “o templo de Cristo, corpo e alma” — dwelling, name and wholeness; pieces temple · Christ · body · soul; no catechism; Valeu !!!',
    excerptEs:
      'Dichos: «o templo de Cristo, corpo e alma» — morada, nombre y entereza; piezas templo · Cristo · cuerpo · alma; sin catecismo; ¡Valeu !!!',

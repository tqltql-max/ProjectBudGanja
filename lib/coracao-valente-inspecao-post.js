...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte *deste* épico *desta* lenda.
...
[▶ Artes](${hub}) · [▶ coração](${coracao}) · [▶ Mel Gibson](${GIBSON}) · [▶ A Paixão de Cristo (outra ficha)](${PAIXAO}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;

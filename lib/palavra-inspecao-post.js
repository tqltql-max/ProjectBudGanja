...
**H1:** *palavra* < *parabola* < *parabolḗ* — fala que **compara / lança ao lado** (alta). O avô e as duas salas (história × curva) estudam-se em [parábola](${parabola}).  
...
| **[Parábola](${parabola})** | Mesmo avô grego — narrativa **e** curva | Alta — estudar na [página dedicada](${parabola}); esta ficha é a **filha** (vocábulo) |
...
**Aprovado na série Palavras** — *palavra* fichada como vocábulo (*parabola*); o avô e as duas salas em [parábola](${parabola}); a série fica no [hub](${hub}); o método em [etimologia](${etimologia}).

[▶ Palavras](${hub}) · [▶ Parábola](${parabola}) · [▶ Etimologia](${etimologia}) · [▶ Língua](${lingua}) · [▶ Guia](${guia}) · [Wikcionário](${WIKT})
`;

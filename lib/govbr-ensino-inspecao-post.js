...
- **H5:** Fecho = [Valeu !!!](${mantra}) — o melhor ecrã possível *nesta* idade *nesta* conta pública, com [respeito](${respeito}) ao tempo de tela ([celular](${celular})).
...
7. Fechar com [Valeu !!!](${mantra}) e [Vida](${vida}).
...
[▶ MEC Livros](${livros}) · [▶ MEC Idiomas](${idiomasFaq}) · [▶ Canal Educação](${canalYt}) · [▶ AVAMEC](${avamec}) · [▶ MEC Enem](${enemApp}) · [▶ gov.br](${gov}) · [▶ Valeu !!!](${mantra})
`;

...
| [Vida](${vida}) · [poemas](${poemMantra}) | Verso que fica no peito | [Faça o melhor!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **hoje** pode tornar-se memorável **depois** |
...
**Veredicto:** Faça o melhor **para que algo possa ser memorável** — ofício agora; memória como efeito, não como atalho.
...
[▶ Palavras](${hub}) · [▶ Inspeções](${hubAll}) · [▶ Genial](${genial}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Fantástico](${fantastico}) · [▶ Livro](${livro}) · [▶ Divertida Mente](${divertida}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
| Craft links | [gesture](${gesto}) · [truth](${verdade}) · [creativity](${criatividade}) · [Do your best!](${mantra}) |
...
[▶ Words](${hub}) · [▶ Genial](${genial}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Do your best!](${mantra})
`;
...
| Oficio | [gesto](${gesto}) · [verdad](${verdade}) · [creatividad](${criatividade}) · [¡Haz lo mejor!](${mantra}) |
...
[▶ Palabras](${hub}) · [▶ Genial](${genial}) · [▶ Maravilhoso](${maravilhoso}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildMemoravelPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «memorável» (lat. memorabilis) — digno de memória; elogio BR; eixo retenção ≠ escala legal/genial/maravilhoso/fantástico; Faça o melhor!',
    excerptEn:
      'Words: “memorável” (Lat. memorabilis) — worth remembering; BR praise; retention axis ≠ legal/genial/maravilhoso intensity; Do your best!',
    excerptEs:
      'Palabras: «memorável» (lat. memorabilis) — digno de memoria; elogio BR; eje retención ≠ intensidad legal/genial/maravilhoso; ¡Haz lo mejor!',

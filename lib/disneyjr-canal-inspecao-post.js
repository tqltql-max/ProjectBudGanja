...
| Elo Artes | [Moana (2016)](${moana}) · [Divertida Mente](${divertida}) · [Alice](${alice}) |
...
**H4:** fecho = [Faça o melhor!](${mantra}) — o melhor cuidado possível *nesta* idade e *neste* ecrã, com [Vida](${vida}).
...
3. Ler a ficha [Moana](${moana}) para a tese artes do oceano.  
4. Fechar com [Faça o melhor!](${mantra}) e [Vida](${vida}).

## Status

**Aprovado** — canal **Disney Jr. Brasil** documentado como hub de **desenhos** no BudGanja; âncora «Aqui no mar»; elo principal [Moana](${moana}).

[▶ Vídeos Disney Jr.](${videosHub}) · [▶ Moana](${moana}) · [▶ Mar](${mar}) · [▶ Canais](${hub}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **[${ch.channelName}](${ch.channelUrl})** (${ch.handle}) — official **cartoon** archive in Portuguese. BudGanja hub for Arts · kids animation; links [Moana](${moana}), [mar](${mar}), [navegar](${navegar}).

Anchor: **“Aqui no mar”** (Little Mermaid) — @youtube ${seed.id}

## Status

**Approved** — Disney Jr. Brasil as desenho channel; sister sheet [Moana](${moana}).

[▶ Videos](${videosHub}) · [▶ Moana](${moana})
`;

  const contentEs = `## Alcance

Inspección de **[${ch.channelName}](${ch.channelUrl})** (${ch.handle}) — archivo oficial de **dibujos** en portugués. Hub BudGanja de Artes · animación infantil; vínculos [Moana](${moana}), [mar](${mar}), [navegar](${navegar}).

Ancla: **«Aqui no mar»** (La Sirenita) — @youtube ${seed.id}

## Estado

**Aprobada** — Disney Jr. Brasil como canal de desenhos; hermana [Moana](${moana}).

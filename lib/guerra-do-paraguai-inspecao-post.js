...
**H4:** fecho [Valeu !!!](${mantra}) — o melhor aqui é **não mentir o preço**.
...
[▶ Palavras](${hub}) · [▶ Paraguai](${paraguai}) · [▶ Troféus](${trofeus}) · [▶ Canhão](${canhao}) · [▶ Valeu !!!](${mantra})
`;
...
The name is not the whole country. A trophy does not settle 1870. Close with [Valeu !!!](${mantra}) — here, that means not lying about the cost.
...
El nombre no es todo el país. Un trofeo no cierra 1870. Cerrar con [¡Valeu !!!](${mantra}).
...
function buildGuerraDoParaguaiPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: Guerra do Paraguai / Paraguay — 1864–1870; Tríplice Aliança; números e culpas em disputa; elos troféus e canhão El Cristiano; Valeu !!!',
    excerptEn:
      'Words: Paraguayan War — 1864–1870; Triple Alliance; disputed tolls and blame; links trophies and El Cristiano cannon; Valeu !!!',
    excerptEs:
      'Palabras: Guerra del Paraguay — 1864–1870; Triple Alianza; cifras y culpas en disputa; vínculos trofeos y cañón El Cristiano; ¡Valeu !!!',

...
3. **Nutrição quantitativa** — EC/PPM, overfert e flush contextualizado para solo vivo e inerte ([Calculadora EC](/calculadoras/ec.html) do laboratório).
...
|----------------|--------------------------------|
| EC/PPM, overfert | [Calculadora EC](/calculadoras/ec.html) · [Inspeção: Nutrição](/posts/post-inspecao-nutricao-cannabis.html) |
...
| Ambiente indoor | [Calculadora VPD](/calculadoras/vpd.html) · [Inspeção: Cultivo Indoor](/posts/post-inspecao-cultivo-indoor-ppfd.html) |

...
function buildMovrecamInspectionPost() {
  ...
  return {
    ...
    excerptEn:
      ...
      ch.videoCount +
      ' catalogued videos; spotlight on lecture 11 (Psychedelics, Prof. Dr. Eliana Rodrigues) from UNIFESP’s 14th edition.',
    excerptEs:
      'Auditoría editorial del canal MovReCam — ' +
      ch.videoCount +
      ' vídeos catalogados; destaque a la 11.ª clase (Psicodélicos, Profa. Dra. Eliana Rodrigues) de la XIV edición UNIFESP.',

...
| Escala de tom | [aff](${aff}) (fecha) ← → **muitoobrigado** (abre com crédito) ← → [jesusamado](${jesusamado}) (calor) |
...
| Elo afecto | [alegria](${alegria}) · [respeito](${respeito}) · [jesusamado](${jesusamado}) · [valeu](${valeu}) |
...
| **Devolver calor** | Responder a [jesusamado](${jesusamado}) / carona / ofício | Elo afectivo |
...
Auditoria oral no fio do laboratório: depois de ajuda e de uma nota de campo em [jesusamado](${jesusamado}) (cuidado / companhia), o sopro de fecho foi **muito obrigado** — gratidão reforçada, sem sermão. Sem dados pessoais.
...
|---------------------|---------|
| [jesusamado](${jesusamado}) | Irmã — calor; esta ficha = crédito explícito |
...
| [Gratidão](${gratidao}) | Qualidade nomeada (*grātus*) — esta ficha é a **fórmula** (*obligare*) |
...
**Aprovado na série Expressões e Ditados populares** — *muitoobrigado* fichado como sopro BR de gratidão reforçada; qualidade em [Gratidão](${gratidao}); contraste com [aff](${aff}); elo [gesto](${gesto}), [respeito](${respeito}) e fecho [Faça o melhor!](${mantra}).

[▶ Expressões](${hub}) · [▶ Gratidão](${gratidao}) · [▶ jesusamado](${jesusamado}) · [▶ Gesto](${gesto}) · [▶ Aff](${aff}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of the Brazilian oral expression **“muito obrigado”** — field request **“Muito obrigado!”**. Lab form **“muitoobrigado”**: **reinforced gratitude** in one breath. Also maps the etymon (*obrigar* ← Lat. *obligare*, “to bind”) with Brazilian **slavery** memory and the [sugarcane](${cana}) cycle — without equating today’s thanks with that crime. Sister of [jesusamado](${jesusamado}); light sister of [valeu](${valeu}).
...
| Tone scale | [aff](${aff}) (closes) ← → **muitoobrigado** (credit) ← → [jesusamado](${jesusamado}) (warmth) |
...
After shared craft help and a [jesusamado](${jesusamado}) care note, the closing breath was **muito obrigado**. No personal data.
...
**Approved** — BR reinforced gratitude; named quality on [Gratidão](${gratidao}); contrast with [aff](${aff}); link [gesture](${gesto}) and [Do your best!](${mantra}).

[▶ Expressions](${hub}) · [▶ jesusamado](${jesusamado}) · [▶ Aff](${aff}) · [▶ Do your best!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEs = `## Alcance

Inspección de la expresión oral brasileña **«muito obrigado»** — pedido de campo **«Muito obrigado!»**. Forma lab **«muitoobrigado»**: **gratitud reforzada** en un soplo. También mapea el étimo (*obrigar* ← lat. *obligare*, «ligar») con la memoria brasileña de la **esclavitud** y el ciclo de la [caña de azúcar](${cana}) — sin igualar el gracias de hoy con ese crimen. Hermana de [jesusamado](${jesusamado}); hermana ligera de [valeu](${valeu}).
...
| Escala | [aff](${aff}) (cierra) ← → **muitoobrigado** (crédito) ← → [jesusamado](${jesusamado}) (calor) |
...
Tras ayuda compartida y una nota de [jesusamado](${jesusamado}), el soplo de cierre fue **muito obrigado**. Sin datos personales.
...
**Aprobada** — gratitud reforzada BR; cualidad en [Gratidão](${gratidao}); contraste con [aff](${aff}); vínculo [gesto](${gesto}) y [¡Haz lo mejor!](${mantra}).

[▶ Expresiones](${hub}) · [▶ jesusamado](${jesusamado}) · [▶ Aff](${aff}) · [▶ ¡Haz lo mejor!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildMuitoObrigadoPost() {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «Muito obrigado!» / muitoobrigado — gratidão reforçada; étimo obligare × memória da escravidão/cana; elos gesto, valeu, jesusamado; Faça o melhor!',
    excerptEn:
      'Sayings: “Muito obrigado!” / muitoobrigado — reinforced gratitude; etymon obligare × slavery/sugarcane memory; gesture, valeu, jesusamado; Do your best!',
    excerptEs:
      'Dichos: «Muito obrigado!» / muitoobrigado — gratitud reforzada; étimo obligare × memoria de esclavitud/caña; gesto, valeu, jesusamado; ¡Haz lo mejor!',

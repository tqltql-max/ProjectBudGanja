...
**Aprovada** — Orfeu fichado como **nome**; mito e *Orfeu Negro* são camadas; **Morpheus do Matrix é primo do ouvido, não do étimo.** [Faça o melhor!](${mantra})

[▶ Palavras](${hub}) · [▶ Matrix](${matrix}) · [▶ Jobim](${jobim}) · [▶ Faça o melhor!](${mantra})
`;
...
**Approved** — Orfeu filed as a **name**; *Black Orpheus* is a layer; Matrix Morpheus is a cousin of the **ear**, not of the etymon. [Do your best!](${mantra})
...
**Aprobada** — Orfeu fichado como **nombre**; *Orfeu Negro* es capa; el Morpheus de Matrix es primo del **oído**, no del étimo. [¡Haz lo mejor!](${mantra})
...
function buildOrfeuPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «Orfeu» (gr. Ὀρφεύς, étimo incerto) — mito da lira e Eurídice; no BR, Orfeu da Conceição / Orfeu Negro; cola de ouvido com Morpheus do Matrix, não de étimo (Morfeu ← morphē); Faça o melhor!',
    excerptEn:
      'Words: “Orfeu” / Orpheus (Gk. Ὀρφεύς, uncertain etymon) — lyre and Eurydice; in BR, Black Orpheus; ear-glue with Matrix Morpheus, not the same etymon (Morpheus ← morphē); Do your best!',
    excerptEs:
      'Palabras: «Orfeu» (gr. Ὀρφεύς, étimo incerto) — lira y Eurídice; en BR, Orfeu Negro; pegamento de oído con Morpheus de Matrix, no el mismo étimo (Morfeo ← morphē); ¡Haz lo mejor!',

...
/** Ordem de exibição no hub de /videos/: MovReCam → CANABinALL → Inspetor → Lair → Davis → Disney Jr. → Tamara. Zangado e Paulinho ficam em /jogos/. */
const CHANNEL_META = [
  {
    id: 'movrecam',
    label: 'MovReCam',
...
function topicsFor(channelId, v, overrides, themeById) {
  ...
  if (channelId === 'tamara' || channelId === 'amyr') {

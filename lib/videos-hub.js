...
/** Ordem de exibição no hub: MovReCam → CANABinALL → Inspetor → Lair → Davis → Disney Jr. → Zangado → Paulinho. */
const CHANNEL_META = [
  {
    id: 'movrecam',
    label: 'MovReCam',
  ...
  },
  {
    ...
    seriesAliases: ['paulinho', 'paulinho-loko', 'paulinholoko'],
    inspectionUrl: '/jogos/?canal=paulinho',

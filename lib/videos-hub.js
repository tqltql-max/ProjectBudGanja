...
/** Ordem de exibição no hub de /videos/: MovReCam → CANABinALL → Inspetor → Lair → Davis → Tamara → Amyr → Rasmussen → Disney Jr. → Slivki → Manual do Mundo. Zangado e Paulinho ficam em /jogos/. */
const CHANNEL_META = [
  {
    id: 'movrecam',
    label: 'MovReCam',

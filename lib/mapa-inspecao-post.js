...
| Tipo BudGanja | Palavra — pano × desenho × plano × ofício na palma |
...
**H6:** *mapear* = variação verbal nesta ficha.  
**H7:** *cartografia* / *carta* = outra árvore (grego).  
...
| [Caminho](${caminho}) · [passar](${passar}) | A rota que o mapa desenha |
...
**Aprovado** — **mapa** fichado como **pano do mundo** (lat. *mappa*); [relação](${relacao}) com **[mão](${mao})** (*manus*) por cola *MA-* (*MApa* / *Maão*), pano na palma e locução *mapa na mão* — **sem** fundir étimos. Sem afiliação.

[▶ Palavras](${hub}) · [▶ Mão](${mao}) · [▶ Caminho](${caminho}) · [▶ Relação](${relacao}) · [▶ Valeu !!!](${mantra})
`;
...
**Approved** — **mapa** as cloth of the world (*mappa*); **[mão](${mao})** as palm (*manus*); relation without fusing etymons.

[▶ Words](${hub}) · [▶ Hand](${mao}) · [▶ Path](${caminho}) · [▶ Valeu !!!](${mantra})
`;
...
**Aprobada** — **mapa** como paño del mundo (*mappa*); **[mão](${mao})** como palma (*manus*); relación sin fusionar étimos.

[▶ Palabras](${hub}) · [▶ Mano](${mao}) · [▶ Camino](${caminho}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildMapaPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: mapa (lat. mappa «pano») × mão (lat. manus); cola MA- (MApa / Maão); mapa na mão; ≠ cartografia; Valeu !!!',
    excerptEn:
      'Words: mapa (Lat. mappa “cloth”) × mão (Lat. manus); MA- glue (MApa / Maão); map in hand; ≠ cartography; Valeu !!!',
    excerptEs:
      'Palabras: mapa (lat. mappa «paño») × mão (lat. manus); cola MA- (MApa / Maão); mapa en la mano; ≠ cartografía; ¡Valeu !!!',

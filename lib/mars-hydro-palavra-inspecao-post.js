...
| «Faça diferente» (anúncio) | [Faça o melhor!](${L.mantra}) **neste** circuito |
...
**Aprovado** — **Mars Hydro** fichado (*marshydrobr* → Mars Hydro): *Mars* + *Hydro*; rasto BR; anti-pedestal; elo [cluster de incêndio](${L.cluster}); fecho [Faça o melhor!](${L.mantra}).

[▶ Palavras](${L.hub}) · [▶ Cluster incêndio](${L.cluster}) · [▶ Catálogo BR](${L.marsEquip}) · [▶ Vivosun](${L.vivosunPalavra}) · [▶ Faça o melhor!](${L.mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **[Mars Hydro](${self})** — 2009 Shenzhen LED / tent brand. Field trail *marshydrobr* is the Brazil domain, not the brand spelling. Covers *Mars* + *Hydro*, the BR mirror, and the correction: brand ≠ [fire control](${L.cluster}). Links: [mar](${L.mar}), [água](${L.agua}), [Vivosun](${L.vivosunPalavra}), [Brazil catalog](${L.marsEquip}), [Do your best!](${L.mantra}).
...
**Mars Hydro ≠ fire certificate.** *marshydrobr* → **Mars Hydro**. Inspect [fonte](${L.fonte}), [tenda](${L.tenda}), [interruptor](${L.interruptor}). Close with [Do your best!](${L.mantra}).

## Status

**Approved** — *Mars* + *Hydro*; BR trail; [fire cluster](${L.cluster}); [Do your best!](${L.mantra}).

[▶ Words](${L.hub}) · [▶ Fire cluster](${L.cluster}) · [▶ Catalog](${L.marsEquip}) · [▶ Do your best!](${L.mantra})
`;

  const contentEs = `## Alcance

Inspección de **[Mars Hydro](${self})** — marca 2009 (Shenzhen). El rastro *marshydrobr* es el dominio Brasil, no la grafía. Cubre *Mars* + *Hydro* y la corrección: marca ≠ [control de incendio](${L.cluster}). Vínculos: [mar](${L.mar}), [água](${L.agua}), [Vivosun](${L.vivosunPalavra}), [catálogo](${L.marsEquip}), [¡Haz lo mejor!](${L.mantra}).
...
**Mars Hydro ≠ certificado de incendio.** *marshydrobr* → **Mars Hydro**. Cerrar con [¡Haz lo mejor!](${L.mantra}).

## Estado

**Aprobado** — *Mars* + *Hydro*; rastro BR; [clúster](${L.cluster}); [¡Haz lo mejor!](${L.mantra}).

[▶ Palabras](${L.hub}) · [▶ Clúster incendio](${L.cluster}) · [▶ Catálogo](${L.marsEquip}) · [▶ ¡Haz lo mejor!](${L.mantra})
`;
...
function buildMarsHydroPalavraPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «Mars Hydro» (*marshydrobr*) — Mārs + hýdōr; marca ≠ controle de incêndio; elos tenda, fonte, Vivosun; Faça o melhor!',
    excerptEn:
      'Words: “Mars Hydro” (*marshydrobr*) — Mārs + hýdōr; brand ≠ fire control; tent, driver, Vivosun; Do your best!',
    excerptEs:
      'Palabras: «Mars Hydro» (*marshydrobr*) — Mārs + hýdōr; marca ≠ control de incendio; carpa, fuente, Vivosun; ¡Haz lo mejor!',

...
- Com **Vinicius de Moraes**: *Orfeu da Conceição* → trilha de *Orfeu Negro* (1959) — ficha do **nome**: [Orfeu](${orfeu}) (≠ Morpheus / Matrix).  
...
| Recurso | Papel |
|---------|-------|
| [Orfeu](${orfeu}) | Nome do mito e da peça *Orfeu da Conceição* — ≠ Morpheus (Matrix) |
...
[▶ Águas…](${aguas}) · [▶ Água](${agua}) · [▶ Mar](${mar}) · [▶ Valeu !!!](${mantra}) · [▶ Pessoas](${hub})
`;
...
[▶ Waters poem](${aguas}) · [▶ Valeu !!!](${mantra})
`;

...
| Elo ofício | [verdade](${verdade}) · [respeito](${respeito}) · [simbiose](${simbiose}) · [Valeu !!!](${mantra}) |
...
| **Trocadilho** | Lê A+B como C **já existente** | *cara+alho* — [trocadilho](${trocadilho}) | Jogo; [etimologia popular](${etimologia}) |
...
| Nome do fenómeno | **Aglutinação** | **Trocadilho** + [etimologia popular](${etimologia}) |
...
**H5:** fecho = [Valeu !!!](${mantra}) — colar com [verdade](${verdade}).
...
| [Etimologia](${etimologia}) | Étimo da solda × história popular da piada |
...
[▶ Palavras](${hub}) · [▶ Etimologia](${etimologia}) · [▶ Trocadilho](${trocadilho}) · [▶ Polimorfismo](${polimorfismo}) · [▶ Valeu !!!](${mantra})
`;
...
function buildAglutinacaoPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: aglutinação — composição por fusão (planalto, embora); cara+alho é máscara, o nome certo é trocadilho; ≠ polimorfismo; Valeu !!!',
    excerptEn:
      'Words: agglutination — compounding by fusion (planalto); cara+alho is a mask, the right name is pun; ≠ polymorphism; Valeu !!!',
    excerptEs:
      'Palabras: aglutinación — composición por fusión (planalto); cara+alho es máscara, el nombre cierto es trocadilho; ≠ polimorfismo; ¡Valeu !!!',

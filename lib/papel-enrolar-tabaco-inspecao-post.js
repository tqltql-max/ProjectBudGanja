 ...
 * elos cinzeiro / fogo / gesto / cannabis · Valeu !!!
 */
...
|--------|-------------------|
| Tabaco americano | Planta do Novo Mundo — uso indígena antes do [cigarro](/posts/post-inspecao-palavra-cigarro.html) industrial |
...
| [Valeu !!!](${mantra}) · [poema](${poemMantra}) | Ofício sem romantizar brasa |
...
**Valeu !!!** — o melhor possível **nesta ficha de origem**, hoje.
...
[▶ Cinzeiro](${cinzeiro}) · [▶ Maconha](${maconha}) · [▶ Fogo](${fogo}) · [▶ Valeu !!!](${mantra}) · [▶ Palavras](${hub})
`;
...
[▶ Cinzeiro](${cinzeiro}) · [▶ Maconha](${maconha}) · [▶ Valeu !!!](${mantra})
`;
...
function buildPapelEnrolarTabacoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: papel de enrolar × tabaco — planta americana e mortalha europeia; elos cinzeiro, fogo, maconha; Valeu !!!',
    excerptEn:
      'Words: rolling paper × tobacco — American plant and European paper; links cinzeiro, fogo, maconha; Valeu !!!',
    excerptEs:
      'Palabras: papel de liar × tabaco — planta americana y papel europeo; vínculos cinzeiro, fogo, maconha; ¡Valeu !!!',

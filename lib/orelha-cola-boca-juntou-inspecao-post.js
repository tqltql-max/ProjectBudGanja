...
| **[Cigarro](/posts/post-inspecao-palavra-cigarro.html) × [cigarra](/posts/post-inspecao-palavra-cigarra.html)** | Uma letra (*o* × *a*); produto × insecto | **Duas fichas.** [Orelha](${orelha}) nomeia o caso |

Parecem irmãs. **Não são a mesma tesoura.** Esta página é a tesoura da **frase**. A outra é a tesoura da **origem**. O par cigarro/cigarra é o **caso vivo** na [orelha](${orelha}).
...
| [Orelha](${orelha}) | A peça que pega — caso vivo: cigarro × cigarra |
| [Cigarro](/posts/post-inspecao-palavra-cigarro.html) · [Cigarra](/posts/post-inspecao-palavra-cigarra.html) | Uma letra; duas salas |
...
[▶ Expressões](${hub}) · [▶ Orelha](${orelha}) · [▶ Cigarro](/posts/post-inspecao-palavra-cigarro.html) · [▶ Cigarra](/posts/post-inspecao-palavra-cigarra.html) · [▶ Escravidão](${escravidao}) · [▶ Cola](${cola}) · [▶ Valeu !!!](${mantra})
`;

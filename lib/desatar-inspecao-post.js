...
> **Nota metodológica:** auditoria independente. Fontes: [Wikcionário · desatar](${WIKT}), [atar](${WIKT_ATAR}). **Ficha ≠ terapia, ≠ protocolo de crise.** Depois do gesto: **[ufa](${ufa})**. Fecho: [Valeu !!!](${mantra}).
...
[Desatar](${self}) com [verdade](${verdade}): puxar o fio certo, não cortar a [vida](${vida}). Depois do laço solto: **[ufa](${ufa})** — e, se couber o sorriso BR, [legal](${legal}) (gíria). Ofício: [Valeu !!!](${mantra}) neste [caminho](${caminho}).

## Status

**Aprovado** — **desatar** fichado: *des-* + *atar*; ≠ [desastre](${desastre}); ditado [desatar o nó](${desatarNo}).

[▶ Palavras](${hub}) · [▶ Nó](${no}) · [▶ Desastre](${desastre}) · [▶ Desatar o nó](${desatarNo}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Portuguese **desatar** (to untie) = *des-* + *atar*. Not [desastre](${desastre}) (ill-starred). Saying: [desatar o nó](${desatarNo}). After the gesture: [ufa](${ufa}). Close: [Valeu !!!](${mantra}).

## Status

**Approved** — untying is reversal of tying; disaster is another etymon.

[▶ Words](${hub}) · [▶ Knot](${no}) · [▶ Disaster](${desastre}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

**Desatar** = *des-* + *atar*. No es [desastre](${desastre}) (mala estrella). Dicho: [desatar o nó](${desatarNo}). Después: [ufa](${ufa}). Cierre: [¡Valeu !!!](${mantra}).

## Estado

**Aprobado** — desatar es revertir el atar; desastre es otro étimo.

[▶ Palabras](${hub}) · [▶ Nó](${no}) · [▶ Desastre](${desastre}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildDesatarPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «desatar» (*des-* + *atar*) — gesto de soltar o nó; ≠ desastre (*astro*); ditado desatar o nó; ufa no fim; Valeu !!!',
    excerptEn:
      'Words: “desatar” (*des-* + *atar*) — untying the knot; ≠ disaster (*star*); saying desatar o nó; phew at the end; Valeu !!!',
    excerptEs:
      'Palabras: «desatar» (*des-* + *atar*) — soltar el nudo; ≠ desastre (*astro*); dicho desatar o nó; ufa al final; ¡Valeu !!!',

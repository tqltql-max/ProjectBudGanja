...
**H6:** fecho = [Faça o melhor!](${mantra}) — colar papel, não vidro; soltar pipa com [respeito](${respeito}).
...
| [Vida](${vida}) · [Faça o melhor!](${mantra}) · [poema](${poemMantra}) | Fecho |
...
[▶ Palavras](${hub}) · [▶ Cerol (fonte)](${WIKI_CEROL}) · [▶ Risco](${risco}) · [▶ Aglutinação](${aglutinacao}) · [▶ Faça o melhor!](${mantra})
`;
...
[▶ Words](${hub}) · [▶ Risk](${risco}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Riesgo](${risco}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildColaColarPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: cola/colar (kólla ≠ pescoço ≠ noz); cadeia BR colante·cortante·cerol·pipa·linha; Brasil com P de Perigo; ficha ≠ receita; Faça o melhor!',
    excerptEn:
      'Words: cola/colar (glue ≠ necklace ≠ kola); BR chain sticky·cutting·cerol·kite·line; Brazil with P for Danger; not a recipe; Do your best!',
    excerptEs:
      'Palabras: cola/colar (pegamento ≠ collar ≠ cola); cadena BR; Brasil con P de Peligro; no es receta; ¡Haz lo mejor!',

...
**H5:** fecho = ler o [sinal](${sinal}), calcular o risco, escolher [gesto](${gesto}) / [EXIT](${exit}) com [verdade](${verdade}) — [Faça o melhor!](${mantra}).
...
6. Fechar com [Faça o melhor!](${mantra}) — e voltar ao [hub](${hubAll}).

## 7. Faça o melhor!

| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **com o risco à vista**, hoje |
...
**Veredicto:** Faça o melhor **com o risco nomeado** — calcular, assumir ou sair. Risco sem [verdade](${verdade}) = bluff; risco com ofício = mapa curto para o próximo [gesto](${gesto}).
...
**Aprovado** — **risco** fichado: eixos (perigo calculado × traço), contraste com [medo](${medo}), rede [sinal](${sinal}) · [caminho](${caminho}) · [EXIT](${exit}) · [verdade](${verdade}), legado [Tamara](${tamara}) / [Amyr](${amyr}) / [*Bom dia, Inverno*](${bomDia}); [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Medo](${medo}) · [▶ Sinal](${sinal}) · [▶ Tamara](${tamara}) · [▶ Bom dia, Inverno](${bomDia}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **risco** (“risk”) — **calculable danger** and, in a parallel sense, the **graphic stroke** (“fazer um risco”). In the BudGanja lab, risk is not bravado or panic: it is a **map of what can fail**, with method. Links [medo](${medo}), [sinal](${sinal}), [caminho](${caminho}), [EXIT](${exit}), [verdade](${verdade}), [Tamara](${tamara}) / [Amyr](${amyr}) / [*Bom dia, Inverno*](${bomDia}), and [Do your best!](${mantra}).
...
| Links | [medo](${medo}) · [sinal](${sinal}) · [EXIT](${exit}) · [Tamara](${tamara}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
| Vínculos | [medo](${medo}) · [sinal](${sinal}) · [EXIT](${exit}) · [Tamara](${tamara}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — ejes · contraste con miedo · vínculo Tamara/Amyr · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Medo](${medo}) · [▶ Sinal](${sinal}) · [▶ Tamara](${tamara}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildRiscoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «risco» — perigo calculado × traço (*riscar*); elos medo, sinal, caminho, EXIT, Tamara/Amyr; Faça o melhor!',
    excerptEn:
      'Words: “risco” — calculated danger × stroke (*riscar*); links medo, sinal, caminho, EXIT, Tamara/Amyr; Do your best!',
    excerptEs:
      'Palabras: «risco» — peligro calculado × trazo (*riscar*); vínculos medo, sinal, caminho, EXIT, Tamara/Amyr; ¡Haz lo mejor!',

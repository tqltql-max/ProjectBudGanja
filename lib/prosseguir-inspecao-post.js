...
Inspeção editorial da palavra **prosseguir** — verbo do português do Brasil que nomeia **continuar adiante** depois de uma pausa, um corte ou um começo. Esta ficha cobre o **objeto** (latim *prōsequī* / *prosequor*), as **derivações** (*prosseguimento*, *prosseguido*…), o par com [sempre](${sempre}) e [já](${ja}), e o fecho [Faça o melhor!](${mantra}).
...
| **Ofício lab** | Continuar ficha, cultivo, [diário](${diario}) | [Faça o melhor!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **hoje**, no próximo passo |
...
**Veredicto:** Faça o melhor **e prossiga**. Prosseguir sem [caminho](${caminho}) = corrida; prosseguir com método = continuação que respeita a pausa.
...
**H4:** fecho = [Faça o melhor!](${mantra}) — próximo passo vivo.
...
**Aprovado** — **prosseguir** fichado com derivações, retoma deliberada, rede tempo/movimento e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Sempre](${sempre}) · [▶ Já](${ja}) · [▶ Caminho](${caminho}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **prosseguir** (to proceed / continue) — deliberate continuation after a pause, cut, or start. Covers **object** (Lat. *prōsequī*), **derivatives** (*prosseguimento*…), pair with [sempre](${sempre}) and [já](${ja}), and [Do your best!](${mantra}).
...
| Links | [sempre](${sempre}) · [já](${ja}) · [caminho](${caminho}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · derivatives · deliberate resume · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Sempre](${sempre}) · [▶ Já](${ja}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **prosseguir** (proseguir / continuar) — continuación deliberada después de pausa, corte o comienzo. Cubre **objeto** (lat. *prōsequī*), **derivaciones** (*prosseguimento*…), par con [sempre](${sempre}) y [já](${ja}), y [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [sempre](${sempre}) · [já](${ja}) · [caminho](${caminho}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · derivaciones · retoma deliberada · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Sempre](${sempre}) · [▶ Já](${ja}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildProsseguirPost(seriesOrder) {
  ...
  return makePalavra({
    title: 'Inspeção: Prosseguir — continuar, retomar e Faça o melhor!',
    titleEn: 'Inspection: Prosseguir — continue, resume and Do your best!',
    titleEs: 'Inspección: Prosseguir — continuar, retomar y ¡Haz lo mejor!',
    excerpt:
      'Palavras: «prosseguir» (lat. *prōsequī*) — continuar × retomar BR; derivações prosseguimento; elos sempre, já, caminho; Faça o melhor!',
    excerptEn:
      'Words: “prosseguir” (Lat. *prōsequī*) — continue × resume in BR; derivatives prosseguimento; links sempre, já, caminho; Do your best!',
    excerptEs:
      'Palabras: «prosseguir» (lat. *prōsequī*) — continuar × retomar BR; derivaciones prosseguimento; vínculos sempre, já, caminho; ¡Haz lo mejor!',

...
Inspeção editorial da palavra **[etimologia](${self})** — o **ofício de perguntar de onde veio a palavra**. A série [Palavras](${hub}) usa este método em todas as fichas; a palavra **ela mesma** ainda não tinha ficha nem citação própria. Esta página cobre o étimo grego (*étymon* + *lógos*), a distinção **[étimo](${etimo}) × etimologia popular**, e o elo com o cluster [trocadilho](${trocadilho}) · [aglutinação](${aglutinacao}) · [polimorfismo](${polimorfismo}). Espécime vivo: o [étimo](${etimo}) de [ação](${acao}) é lat. *āctiō* ← *agere* («fazer, impulsionar»).
...
| Família | **[étimo](${etimo})** · *etimológico* · *etimologista* · *etimologia popular* |
| Ofício no lab | Método da série [Palavras](${hub}): origem → viagem → uso → ressalva |
| Tipo BudGanja | Palavra — o nome do próprio método |
| Elo ofício | [verdade](${verdade}) · [língua portuguesa](${lingua}) · [Duvivier](${duvivier}) · [Valeu !!!](${mantra}) |
...
|------|-----------|-------------|-----------|
| **[Étimo](${etimo})** | Origem histórica rastreável (ou a melhor hipótese) — **a peça** | *etimologia* ← gr. *etymología* · [ação](${acao}): *āctiō* ← *agere* | Alta neste vocábulo |
...
No laboratório, etimologia é o **chão** da série: [maconha](${maconha}) (disputa afro-atlântica), [simbiose](${simbiose}) (*syn* + *bíōsis*), [relação](${relacao}) (*relatĭō*), [grok](${grok}) (Heinlein). [Língua portuguesa](${lingua}) é o solo; [Duvivier](${duvivier}) é o método da palavra como pesquisa. [Valeu !!!](${mantra}) = nomear com o étimo à vista, sem inventar origem.
...
**H6:** fecho = [Valeu !!!](${mantra}) — origem honesta, uso vivo, sem arma moral.

## Rede BudGanja

| Recurso | Papel |
|---------|-------|
| **[Étimo](${etimo})** | A peça — ficha irmã; espécime [ação](${acao}) (*āctiō* ← *agere*) |
...
| [Teoria das cordas](${teoriaCordas}) | Calque de *string theory* — o método no composto de física |
| [Duvivier](${duvivier}) · [Grok](${grok}) | Palavra como pesquisa · tom de ofício |
| [Valeu !!!](${mantra}) | Nomear com origem à vista |
...
[▶ Palavras](${hub}) · [▶ Trocadilho](${trocadilho}) · [▶ Aglutinação](${aglutinacao}) · [▶ Polimorfismo](${polimorfismo}) · [▶ Língua portuguesa](${lingua}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Words](${hub}) · [▶ Pun](${trocadilho}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Trocadilho](${trocadilho}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildEtimologiaPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: etimologia (étymon + lógos) — método da série; étimo ≠ etimologia popular (cara+alho); irmãs aglutinação e polimorfismo; Valeu !!!',
    excerptEn:
      'Words: etymology (étymon + lógos) — method of the series; etymon ≠ folk etymology (cara+alho); sisters agglutination and polymorphism; Valeu !!!',
    excerptEs:
      'Palabras: etimología (étymon + lógos) — método de la serie; étimo ≠ etimología popular (cara+alho); hermanas aglutinación y polimorfismo; ¡Valeu !!!',

...
**H4:** fecho = [Valeu !!!](${mantra}) — o melhor recorte possível *deste* crítico *neste* ecrã.
...
[▶ Games · Zangado](${games}) · [▶ Vídeos](${videosHub}) · [▶ GTA 6](${gta6}) · [▶ Canais](${hub}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **[${ch.channelName || 'Zangado'}](${ch.channelUrl})** (${ch.handle || '@zangadoreview'}) — Brazilian game-critic voice since **2006**. No face on camera; craft in the voice. Lives on [Games](${games}) (${count} videos tagged by his own formats: sagas, worth-playing reviews, first half hour). Distinct from the **person** sheet for [Aleff](/posts/post-inspecao-figura-aleff.html).
...
Inspección de **[${ch.channelName || 'Zangado'}](${ch.channelUrl})** (${ch.handle || '@zangadoreview'}) — voz crítica gamer de Brasil desde **2006**. Sin rostro en cámara; oficio en la voz. Vive en [Games](${games}) (${count} vídeos por sus formatos: sagas, ¿vale la pena?, primera media hora). Distinta de la ficha de **persona** de [Aleff](/posts/post-inspecao-figura-aleff.html).

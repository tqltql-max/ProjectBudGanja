...
**H5:** fecho = [Valeu !!!](${mantra}) — o melhor recorte *desta* turma *desta* década, sem fundir com [HIMYM](${HIMYM}).
...
[▶ Artes](${hub}) · [▶ vida](${vida}) · [▶ How I Met Your Mother (outra ficha)](${HIMYM}) · [▶ Valeu !!!](${mantra}) · [Wikipedia](${wiki})
`;
...
**H5:** fecho = [Valeu !!!](${mantra}) — o melhor recorte *deste* [tempo](${tempo}) *desta* [mãe](${mae}), sem fundir com [Friends](${FRIENDS}).
...
[▶ Artes](${hub}) · [▶ tempo](${tempo}) · [▶ Friends (outra ficha)](${FRIENDS}) · [▶ Valeu !!!](${mantra}) · [Wikipedia](${wiki})
`;

...
| Elo Palavras | [caminho](${caminho}) · [passar](${passar}) · [sinal](${sinal}) · [esperança](${esperanca}) · [vida](${vidaPalavra}) · [coração](${coracao}) · [navegar](${navegar}) · [Faça o melhor!](${faca}) |
...
| [Faça o melhor!](${faca}) | O melhor recorte *desta* obra *neste* ofício — sem hype de best-seller |

...
**H5:** a [relação](${relacao}) pedida é o **entre** lexical; fecho [Valeu !!!](${mantra}).
...
**Tanzânia = país.** Si la boca dijo *Taz Manaia*, abrir esta ficha **y** [Taz Manaia](${tazManaia}). Cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — ficha de país; lapsus y relación separados.

[▶ Palabras](${hub}) · [▶ Taz Manaia](${tazManaia}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildTanzaniaPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «Tanzânia» — país (Tan+Zan+-ia, 1964); Taz = hipocorístico; ≠ Tasmânia; relação com o lapso Taz Manaia; Valeu !!!',
    excerptEn:
      'Words: “Tanzânia” — country (Tan+Zan+-ia, 1964); Taz = clipping; ≠ Tasmania; relation with the slip Taz Manaia; Valeu !!!',
    excerptEs:
      'Palabras: «Tanzânia» — país (Tan+Zan+-ia, 1964); Taz = hipocorístico; ≠ Tasmania; relación con el lapsus Taz Manaia; ¡Valeu !!!',

 ...
 * Eixos: maravilha · assombro · elogio BR · escala vs genial/aff · Valeu !!!
 */
...
function buildMaravilhosoBodies() {
  ...
  const mara = '/posts/post-inspecao-palavra-mara.html';
  const poemMara = '/vida/#poema=barquinhos-de-papel';

  const body = `## Escopo

Inspeção editorial da palavra **maravilhoso** — adjetivo (e sopro de elogio no português do Brasil) nascido de **maravilha**: o que causa **assombro**, admiração, o «não acredito que ficou assim». Esta ficha cobre o **objeto**, os **sentidos** (assombro × elogio quotidiano), uma **escala de intensidade** com [legal](${legal}), [genial](${genial}) e [aff](${aff}), e o fecho [Valeu !!!](${mantra}). Tom: **calor**, não sermão.
...
| Elo afecto | [alegria](${alegria}) · [meudeusdoceu](${meudeusdoceu}) · [jesusamado](${jesusamado}) |
...
|----------------|---------|
| Expressão | [Valeu !!!](${mantra}) — o melhor possível **hoje**, mesmo quando o peito está maravilhado |
...
**Veredicto:** Valeu !!! **com o maravilhoso** — deixar o peito abrir, creditando o feito; depois continuar o ofício. Maravilhoso sem [caminho](${caminho}) = pose; maravilhoso com método = lareira de admiração.
...
**H4:** fecho = [Valeu !!!](${mantra}) depois do «uau».
...
| [Alegria](${alegria}) · [meudeusdoceu](${meudeusdoceu}) · [jesusamado](${jesusamado}) | Peito que abre |
...
| [Mara](${mara}) · [barquinhos de papel](${poemMara}) | Nome que cola no som de *maravilha*; maravilha pequena |
...
**Aprovado** — **maravilhoso** fichado: maravilha → assombro → elogio BR; escala com [legal](${legal}) / [genial](${genial}) / [aff](${aff}); elo [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Alegria](${alegria}) · [▶ Mara](${mara}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **maravilhoso** — adjective and warm BR praise from **maravilha** (marvel/wonder). Covers **object**, **senses**, an **intensity scale** with [legal](${legal}), [genial](${genial}) and [aff](${aff}), and [Valeu !!!](${mantra}). Warm tone, not preachy.
...
| Links | [legal](${legal}) · [genial](${genial}) · [aff](${aff}) · [alegria](${alegria}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
After the “wow,” keep the craft — [Valeu !!!](${mantra}). Wonder without [path](${caminho}) = pose; wonder with method = lasting admiration.

## Status

**Approved** — marvel → awe → BR praise; scale with [legal](${legal}) / [genial](${genial}) / [aff](${aff}); [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Alegria](${alegria}) · [▶ Mara](${mara}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **maravilhoso** — adjetivo y elogio cálido BR desde **maravilha** (asombro). Cubre **objeto**, **sentidos**, una **escala** con [legal](${legal}), [genial](${genial}) y [aff](${aff}), y [¡Valeu !!!](${mantra}). Calor, no sermón.
...
| Vínculos | [legal](${legal}) · [genial](${genial}) · [aff](${aff}) · [alegria](${alegria}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Después del «guau», seguir el oficio — [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — maravilla → asombro → elogio BR; escala con [legal](${legal}) / [genial](${genial}) / [aff](${aff}); [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Alegria](${alegria}) · [▶ Mara](${mara}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildMaravilhosoPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Maravilhoso — maravilha, assombro, elogio BR e Valeu !!!',
    titleEn:
      'Inspection: Maravilhoso — marvel, wonder, BR praise and Valeu !!!',
    titleEs:
      'Inspección: Maravilhoso — maravilla, asombro, elogio BR y ¡Valeu !!!',
    excerpt:
      'Palavras: «maravilhoso» (de maravilha / lat. *mirabilia*) — assombro e elogio BR; escala com legal, genial e aff; Valeu !!! depois do «uau».',
    excerptEn:
      'Words: “maravilhoso” (from maravilha / Lat. *mirabilia*) — wonder and BR praise; scale with legal, genial and aff; Valeu !!! after the wow.',
    excerptEs:
      'Palabras: «maravilhoso» (de maravilha / lat. *mirabilia*) — asombro y elogio BR; escala con legal, genial y aff; ¡Valeu !!! después del guau.',

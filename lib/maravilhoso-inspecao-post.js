...
[▶ Palavras](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Alegria](${alegria}) · [▶ Mara](${mara}) · [▶ Faça o melhor!](${mantra})
`;
...
[▶ Words](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Alegria](${alegria}) · [▶ Mara](${mara}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Aff](${aff}) · [▶ Alegria](${alegria}) · [▶ Mara](${mara}) · [▶ ¡Haz lo mejor!](${mantra})
`;

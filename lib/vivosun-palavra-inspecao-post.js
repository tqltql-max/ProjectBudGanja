...
| «Faça diferente» | [Valeu !!!](${L.mantra}) **neste** cabo |
...
**Aprovado** — **Vivosun** fichado: *vivo* + *sun* («sol vivo»); rasto BR; anti-pedestal; elo [cluster de incêndio](${L.cluster}); fecho [Valeu !!!](${L.mantra}).

[▶ Palavras](${L.hub}) · [▶ Cluster incêndio](${L.cluster}) · [▶ Catálogo](${L.vivosunEquip}) · [▶ Mars Hydro](${L.marsPalavra}) · [▶ Valeu !!!](${L.mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **[Vivosun](${self})** — indoor brand (*vivo* + *sun* = living sun). Same method as [Mars Hydro](${L.marsPalavra}). Brand ≠ [fire control](${L.cluster}). In Brazil it arrives through **resellers**, not a first-party .com.br mirror inspected here. Links: [sol](${L.sol}), [catalog](${L.vivosunEquip}), [Valeu !!!](${L.mantra}).
...
**Vivosun ≠ star and ≠ fire certificate.** Inspect [fonte](${L.fonte}) and the [switch](${L.interruptor}). Close with [Valeu !!!](${L.mantra}).

## Status

**Approved** — *vivo* + *sun*; [fire cluster](${L.cluster}); [Valeu !!!](${L.mantra}).

[▶ Words](${L.hub}) · [▶ Fire cluster](${L.cluster}) · [▶ Catalog](${L.vivosunEquip}) · [▶ Valeu !!!](${L.mantra})
`;

  const contentEs = `## Alcance

Inspección de **[Vivosun](${self})** — marca indoor (*vivo* + *sun* = sol vivo). Mismo método que [Mars Hydro](${L.marsPalavra}). Marca ≠ [control de incendio](${L.cluster}). En Brasil llega por **revendedores**. Vínculos: [sol](${L.sol}), [catálogo](${L.vivosunEquip}), [¡Valeu !!!](${L.mantra}).
...
**Vivosun ≠ astro y ≠ certificado de incendio.** Cerrar con [¡Valeu !!!](${L.mantra}).

## Estado

**Aprobado** — *vivo* + *sun*; [clúster](${L.cluster}); [¡Valeu !!!](${L.mantra}).

[▶ Palabras](${L.hub}) · [▶ Clúster incendio](${L.cluster}) · [▶ Catálogo](${L.vivosunEquip}) · [▶ ¡Valeu !!!](${L.mantra})
`;
...
function buildVivosunPalavraPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «Vivosun» (*vivo* + *sun*) — sol vivo no nome; marca ≠ controle de incêndio; elos Mars Hydro, tenda, fonte; Valeu !!!',
    excerptEn:
      'Words: “Vivosun” (*vivo* + *sun*) — living sun in the name; brand ≠ fire control; Mars Hydro, tent, driver; Valeu !!!',
    excerptEs:
      'Palabras: «Vivosun» (*vivo* + *sun*) — sol vivo en el nombre; marca ≠ control de incendio; Mars Hydro, carpa, fuente; ¡Valeu !!!',

...
**H5:** fecho = [Valeu !!!](${mantra}) — o melhor recorte *deste* filme *deste* autor.
...
| [Valeu !!!](${mantra}) | O melhor desta homenagem ao texto |
...
[▶ Artes](${hub}) · [▶ Richard Curtis](${AUTOR}) · [▶ tempo](${tempo}) · [▶ vida](${vida}) · [▶ De Volta para o Futuro](${bttf}) · [▶ Valeu !!!](${mantra}) · ${wikiAShort}
`;
...
[▶ Pessoas](${hub}) · [▶ o filme](${FILME}) · [▶ tempo](${tempo}) · [▶ Comic Relief](${comic}) · [▶ Valeu !!!](${mantra}) · [Wikipedia](${wiki})
`;

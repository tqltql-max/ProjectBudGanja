 ...
 * Fonte: Vida/Historia.txt + Vida/Personagens.txt + Vida/Historia-sementinha-jogo.txt
...
const HISTORIA2 = '/posts/post-inspecao-conto-vida-sementinha-jogo.html';
...
A plantinha cresceu feliz: **Brotinho** → **Vegetativo** (folhas fortes) → linda **Floração**. Quando recebeu o selo de **Cultivador Sênior**, o laboratório inteiro virou festa!
...
- Hub [Vida](${HUB}) · personagens: [Inspetor](${INSPETOR}), [Dona Maria](${DONA_MARIA}), [DJ Brisa](${DJ_BRISA}), [Joana](${JOANA}), [Three Little Birds](${PASSARINHOS})
- Continuação: [A Sementinha e o jogo da cidade](${HISTORIA2})
...
The plant grew happily: **Sprout** → **Vegetative** → beautiful **Flowering**. When it earned the **Senior Grower** seal, the whole lab threw a party!
...
La plantita creció feliz hasta la **Floración** y recibió el sello de **Cultivador Sénior**. ¡Fiesta en el laboratorio!
...
- Equipe: [Inspetor](${INSPETOR}) · [Dona Maria](${DONA_MARIA}) · [DJ Brisa](${DJ_BRISA}) · [Joana](${JOANA}) · [Three Little Birds](${PASSARINHOS})
${cfg.elosExtra || ''}

## Status

**Publicado** — personagem da série Vida (2026-08-01).`;
}
...
function buildSementinhaJogoBody() {
  return `## Escopo

Segundo conto da **sementinha** no [Laboratório BudGanja](${HUB}). A equipe assiste a um vídeo de [Paulinho o LOKO](${PAULINHO}) no **GTA RP** — «plantei muita erva» na cidade do jogo — e a sementinha aprende a diferença entre **ficção de jogo** e **cuidado no vaso**.

> **Nota:** conteúdo educacional. GTA RP é faz-de-conta. **Ficção de jogo ≠ manual de crime.** Não é protocolo de cultivo ilegal nem substitui orientação responsável. O laboratório continua a metáfora de cuidado — ritmo, atenção e amizade.

Hub ilustrado: [Vida](${HUB}). Conto âncora: [O Laboratório e a Sementinha](${HISTORIA}).

## O vídeo

Arquivo do canal [Paulinho o LOKO](https://www.youtube.com/@PaulinhoLOKOoficial): *PLANTEI MUITA ERVA ILEGAL no GTA RP!* — crédito [Aleff](${ALEFF}) / Paulinho, **sem afiliação**. Catálogo: [Games](${JOGOS}).

@youtube ${VIDEO_ID}

## A história

A plantinha já tinha a cama fofinha da [Dona Maria](${DONA_MARIA}) e as primeiras raízes. A [DJ Brisa](${DJ_BRISA}) ligou o ecrã da [Rádio](${RADIO}). No vídeo, o Paulinho plantava **muita** erva na cidade do GTA RP — rápido, em festa, com o título a gritar «ilegal».

A sementinha tremeu.

> «Será que eu preciso ser muita? Será que o meu vaso é ilegal?»

O [Inspetor](${INSPETOR}) baixou a lupa e o braço de bronze.

> «Calma, sementinha. Isto é um **jogo**. Na cidade do GTA a gente brinca de história. No laboratório, tu és **uma**. E o nosso ofício é [Faça o melhor!](${MANTRA}) — não plantar o mapa inteiro.»

A Dona Maria puxou o balde de **Super Solo**.

> «No jogo planta-se muita para a cena. Aqui a cama é para **ti**. Carinho e Chá Microbiano. Uma semente de cada vez.»

A [Joaninha Joana](${JOANA}) pousou no vaso: «Eu cuido dos monstros das folhas. Os monstros do jogo ficam no ecrã.»

Os [Three Little Birds](${PASSARINHOS}) chegaram:

- O **Passarinho Verde** mostrou a calculadora: no jogo as gotas são infinitas; no lab cada gota conta.
- O **Passarinho Amarelo** escreveu no [Diário](${DIARIO}): «ficção ≠ diário de pesquisas».
- E a DJ Brisa bateu o ritmo: «Se o vídeo gritar [Valeu !!!](${VALEU}) depois de plantar o mapa, e tu te perderes — volta para **[Faça o melhor!](${MANTRA})**.»

A sementinha olhou para o ecrã, depois para a terra. Entendeu: podia **assistir** o Paulinho na cidade do jogo — e **ficar** no vaso, fazendo o melhor de hoje.

Quando o vídeo acabou, o laboratório não virou plantação da cidade. Virou o mesmo canto de sempre: luz medida, solo vivo, uma semente, uma equipe.

> Cultivar no laboratório não é ganhar o mapa. É fazer o melhor para **esta** semente, hoje.

## O que esta história ensina

| Lição | Na prática |
|-------|------------|
| Jogo ≠ vaso | GTA RP é teatro de servidor. O vaso é ofício. Ver [canal Paulinho](${PAULINHO}) |
| Uma, não muita | No lab não se copia a quantidade do título — ver [Super Solo](${SUPER_SOLO}) |
| Mantra | [Faça o melhor!](${MANTRA}) — se te perderes no [Valeu !!!](${VALEU}), volta |
| Assistir com método | Ver o arquivo em [Games](${JOGOS}), com crédito, sem copiar o crime da cena |
| Equipe | Ninguém assiste sozinho — [Inspetor](${INSPETOR}), [Dona Maria](${DONA_MARIA}), [Joana](${JOANA}), [pássaros](${PASSARINHOS}) |

## Elos

- Hub [Vida](${HUB}) · conto âncora [O Laboratório e a Sementinha](${HISTORIA})
- Mantra [Faça o melhor!](${MANTRA}) · irmã [Valeu !!!](${VALEU})
- Games: [Paulinho / Aleff](${JOGOS}) · [canal](${PAULINHO}) · [pessoa Aleff](${ALEFF})
- Ferramentas: [Super Solo](${SUPER_SOLO}) · [Diário](${DIARIO}) · [Rádio](${RADIO})
- Vídeo: [${VIDEO_URL}](${VIDEO_URL})

## Status

**Publicado** — segundo conto da série Vida (2026-09-17).`;
}

function buildSementinhaJogoBodyEn() {
  return `## Scope

Second **little-seed** story in the [BudGanja Lab](${HUB}). The team watches a [Paulinho o LOKO](${PAULINHO}) **GTA RP** video — “I planted a lot of herb” in the game city — and the seed learns the difference between **game fiction** and **care in the pot**.

> Educational content. GTA RP is make-believe. **Game fiction ≠ a crime manual.** Not a protocol for illegal growing.

Illustrated hub: [Vida](${HUB}). Anchor story: [The Lab and the Little Seed](${HISTORIA}).

## The video

Archive from [Paulinho o LOKO](https://www.youtube.com/@PaulinhoLOKOoficial): *PLANTEI MUITA ERVA ILEGAL no GTA RP!* — credit [Aleff](${ALEFF}) / Paulinho, **no affiliation**. Catalog: [Games](${JOGOS}).

@youtube ${VIDEO_ID}

## The story

The plant already had [Dona Maria](${DONA_MARIA})’s fluffy bed and its first roots. [DJ Brisa](${DJ_BRISA}) turned on the screen. In the video, Paulinho planted **lots** of herb in the GTA RP city — fast, festive, with a title shouting “illegal”.

The little seed trembled.

> “Do I need to be lots? Is my pot illegal?”

The [Inspector](${INSPETOR}) lowered his loupe.

> “Easy, little seed. This is a **game**. In the GTA city we play at stories. In the lab, you are **one**. Our craft is [Do your best!](${MANTRA}) — not planting the whole map.”

Dona Maria pulled the **Super Soil** bucket.

> “In the game they plant lots for the scene. Here the bed is for **you**. Kindness and Microbial Tea. One seed at a time.”

[Ladybug Joana](${JOANA}) landed on the pot: “I watch the leaf monsters. The game monsters stay on the screen.”

The [Three Little Birds](${PASSARINHOS}) arrived:

- The **Green Bird** showed the calculator: in the game the drops are endless; in the lab every drop counts.
- The **Yellow Bird** wrote in the [Diary](${DIARIO}): “fiction ≠ research diary”.
- And DJ Brisa kept the beat: “If the video shouts [Valeu !!!](${VALEU}) after planting the map, and you get lost — come back to **[Do your best!](${MANTRA})**.”

The little seed looked at the screen, then at the soil. It could **watch** Paulinho in the game city — and **stay** in the pot, doing today’s best.

When the video ended, the lab did not become the city’s plantation. It stayed the same corner: measured light, living soil, one seed, one team.

> Growing in the lab is not winning the map. It is doing the best for **this** seed, today.

## Status

**Published** — second Vida story (2026-09-17).`;
}

function buildSementinhaJogoBodyEs() {
  return `## Alcance

Segundo cuento de la **semillita** en el [Laboratorio BudGanja](${HUB}). El equipo ve un vídeo de [Paulinho o LOKO](${PAULINHO}) en **GTA RP** — «planté mucha hierba» en la ciudad del juego — y la semilla aprende la diferencia entre **ficción de juego** y **cuidado en la maceta**.

> Contenido educativo. GTA RP es juego. **Ficción de juego ≠ manual de crimen.**

Hub: [Vida](${HUB}). Cuento ancla: [El Laboratorio y la Semillita](${HISTORIA}).

## El vídeo

Archivo de [Paulinho o LOKO](https://www.youtube.com/@PaulinhoLOKOoficial): *PLANTEI MUITA ERVA ILEGAL no GTA RP!* — crédito [Aleff](${ALEFF}) / Paulinho, **sin afiliación**. Catálogo: [Games](${JOGOS}).

@youtube ${VIDEO_ID}

## La historia

La plantita ya tenía la cama mullida de [Doña María](${DONA_MARIA}) y las primeras raíces. [DJ Brisa](${DJ_BRISA}) encendió la pantalla. En el vídeo, Paulinho plantaba **mucha** hierba en la ciudad del GTA RP — rápido, de fiesta, con el título gritando «ilegal».

La semillita tembló.

> «¿Tengo que ser mucha? ¿Mi maceta es ilegal?»

El [Inspector](${INSPETOR}) bajó la lupa.

> «Tranquila, semillita. Esto es un **juego**. En la ciudad del GTA jugamos a historias. En el laboratorio, tú eres **una**. Nuestro oficio es [¡Haz lo mejor!](${MANTRA}) — no plantar el mapa entero.»

Doña María trajo el balde de **Super Suelo**.

> «En el juego se planta mucha para la escena. Aquí la cama es para **ti**. Cariño y Té Microbiano. Una semilla cada vez.»

La [Mariquita Juana](${JOANA}) se posó en la maceta: «Yo cuido los monstruos de las hojas. Los del juego se quedan en la pantalla.»

Los [Three Little Birds](${PASSARINHOS}) llegaron:

- El **Pajarito Verde** mostró la calculadora: en el juego las gotas son infinitas; en el lab cada gota cuenta.
- El **Pajarito Amarillo** escribió en el [Diario](${DIARIO}): «ficción ≠ diario de investigaciones».
- Y DJ Brisa marcó el ritmo: «Si el vídeo grita [¡Valeu !!!](${VALEU}) después de plantar el mapa, y te pierdes — vuelve a **[¡Haz lo mejor!](${MANTRA})**.»

La semillita miró la pantalla, después la tierra. Podía **ver** a Paulinho en la ciudad del juego — y **quedarse** en la maceta, haciendo lo mejor de hoy.

Cuando acabó el vídeo, el laboratorio no se volvió la plantación de la ciudad. Siguió siendo el mismo rincón: luz medida, suelo vivo, una semilla, un equipo.

> Cultivar en el laboratorio no es ganar el mapa. Es hacer lo mejor para **esta** semilla, hoy.

## Estado

**Publicado** — segundo cuento de la serie Vida (2026-09-17).`;
}

function buildSementinhaJogoPost() {
  return contoPost({
    ...
    excerpt:
      'Segundo conto: a sementinha assiste Paulinho o LOKO plantar muita erva no GTA RP e aprende que jogo não é vaso — Faça o melhor, uma de cada vez.',
    excerptEn:
      'Second story: the little seed watches Paulinho o LOKO plant lots of herb in GTA RP and learns that the game is not the pot — do your best, one at a time.',
    excerptEs:
      'Segundo cuento: la semillita ve a Paulinho o LOKO plantar mucha hierba en GTA RP y aprende que el juego no es la maceta — haz lo mejor, una cada vez.',
    slug: 'inspecao-conto-vida-sementinha-jogo',
    date: '2026-09-17T19:30:00.000Z',
    seriesOrder: 7,
    coverImage: 'imagens/inspecoes/vida-sementinha-jogo-cover.jpg',
    videoId: VIDEO_ID,
    sourceUrl: VIDEO_URL,
    body: buildSementinhaJogoBody(),
    contentEn: buildSementinhaJogoBodyEn(),
    contentEs: buildSementinhaJogoBodyEs()
  });
}

function buildVidaPosts() {
  return [buildHistoriaPost(), buildSementinhaJogoPost()].concat(PERSONAGENS.map(buildPersonagemPost));
}

module.exports = {
  buildVidaPosts,
  buildHistoriaPost,
  buildSementinhaJogoPost,
  PERSONAGENS,
  HUB,
  HISTORIA2,
  VIDEO_ID

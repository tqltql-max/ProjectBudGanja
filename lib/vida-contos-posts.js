...
/**
 * Série Vida — contos familiares sobre cuidar de plantas com carinho.
 * Fonte: Vida/Historia.txt + Vida/Personagens.txt
 * Tom: educação familiar; ciência + natureza + amizade. Não é protocolo clínico.
 */
...
Conto familiar do **Laboratório BudGanja**: como uma sementinha vira planta feliz quando ciência, natureza e amizade caminham juntas. Ideal para ler em família — ensina o jeito certo de cuidar das plantas, com carinho e curiosidade.

> **Nota:** conteúdo educacional e lúdico. Não substitui orientação adulta responsável nem protocolo clínico. O laboratório é metáfora de cuidado — ritmo, atenção e amizade.
...
> «Para esta semente virar uma planta Sênior, precisaremos de toda a equipe!» — anunciou ele, ajustando a lupa.
...
A family story from the **BudGanja Lab**: how a tiny seed becomes a happy plant when science, nature and friendship work together. Read aloud with kids — gentle plant-care lessons.

> Educational and playful. Not clinical advice. The lab is a metaphor for care — rhythm, attention and friendship.
...
Cuento familiar del **Laboratorio BudGanja**: cómo una semillita se vuelve una planta feliz cuando ciencia, naturaleza y amistad caminan juntas. Para leer en familia.

> Contenido educativo y lúdico. No es consejo clínico. El laboratorio es metáfora de cuidado.
...
Ficha do personagem **${cfg.nome}** na série [Vida](${HUB}) — conto familiar sobre cuidar de plantas com carinho. Fonte narrativa do laboratório BudGanja.

> Conteúdo educacional e lúdico para ler em família.
...
function buildHistoriaPost() {
  return contoPost({
    ...
    excerpt:
      'Conto familiar: o Inspetor, a Dona Maria, a Joaninha Joana e os Three Little Birds ensinam a cuidar de uma semente com ciência, natureza e amizade.',
    excerptEn:
      'Family story: the Inspector, Dona Maria, Ladybug Joana and the Three Little Birds teach how to care for a seed with science, nature and friendship.',
    excerptEs:
      'Cuento familiar: el Inspector, Doña María, la Mariquita Juana y los Three Little Birds enseñan a cuidar una semilla con ciencia, naturaleza y amistad.',
...
- Ciência pode ser divertida — números também cuidam.`,
    pratica: `- Com um adulto, experimentar o [Luxímetro](${LUXIMETRO}) e falar sobre «luz boa».  
...
- Natureza e ciência não são inimigas — dançam juntas.`,
    pratica: `- Explorar a [calculadora Super Solo](${SUPER_SOLO}) com um adulto.  
- Montar um vasinho com terra boa e explicar: «aqui dorme a semente».`,
...
- Comunicar com carinho faz parte do cultivo.`,
    pratica: `- Ouvir a [Rádio BudGanja](${RADIO}) enquanto rega (com um adulto).  
...
- Manter a alegria no laboratório (DJ Brisa).`,
    pratica: `- Abrir o [Diário](${DIARIO}) e marcar «tarefa do dia» com um adulto.  
- Explorar uma [calculadora](/calculadoras/) e falar: «números também são amigos».  
...
function buildPersonagemPost(cfg) {
  ...
  return contoPost({
    ...
    body,
    contentEn: body
      .replace(/Conteúdo educacional e lúdico para ler em família\./g, 'Educational and playful content for family reading.')
      .replace(/Ficha do personagem/g, 'Character sheet')
      .replace(/## Quem é/g, '## Who they are')
      .replace(/## O que ensina às crianças/g, '## What they teach kids')
      .replace(/## Na prática \(com um adulto\)/g, '## In practice (with an adult)')
      .replace(/## Status/g, '## Status')
      .replace(/\*\*Publicado\*\*/g, '**Published**'),
    contentEs: body
      .replace(/Conteúdo educacional e lúdico para ler em família\./g, 'Contenido educativo y lúdico para leer en familia.')
      .replace(/Ficha do personagem/g, 'Ficha del personaje')
      .replace(/## Quem é/g, '## Quién es')
      .replace(/## O que ensina às crianças/g, '## Qué enseña a los niños')
      .replace(/## Na prática \(com um adulto\)/g, '## En la práctica (con un adulto)')

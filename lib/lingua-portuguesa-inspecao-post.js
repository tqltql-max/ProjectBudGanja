 ...
 * Eixos: originalidade · alterações no tempo · para que serve · Faça o melhor!
 */
...
Inspeção editorial da **língua portuguesa** — o meio em que o Inspetor BudGanja **pensa, inspeta e publica**. Esta ficha cobre a **originalidade**, as **alterações ao longo do tempo**, **para que serve** no laboratório, e o fecho [Faça o melhor!](${mantra}): o melhor ofício **nesta língua, hoje**.
...
| Elo método | [Duvivier](${duvivier}) · [verdade](${verdade}) · [gesto](${gesto}) · [criatividade](${criatividade}) · [passar](${passar}) · [caminho](${caminho}) |
| Elo léxico / oralidade | [aff](${aff}) · [já](${ja}) · [genial](${genial}) · [jesusamando](${jesusamando}) · [esquerdo](${esquerdo}) · [maconha](${maconha}) |
...
| **Português brasileiro** | Pronúncia, gíria, interjeições, ritmo — *aff*, *já*, *genial!*, *jesusamando* | [aff](${aff}) · [genial](${genial}) · [jesusamando](${jesusamando}) |
...
**Oralidade viva:** no tempo digital, sopros como [aff](${aff}) e [jesusamando](${jesusamando}) mostram a língua a **mudar no peito** — enfado × calor — sem sair do português.
...
**H5:** fecho = [Faça o melhor!](${mantra}) nesta língua, hoje.
...
| [jesusamando](${jesusamando}) · [aff](${aff}) | Oralidade BR — calor × enfado |
...
**Aprovado** — língua portuguesa fichada: **originalidade**, **alterações ao longo do tempo**, **para que serve** e elo [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Guia](${guia}) · [▶ jesusamando](${jesusamando}) · [▶ Duvivier](${duvivier}) · [▶ Passar](${passar}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of the **Portuguese language** — the medium in which Inspetor BudGanja thinks, inspects and publishes. Covers **originality**, **changes over time**, **what it is for**, and [Do your best!](${mantra}). Oral cross-link: [jesusamando](${jesusamando}).
...
| Links | [Duvivier](${duvivier}) · [truth](${verdade}) · [gesture](${gesto}) · [pass](${passar}) · [path](${caminho}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Temporal hypothesis:** each [Words](${hub}) sheet is a **cut in time**. Change ≠ decay; freezing “pure ancient Portuguese” = fail; erasing history = also fail. Living breath in BR orality: [jesusamando](${jesusamando}) vs [aff](${aff}).
...
[Do your best!](${mantra}) is written and said **in Portuguese** — honest **in this moment**, knowing the language still moves. Imperfect Portuguese ≠ stop; eternal purism ≠ the mantra.

## Status

**Approved** — originality · changes over time · purpose · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ jesusamando](${jesusamando}) · [▶ Duvivier](${duvivier}) · [▶ Pass](${passar}) · [▶ Do your best!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEs = `## Alcance

Inspección de la **lengua portuguesa** — el medio en que Inspetor BudGanja piensa, inspecciona y publica. Cubre **originalidad**, **cambios a lo largo del tiempo**, **para qué sirve** y [¡Haz lo mejor!](${mantra}). Vínculo oral: [jesusamando](${jesusamando}).
...
| Vínculos | [Duvivier](${duvivier}) · [verdad](${verdade}) · [gesto](${gesto}) · [pasar](${passar}) · [camino](${caminho}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Hipótesis temporal:** cada ficha de [Palabras](${hub}) es un **corte en el tiempo**. Cambio ≠ decadencia; congelar «portugués puro eterno» = reprobado. Soplo vivo BR: [jesusamando](${jesusamando}) vs [aff](${aff}).
...
[¡Haz lo mejor!](${mantra}) se escribe y se dice **en portugués** — honesto **en este momento**, sabiendo que la lengua sigue moviéndose.

## Estado

**Aprobada** — originalidad · cambios en el tiempo · para qué sirve · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ jesusamando](${jesusamando}) · [▶ Duvivier](${duvivier}) · [▶ Pasar](${passar}) · [▶ ¡Haz lo mejor!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildLinguaPortuguesaPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Língua portuguesa — originalidade, alterações no tempo e Faça o melhor!',
    titleEn:
      'Inspection: Portuguese language — originality, changes over time and Do your best!',
    titleEs:
      'Inspección: Lengua portuguesa — originalidad, cambios en el tiempo y ¡Haz lo mejor!',
    excerpt:
      'Palavras: língua portuguesa — originalidade; alterações ao longo do tempo (latim → BR → digital); para que serve; Faça o melhor! nesta língua.',
    excerptEn:
      'Words: Portuguese language — originality; changes over time (Latin → BR → digital); purpose; Do your best! in this language.',
    excerptEs:
      'Palabras: lengua portuguesa — originalidad; cambios a lo largo del tiempo (latín → BR → digital); para qué sirve; ¡Haz lo mejor! en esta lengua.',

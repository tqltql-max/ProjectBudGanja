...
[▶ Palavras](${hub}) · [▶ Guia](${guia}) · [▶ Duvivier](${duvivier}) · [▶ Passar](${passar}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of the **Portuguese language** — the medium in which Inspetor BudGanja thinks, inspects and publishes. Covers **originality**, **changes over time**, **what it is for**, and [Do your best!](${mantra}).
...
**Temporal hypothesis:** each [Words](${hub}) sheet is a **cut in time**. Change ≠ decay; freezing “pure ancient Portuguese” = fail; erasing history = also fail.
...
[▶ Words](${hub}) · [▶ Duvivier](${duvivier}) · [▶ Pass](${passar}) · [▶ Do your best!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEs = `## Alcance

Inspección de la **lengua portuguesa** — el medio en que Inspetor BudGanja piensa, inspecciona y publica. Cubre **originalidad**, **cambios a lo largo del tiempo**, **para qué sirve** y [¡Haz lo mejor!](${mantra}).
...
**Hipótesis temporal:** cada ficha de [Palabras](${hub}) es un **corte en el tiempo**. Cambio ≠ decadencia; congelar «portugués puro eterno» = reprobado.
...
[▶ Palabras](${hub}) · [▶ Duvivier](${duvivier}) · [▶ Pasar](${passar}) · [▶ ¡Haz lo mejor!](${mantra}) · [▶ Vida](${vida})
`;

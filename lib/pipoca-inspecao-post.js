 ...
 * transformação com ofício · Valeu !!!
 */
...
| Elo ofício | [gesto](${gesto}) · [criatividade](${criatividade}) · [verdade](${verdade}) · [Valeu !!!](${mantra}) |
...
| **Fechar** | Depois do estalo, o acto | [Verdade](${verdade}) + [Valeu !!!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor estalo possível **com o calor que tens hoje** — sem forçar o grão nem queimar o saco |
...
**Veredicto:** Valeu !!! **como pipoca boa** — calor certo, estalo limpo, partilha. Pipoca sem [caminho](${caminho}) = queimado; pipoca com ofício = florescência que fica.
...
**H4:** fecho = [Valeu !!!](${mantra}) com calor medido e partilha.
...
**Aprovado** — **pipoca** fichada: objeto (tupi *pi'poka*), viagem milho→calor→estouro, usos (rua · cinema · figura) e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Fogo](${fogo}) · [▶ Alegria](${alegria}) · [▶ Gesto](${gesto}) · [▶ Criatividade](${criatividade}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **pipoca** (popcorn) — corn that pops, street and cinema snack, metaphor of transformation. Covers **object** (Tupi loan in Brazilian Portuguese), the journey grain→heat→pop, cultural uses, and [Valeu !!!](${mantra}). Links: [fogo](${fogo}), [alegria](${alegria}), [criatividade](${criatividade}), [gesto](${gesto}).
...
| Links | [fogo](${fogo}) · [alegria](${alegria}) · [gesture](${gesto}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name the snack · celebrate BR street/cinema culture · map transformation with craft · close with [Valeu !!!](${mantra}). Not pouca / roça / coca.
...
**Approved** — Tupi etymon · milho→heat→pop · street/cinema · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Fogo](${fogo}) · [▶ Alegria](${alegria}) · [▶ Gesture](${gesto}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **pipoca** (palomitas) — maíz que estalla, merienda de calle y cine, metáfora de transformación. Cubre **objeto** (préstamo tupí en el portugués de Brasil), el viaje grano→calor→estallido, usos culturales y [¡Valeu !!!](${mantra}). Vínculos: [fogo](${fogo}), [alegria](${alegria}), [criatividade](${criatividade}), [gesto](${gesto}).
...
| Vínculos | [fogo](${fogo}) · [alegria](${alegria}) · [gesto](${gesto}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar · celebrar la cultura BR · mapear transformación con oficio · cerrar con [¡Valeu !!!](${mantra}). No confundir con pouca / roça / coca.
...
**Aprobada** — étimo tupí · milho→calor→estallido · calle/cine · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Fogo](${fogo}) · [▶ Alegria](${alegria}) · [▶ Gesto](${gesto}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildPipocaPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «pipoca» (tupi *pi\'poka*) — milho→calor→estouro; rua e cinema BR; transformação com ofício; Valeu !!!',
    excerptEn:
      'Words: “pipoca” (Tupi *pi\'poka*) — grain→heat→pop; BR street and cinema; craftful transformation; Valeu !!!',
    excerptEs:
      'Palabras: «pipoca» (tupí *pi\'poka*) — grano→calor→estallido; calle y cine BR; transformación con oficio; ¡Valeu !!!',

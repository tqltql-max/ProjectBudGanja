...
| Elo Palavras | [gesto](${gesto}) · [skill](${skill}) · [caminho](${caminho}) · [coração](${coracao}) · [verdade](${verdade}) · [etimologia](${etimologia}) · [nó](${no}) · [Faça o melhor!](${mantra}) |
...
[▶ Pessoas](${hub}) · [▶ Filme 1996](${filme}) · [▶ DiCaprio](${dicaprio}) · [▶ Filmografia](${filo}) · [▶ Peça](${peca}) · [▶ Shakespeare](${shake}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;
...
[▶ People](${hub}) · [▶ 1996 film](${filme}) · [▶ Do your best!](${mantra})
`;
...
[▶ Personas](${hub}) · [▶ Filme 1996](${filme}) · [▶ ¡Haz lo mejor!](${mantra})
`;

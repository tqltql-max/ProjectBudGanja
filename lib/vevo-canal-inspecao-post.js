...
function buildVevoBodies() {
  ...
  const elvis = 'https://www.youtube.com/@ElvisPresleyVEVO';
  const gnr = 'https://www.youtube.com/@GunsNRosesVEVO';
  ...
  const letItGoId = 'L0MK7qz13bU';
  const letItGo = 'https://www.youtube.com/watch?v=' + letItGoId;
...
| Elos Artes | [Send Me On My Way](${sendMe}) · [Só os Loucos Sabem](${loucos}) · [Megamente](${megamente}) · [Elza / Frozen](${elza}) |
| Elos Vida / Rádio | [Three Little Birds](${birds}) · [DJ Brisa](${brisa}) · [Rádio](${radio}) |
| Distinto de | [Disney Jr.](${disney}) (desenhos em PT) · MovReCam / CANABinALL (formação) — *Let It Go* é [DisneyMusicVEVO](${disneyVevo}), não Jr. |
...
**H5:** o desenho [Megamente](${megamente}) usa clipes *VEVO da **banda sonora** (Elvis JXL, AC/DC, Guns N' Roses) **junto** da ficha — ainda transporte, não génese do filme.  
**H6:** a personagem [Elza](${elza}) (*Frozen*, 2013) usa [DisneyMusicVEVO](${disneyVevo}) · *Let It Go* **junto** da ficha — família VEVO, não o canal [Disney Jr.](${disney}) (desenhos em PT).
...
| [ElvisPresleyVEVO](${elvis}) · *A Little Less Conversation* (JXL) | Clipe **junto** de [Megamente](${megamente}) — palco Elvis do Metro Man |
| [GunsNRosesVEVO](${gnr}) · *Welcome to the Jungle* | Selva de papéis — tabela da mesma ficha [Megamente](${megamente}) |
| [DisneyMusicVEVO](${disneyVevo}) · *Let It Go* | Clipe **junto** de [Elza / Frozen](${elza}) — gelo × porta; **sem** colar a letra |

> **Hierarquia:** sem a **canção** (álbum, créditos, tese cultural) não há Artes. Sem **VEVO** (ou outro canal oficial) o laboratório perde a referência audiovisual licenciada — mas **não** inventa a obra. O **desenho** [Megamente](${megamente}) e a personagem [Elza](${elza}) vêm primeiro; os clipes são ecos.
...
## Clipe VEVO junto de Megamente

Embed de [ElvisPresleyVEVO](${elvisYt}) — o mesmo clipe que a ficha [Megamente](${megamente}) coloca ao lado do trailer. **Não** substitui a âncora Marley.

@youtube ${elvisId}

## Clipe VEVO junto de Elza / Frozen

Embed de [DisneyMusicVEVO](${letItGo}) — o mesmo clipe que a ficha [Elza](${elza}) coloca ao lado do trailer. **Não** substitui a âncora Marley. **Não** cola a letra.
...
3. Cruzar com [Send Me On My Way](${sendMe}), [Só os Loucos Sabem](${loucos}), [Megamente](${megamente}), [Elza / Frozen](${elza}) e [Three Little Birds](${birds}).  
4. Não misturar VEVO com hubs de formação ([MovReCam](${movrecam}), [CANABinALL](${canabinall})) nem com [Disney Jr.](${disney}) — *Let It Go* vive em [DisneyMusicVEVO](${disneyVevo}), não no Jr.

## Status

**Aprovado** — rede **VEVO** documentada como canal/meta de **videoclipes oficiais** no BudGanja; âncora *Three Little Birds* (BobMarleyVEVO); clipes **junto** de [Megamente](${megamente}) e [Elza / Frozen](${elza}); elos Artes e Rádio/Vida.

[▶ @VEVO](${ytHub}) · [▶ Rádio](${radio}) · [▶ Send Me On My Way](${sendMe}) · [▶ Só os Loucos Sabem](${loucos}) · [▶ Megamente](${megamente}) · [▶ Elza](${elza}) · [▶ Three Little Birds](${birds}) · [▶ Canais](${hub})
`;
...
| Arts links | [Send Me On My Way](${sendMe}) · [Só os Loucos Sabem](${loucos}) · [Megamind](${megamente}) · [Elsa / Frozen](${elza}) |
| Date | ${inspected} |
...
| ElvisPresleyVEVO · *A Little Less Conversation* (JXL) | Soundtrack clip **beside** [Megamind](${megamente}) |
| DisneyMusicVEVO · *Let It Go* | Clip **beside** [Elsa / Frozen](${elza}) — no pasted lyric |

@youtube ${seedId}

Soundtrack companion (same clip as on the Megamind sheet):

@youtube ${elvisId}

Character companion (same clip as on the Elsa sheet):

@youtube ${letItGoId}

## Status

**Approved** — VEVO as official music-video network in BudGanja; anchor *Three Little Birds*; clips beside Megamind and Elsa / Frozen; Arts and Radio/Vida links.

[▶ @VEVO](${ytHub}) · [▶ Radio](${radio}) · [▶ Elsa](${elza}) · [▶ Arts](${artes})
`;
...
**Aprobada** — red VEVO como canal/meta de videoclips oficiales; ancla *Three Little Birds*; clips junto de Megamente y Elza / Frozen; vínculos Artes y Radio/Vida.

[▶ @VEVO](${ytHub}) · [▶ Radio](${radio}) · [▶ Elza](${elza}) · [▶ Artes](${artes})
`;

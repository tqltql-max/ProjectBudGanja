 ...
 * · distinção trilha /vida/ e Árvore da Vida · elos afecto · Valeu !!!
...
| **Fechar** | Depois de nomear, o acto | [Valeu !!!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **nesta vida nomeada**, hoje — sem pose de guru |
...
**Veredicto:** Valeu !!! **com vida** — [gesto](${gesto}) e [verdade](${verdade}). Vida sem [caminho](${caminho}) = cartaz; vida com método = arco que se pode inspecionar.
...
**H4:** fecho = [Valeu !!!](${mantra}); trilha e árvore ficam à parte.
...
**Aprovado** — **vida** fichada: objeto (*vīta*), sentidos (facto · tempo · modo · animação), distinção trilha/figura e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Alegria](${alegria}) · [▶ Coração](${coracao}) · [▶ Esperança](${esperanca}) · [▶ Caminho](${caminho}) · [▶ Valeu !!!](${mantra}) · [▶ Trilha Vida](${trilha})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **vida** (life) — the fact of living, lifetime, way of living, and what “has life.” Covers **object**, **senses**, distinction from the [Vida](${trilha}) trail and [Árvore da Vida](${arvore}), and [Valeu !!!](${mantra}). Links: [alegria](${alegria}), [coração](${coracao}), [esperança](${esperanca}), [caminho](${caminho}), [passar](${passar}).
...
| Links | [alegria](${alegria}) · [coração](${coracao}) · [esperança](${esperanca}) · [caminho](${caminho}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name the fact · map time with [passar](${passar}) · mode with craft · color with [alegria](${alegria}) / [coração](${coracao}) / [esperança](${esperanca}) · close with [Valeu !!!](${mantra}).
...
**Approved** — object · senses · trail/figure distinction · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Alegria](${alegria}) · [▶ Coração](${coracao}) · [▶ Esperança](${esperanca}) · [▶ Valeu !!!](${mantra}) · [▶ Vida trail](${trilha})
`;

  const contentEs = `## Alcance

Inspección de **vida** — el hecho de vivir, el tiempo vivido, el modo de vivir y lo que «tiene vida». Cubre **objeto**, **sentidos**, distinción frente a la trama [Vida](${trilha}) y [Árvore da Vida](${arvore}), y [¡Valeu !!!](${mantra}). Vínculos: [alegria](${alegria}), [coração](${coracao}), [esperança](${esperanca}), [caminho](${caminho}), [passar](${passar}).
...
| Vínculos | [alegria](${alegria}) · [coração](${coracao}) · [esperança](${esperanca}) · [caminho](${caminho}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar · mapear el tiempo con [passar](${passar}) · modo con oficio · color con [alegria](${alegria}) / [coração](${coracao}) / [esperança](${esperanca}) · cerrar con [¡Valeu !!!](${mantra}).
...
**Aprobada** — objeto · sentidos · distinción trama/figura · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Alegria](${alegria}) · [▶ Coração](${coracao}) · [▶ Esperança](${esperanca}) · [▶ ¡Valeu !!!](${mantra}) · [▶ Trama Vida](${trilha})
`;
...
function buildVidaPost() {
  ...
  return makePalavra({
    title: 'Inspeção: Vida — facto, tempo, modo e Valeu !!!',
    titleEn: 'Inspection: Vida — fact, time, mode and Valeu !!!',
    titleEs: 'Inspección: Vida — hecho, tiempo, modo y ¡Valeu !!!',
    excerpt:
      'Palavras: «vida» (lat. *vīta*) — facto de viver, tempo e modo; distinta da trilha /vida/ e da Árvore da Vida; elos alegria/coração/esperança; Valeu !!!',
    excerptEn:
      'Words: “vida” (Lat. *vīta*) — fact of living, time and mode; distinct from the Vida trail and Tree of Life; alegria/coração/esperança links; Valeu !!!',
    excerptEs:
      'Palabras: «vida» (lat. *vīta*) — hecho de vivir, tiempo y modo; distinta de la trama /vida/ y del Árbol de la Vida; vínculos alegria/coração/esperança; ¡Valeu !!!',

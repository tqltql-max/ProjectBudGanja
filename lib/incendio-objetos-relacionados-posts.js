...
${opts.enFix} Close with [Valeu !!!](${L.mantra}).

## Status

**Approved** — ${opts.word}; [fire cluster](${L.cluster}); [Valeu !!!](${L.mantra}).

[▶ Words](${L.hub}) · [▶ Fire cluster](${L.cluster}) · [▶ Valeu !!!](${L.mantra})
`;
...
${opts.esFix} Cerrar con [¡Valeu !!!](${L.mantra}).

## Estado

**Aprobado** — ${opts.word}; [clúster](${L.cluster}); [¡Valeu !!!](${L.mantra}).

[▶ Palabras](${L.hub}) · [▶ Clúster incendio](${L.cluster}) · [▶ ¡Valeu !!!](${L.mantra})
`;
...
Não pendurar a [fonte](${L.fonte}) contra o Mylar; não tapar o [exaustor](${L.exaustor}); [interruptor](${L.interruptor}) fora do pano se possível. Tenda da marca ≠ laudo. Fechar com [Valeu !!!](${L.mantra}).

## Status

**Aprovado** — **tenda** (*tendere*): recinto do cluster; elos [Mars Hydro](${L.marsPalavra}) · [Vivosun](${L.vivosunPalavra}); [Valeu !!!](${L.mantra}).

[▶ Cluster](${L.cluster}) · [▶ Exaustor](${L.exaustor}) · [▶ Ventilação](${L.ventilacao}) · [▶ Valeu !!!](${L.mantra})
`;
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «tenda» (lat. tendere) — grow tent concentra luz e calor; objecto do cluster de incêndio; Valeu !!!',
    excerptEn:
      'Words: “tenda” (Lat. tendere) — grow tent traps light and heat; fire-cluster object; Valeu !!!',
    excerptEs:
      'Palabras: «tenda» (lat. tendere) — la carpa concentra luz y calor; objeto del clúster de incendio; ¡Valeu !!!',
...
Controle = aviso + corte + (depois) extintor. Não atirar [água](${L.agua}) ao driver. Não transformar o cilindro em [ídolo](${L.idolo}) de segurança. [Valeu !!!](${L.mantra}) **antes** da labareda: circuito e [extensão](${L.extensao}).

## Status

**Aprovado** — **extintor** (*exstinguere*): coluna controle do [cluster](${L.cluster}); ≠ manual de bombeiros; [Valeu !!!](${L.mantra}).

[▶ Cluster](${L.cluster}) · [▶ Incêndio](${L.incendio}) · [▶ Fogo](${L.fogo}) · [▶ Valeu !!!](${L.mantra})
`;
  const i18n = shortEnEs({
    word: 'extintor',
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «extintor» (lat. exstinguere) — objecto de controle; ≠ NR-23; elos incêndio, interruptor; Valeu !!!',
    excerptEn:
      'Words: “extintor” (Lat. exstinguere) — control object; not a fire code; Valeu !!!',
    excerptEs:
      'Palabras: «extintor» (lat. exstinguere) — objeto de control; no es NR-23; ¡Valeu !!!',
...
Inspeção editorial da palavra **[incêndio](${self})** — o **evento** descontrolado (lat. *incendium*). Pedido de campo: *controle de incêndio*. Distingue-se de **[fogo](${L.fogo})** (lat. *focus*, elemento / lareira). Elos: [risco](${L.risco}), [extintor](${L.extintor}), [cluster](${L.cluster}), [Valeu !!!](${L.mantra}).
...
Não fundir [fogo](${L.fogo}) (ofício, medida, metáfora) com incêndio (sinistro). [Valeu !!!](${L.mantra}) **antes** do evento: nomear os [objectos](${L.objetosPalavra}) do [cluster](${L.cluster}).

## Status

**Aprovado** — **incêndio** (*incendium*) ≠ [fogo](${L.fogo}) (*focus*); eixo do [mapa](${L.cluster}); [Valeu !!!](${L.mantra}).

[▶ Cluster](${L.cluster}) · [▶ Fogo](${L.fogo}) · [▶ Extintor](${L.extintor}) · [▶ Valeu !!!](${L.mantra})
`;
  const i18n = shortEnEs({
    word: 'incêndio',
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «incêndio» (lat. incendium) ≠ fogo (focus); evento descontrolado; eixo do cluster da tenda; Valeu !!!',
    excerptEn:
      'Words: “incêndio” (Lat. incendium) ≠ fogo (focus); uncontrolled event; tent cluster; Valeu !!!',
    excerptEs:
      'Palabras: «incêndio» (lat. incendium) ≠ fogo (focus); evento descontrolado; ¡Valeu !!!',
...
Nomear a fonte como [objecto](${L.objetosPalavra}) distinto da [lâmpada](${L.lampada}). Não a esconder na [tenda](${L.tenda}) sem ar. [Interruptor](${L.interruptor}) a montante. [Valeu !!!](${L.mantra}).

## Status

**Aprovado** — **fonte** (*fons* → driver): ponto cego do [cluster](${L.cluster}); [Valeu !!!](${L.mantra}).

[▶ Cluster](${L.cluster}) · [▶ Extensão](${L.extensao}) · [▶ Lâmpada](${L.lampada}) · [▶ Valeu !!!](${L.mantra})
`;
  const i18n = shortEnEs({
    word: 'fonte',
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «fonte» (lat. fons) — no indoor é o driver; perigo escondido do cluster; Valeu !!!',
    excerptEn:
      'Words: “fonte” (Lat. fons) — indoors it is the LED driver; hidden cluster hazard; Valeu !!!',
    excerptEs:
      'Palabras: «fonte» (lat. fons) — en indoor es el driver; peligro escondido; ¡Valeu !!!',
...
Inspeção editorial da palavra **[extensão](${self})** — cabo / régua / *benjamim* que **estica** a tomada até à [tenda](${L.tenda}). Pedido de campo: objectos perigosos para [controle de incêndio](${L.cluster}). Elos: [fonte](${L.fonte}), [interruptor](${L.interruptor}), [risco](${L.risco}), [Valeu !!!](${L.mantra}).
...
Não empilhar extensões. Preferir circuito dedicado quando o watt do [catálogo](${L.marsEquip}) / [Vivosun](${L.vivosunEquip}) pede. [Interruptor](${L.interruptor}) acessível. [Valeu !!!](${L.mantra}).

## Status

**Aprovado** — **extensão** (*extendere*): perigo banal do [cluster](${L.cluster}); [Valeu !!!](${L.mantra}).

[▶ Cluster](${L.cluster}) · [▶ Fonte](${L.fonte}) · [▶ Interruptor](${L.interruptor}) · [▶ Valeu !!!](${L.mantra})
`;
  const i18n = shortEnEs({
    word: 'extensão',
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «extensão» (lat. extendere) — régua/benjamim; perigo banal do cluster; Valeu !!!',
    excerptEn:
      'Words: “extensão” (Lat. extendere) — strip/cord; banal cluster hazard; Valeu !!!',
    excerptEs:
      'Palabras: «extensão» (lat. extendere) — regleta; peligro banal del clúster; ¡Valeu !!!',
...
Inspeção editorial da palavra **[exaustor](${self})** — o **motor** que tira ar da [tenda](${L.tenda}) (inline, duto, filtro). Pedido de campo: objectos relacionados Mars Hydro / Vivosun (iFresh, AeroWave). Elos: [ventilação](${L.ventilacao}), [tenda](${L.tenda}), [cluster](${L.cluster}), [Valeu !!!](${L.mantra}).
...
Dimensionar com a [ficha de ventilação](${L.ventilacao}) e [VPD](${L.vpd}). Não estrangular o duto. Cabo na [extensão](${L.extensao}) conta na soma. [Valeu !!!](${L.mantra}).

## Status

**Aprovado** — **exaustor** (*exhaurīre*): ar × motor no [cluster](${L.cluster}); [Valeu !!!](${L.mantra}).

[▶ Cluster](${L.cluster}) · [▶ Tenda](${L.tenda}) · [▶ Ventilação](${L.ventilacao}) · [▶ Valeu !!!](${L.mantra})
`;
  const i18n = shortEnEs({
    word: 'exaustor',
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «exaustor» (lat. exhaurīre) — motor inline na tenda; perigo × clima; elos ventilação, Mars/Vivosun; Valeu !!!',
    excerptEn:
      'Words: “exaustor” (Lat. exhaurīre) — inline motor in the tent; hazard × climate; Valeu !!!',
    excerptEs:
      'Palabras: «exaustor» (lat. exhaurīre) — motor inline; peligro × clima; ¡Valeu !!!',

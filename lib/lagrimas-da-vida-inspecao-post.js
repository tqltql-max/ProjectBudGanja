...
Inspeção editorial do poema **«Lágrimas da Vida»** (também referido no singular como *a lágrima da vida*) — peça de **Álvares de Azevedo** na **[Lira dos Vinte Anos](${wikiLira})**, marco do **ultrarromantismo** brasileiro. O **recorte principal** é o **texto poético**; a biografia do autor e o livro completo entram como contexto. Homenagem ao autor: [Álvares de Azevedo](${autor}) (série Pessoas).
...
| Autor | **[Álvares de Azevedo](${autor})** (1831–1852) — homenagem em Pessoas |
...
| Elo Pessoas | [Álvares de Azevedo](${autor}) — ofício do autor |
...
|-------|------------------------------|
| Autor | [Álvares de Azevedo](${autor}) — principal voz da 2.ª geração romântica no Brasil; morreu aos 21 anos |
...
> **Hierarquia BudGanja:** sem o poema (e a *Lira*), não há «lágrima da vida» cultural nesta ficha. A homenagem em [Pessoas](${autor}) explica o ofício; **não** substitui a leitura do verso.
...
| Recurso | Papel |
|---------|-------|
| [Álvares de Azevedo](${autor}) | Homenagem Pessoas — ofício do autor |
...
3. Abrir a [homenagem ao autor](${autor}) se o interesse for a pessoa.  
4. Se a dor pesar, ir a [Vida](${vida}) — companhia do laboratório, não só verso.  
...
### Limites
- Não é biografia completa — ver [Álvares de Azevedo](${autor}).  
- Não inventaria toda a *Lira dos Vinte Anos*.  
- Não é apoio clínico.

## Status

**Aprovado** — «Lágrimas da Vida» documentada como poema da *Lira*, com elos a [Álvares de Azevedo](${autor}), [Vida](${vida}), [emoção](${emocao}) e [tristeza](${tristeza}).

[▶ Artes](${hub}) · [▶ Autor](${autor}) · [▶ Águas e Lágrimas](${aguas}) · [▶ Vida](${vida}) · [▶ Emoção](${emocao}) · [▶ Tristeza](${tristeza}) · [▶ Texto](${poemaAlt})
`;

  const contentEn = `## Scope

Editorial inspection of the poem **“Lágrimas da Vida”** (“Tears of Life”; also called *the tear of life*) by **Álvares de Azevedo**, in *Lira dos Vinte Anos* — Brazilian ultra-romanticism. Main cut: the **poem**; author homage: [Álvares de Azevedo](${autor}).
...
| Author | [Álvares de Azevedo](${autor}) (1831–1852) |
| Book | *Lira dos Vinte Anos* |
| Lab links | [Author](${autor}) · [Vida](${vida}) · [emoção](${emocao}) · [tristeza](${tristeza}) |
| Date | ${inspected} |
...
**Approved** — poem fixed on the Arts map with author homage and Vida links.

[▶ Arts](${hub}) · [▶ Author](${autor}) · [▶ Vida](${vida})
`;

  const contentEs = `## Alcance

Inspección del poema **«Lágrimas da Vida»** (también *la lágrima de la vida*) de **Álvares de Azevedo**, en *Lira dos Vinte Anos* — ultrarromanticismo brasileño. Recorte: el **poema**. Homenaje: [Álvares de Azevedo](${autor}).
...
| Autor | [Álvares de Azevedo](${autor}) |
| Libro | *Lira dos Vinte Anos* |
| Vínculos | [Autor](${autor}) · [Vida](${vida}) · [emoção](${emocao}) · [tristeza](${tristeza}) |
| Fecha | ${inspected} |
...
**Aprobada** — poema en el mapa Artes con homenaje al autor y vínculos a Vida.

[▶ Artes](${hub}) · [▶ Autor](${autor}) · [▶ Vida](${vida})
`;

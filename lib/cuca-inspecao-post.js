...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor conto possível **com** a criança, **sem** ameaça |
...
**Veredicto:** Faça o melhor **ao ninar** — [respeito](${respeito}) + [medo](${medo}) nomeado. Cuca no quarto é história; Cuca como arma de obediência é mapa incompleto.
...
**H5:** fecho = [Faça o melhor!](${mantra}) com [respeito](${respeito}) à infância.
...
[▶ Palavras](${hub}) · [▶ Medo](${medo}) · [▶ Respeito](${respeito}) · [▶ Toda criança nasce cientista](${crianca}) · [▶ Disney Jr.](${disney}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
[▶ Words](${hub}) · [▶ Fear](${medo}) · [▶ Respect](${respeito}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Miedo](${medo}) · [▶ Respeto](${respeito}) · [▶ ¡Haz lo mejor!](${mantra})
`;

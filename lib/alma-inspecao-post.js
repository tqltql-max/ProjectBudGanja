...
Inspeção editorial da palavra **alma** — o **centro vivo** da pessoa (e, por extensão, o íntimo de uma obra, de um projecto, de um [gesto](${gesto})). Pedido do lab: que as fichas **cheguem na alma**, não só no inventário. Esta ficha cobre o **objeto** (lat. *anima*), o eixo **alma × coração × vida**, o contraste com [tudo](${tudo}) (totalidade sem centro), a rede com a expressão [vingança / alma / veneno](${vinganca}), e o fecho [Valeu !!!](${mantra}).
...
| **Ofício lab** | Escrever tabelas *e* calor | [Valeu !!!](${mantra}) com sentimento |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **para tocar com verdade**, hoje |
...
**Veredicto:** Valeu !!! **até chegar na alma**. Alma sem [gesto](${gesto}) = abstracção; alma com ofício = ficha que fica.
...
**Aprovado** — **alma** fichada: *anima*, centro vivo, rede com tudo/coração/vida e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Tudo](${tudo}) · [▶ Coração](${coracao}) · [▶ Vida](${vida}) · [▶ Valeu !!!](${mantra}) · [▶ Vingança/alma](${vinganca})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **alma** (soul) — Lat. *anima*, the living center. Lab note: sheets should **reach the soul**, not only the inventory. Links [tudo](${tudo}), [coracao](${coracao}), [vida](${vidaPalavra}), [Valeu !!!](${mantra}).
...
| Links | [tudo](${tudo}) · [coracao](${coracao}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — center · warmth · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Tudo](${tudo}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **alma** — lat. *anima*, el centro vivo. Nota del lab: las fichas deben **llegar al alma**, no solo al inventario. Vínculos [tudo](${tudo}), [coracao](${coracao}), [vida](${vidaPalavra}), [¡Valeu !!!](${mantra}).
...
| Vínculos | [tudo](${tudo}) · [coracao](${coracao}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — centro · calor · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Tudo](${tudo}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildAlmaPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «alma» (lat. *anima*) — centro vivo; chegar na alma; elos tudo, coração, vida; Valeu !!!',
    excerptEn:
      'Words: “alma” (Lat. *anima*) — living center; reaching the soul; links tudo, coração, vida; Valeu !!!',
    excerptEs:
      'Palabras: «alma» (lat. *anima*) — centro vivo; llegar al alma; vínculos tudo, corazón, vida; ¡Valeu !!!',

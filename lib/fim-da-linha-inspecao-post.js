...
| Elo ofício | [Valeu !!!](${mantra}) · [verdade](${verdade}) · [língua portuguesa](${lingua}) |
...
**H4:** responder ao fim da linha **não** é rancor nem desistência — é [Valeu !!!](${mantra}) **neste resto de fita**, hoje.
...
| [Loop infinito](/posts/post-inspecao-expressao-loop-infinito.html) | O contrário útil — o processo **não** acaba; a sequência oral é [ando, indo, vindo, voltando](/posts/post-inspecao-expressao-ando-indo-vindo-voltando.html) |
| [Gesto](${gesto}) · [risco](${risco}) · [sinal](${sinal}) | Aperto, anelamento, cor da casca / da fita |
| [Planta](${planta}) | Onde a fita tutora o vivo |
| [Valeu !!!](${mantra}) | Ofício no resto da linha |
...
**Aprovado na série Expressões e Ditados populares** — *fim da linha* fichada como locução de **limite inspeccionável**; caso de laboratório = confeito casca + chocolate (formato M&M's); elos [cinta / fita](${cinta}), [vida](${vida}), [chocolate](${chocolate}), [Valeu !!!](${mantra}).

[▶ Expressões](${hub}) · [▶ Cinta](${cinta}) · [▶ Vida](${vida}) · [▶ Chocolate](${chocolate}) · [▶ Valeu !!!](${mantra}) · [▶ trilha Vida](${vidaTrilha})
`;

  const contentEn = `## Scope

Editorial inspection of the Brazilian saying **“fim da linha”** (end of the line) — end of a route, of options, of [tape / cinta](${cinta}), of [life](${vida}), and of a **factory belt**. Lab case: **candy-coated chocolate** (popular **M&M's** format): the shell wraps like tape; the core is chocolate ([life](${vida}) the shell keeps until the last gesture). Links [cinta](${cinta}), [vida](${vida}) / trail [Vida](${vidaTrilha}), [industrial chocolate](${chocolate}); close [Valeu !!!](${mantra}).
...
| Links | [cinta](${cinta}) · [vida](${vida}) · [chocolate](${chocolate}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**H4:** the reply is [Valeu !!!](${mantra}) **on this remaining tape**, today.
...
[▶ Expressions](${hub}) · [▶ Cinta](${cinta}) · [▶ Vida](${vida}) · [▶ Chocolate](${chocolate}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de la locución brasileña **«fim da linha»** (fin de la línea) — fin de trayecto, de opciones, de [cinta / fita](${cinta}), de [vida](${vida}) y de **cinta de fábrica**. Caso de laboratorio: **confite de chocolate con cáscara de color** (formato popular **M&M's**): la cáscara envuelve como cinta; el núcleo es el chocolate (la [vida](${vida}) que la cáscara guarda hasta el último gesto). Vínculos [cinta](${cinta}), [vida](${vida}) / senda [Vida](${vidaTrilha}), [chocolate industrial](${chocolate}); cierre [¡Valeu !!!](${mantra}).
...
| Vínculos | [cinta](${cinta}) · [vida](${vida}) · [chocolate](${chocolate}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**H4:** la respuesta es [¡Valeu !!!](${mantra}) **en este resto de cinta**, hoy.
...
[▶ Expresiones](${hub}) · [▶ Cinta](${cinta}) · [▶ Vida](${vida}) · [▶ Chocolate](${chocolate}) · [▶ ¡Valeu !!!](${mantra})
`;

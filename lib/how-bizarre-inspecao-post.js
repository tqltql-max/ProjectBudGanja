...
| Swagger sem tanque | [alegria](${alegria}) · [Valeu !!!](${mantra}) |
...
| [gesto](${gesto}) · [já](${ja}) · [Valeu !!!](${mantra}) | Ofício de nomear e ficar |
...
[▶ Spotify](${SPOTIFY}) · [▶ Áudio](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=how-bizarre) · [▶ Criatividade](${criatividade}) · [▶ Alegria](${alegria}) · [▶ Valeu !!!](${mantra})
`;

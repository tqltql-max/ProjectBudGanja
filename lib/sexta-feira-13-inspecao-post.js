 ...
 * o dia é dia — não azar, não marca · Valeu !!!
 */
...
**H4:** fecho = viver o dia com [gesto](${gesto}) e [verdade](${verdade}) — [Valeu !!!](${mantra}) **como em qualquer outro**.
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **neste dia**, como no anterior |
...
**H4:** fecho = [Valeu !!!](${mantra}) no dia que há.
...
**Aprovado** — **sexta-feira 13** fichada como data: **13 de novembro de 2026** é sexta e é **apenas mais um dia qualquer**; lançamentos da franquia no dia 13 = elo de calendário, não o objecto; [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Tempo](${tempo}) · [▶ Medo](${medo}) · [▶ Risco](${risco}) · [▶ Sinal](${sinal}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
**H4:** close = [Valeu !!!](${mantra}) **as on any other day**.
...
**Approved** — Friday the 13th filed as a date: **just another ordinary day**; franchise openings on the 13th = calendar link; [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Tempo](${tempo}) · [▶ Valeu !!!](${mantra})
`;
...
El 13 de noviembre — y cualquier viernes 13 — es un día civil. La superstición es cultura; el [medo](${medo}) es afecto; el [risco](${risco}) pide mapa. Algunos estrenos de la franquicia cayeron en viernes 13 como **agenda comercial**, no como presagio. Cierre: [¡Valeu !!!](${mantra}) **como en cualquier otro día**.
...
**Aprobado** — viernes 13 fichado como fecha: **solo un día cualquiera**; [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Tempo](${tempo}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildSextaFeira13Post() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «sexta-feira 13» — data, não azar; 13 de novembro de 2026 é sexta e é um dia qualquer; estreias da franquia no dia 13 = calendário, não o objecto; Valeu !!!',
    excerptEn:
      'Words: “sexta-feira 13” (Friday the 13th) — a date, not a curse; 13 November 2026 is a Friday and an ordinary day; franchise openings on the 13th = calendar, not the object; Valeu !!!',
    excerptEs:
      'Palabras: «sexta-feira 13» — fecha, no mala suerte; el 13 de noviembre de 2026 es viernes y un día cualquiera; estrenos de la franquicia el 13 = calendario, no el objeto; ¡Valeu !!!',

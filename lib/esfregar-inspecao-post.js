...
4. Fechar com [Faça o melhor!](${mantra}) **nesta** mão, hoje.
...
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — o melhor **nesta** palma, com rasto |
...
| [Faça o melhor!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) | Fecho sem teatro |
...
**Aprovado** — **esfregar** fichado como atrito (*fricare*); cue do conto ≠ clique do lab; elos [lâmpada](${lampada}), [gesto](${gesto}), [desejos](${desejos}); fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Lâmpada](${lampada}) · [▶ Gesto](${gesto}) · [▶ Ligar × desligar](${ligar}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Inspection of Portuguese **esfregar** (“to rub”) — the **tale’s false gesture** on the [lamp](${lampada}) map. In the room, rubbing is friction (clean, warm, polish). In [Aladdin](${wikiAladim}) it is the **hand cue** that summons the genie — tactile cousin of [abracadabra](${abracadabra}). Rubbing the bulb is not [turning it on](${ligar}). Links: [gesture](${gesto}), [wishes](${desejos}), [three](${tres}), [Do your best!](${mantra}).
...
**Rub ≠ on.** Palm on the [switch](${interruptor}), not on the glass. Close with [Do your best!](${mantra}) in this hand.
...
**Frotar ≠ encender.** Palma en el [interruptor](${interruptor}), no en el vidrio. Cerrar con [¡Haz lo mejor!](${mantra}).
...
function buildEsfregarPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «esfregar» (*fricare*) — gesto do conto na lâmpada de Aladim × clique do interruptor; ≠ ligar; elos gesto, desejos e três; Faça o melhor!',
    excerptEn:
      'Words: “esfregar” (*fricare*) — Aladdin lamp cue × switch click; ≠ turning on; links gesture, wishes and three; Do your best!',
    excerptEs:
      'Palabras: «esfregar» (*fricare*) — señal de Aladino × clic del interruptor; ≠ encender; vínculos gesto, deseos y tres; ¡Haz lo mejor!',

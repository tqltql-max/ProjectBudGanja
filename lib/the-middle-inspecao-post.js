...
- Tese BudGanja da **génese**: o meio da viagem é ofício — [tempo](${tempo}) + [já](${ja}) + [Faça o melhor!](${mantra}), sem pedir licença à festa.  
...
| [esperança](${esperanca}) · [legal](${legal}) · [alegria](${alegria}) · [Faça o melhor!](${mantra}) | Ficar, caber, ofício |
...
[▶ Spotify](${SPOTIFY}) · [▶ Clipe 4K](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=the-middle) · [▶ Caminho](${caminho}) · [▶ Já](${ja}) · [▶ Faça o melhor!](${mantra})
`;

...
| «Faça diferente» (vazio) | [Valeu !!!](${L.mantra}) **neste** circuito, hoje |
...
| [Valeu !!!](${L.mantra}) · [poema](${L.poemMantra}) | Fecho sem culto de kit |

**Veredicto:** Valeu !!! **sem o culto da marca e sem o teatro do extintor** — inspecionar o cabo, a [fonte](${L.fonte}), a [tenda](${L.tenda}) e o gesto de [desligar](${L.ligar}).
...
**H4:** fecho [Valeu !!!](${L.mantra}); ficha ≠ NR-23.
...
**Aprovado** — mapa **objectos perigosos para controle de incêndio**: colunas perigo × corte × nome; origens [Mars Hydro](${L.marsPalavra}) e [Vivosun](${L.vivosunPalavra}); todos os relacionados fichados ou elos; fecho [Valeu !!!](${L.mantra}).

[▶ Palavras](${L.hub}) · [▶ Mars Hydro](${L.marsPalavra}) · [▶ Vivosun](${L.vivosunPalavra}) · [▶ Incêndio](${L.incendio}) · [▶ Extintor](${L.extintor}) · [▶ Objetos](${L.objetos}) · [▶ Valeu !!!](${L.mantra})
`;

  const contentEn = `## Scope

Editorial map of **dangerous objects for fire control** in the indoor lab — what can ignite, what cuts / warns / extinguishes, and brand names that only label SKUs. Field request: Mars Hydro BR, Vivosun, word origins, all related objects. **Not a fire-department manual.** Links: [fogo](${L.fogo}), [incêndio](${L.incendio}), [Mars Hydro](${L.marsPalavra}), [Vivosun](${L.vivosunPalavra}), [Valeu !!!](${L.mantra}).
...
**Brand ≠ fire control.** Name the thing, put it in the right column, keep the [switch](${L.interruptor}) reachable. Close with [Valeu !!!](${L.mantra}).

## Status

**Approved** — cluster map; word origins; related objects; [Valeu !!!](${L.mantra}).

[▶ Words](${L.hub}) · [▶ Mars Hydro](${L.marsPalavra}) · [▶ Vivosun](${L.vivosunPalavra}) · [▶ Valeu !!!](${L.mantra})
`;

  const contentEs = `## Alcance

Mapa editorial de **objetos peligrosos para control de incendio** en el lab indoor — lo que puede encender, lo que corta / avisa / apaga, y las marcas que solo nombran el SKU. Pedido: Mars Hydro BR, Vivosun, origen de la palabra, todos los objetos relacionados. **No es manual de bomberos.** Vínculos: [fogo](${L.fogo}), [incêndio](${L.incendio}), [Mars Hydro](${L.marsPalavra}), [Vivosun](${L.vivosunPalavra}), [¡Valeu !!!](${L.mantra}).
...
**Marca ≠ control de incendio.** Nombrar la cosa, ponerla en la columna cierta. Cerrar con [¡Valeu !!!](${L.mantra}).

## Estado

**Aprobado** — mapa del clúster; orígenes; objetos relacionados; [¡Valeu !!!](${L.mantra}).

[▶ Palabras](${L.hub}) · [▶ Mars Hydro](${L.marsPalavra}) · [▶ Vivosun](${L.vivosunPalavra}) · [▶ ¡Valeu !!!](${L.mantra})
`;
...
function buildObjetosPerigososIncendioPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: mapa perigo × corte × marca — Mars Hydro / Vivosun e todos os objectos da tenda; ≠ manual de bombeiros; Valeu !!!',
    excerptEn:
      'Words: hazard × cut × brand map — Mars Hydro / Vivosun and every tent object; not a fire-crew manual; Valeu !!!',
    excerptEs:
      'Palabras: mapa peligro × corte × marca — Mars Hydro / Vivosun y todos los objetos de la carpa; no es manual de bomberos; ¡Valeu !!!',

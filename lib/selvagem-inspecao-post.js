...
| **Ofício na margem** | Observar → [gesto](${gesto}) → [Faça o melhor!](${mantra}) |
| **Lembrar a silva** | Tipografia *silvaogsn* → a mata no teclado |

| Camada mantra | Ligação |
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — o melhor cuidado **com** o que é livre e **com** o que se cultiva, hoje |
| Poema | [poema Vida](${poemMantra}) |
| Anti-armadilha | «Selvagem = puro / superior» **ou** «selvagem = inimigo» = mapas incompletos |

**Veredicto:** Faça o melhor **na margem entre silva e canteiro** — literacia da palavra, respeito ao vivo, [gesto](${gesto}) quando o risco for real.
...
**H5:** fecho = [Faça o melhor!](${mantra}) entre mata e cultivo.
...
| [Richard Rasmussen](${rasmussen}) · [canal Selvagem](${rasmussenCanal}) · [Vídeos](${rasmussenVideos}) | Ofício de ecrã — o handle leva esta palavra; pessoa ≠ canal |
...
**Aprovado** — **selvagem** fichado: *silva* / *silvaticus*; selvagem × domesticado; elos planta · animal · inseto; «bicho selvagem» com limites; fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Planta](${planta}) · [▶ Animal](${animal}) · [▶ Inseto](${inseto}) · [▶ Simbiose](${simbiose}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **selvagem** (“wild”) — from Lat. *silva* / *silvaticus* to Brazilian use: nature, wild vs domesticated, and “bicho selvagem.” Warm lab tone. Links: [planta](${planta}), [animal](${animal}), [inseto](${inseto}), [simbiose](${simbiose}). Close: [Do your best!](${mantra}). Does **not** romanticize harm. Typo trail: *silvaogsn* → **selvagem**.
...
Literacy on the edge between forest and bed — [Do your best!](${mantra}) with respect and real [risk](${risco}) in view.

## Status

**Approved** — selvagem; silva etymon; plant/animal/insect links; no romance of harm; [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Plant](${planta}) · [▶ Animal](${animal}) · [▶ Insect](${inseto}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **selvagem** («salvaje») — de lat. *silva* / *silvaticus* al uso BR: naturaleza, salvaje × domesticado, «bicho selvagem». Tono de lab. Vínculos: [planta](${planta}), [animal](${animal}), [inseto](${inseto}), [simbiose](${simbiose}). Cierre: [¡Haz lo mejor!](${mantra}). **Sin** romantizar daño. Tipografía: *silvaogsn* → **selvagem**.
...
Literacia en el borde entre selva y cantero — [¡Haz lo mejor!](${mantra}) con respeto y [riesgo](${risco}) real a la vista.

## Estado

**Aprobada** — selvagem; étimo silva; vínculos planta/animal/insecto; sin romance del daño; [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Planta](${planta}) · [▶ Animal](${animal}) · [▶ Insecto](${inseto}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildSelvagemPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «selvagem» (lat. silvaticus ← silva) — natureza, selvagem × domesticado, «bicho selvagem»; elos planta/animal/inseto; sem romantizar dano; Faça o melhor!',
    excerptEn:
      'Words: “selvagem” (Lat. silvaticus ← silva) — nature, wild vs domesticated, “bicho selvagem”; plant/animal/insect links; no romance of harm; Do your best!',
    excerptEs:
      'Palabras: «selvagem» (lat. silvaticus ← silva) — naturaleza, salvaje × domesticado, «bicho selvagem»; vínculos planta/animal/insecto; sin romantizar daño; ¡Haz lo mejor!',

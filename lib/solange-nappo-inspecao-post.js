...
function buildSolangeNappoBodies(inspected) {
  ...
  const coverNote =
    'Capa editorial BudGanja (hero do laboratório + tipografia). Sem retrato fotográfico licenciado disponível no momento da inspeção — ver [CEBRID](https://www.cebrid.com.br/) e [Prodmais UNIFESP](https://unifesp.br/prodmais/profile.php?lattesID=4675292090990088).';
...
![Profa. Solange Nappo — CEBRID](${cover})
...
![Prof. Solange Nappo — CEBRID](${cover})

*Editorial BudGanja cover (lab hero + typography). No licensed portrait photo was available at inspection time — see [CEBRID](https://www.cebrid.com.br/) and [Prodmais UNIFESP](https://unifesp.br/prodmais/profile.php?lattesID=4675292090990088).*
...
*Portada editorial BudGanja (hero del laboratorio + tipografía). Sin retrato fotográfico licenciado disponible en el momento de la inspección — ver [CEBRID](https://www.cebrid.com.br/) y [Prodmais UNIFESP](https://unifesp.br/prodmais/profile.php?lattesID=4675292090990088).*

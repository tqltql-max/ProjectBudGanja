...
**H4:** fecho = [Valeu !!!](${mantra}) — o melhor recorte possível *deste* arquivo *neste* laboratório, com [Vida](${vida}).
...
6. Fechar com [Valeu !!!](${mantra}) e [Vida](${vida}).
...
[▶ Vídeos · Tamara](${videosHub}) · [▶ Tamara · legado](${pessoa}) · [▶ Bom dia, Inverno](${inverno}) · [▶ Canais](${hub}) · [▶ Valeu !!!](${mantra})
`;

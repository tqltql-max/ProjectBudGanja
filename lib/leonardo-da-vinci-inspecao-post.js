...
| Elo Palavras | [gesto](${gesto}) · [criatividade](${criatividade}) · [skill](${skill}) · [pattern](${pattern}) · [caminho](${caminho}) · [verdade](${verdade}) · [respeito](${respeito}) · [Faça o melhor!](${mantra}) |
...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte *desta* pessoa *neste* ofício.
...
[▶ Pessoas](${hub}) · [▶ Santa Ceia](${ceia}) · [▶ Artes](${artes}) · [▶ gesto](${gesto}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki}) · [Vida](${vida})
`;
...
[▶ Last Supper](${ceia}) · [▶ Do your best!](${mantra})
`;
...
Taller de Verrocchio primero. Milán / Sforza: los años de la [Cena](${ceia}). Cuadernos en especular = **método**, no cifrado de thriller. Cierre: [¡Haz lo mejor!](${mantra}).
...
[▶ Santa Ceia](${ceia}) · [▶ ¡Haz lo mejor!](${mantra})
`;

...
| Elo tom do lab | [aff](${aff}) · [jesusudavi](${jesusudavi}) · [jesusamado](${jesusamado}) · [emoção](${emocao}) |
...
| **warm** | Calor / bênção leve | [jesusamado](${jesusamado}) |
...
Escala oral irmã (expressões): [aff](${aff}) ← [jesusamado](${jesusamado}) ← [jesusudavi](${jesusudavi}) ← [PQP](${pqp}) ← [código vermelho](${nsasj}).
...
| **Fechar com ofício** | Depois do mapa | [gesto](${gesto}) · [Valeu !!!](${mantra}) |
...
| [aff](${aff}) · [jesusudavi](${jesusudavi}) · [jesusamado](${jesusamado}) | Tônicos afectivos (tom do lab) |
...
| [Valeu !!!](${mantra}) | Depois do mapa — trabalhar |
...
**Aprovado na série Palavras** — *tônico* fichado como **mapa de sentidos** a partir de *tónos*; **tônicos da palavra** = sílaba + tom do lab; os outros ofícios (planta, Ayurveda, crise, música, músculo, cosmética, bebida) ficam etiquetados; fecho [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Tónos](${tonos}) · [▶ Expressões](${hubExpr}) · [▶ Língua portuguesa](${lingua}) · [▶ Isotônico](${isotonico}) · [▶ Pfaffia](${pfaffia}) · [▶ Aff](${aff}) · [▶ jesusudavi](${jesusudavi}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [tónos](${tonos}) · [Portuguese](${lingua}) · [Pfaffia](${pfaffia}) · [isotônico](${isotonico}) · [aff](${aff}) · [jesusudavi](${jesusudavi}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Verdict:** one *tónos*, nine offices; [Valeu !!!](${mantra}) after the map.

[▶ Words](${hub}) · [▶ Tónos](${tonos}) · [▶ Portuguese](${lingua}) · [▶ Pfaffia](${pfaffia}) · [▶ Valeu !!!](${mantra})
`;
...
| Vínculos | [tónos](${tonos}) · [portugués](${lingua}) · [Pfaffia](${pfaffia}) · [isotônico](${isotonico}) · [aff](${aff}) · [jesusudavi](${jesusudavi}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Veredicto:** un *tónos*, nueve oficios; [¡Valeu !!!](${mantra}) después del mapa.

[▶ Palabras](${hub}) · [▶ Tónos](${tonos}) · [▶ Portugués](${lingua}) · [▶ Pfaffia](${pfaffia}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildTonicoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «tônico» (gr. tónos) — sílaba tônica × tom do lab × planta × Ayurveda × crise × música × músculo × cosmética × água tónica; Valeu !!!',
    excerptEn:
      'Words: “tônico” (Gr. tónos) — stress × lab tone × herb × Ayurveda × seizure × music × muscle × cosmetic × tonic water; Valeu !!!',
    excerptEs:
      'Palabras: «tônico» (gr. tónos) — sílaba × tono lab × planta × Ayurveda × crisis × música × músculo × cosmética × agua tónica; ¡Valeu !!!',

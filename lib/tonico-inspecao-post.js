...
| Étimo (trabalho) | Gr. *tónos* «tensão, tom, corda» → lat. *tonus* → PT **tônico** — confiança **alta** |
...
[▶ Palavras](${hub}) · [▶ Expressões](${hubExpr}) · [▶ Língua portuguesa](${lingua}) · [▶ Isotônico](${isotonico}) · [▶ Pfaffia](${pfaffia}) · [▶ Aff](${aff}) · [▶ jesusudavi](${jesusudavi}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
|-------|-------|
| Word | **tônico** / **tônicos** |
| Etymon | Gr. *tónos* → Lat. *tonus* — **high** confidence |
| Links | [Portuguese](${lingua}) · [Pfaffia](${pfaffia}) · [isotônico](${isotonico}) · [aff](${aff}) · [jesusudavi](${jesusudavi}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
[▶ Words](${hub}) · [▶ Portuguese](${lingua}) · [▶ Pfaffia](${pfaffia}) · [▶ Do your best!](${mantra})
`;
...
| Étimo | Gr. *tónos* → lat. *tonus* — confianza **alta** |
| Vínculos | [portugués](${lingua}) · [Pfaffia](${pfaffia}) · [isotônico](${isotonico}) · [aff](${aff}) · [jesusudavi](${jesusudavi}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
[▶ Palabras](${hub}) · [▶ Portugués](${lingua}) · [▶ Pfaffia](${pfaffia}) · [▶ ¡Haz lo mejor!](${mantra})
`;

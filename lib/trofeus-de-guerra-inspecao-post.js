...
**H4:** fecho [Faça o melhor!](${mantra}) — o melhor é **não confundir bronze com [verdade](${verdade})**.
...
[▶ Palavras](${hub}) · [▶ Canhão](${canhao}) · [▶ Guerra do Paraguai](${guerra}) · [▶ Faça o melhor!](${mantra})
`;
...
A trophy is an [object](${objetos}), not the whole truth of the war. Close with [Do your best!](${mantra}).
...
El trofeo es un [objeto](${objetos}), no toda la verdad de la guerra. Cerrar con [¡Haz lo mejor!](${mantra}).
...
function buildTrofeusDeGuerraPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: troféus de guerra (*tropaeum*) — espólio ≠ verdade da guerra; caso canhão El Cristiano (devolução autorizada, entrega não fechada); Faça o melhor!',
    excerptEn:
      'Words: war trophies (*tropaeum*) — spoils ≠ the war’s truth; El Cristiano case (return authorized, delivery not closed); Do your best!',
    excerptEs:
      'Palabras: trofeos de guerra (*tropaeum*) — botín ≠ verdad de la guerra; caso El Cristiano (devolución autorizada, entrega no cerrada); ¡Haz lo mejor!',

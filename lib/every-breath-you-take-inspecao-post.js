...
| [legal](${legal}) · [verdade](${verdade}) · [Faça o melhor!](${mantra}) | Posse ≠ acordo; ler o desvio |
...
[▶ Clipe](${YT}) · [▶ Spotify](${SPOTIFY}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=every-breath-you-take) · [▶ Perseguição](${perseguicao}) · [▶ Coração](${coracao}) · [▶ Faça o melhor!](${mantra})
`;

...
Inspeção editorial da palavra **ídolo** — pessoa admirada / celebridade, imagem de culto, verbo figurado **idolatrar**, e o eco na **cultura de média**. Esta ficha cobre o **objeto**, os **sentidos em camadas**, o **bom × mau uso** no laboratório e o fecho [Valeu !!!](${mantra}). Elos: fichas [Senna](${senna}), [Chorão](${chorao}), [Keanu](${keanu}) (figuras do catálogo — não «santos» do lab), [genial](${genial}), [verdade](${verdade}), [gesto](${gesto}).
...
| Elo afecto / peito | [coração](${coracao}) · [fogo](${fogo}) · [jesusamado](${jesusamado}) · [meudeusdoceu](${meudeusdoceu}) |
| Elo ofício | [gesto](${gesto}) · [verdade](${verdade}) · [genial](${genial}) · [Valeu !!!](${mantra}) |
...
| **Fechar** | Depois da admiração, o acto | [Valeu !!!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **nesta mão**, hoje — mesmo (e sobretudo) quando há ídolos no horizonte |
...
**Veredicto:** Valeu !!! **com ídolos no mapa** — admirar o que inspira; trabalhar o que é teu. Ídolo sem [caminho](${caminho}) = pedestal oco; ídolo com método = referência que devolve a mão.
...
**H4:** fecho = [Valeu !!!](${mantra}) sem entregar o ofício.
...
| [jesusamado](${jesusamado}) · [meudeusdoceu](${meudeusdoceu}) | Sopros orais — assombro ≠ catecismo nesta ficha |
...
**Aprovado** — **ídolo** fichado: imagem → pessoa admirada → *idolatrar* → média; elos figuras e ofício; [Valeu !!!](${mantra}) sem pedestal oco.

[▶ Palavras](${hub}) · [▶ Senna](${senna}) · [▶ Genial](${genial}) · [▶ Verdade](${verdade}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **ídolo** (idol) — admired person / celebrity, cult image, figurative *idolatrar*, and media culture. Covers **object**, **layered senses**, lab **use**, and [Valeu !!!](${mantra}). Links: [Senna](${senna}), [Chorão](${chorao}), [genial](${genial}), [truth](${verdade}), [gesture](${gesto}).
...
| Links | [Senna](${senna}) · [gesture](${gesto}) · [truth](${verdade}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
Name admiration · separate persona from person · warn on excess · read media without cheap morals · close with [Valeu !!!](${mantra}).
...
**Approved** — image → admired person → *idolatrar* → media; [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Senna](${senna}) · [▶ Genial](${genial}) · [▶ Truth](${verdade}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **ídolo** — persona admirada / celebridad, imagen de culto, *idolatrar* figurado y cultura mediática. Cubre **objeto**, **sentidos**, uso en el lab y [¡Valeu !!!](${mantra}). Vínculos: [Senna](${senna}), [Chorão](${chorao}), [genial](${genial}), [verdad](${verdade}), [gesto](${gesto}).
...
| Vínculos | [Senna](${senna}) · [gesto](${gesto}) · [verdad](${verdade}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar admiración · separar persona y persona mediática · avisar el exceso · leer medios · cerrar con [¡Valeu !!!](${mantra}).
...
**Aprobada** — imagen → persona admirada → *idolatrar* → medios; [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Senna](${senna}) · [▶ Genial](${genial}) · [▶ Verdad](${verdade}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildIdoloPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Ídolo — admiração, imagem, média e Valeu !!!',
    titleEn:
      'Inspection: Ídolo — admiration, image, media and Valeu !!!',
    titleEs:
      'Inspección: Ídolo — admiración, imagen, medios y ¡Valeu !!!',
    excerpt:
      'Palavras: «ídolo» (gr. eídōlon) — celebridade, culto lexical, idolatrar e cultura de média; admirar com ofício; Valeu !!!',
    excerptEn:
      'Words: “ídolo” (Gk. eídōlon) — celebrity, lexical cult sense, idolatrar and media culture; admire with craft; Valeu !!!',
    excerptEs:
      'Palabras: «ídolo» (gr. eídōlon) — celebridad, culto léxico, idolatrar y cultura mediática; admirar con oficio; ¡Valeu !!!',

...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **depois de parar um pouco**, hoje |
| Poema | [poema Vida](${poemMantra}) |
| Anti-armadilha | «Nap = preguiça» = falso · «pausa que devolve o gesto» = ofício |
| Par vivo | [alma](${alma}) · [gesto](${gesto}) · [vida](${vidaPalavra}) |

**Veredicto:** Faça o melhor **também ao cochilar**. Nap sem culpa = cuidado; nap como fuga eterna = outro assunto — inspecionar com [verdade](${verdade}).
...
**Aprovado** — **nap** fichado: sono curto EN, ofício de pausa, rede com alma/gesto e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Alma](${alma}) · [▶ Gesto](${gesto}) · [▶ Vida](${vida}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **nap** as used in Brazilian Portuguese — English loanword for a **short sleep** / power nap. Links [gesto](${gesto}), [alma](${alma}), [vida](${vidaPalavra}), [Do your best!](${mantra}).
...
| Links | [alma](${alma}) · [gesto](${gesto}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — short rest · craft pause · [Do your best!](${mantra}).
...
Inspección de **nap** en uso BR — préstamo del inglés para **sueño corto** / power nap. Vínculos [gesto](${gesto}), [alma](${alma}), [vida](${vidaPalavra}), [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [alma](${alma}) · [gesto](${gesto}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobado** — descanso corto · pausa de oficio · [¡Haz lo mejor!](${mantra}).
...
function buildNapPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «nap» (EN) — cochilo / power nap no BR; elos gesto, alma, vida; Faça o melhor!',
    excerptEn:
      'Words: “nap” (EN) — short sleep / power nap in BR use; links gesto, alma, vida; Do your best!',
    excerptEs:
      'Palabras: «nap» (EN) — siesta corta / power nap en uso BR; vínculos gesto, alma, vida; ¡Haz lo mejor!',

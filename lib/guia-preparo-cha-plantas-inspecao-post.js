...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${L.faca}) — medir, tapar, coar, respeitar a planta |
...
**H4:** fecho = [Faça o melhor!](${L.faca}) · rede [Plantas](${L.plantas}).
...
**Aprovado** — manual de preparo de chá de plantas: infusão · decoção · segurança · elos Plantas / Farmácia Viva / [Faça o melhor!](${L.faca}).

[▶ Plantas](${L.plantas}) · [▶ Planta](${L.planta}) · [▶ Farmácia Viva](${L.farmacia}) · [▶ Faça o melhor!](${L.faca}) · [▶ Guia técnico](${L.guiaTec}) · [▶ Hub](${L.hub})
`;
...
> Identify the plant; cannabis and strong alkaloids are **out of scope** as free tea. [Do your best!](${L.faca}).
...
[▶ Plants](${L.plantas}) · [▶ Do your best!](${L.faca})
`;
...
> Identificar la planta; cannabis y alcaloides fuertes **fuera** del «té libre». [¡Haz lo mejor!](${L.faca}).
...
[▶ Plantas](${L.plantas}) · [▶ ¡Haz lo mejor!](${L.faca})
`;
...
function buildGuiaPreparoChaPlantasPost(seriesOrder) {
  ...
  return palavraPost({
    ...
    excerpt:
      'Manual: infusão e decoção caseiras — material, tempos, proporções de ofício, segurança e elos com Plantas; Faça o melhor!',
    excerptEn:
      'Manual: home infusion and decoction — gear, times, craft ratios, safety, links to Plants; Do your best!',
    excerptEs:
      'Manual: infusión y decocción caseras — material, tiempos, proporciones, seguridad y vínculos con Plantas; ¡Haz lo mejor!',

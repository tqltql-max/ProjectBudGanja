 ...
 * ligar/desligar luz/energia (interruptor) · Faça o melhor!
 */
...
**H5:** [ligar × desligar](${ligar}) é o verbo do circuito; torcer/abrir é o verbo do vão — ambos fecham com [Faça o melhor!](${mantra}).
...
| [Faça o melhor!](${mantra}) · [poema](${poemMantra}) | Fecho |
...
**Faça o melhor!** — o melhor possível **neste limiar e neste circuito**, hoje.

## 9. Status

**Aprovado** — **maçaneta** fichada + cruzamento **gesto (torcer/abrir) × mãos E/D × porta/janela × ligar/desligar luz/energia**.

[▶ Gesto](${gesto}) · [▶ Mãos](${maos}) · [▶ Interruptor](${interruptor}) · [▶ Ligar × desligar](${ligar}) · [▶ Faça o melhor!](${mantra}) · [▶ Palavras](${hub})
`;
...
[▶ Gesture](${gesto}) · [▶ Hands](${maos}) · [▶ Switch](${interruptor}) · [▶ On/off](${ligar}) · [▶ Do your best!](${mantra})
`;
...
[▶ Gesto](${gesto}) · [▶ Manos](${maos}) · [▶ Interruptor](${interruptor}) · [▶ Ligar/desligar](${ligar}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildMacanetaPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: maçaneta — gesto torcer/abrir × mão E/D × porta/janela × ligar/desligar luz; elos gesto, interruptor; Faça o melhor!',
    excerptEn:
      'Words: maçaneta — twist/open × hands × door/window × on/off light; links gesto, interruptor; Do your best!',
    excerptEs:
      'Palabras: maçaneta — torcer/abrir × manos × puerta/ventana × ligar/desligar luz; vínculos gesto, interruptor; ¡Haz lo mejor!',

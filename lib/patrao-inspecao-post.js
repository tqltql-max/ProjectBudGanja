 ...
 * elo Pattern / padrão · Faça o melhor!
 */
...
Inspeção editorial da palavra **patrão** — quem **manda**, **emprega** ou é tratado como **chefe** / **dono**. Do latim *patronus* (protetor, patrocinador): a mesma raiz que alimenta o inglês [pattern](${pattern}) e o PT *padrão*. Esta ficha cobre o **objeto**, o eixo **patrão × respeito × poder**, o ofício de **trabalhar com hierarquia sem perder ofício**, e o fecho [Faça o melhor!](${mantra}).
...
| **Ofício** | Ordem no lab / na obra | [Faça o melhor!](${mantra}) sob qualquer hierarquia |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **com ou sem patrão a olhar**, hoje |
...
**Veredicto:** Faça o melhor **também sob hierarquia**. Patrão que inspira [respeito](${respeito}) ≠ patrão que exige culto ([ídolo](${idolo})).
...
**Aprovado** — **patrão** fichado: chefe/empregador, raiz *patronus*, rede com respeito/pattern e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Respeito](${respeito}) · [▶ Pattern](${pattern}) · [▶ Todas as inspeções](${hubAll}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **patrão** — Portuguese for **boss** / **employer** / **owner**, from Latin *patronus*. Same root as [pattern](${pattern}) and *padrão*. Links [respeito](${respeito}), [gesto](${gesto}), [Do your best!](${mantra}).
...
| Links | [respeito](${respeito}) · [pattern](${pattern}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — boss · *patronus* · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Respeito](${respeito}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **patrão** — jefe / empleador / dueño, del latín *patronus*. Misma raíz que [pattern](${pattern}) y *padrão*. Vínculos [respeito](${respeito}), [gesto](${gesto}), [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [respeito](${respeito}) · [pattern](${pattern}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobado** — jefe · *patronus* · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Respeito](${respeito}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildPatraoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «patrão» — chefe/empregador (lat. patronus); elos respeito, pattern, gesto; Faça o melhor!',
    excerptEn:
      'Words: “patrão” — boss/employer (Lat. patronus); links respeito, pattern, gesto; Do your best!',
    excerptEs:
      'Palabras: «patrão» — jefe/empleador (lat. patronus); vínculos respeito, pattern, gesto; ¡Haz lo mejor!',

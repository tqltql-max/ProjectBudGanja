...
> **Nota metodológica:** auditoria independente. Objecto = a **locução viva**. **Ficha ≠ terapia, ≠ corte de laços humanos como receta.** Par: [nó na vida!](${noVida}). Depois: **[ufa](${ufa})**. Fecho: [Faça o melhor!](${mantra}).
...
[▶ Expressões](${hub}) · [▶ Desatar](${desatar}) · [▶ Desastre](${desastre}) · [▶ Nó na vida!](${noVida}) · [▶ Ufa](${ufa}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Brazilian saying **“desatar o nó”** (untie the knot). Craft on the [corda](${corda}) and in [life](${vida}). Related to [desastre](${desastre}) by **method**, not etymon. After: [ufa](${ufa}). Close: [Do your best!](${mantra}).
...
[▶ Sayings](${hub}) · [▶ Untie](${desatar}) · [▶ Disaster](${desastre}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Dicho BR **«desatar o nó»**. Oficio en la [corda](${corda}) y en la [vida](${vida}). Relacionado con [desastre](${desastre}) por **método**, no por étimo. Después: [ufa](${ufa}). Cierre: [¡Haz lo mejor!](${mantra}).
...
[▶ Expresiones](${hub}) · [▶ Desatar](${desatar}) · [▶ Desastre](${desastre}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildDesatarONoPost(seriesOrder) {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «desatar o nó» — soltar o laço na corda e na vida; ≠ desastre (*astro*); par nó na vida; ufa depois; Faça o melhor!',
    excerptEn:
      'Sayings: “desatar o nó” — untie the knot on the rope and in life; ≠ disaster (*star*); pair nó na vida; phew after; Do your best!',
    excerptEs:
      'Dichos: «desatar o nó» — soltar el nudo en la cuerda y en la vida; ≠ desastre (*astro*); par nó na vida; ufa después; ¡Haz lo mejor!',

...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte *desta* marca *neste* ecrã, sem virar vitrine.
...
[▶ Inspeções](${hubLojas}) · [▶ ANVISA](${anvisa}) · [▶ risco](${risco}) · [▶ principiaskin.com](${SITE}) · [▶ Faça o melhor!](${mantra})
`;
...
Cosmetic ≠ medicine ([ANVISA](${anvisa})). “Dermatologically tested” ≠ drug approval. Concentrations on the label are the solid literacy point. Close with [Do your best!](${mantra}).
...
Cosmético ≠ medicamento ([ANVISA](${anvisa})). Cerrar con [¡Haz lo mejor!](${mantra}).

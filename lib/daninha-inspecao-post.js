 ...
 * planta / selvagem / cultivo · Faça o melhor!
 */
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **neste canteiro**, hoje |
...
**Veredicto:** Faça o melhor **com o juízo certo**. Daninha sem [planta](${planta}) = insulto; daninha com método = manejo que ainda respeita o vivo.
...
**H4:** fecho = [Faça o melhor!](${mantra}) — arrancar ou conviver com inspeção.
...
**Aprovado** — **daninha** fichada: *dano*+*-inha*, planta daninha como juízo de lugar, rede com planta/cultivo e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Planta](${planta}) · [▶ Cultivo](${cultivo}) · [▶ Selvagem](${selvagem}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **daninha** — chiefly in **planta daninha** (weed in the agronomic sense): a plant judged unwanted in a crop or garden. Covers **object** (*dano* + *-inha*), judgment vs biology, links to [planta](${planta}), [selvagem](${selvagem}), [cultivo](${cultivo}), and [Do your best!](${mantra}).
...
| Links | [planta](${planta}) · [cultivo](${cultivo}) · [selvagem](${selvagem}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · place-conflict · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Planta](${planta}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **daninha** — sobre todo en **planta daninha**: vegetal juzgado indeseado en un cultivo. Cubre **objeto** (*dano* + *-inha*), juicio × biología, vínculos con [planta](${planta}), [selvagem](${selvagem}), [cultivo](${cultivo}) y [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [planta](${planta}) · [cultivo](${cultivo}) · [selvagem](${selvagem}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · conflicto de lugar · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Planta](${planta}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildDaninhaPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «daninha» (*dano* + *-inha*) — planta daninha como juízo de lugar; elos planta, cultivo, selvagem; Faça o melhor!',
    excerptEn:
      'Words: “daninha” (*dano* + *-inha*) — weed as place-judgment; links planta, cultivo, selvagem; Do your best!',
    excerptEs:
      'Palabras: «daninha» (*dano* + *-inha*) — planta daninha como juicio de lugar; vínculos planta, cultivo, selvagem; ¡Haz lo mejor!',

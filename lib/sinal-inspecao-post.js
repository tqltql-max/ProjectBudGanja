 ...
 * elos gesto · risco · verdade · Faça o melhor!
...
Inspeção editorial da palavra **sinal** — marca, aviso, indício e mensagem que o mundo (ou o corpo) manda antes da decisão. Esta ficha cobre o **objeto** (lat. *signum*), os **sentidos** (marca · trânsito · linguagem corporal · «dar sinal» · aviso de [risco](${risco})), e o fecho [Faça o melhor!](${mantra}). Tom: Inspetor BudGanja — ler o sinal com método, não inventar o mapa. Elos: [gesto](${gesto}), [risco](${risco}), [verdade](${verdade}).
...
| **Fechar** | Depois de ler, agir | [Faça o melhor!](${mantra}) com o sinal à vista |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **com o sinal que há**, hoje |
...
**Veredicto:** Faça o melhor **com o sinal** — ler, nomear, agir. Sinal sem [verdade](${verdade}) = ruído; sinal com ofício = mapa curto para o próximo passo.
...
**H4:** fecho = [Faça o melhor!](${mantra}) lendo o sinal com método (não superstição).
...
| Links | [gesto](${gesto}) · [risco](${risco}) · [verdade](${verdade}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · senses · traffic/body/warning · links gesto/risco/verdade · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Gesto](${gesto}) · [▶ Risco](${risco}) · [▶ Verdade](${verdade}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **sinal** (señal / signo / marca) — marca, aviso, indicio y mensaje antes de la decisión. Cubre **objeto** (lat. *signum*), **sentidos** (marca · tráfico · cuerpo · «dar sinal» · alerta de [risco](${risco})), y [¡Haz lo mejor!](${mantra}). Entrada tipográfica «singlam» → lema canónico **sinal**. Vínculos: [gesto](${gesto}), [risco](${risco}), [verdade](${verdade}).
...
| Vínculos | [gesto](${gesto}) · [risco](${risco}) · [verdade](${verdade}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · sentidos · tráfico/cuerpo/aviso · vínculos gesto/risco/verdade · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Gesto](${gesto}) · [▶ Risco](${risco}) · [▶ Verdade](${verdade}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildSinalPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «sinal» (lat. *signum*) — marca, trânsito, corpo, aviso e «dar sinal»; tipografia singlam → sinal; elos gesto, risco, verdade; Faça o melhor!',
    excerptEn:
      'Words: “sinal” (Lat. *signum*) — mark, traffic, body, warning and “dar sinal”; typed singlam → sinal; links gesto, risco, verdade; Do your best!',
    excerptEs:
      'Palabras: «sinal» (lat. *signum*) — marca, tráfico, cuerpo, aviso y «dar sinal»; tipografía singlam → sinal; vínculos gesto, risco, verdade; ¡Haz lo mejor!',

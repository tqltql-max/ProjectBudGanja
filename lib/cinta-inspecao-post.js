 ...
 * cultivo × gesto · ≠ sinta · ≠ cinta ID (amor) · Faça o melhor!
 */
...
Inspeção editorial da palavra **cinta** — no português do Brasil, a **faixa** ou **banda** que **cinge**, **segura** ou **amarra**: cintura, correia, tira, e no ofício de cultivo a **cinta / fita** que tutora ou marca a [planta](${planta}) sem a estrangular. Esta ficha cobre o **objeto**, o eixo **suporte × cuidado**, a distinção **cinta ≠ sinta** e o falso amigo **cinta** (indonésio «amor»), e o fecho [Faça o melhor!](${mantra}).
...
| Elo projecto | [Equipamentos](${equipamentos}) · [Plantas](${plantas}) · [Guia](${guia}) · [hub](${hubAll}) · [Vida](${vida}) |
...
| **fita** | Tira fina (adesiva, de marcar) | Vizinha de ofício; no BR lab muitas vezes sinónimo prático de cinta de tutoramento |
...
| [Equipamentos](${equipamentos}) | Clonadoras e montagens — fitas/cintas no material |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor aperto **nesta haste**, hoje |
...
**Veredicto:** Faça o melhor **com a cinta certa**. Cinta sem [gesto](${gesto}) = estrangulamento; cinta com inspeção = suporte que respeita o vivo.
...
**H4:** fecho = [Faça o melhor!](${mantra}) — amarrar e revisitar.
...
**Aprovado** — **cinta** fichada: faixa que cinge, ofício de suporte no cultivo, distinções *sinta* / falso amigo ID, rede com gesto/planta e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Gesto](${gesto}) · [▶ Planta](${planta}) · [▶ Cultivo](${cultivo}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **cinta** — a **band / strap / belt** that girds or holds; in the lab, soft ties and tapes that stake or label a [planta](${planta}) without girdling it. Links [gesto](${gesto}), [cultivo](${cultivo}), [risco](${risco}), [Do your best!](${mantra}).
...
| Links | [gesto](${gesto}) · [planta](${planta}) · [cultivo](${cultivo}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · support craft · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Gesto](${gesto}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **cinta** — **banda / correa / tira** que ciñe o sujeta; en el lab, cintas que tutoran o marcan la [planta](${planta}) sin estrangularla. Vínculos [gesto](${gesto}), [cultivo](${cultivo}), [risco](${risco}), [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [gesto](${gesto}) · [planta](${planta}) · [cultivo](${cultivo}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · oficio de soporte · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Gesto](${gesto}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildCintaPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «cinta» (lat. *cincta* / *cingere*) — faixa que segura; tutoramento com gesto; ≠ sinta; Faça o melhor!',
    excerptEn:
      'Words: “cinta” (Lat. *cincta* / *cingere*) — band that holds; staking with craft; ≠ sinta; Do your best!',
    excerptEs:
      'Palabras: «cinta» (lat. *cincta* / *cingere*) — banda que sujeta; tutorado con oficio; ≠ sinta; ¡Haz lo mejor!',

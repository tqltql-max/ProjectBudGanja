...
const KNOWN_SERIES = {
  ...
  'pesquisa-molecula-ao-lixo': { series: SERIES_LAB, seriesLabel: 'Laboratório' },
  'pesquisa-insumos-organicos-vs-industrializados-fruto': {
    series: SERIES_LAB,
    seriesLabel: 'Laboratório'
  },
  'pesquisa-oficio-roubo-proibicao': {
    series: SERIES_LAB,
    seriesLabel: 'Laboratório'
  },
  'pesquisa-fitocanabinoides': {
    series: SERIES_LAB,
    seriesLabel: 'Laboratório'
  }
};

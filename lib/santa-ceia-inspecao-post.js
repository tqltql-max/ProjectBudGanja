...
| Elo Expressões | [filho de deus](${filho}) · [templo de Cristo, corpo e alma](${templo}) · [jesusamando](${jesusamando}) · [os doze apóstolos](${doze}) · [Faça o melhor!](${mantra}) |
...
**H7:** fecho = [Faça o melhor!](${mantra}) — olhar até o [gesto](${gesto}) falar, como Leonardo pediu ao ofício.
...
| Restauro | Cuidar o que resta — [Faça o melhor!](${mantra}) de conservação, não de invenção |
...
| [filho de deus](${filho}) · [templo…](${templo}) · [jesusamando](${jesusamando}) | Expressões — respeito à fé; sem púlpito nesta ficha |
...
| [Faça o melhor!](${mantra}) | Olhar até o gesto falar — o melhor *desta* parede *neste* ofício |
...
[▶ Artes](${hub}) · [▶ Leonardo da Vinci](${leonardo}) · [▶ A Paixão de Cristo (outra ficha)](${paixao}) · [▶ The Chosen](${chosen}) · [▶ os doze apóstolos](${doze}) · [▶ gesto](${gesto}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;
...
**H6:** close with [Do your best!](${mantra}) — look until the gesture speaks.
...
[▶ Leonardo](${leonardo}) · [▶ Passion (separate)](${paixao}) · [▶ Do your best!](${mantra})
`;
...
[▶ Leonardo](${leonardo}) · [▶ Pasión (otra)](${paixao}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildSantaCeiaPost() {
  ...
  return artePost({
    ...
    excerpt:
      'Artes · pintura: Santa Ceia / A Última Ceia (1495–1498, Leonardo) — Evangelhos primeiro; mural ≠ sacramento ≠ Código Da Vinci. Autor em Pessoas. Faça o melhor!',
    excerptEn:
      'Arts · painting: The Last Supper (1495–1498, Leonardo) — Gospels first; mural ≠ sacrament ≠ Da Vinci Code. Author in People. Do your best!',
    excerptEs:
      'Artes · pintura: La última cena (1495–1498, Leonardo) — Evangelios primero; mural ≠ sacramento ≠ Código Da Vinci. Autor en Personas. ¡Haz lo mejor!',

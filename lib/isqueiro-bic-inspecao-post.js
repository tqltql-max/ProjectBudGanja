...
| **Par** | Clipper | Irmã recarregável — ficha [Clipper](${clipper}) · não é a mesma casa |
...
**H4:** fichar ≠ promover fumo; fecho [Valeu !!!](${mantra}).
...
| [Clipper](${clipper}) | Irmã — Flamagas, recarregável; outro ofício de bolso |
...
**Isqueiro BIC = tool + brand.** If the mouth said *esqueiro biq*, open this sheet **and** [Moçambique](${mocambique}). Close with [Valeu !!!](${mantra}).

## Status

**Approved** — object sheet; slip and *tónos* labeled.

[▶ Words](${hub}) · [▶ Mozambique](${mocambique}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **isqueiro BIC** — el **encendedor** de bolsillo (lat. *esca* → *isca* + *-eiro*) y la marca **BIC** (1973). El lapsus **esqueiro biq** mezcla el encendedor con **Biq** (jeque detrás de [Moçambique](${mocambique})). **Tónos** aquí es la **tensión** del pulgar (EN 13869 ~**42 N**) y el **BI** tónico del nombre del país. Vínculos: [tônico](${tonico}), [fogo](${fogo}), [¡Valeu !!!](${mantra}).
...
**Isqueiro BIC = utensilio + marca.** Si la boca dijo *esqueiro biq*, abrir esta ficha **y** [Moçambique](${mocambique}). Cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — ficha de objeto; lapsus y *tónos* etiquetados.

[▶ Palabras](${hub}) · [▶ Mozambique](${mocambique}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildIsqueiroBicPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «isqueiro BIC» — isca+eiro; marca 1973; tónos = tensão (~42 N); lapso esqueiro biq ≠ Moçambique; Valeu !!!',
    excerptEn:
      'Words: “isqueiro BIC” — tinder+suffix; 1973 brand; tónos = tension (~42 N); slip esqueiro biq ≠ Mozambique; Valeu !!!',
    excerptEs:
      'Palabras: «isqueiro BIC» — isca+eiro; marca 1973; tónos = tensión (~42 N); lapsus esqueiro biq ≠ Mozambique; ¡Valeu !!!',

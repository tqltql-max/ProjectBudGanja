...
| Elo ofício | [verdade](${verdade}) · [skill](${skill}) · [commitar](${commitar}) · [simbiose](${simbiose}) · [Valeu !!!](${mantra}) |
...
**H5:** fecho = [Valeu !!!](${mantra}) — nome certo depois da pergunta certa.
...
| [Teoria das cordas](${teoriaCordas}) | Analogia: **mesma** corda, **vários** modos — **não** é o termo desta ficha |
...
| [Valeu !!!](${mantra}) | Fechar com o mapa certo |
...
[▶ Palavras](${hub}) · [▶ Etimologia](${etimologia}) · [▶ Trocadilho](${trocadilho}) · [▶ Aglutinação](${aglutinacao}) · [▶ Valeu !!!](${mantra})
`;
...
function buildPolimorfismoPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: polimorfismo (poly+morphē) — biologia, código, alomorfia; cara+alho não é isto, é trocadilho; irmã aglutinação; Valeu !!!',
    excerptEn:
      'Words: polymorphism (poly+morphē) — biology, code, allomorphy; cara+alho is not this, it is a pun; sister agglutination; Valeu !!!',
    excerptEs:
      'Palabras: polimorfismo (poly+morphē) — biología, código, alomorfia; cara+alho no es esto, es trocadilho; hermana aglutinación; ¡Valeu !!!',

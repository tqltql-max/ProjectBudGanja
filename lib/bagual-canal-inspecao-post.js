...
[Muito obrigado](${obrigado}) ao ofício no ecrã. Personagem de servidor, crédito ao streamer, sem pedestal. [Faça o melhor!](${mantra})
...
[▶ Live · Kick](${kickUrl}) · [▶ GTA RP · Bagual](${games}) · [▶ GTA RP](${gtarp}) · [▶ Hope Joy](${hopejoy}) · [▶ Canais](${hub}) · [▶ Faça o melhor!](${mantra})
`;

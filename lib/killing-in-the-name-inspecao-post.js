...
| Elo ofício | [Faça o melhor!](${mantra}) · [pesquisa ofício / roubo / proibição](${oficio}) |
...
| Recusa | [Faça o melhor!](${mantra}) — ofício sem matar no nome |
...
[▶ Clipe](${YT}) · [▶ O Início](${oInicio}) · [▶ Poema Vida](${vida}#poema=killing-in-the-name) · [▶ Raiva](${raiva}) · [▶ Proibição](${proibicao}) · [▶ Faça o melhor!](${mantra})
`;

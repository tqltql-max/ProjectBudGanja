...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte *desta* novela *deste* filme.
...
| «Get busy living or get busy dying» | Escolha de ofício — [Faça o melhor!](${mantra}) com o dia que resta |
...
| [Faça o melhor!](${mantra}) | O melhor desta adaptação creditada |
...
[▶ Artes](${hub}) · [▶ Stephen King](${AUTOR}) · [▶ esperança](${esperanca}) · [▶ caminho](${caminho}) · [▶ Alice](${alice}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;
...
[▶ Pessoas](${hub}) · [▶ o filme](${FILME}) · [▶ esperança](${esperanca}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;

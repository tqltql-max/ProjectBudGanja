 ...
 * chegou sem ser a intenção · ≠ Tamara / Maria / mar / Māra · Valeu !!!
 */
...
| **Fechar** | [Valeu !!!](${mantra}) — o melhor possível **hoje**, com o que chegou |
...
| [Valeu !!!](${mantra}) · [poema Vida](${poema}) | Fecho e verso |
...
**Aprovado** — **Mara** fichada: nome que chegou; cola em [maravilha](${maravilhoso}); poema dos [barquinhos de papel](${poema}); [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Poema](${poema}) · [▶ Barco](${barco}) · [▶ Mãe](${mae}) · [▶ Tamara](${tamara}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida}) · [▶ Hub](${hubAll})
`;
...
**Approved** — Mara filed; glued to [wonder](${maravilhoso}); paper boats; [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Poem](${poema}) · [▶ Valeu !!!](${mantra})
`;
...
**Aprobada** — Mara fichada; pega en [maravilla](${maravilhoso}); barquitos; [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Poema](${poema}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildMaraPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «Mara» — nome que chegou sem estar na lista; cola em maravilha; étimo hebr. mārāh é camada, não veredicto; poema dos barquinhos de papel; Valeu !!!',
    excerptEn:
      'Words: “Mara” — a name that arrived unplanned; glued to maravilha (wonder); Heb. mārāh is a layer, not a verdict; paper-boat poem; Valeu !!!',
    excerptEs:
      'Palabras: «Mara» — nombre que llegó sin lista; pega en maravilha; el hebr. mārāh es capa, no veredicto; poema de barquitos de papel; ¡Valeu !!!',

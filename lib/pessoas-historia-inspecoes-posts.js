...
## A letra — mapa na ficha da canção

Esta ficha **não** cola verso. A inspeção da letra de *Só os Loucos Sabem* (2009) vive na página dedicada da obra: [Só os Loucos Sabem](${loucos}) — o mesmo molde de Girassol (motivos, não citação). Aqui fica a **pessoa**.

| Motivo (resumo) | Em uma linha |
|-----------------|--------------|
| Recomeço / paz | Ofício de entrar de novo |
| Ânimo ao outro | [Gesto](${gesto}) dirigido — não propaganda |
| Nós / dias duros | O [medo](${medo}) não é glória |
| Título | Quem fica vê — tese da canção, não da banda |
...
| [Só os Loucos Sabem](${loucos}) | Artes — página dedicada da canção (letra por motivos) |
...
**Aprovado na série Pessoas** — Chorão documentado como letrista; elo principal com [Palavras](${palavras}) / [maconha](${maconha}); página dedicada da canção em [Só os Loucos Sabem](${loucos}); cinema em [*O Magnata*](${magnata}).
...
## The lyric — map on the song page

This sheet does **not** paste verses. The lyric of *Só os Loucos Sabem* (2009) is inspected on the dedicated work page: [Só os Loucos Sabem](${loucos}). Here stays the **person**.

## Status

**Approved in the People series** — primary link to Words / maconha; dedicated song page [Só os Loucos Sabem](${loucos}); film on [*O Magnata*](${magnata}).

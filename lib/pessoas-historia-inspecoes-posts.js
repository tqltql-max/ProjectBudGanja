...
**Aprovado na série Pessoas** — Chorão documentado como letrista; elo principal com [Palavras](${palavras}) / [maconha](${maconha}); frases de luta anotadas em [Só os Loucos Sabem](${loucos}).

[▶ Pessoas](${hub}) · [▶ Palavras](${palavras}) · [▶ Só os Loucos Sabem](${loucos}) · [Wikipédia](${wiki})
`;
...
**Approved in the People series** — primary link to Words / maconha; struggle phrases annotated on [Só os Loucos Sabem](${loucos}).

[▶ People](${hub}) · [▶ Words](${palavras}) · [▶ Só os Loucos Sabem](${loucos}) · [Wikipedia](${wiki})
`;
...
**Aprobado en la serie Personas** — enlace principal con Palabras / maconha; frases de lucha en [Só os Loucos Sabem](${loucos}).

[▶ Personas](${hub}) · [▶ Palabras](${palavras}) · [▶ Só os Loucos Sabem](${loucos}) · [Wikipedia](${wiki})
`;
...
**H1:** o valor BudGanja de Gaarder é um **método de iniciação**: metaficção e olhar infantil/juvenil para fazer o leitor **perguntar**.  
...
- Nascido em Oslo (1952); pais ligados à escola e à literatura infantil (contexto wiki).  
...
[▶ Pessoas](${hub}) · [▶ A História das Coisas](${historia}) · [Wikipedia](${wiki})
`;

...
[Muito obrigado](${obrigado}) — [total](${total}) a ele. No laboratório, Aleff é **herói de ofício**, não ídolo de pedestal. O engenheiro-arquiteto lê a cidade nos [cadernos](${cadernosEng}); ele joga a sessão. Crédito à pessoa. [Faça o melhor!](${mantra})
...
[▶ Pessoas](${hub}) · [▶ respeito](${respeito}) · [▶ caminho](${caminho}) · [▶ ídolo](${idolo}) · [▶ Faça o melhor!](${mantra}) · [▶ Canal](${canal}) · [▶ Games (arquivo)](${games}) · [Wikipedia](${wiki})
`;

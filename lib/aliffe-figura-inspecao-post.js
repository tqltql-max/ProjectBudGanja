...
function buildAliffeBodies() {
  ...
  const canal = '/posts/post-inspecao-canal-paulinho.html';
...
| Elo mantra | [Valeu !!!](${mantra}) |
| Contraste | [Zangado](${zangado}) — crítica · [canal Paulinho](${canal}) — arquivo · Aleff — **pessoa** |
| Arquivo (secundário) | [Games](${games}) · [inspeção do canal](${canal}) — crédito do trabalho; não substituem esta ficha |
...
[Gratidão](${obrigado}) — [total](${total}) a ele. No laboratório, Aleff é **herói de ofício**, não ídolo de pedestal. O engenheiro-arquiteto lê a cidade nos [cadernos](${cadernosEng}); ele joga a sessão. Crédito à pessoa. [Valeu !!!](${mantra})
...
**H5:** fecho = [respeito](${respeito}) + [Valeu !!!](${mantra}) — o melhor recorte possível *desta* pessoa *nesta* ficha.
...
| «A inspeção é o catálogo» | O catálogo está em [Games](${games}) e na [ficha do canal](${canal}). Aqui está a **pessoa** |
| «É o par do Zangado» | Zangado tem ficha de [crítica](${zangado}). Paulinho tem ficha de [canal RP](${canal}). Aleff tem ficha de **Pessoas**. Complementares, não simétricos |
...
| [Valeu !!!](${mantra}) | O melhor recorte *desta* pessoa *hoje* |
| Hub [Palavras](${palavras}) | Léxico que protege a gente |

> Abrir primeiro esta ficha se o interesse for o **Aleff**. Abrir [Games](${games}) / [canal](${canal}) se o interesse for o **arquivo**. Abrir [Zangado](${zangado}) se o interesse for a **crítica de jogo**. Não trocar uma pela outra.
...
- [Games](${games}) e a [inspeção do canal](${canal}) guardam o arquivo; o cartão da pessoa aponta para cá.  
...
[▶ Pessoas](${hub}) · [▶ respeito](${respeito}) · [▶ caminho](${caminho}) · [▶ ídolo](${idolo}) · [▶ Valeu !!!](${mantra}) · [▶ Canal](${canal}) · [▶ Games (arquivo)](${games}) · [Wikipedia](${wiki})
`;
...
> **Method note:** independent audit from [Wikipedia · Paulinho o Loko](${wiki}) and public reports. Civil spelling **Aliffe**; lab spelling **Aleff**. No affiliation. Distinct from cannabis [Legacy](${legado}), from the [Paulinho channel](${canal}) sheet, and from the [Zangado channel](${zangado}) sheet. **Game fiction is not a crime manual.** No invented private life.
...
| Contrast | [Zangado](${zangado}) = critique · [Paulinho channel](${canal}) = archive · Aleff = **person** |
| Archive (secondary) | [Games](${games}) · [channel sheet](${canal}) |
...
[▶ People](${hub}) · [▶ respect](${respeito}) · [▶ Channel](${canal}) · [▶ Games (archive)](${games})
`;
...
> **Nota metodológica:** auditoría independiente a partir de [Wikipedia · Paulinho o Loko](${wiki}). Grafía civil **Aliffe**; grafía del lab **Aleff**. Sin afiliación. Distinto del [Legado](${legado}) cannábico, de la ficha del [canal Paulinho](${canal}) y de la ficha del [canal Zangado](${zangado}). **Ficción de juego ≠ manual de crimen.** No se inventa vida privada.
...
| Contraste | [Zangado](${zangado}) = crítica · [canal Paulinho](${canal}) = archivo · Aleff = **persona** |
| Archivo (secundario) | [Games](${games}) · [ficha del canal](${canal}) |
...
[▶ Personas](${hub}) · [▶ respeto](${respeito}) · [▶ Canal](${canal}) · [▶ Games (archivo)](${games})
`;

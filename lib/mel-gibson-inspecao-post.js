...
**H5:** fecho = [respeito](${respeito}) + [Valeu !!!](${mantra}) — o melhor recorte *desta* pessoa *neste* ofício.
...
[▶ Pessoas](${hub}) · [▶ Coração Valente](${VALENTE}) · [▶ A Paixão de Cristo](${PAIXAO}) · [▶ respeito](${respeito}) · [▶ Valeu !!!](${mantra}) · [Wikipedia](${wiki})
`;

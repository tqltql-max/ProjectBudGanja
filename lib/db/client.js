  ...
  const incremental = [
    ...
    },
    {
      ...
      statements: [
        ...
        `INSERT OR IGNORE INTO post_series (id, label, category, sort_order, created_at) VALUES ('verificacao-equipamento', 'Verifica\u00e7\u00e3o de Equipamentos', 'inspecao', 3, '${new Date().toISOString()}')`
      ]    }
  ];

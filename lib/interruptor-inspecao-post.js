...
[▶ Palavras](${hub}) · [▶ Ligar × Desligar](${ligarDesligar}) · [▶ Luz](${luz}) · [▶ Sinal](${sinal}) · [▶ Gesto](${gesto}) · [▶ Eletrizante](${eletrizante}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
[▶ Words](${hub}) · [▶ Ligar × Desligar](${ligarDesligar}) · [▶ Luz](${luz}) · [▶ Sinal](${sinal}) · [▶ Gesto](${gesto}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Ligar × Desligar](${ligarDesligar}) · [▶ Luz](${luz}) · [▶ Sinal](${sinal}) · [▶ Gesto](${gesto}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildInterruptorPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «interruptor» (lat. *interrumpere*) — peça do circuito; tríade com ligar × desligar e luz; Faça o melhor!',
    excerptEn:
      'Words: “interruptor” (Lat. *interrumpere*) — circuit device; triad with ligar × desligar and luz; Do your best!',
    excerptEs:
      'Palabras: «interruptor» (lat. *interrumpere*) — pieza del circuito; tríada con ligar × desligar y luz; ¡Haz lo mejor!',

...
| Centro | Fundador / diretor científico do **CEBRID** (Centro Brasileiro de Informações sobre Drogas Psicotrópicas) |
...
- **H2:** CEBRID + levantamentos nacionais + presença em OMS/INCB/ANVISA mostram um cientista que ligou bancada, política pública e redução de danos.
- **H3:** o legado sobrevive na UNIFESP (orientação, Diadema/ICAQF, curso de extensão) e na curadoria científica do CANABinALL.
...
| 1997 → | Consolida o **CEBRID** na UNIFESP — informação e levantamentos sobre álcool e outras drogas para políticas públicas. |
...
2. **Instituições que ficaram** — Psicobiologia na EPM/UNIFESP, CEBRID, contribuições à vigilância sanitária e à formação de gerações de pesquisadores. O mérito não é só um paper: é infraestrutura de conhecimento.
...
5. **Ética da continuidade** — CANABinALL, curso SIEX e arquivo MovReCam prolongam o seu nome. Inspecionar esses projectos sem nomear Carlini seria incompleto.
...
| Center | Founder / scientific director of **CEBRID** (Brazilian Center of Information on Psychotropic Drugs) |
...
- **H2:** CEBRID + national surveys + WHO/INCB/ANVISA roles show a scientist who linked bench, public policy, and harm reduction.
- **H3:** The legacy lives on at UNIFESP (supervision, Diadema/ICAQF, extension course) and in CANABinALL’s scientific curation.
...
| 1997 → | Consolidates **CEBRID** at UNIFESP — information and surveys on alcohol and other drugs for public policy. |
...
2. **Institutions that remain** — Psychobiology at EPM/UNIFESP, CEBRID, sanitary-surveillance contributions, and generations of researchers. The merit is not one paper: it is knowledge infrastructure.
...
5. **Ethics of continuity** — CANABinALL, the SIEX course, and the MovReCam archive carry his name forward. Inspecting those projects without naming Carlini would be incomplete.
...
| Centro | Fundador / director científico del **CEBRID** (Centro Brasileño de Informaciones sobre Drogas Psicotrópicas) |
...
- **H2:** CEBRID + encuestas nacionales + presencia en OMS/INCB/ANVISA muestran a un científico que unió laboratorio, política pública y reducción de daños.
- **H3:** el legado sobrevive en la UNIFESP (orientaciones, Diadema/ICAQF, curso de extensión) y en la curaduría científica del CANABinALL.
...
| 1997 → | Consolida el **CEBRID** en la UNIFESP — información y encuestas sobre alcohol y otras drogas para políticas públicas. |
...
2. **Instituciones que permanecen** — Psicobiología en EPM/UNIFESP, CEBRID, aportes a la vigilancia sanitaria y formación de generaciones de investigadores. El mérito no es un paper: es infraestructura de conocimiento.
...
5. **Ética de la continuidad** — CANABinALL, el curso SIEX y el archivo MovReCam prolongan su nombre. Inspeccionar esos proyectos sin nombrar a Carlini sería incompleto.
...
**Aprobado con mérito máximo como referencia de legado científico** — Elisaldo Carlini es piedra angular de la historia que une farmacología, universidad pública y regulación responsable del cannabis medicinal en Brasil. Quien estudia por el [curso UNIFESP](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html) o por [CANABinALL](/posts/post-inspecao-canal-canabinall.html) estudia, en última instancia, el fruto de su trabajo. Descanse en paz — y que el crédito siga siendo público.

[Curso UNIFESP](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html) · [Padre Ticão](/posts/post-inspecao-padre-ticao.html) · [CANABinALL](/posts/post-inspecao-canal-canabinall.html) · [MovReCam](/posts/post-inspecao-canal-movrecam.html) · [Todas las inspecciones](/biblioteca/inspecoes/)`;
...
const PESSOAS_INSPECOES_POSTS = [buildPadreTicaoInspecaoPost(), buildElisaldoCarliniInspecaoPost()];

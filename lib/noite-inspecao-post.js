 ...
 * interruptor · inverno · Faça o melhor!
 */
...
| [Faça o melhor!](${mantra}) · [poema](${poemMantra}) | Melhor noite **hoje** — inclusive a que se respeita sem luz |

## 6. Faça o melhor!

| Campo | Valor |
|-------|-------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **hoje**, inclusive a noite (descanso, escuro, pausa) |
| Veredicto | Noite sem [verdade](${verdade}) = buraco; noite com ofício = ciclo no [caminho](${caminho}). |

**H4:** fecho = [Faça o melhor!](${mantra}) — honrar a noite sem romantizar nem apagar o mapa.

## Estado

**Aprovado** — **noite** fichada como fase do ciclo; par com [sol](${sol}); elos [luz](${luz}), circuito e [cultivo](${cultivo}); [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Sol](${sol}) · [▶ Luz](${luz}) · [▶ Interruptor](${interruptor}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
[▶ Words](${hub}) · [▶ Sol](${sol}) · [▶ Luz](${luz}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Sol](${sol}) · [▶ Luz](${luz}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildNoitePost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «noite» (lat. *nox*) — fase escura do ciclo; par com sol; elos luz e interruptor; cultivo; Faça o melhor!',
    excerptEn:
      'Words: “noite” (Lat. *nox*) — dark phase of the cycle; pair with sol; links luz and interruptor; grow; Do your best!',
    excerptEs:
      'Palabras: «noite» (lat. *nox*) — fase oscura del ciclo; par con sol; vínculos luz e interruptor; cultivo; ¡Haz lo mejor!',

...
| Elo Palavras | [nó](${no}) · [etimologia](${etimologia}) · [coração](${coracao}) · [gesto](${gesto}) · [caminho](${caminho}) · [língua portuguesa](${lingua}) · [Faça o melhor!](${mantra}) |
| Trailer | [YouTube](${yt}) |
...
[▶ Artes](${hub}) · [▶ Peça](${peca}) · [▶ Luhrmann](${luhrmann}) · [▶ DiCaprio](${dicaprio}) · [▶ Filmografia](${filo}) · [▶ Shakespeare](${shake}) · [▶ Trailer](${yt}) · [▶ Faça o melhor!](${mantra})
`;
...
[▶ Play](${peca}) · [▶ Shakespeare](${shake}) · [▶ Do your best!](${mantra})
`;
...
[▶ Pieza](${peca}) · [▶ Shakespeare](${shake}) · [▶ ¡Haz lo mejor!](${mantra})
`;

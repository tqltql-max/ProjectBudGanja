...
| [gesto](${gesto}) · [caminho](${caminho}) · [Valeu !!!](${mantra}) | Olhar e ficar sem transformar em peça |
...
[▶ Spotify](${SPOTIFY}) · [▶ Clipe](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=the-killing-jar) · [▶ Inseto](${inseto}) · [▶ Killing in the Name](${killing}) · [▶ Valeu !!!](${mantra})
`;

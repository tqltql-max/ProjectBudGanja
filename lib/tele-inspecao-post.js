...
| Não é | **tela** (lat. *tēla* «pano / tecido» → ecrã) · Telê (alcunha) · til · telex (sistema) |
...
|-------|------------------|-------------|
| **tele** | A [tela](${WIKT_TELA}); o ecrã | Prefixo *longe* **ou** recorte de televisão |
| **tela** | A tele | Lat. *tēla* — pano, teia, depois ecrã / cinema |
...
**H3:** [tela](${WIKT_TELA}) e **tele** colam na orelha; os étimos **não** se tocam (*tēla* ≠ *têle*).  
...
**H3:** *tela* and *tele* rhyme in the ear; *tēla* ≠ *têle*.  

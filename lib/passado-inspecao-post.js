...
| Elo ofício | [gesto](${gesto}) · [Faça o melhor!](${mantra}) · [Vida](${vida}) |
...
**Veredicto contraste:** o futuro **não apaga** o passado — e o passado **não manda** sozinho no presente. No BudGanja, inspeciona-se o rasto ([memorável](${memoravel}), [diário](${diario}), ficha) e segue-se o [caminho](${caminho}) com [Faça o melhor!](${mantra}).
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor **hoje** escreve o passado de **amanhã** |
...
**Veredicto:** Faça o melhor **agora** — o passado inspecionado vira rasto; o passado ignorado vira ruído.
...
**Aprovado** — **passado** fichado como filho de [passar](${passar}): tempo decorrido, arquivo e particípio; eixo **história × memória** com [memorável](${memoravel}), [verdade](${verdade}) e [língua portuguesa](${lingua}); futuro e presente não apagam o rasto — inspecionam-no; Faça o melhor **hoje**.

[▶ Palavras](${hub}) · [▶ Passar](${passar}) · [▶ Memorável](${memoravel}) · [▶ Verdade](${verdade}) · [▶ Língua portuguesa](${lingua}) · [▶ Heródoto](${herodoto}) · [▶ Já](${ja}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
The future does **not erase** the past — and the past does **not rule** the present alone. Inspect the trace; walk the path with [Do your best!](${mantra}).
...
**Approved** — child of [passar](${passar}); history × memory with [memorável](${memoravel}) / [verdade](${verdade}) / [língua](${lingua}); Do your best **today**.

[▶ Words](${hub}) · [▶ Passar](${passar}) · [▶ Memorável](${memoravel}) · [▶ Truth](${verdade}) · [▶ Do your best!](${mantra})
`;
...
El futuro **no borra** el pasado — y el pasado **no manda** solo en el presente. Inspeccionar el rastro; caminar con [¡Haz lo mejor!](${mantra}).
...
**Aprobada** — hija de [passar](${passar}); historia × memoria con [memorável](${memoravel}) / [verdade](${verdade}) / [língua](${lingua}); Haz lo mejor **hoy**.

[▶ Palabras](${hub}) · [▶ Passar](${passar}) · [▶ Memorável](${memoravel}) · [▶ Verdad](${verdade}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildPassadoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «passado» (de passar / lat. passāre) — tempo já decorrido; memória × história; ≠ futuro; elos memorável, verdade, língua; Faça o melhor!',
    excerptEn:
      'Words: “passado” (from passar / Lat. passāre) — elapsed time; memory × history; ≠ future; links to memorável, truth, language; Do your best!',
    excerptEs:
      'Palabras: «passado» (de passar / lat. passāre) — tiempo trascurrido; memoria × historia; ≠ futuro; vínculos memorável, verdad, lengua; ¡Haz lo mejor!',

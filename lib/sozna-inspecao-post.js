 ...
 * ≠ solitário · medo · caminho · Vida · Faça o melhor!
 */
...
| [Faça o melhor!](${mantra}) · [poema](${poemMantra}) | O melhor **hoje** — inclusive pedir ajuda |

## 6. Faça o melhor!

| Campo | Valor |
|-------|-------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **hoje**, inclusive *sozinho* / *sozna* (um clique, um mapa, um «não sei») |
| Veredicto | Sozinho sem [verdade](${verdade}) = buraco; sozinho com ofício = [caminho](${caminho}) com uma pessoa só, sem vergonha. |

**H4:** fecho = [Faça o melhor!](${mantra}) — honrar o só sem romantizar nem abandonar quem escreveu *sozna*.

## Estado

**Aprovado** — **sozinho** fichado; **sozinha** como par; **sozna** como forma oral; irmã de [solitário](${solitario}); [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Solitário](${solitario}) · [▶ Medo](${medo}) · [▶ Caminho](${caminho}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
[▶ Words](${hub}) · [▶ Solitário](${solitario}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Solitário](${solitario}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildSoznaPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: **sozinho** (lat. *sōlus* + *-zinho*) — par **sozinha**; forma oral **sozna**; ≠ solitário; Faça o melhor!',
    excerptEn:
      'Words: **sozinho** (Lat. *sōlus* + *-zinho*) — pair **sozinha**; oral **sozna**; ≠ solitário; Do your best!',
    excerptEs:
      'Palabras: **sozinho** (lat. *sōlus* + *-zinho*) — par **sozinha**; oral **sozna**; ≠ solitário; ¡Haz lo mejor!',

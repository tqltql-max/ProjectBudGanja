const CATEGORIES = {
  pesquisa: { label: 'Pesquisas', listPage: 'pesquisas.html' },
  equipamento: { label: 'Equipamentos', listPage: 'equipamentos.html' },
  inspecao: { label: 'Inspeções', listPage: 'inspecoes.html' }
};

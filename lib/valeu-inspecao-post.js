...
| Par gratidão | [muitoobrigado](${muito}) · [gesto](${gesto}) · [respeito](${respeito}) |
...
**Aprovado** — **valeu** fichado: objeto (*valēre*), gratidão leve BR, rede com [muitoobrigado](${muito}) e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ muitoobrigado](${muito}) · [▶ Gesto](${gesto}) · [▶ Prosseguir](${prosseguir}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
**Approved** — object · light BR thanks · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ muitoobrigado](${muito}) · [▶ Do your best!](${mantra})
`;
...
**Aprobada** — objeto · gratitud BR ligera · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ muitoobrigado](${muito}) · [▶ ¡Haz lo mejor!](${mantra})
`;

 ...
 * palavra incluída: Boa!!! · derivação: Partiu!!! · Gratidão · gesto · Valeu !!!
 */
...
function buildValeuBodies() {
  ...
  const partiu = '/posts/post-inspecao-expressao-partiu.html';
...
| Família | *valer* · *vale* · *valia* · *valor* · *válido* · *valeu mesmo* · *valeu aí* · **Boa!!!** · **Partiu!!!** |
| Palavra incluída | **[Boa!!!](${boa})** — aprovação quente; mesma sala de fecho, raiz *bonus* ≠ *valēre* |
| Derivação | **[Partiu!!!](${partiu})** — mesmo molde (pretérito 3.ª + !!!); eixo saída / convite (*partir*, não *valer*) |
...
| **[Partiu!!!](${partiu})** | Saída / convite | **Derivação** do molde — pretérito de *partir* + !!!; não apaga Valeu !!! |
...
**H5:** **[Partiu!!!](${partiu})** é **derivação** do mesmo molde — *partir* → *partiu* + !!! — eixo porta, não obrigado.
...
| [Partiu!!!](${partiu}) | Derivação — saída / convite; mesma pontuação; raiz *partir* |
...
| Derivação | **[Partiu!!!](${partiu})** — «vamos / saí»; molde irmão, não troca da mãe |
...
**H5:** derivação = [Partiu!!!](${partiu}) — porta, não gratidão.
...
- **[Partiu!!!](${partiu})** não apaga Valeu !!! — deriva o molde para a porta.  
- Ficha de oralidade, não de etiqueta corporativa.

## Status

**Aprovado** — **valeu** fichado: objeto (*valēre*), palavra incluída **[Boa!!!](${boa})**, derivação **[Partiu!!!](${partiu})**, gratidão leve BR, rede com [Gratidão](${gratidao}) e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Boa!!!](${boa}) · [▶ Partiu!!!](${partiu}) · [▶ Valeu !!!](${faca}) · [▶ Gratidão](${gratidao}) · [▶ Gesto](${gesto}) · [▶ Prosseguir](${prosseguir}) · [▶ eu amo a vida](/posts/post-inspecao-expressao-eu-amo-a-vida.html) · [▶ Vida](${vida})
`;
...
| Links | [Boa!!!](${boa}) · [Partiu!!!](${partiu}) · [Gratidão](${muito}) · [gesto](${gesto}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
[▶ Words](${hub}) · [▶ Boa!!!](${boa}) · [▶ Partiu!!!](${partiu}) · [▶ Gratidão](${gratidao}) · [▶ Valeu !!!](${mantra})
`;
...
| Derivación | **[Partiu!!!](${partiu})** — vamos / me fui; mismo molde, no un recambio |
| Vínculos | [Boa!!!](${boa}) · [Partiu!!!](${partiu}) · [Gratidão](${muito}) · [gesto](${gesto}) · [¡Valeu !!!](${mantra}) |

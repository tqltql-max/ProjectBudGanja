...
Inspeção editorial da palavra **[lemniscata](${self})** — a **curva em forma de fita** (oito / ∞). Pedido de campo depois de [elo de ligação](${eloLigacao}): o **nome** da figura. O vocábulo não é o símbolo do infinito nem o conceito de eternidade. É a **peça gráfica e geométrica**. As duas posturas — [em pé e deitado](${emPe}) — ficam na expressão.
...
| Ficha | Relação |
|-------|---------|
| [Em pé e deitado](${emPe}) | As **duas posturas** da mesma figura (*bodiado* → deitado) |
...
**H3:** posturas = [em pé e deitado](${emPe}); cruzamento = [elo de ligação](${eloLigacao}).  
...
**Aprovado** — **lemniscata** fichada como nome da curva-fita; distinta do conceito de infinito; OCR endereçado; posturas na expressão [em pé e deitado](${emPe}).

[▶ Palavras](${hub}) · [▶ Em pé e deitado](${emPe}) · [▶ Elo de ligação](${eloLigacao}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Portuguese **[lemniscata](${self})** — the **ribbon-shaped curve** (figure-eight / ∞ look). Not eternity. Postures: [em pé e deitado](${emPe}). Crossing: [elo de ligação](${eloLigacao}). Close: [Valeu !!!](${mantra}).
...
[▶ Words](${hub}) · [▶ Standing and lying](${emPe}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

**[lemniscata](${self})** — la **curva en forma de cinta** (ocho / ∞). No es eternidad. Posturas: [em pé e deitado](${emPe}). Cruce: [elo de ligação](${eloLigacao}). Cierre: [¡Valeu !!!](${mantra}).
...
[▶ Palabras](${hub}) · [▶ De pie y acostada](${emPe}) · [▶ ¡Valeu !!!](${mantra})
`;

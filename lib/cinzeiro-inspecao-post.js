...
Inspeção editorial da palavra **cinzeiro** — no português do Brasil, sobretudo o **recipiente** onde se deita a **cinza** (e restolhos) do [fogo](${fogo}) de cigarro / combustão, e, em sentido mais antigo ou literário, o **monte de cinzas**. Pedido oral/escrito «Cinzerio» → forma canónica **cinzeiro**. Esta ficha cobre o **objeto** (*cinza* + *-eiro*), o eixo **cinza × fogo × gesto**, a distinção **cinzeiro ≠ cinzento**, e o fecho [Faça o melhor!](${mantra}).
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **com este resto de fogo**, hoje |
...
**Veredicto:** Faça o melhor **no fim do fogo**. Cinzeiro sem [gesto](${gesto}) = bagunça; cinzeiro com inspeção = contenção que respeita o espaço e o vivo ao lado.
...
**H4:** fecho = [Faça o melhor!](${mantra}) — apagar e conter.
...
**Aprovado** — **cinzeiro** fichado: *cinza*+*-eiro*, recipiente/monte da cinza, rede com fogo/gesto e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Fogo](${fogo}) · [▶ Gesto](${gesto}) · [▶ Risco](${risco}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **cinzeiro** (requested spelling “Cinzerio” → canonical **cinzeiro**) — chiefly the **ashtray** (*cinza* + *-eiro*), also an ash heap. Links [fogo](${fogo}), [gesto](${gesto}), [risco](${risco}), [Do your best!](${mantra}).
...
| Links | [fogo](${fogo}) · [gesto](${gesto}) · [risco](${risco}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · containment · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Fogo](${fogo}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **cinzeiro** (pedido «Cinzerio» → forma canónica **cinzeiro**) — sobre todo el **cenicero** (*cinza* + *-eiro*), también montón de ceniza. Vínculos [fogo](${fogo}), [gesto](${gesto}), [risco](${risco}), [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [fogo](${fogo}) · [gesto](${gesto}) · [risco](${risco}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobado** — objeto · contención · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Fogo](${fogo}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildCinzeiroPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «cinzeiro» (*cinza* + *-eiro*) — recipiente/monte da cinza; elos fogo, gesto, risco; Faça o melhor!',
    excerptEn:
      'Words: “cinzeiro” (*cinza* + *-eiro*) — ashtray / ash heap; links fogo, gesto, risco; Do your best!',
    excerptEs:
      'Palabras: «cinzeiro» (*cinza* + *-eiro*) — cenicero / montón de ceniza; vínculos fogo, gesto, risco; ¡Haz lo mejor!',

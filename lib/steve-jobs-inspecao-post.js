...
Fecho: [Faça o melhor!](${mantra}) **nesta** casa, **hoje** — com [verdade](${verdade}) do que se sabe, sem número inventado.
...
| [Faça o melhor!](${mantra}) · [Vida](${vida}) | Fecho sem culto |
...
**Aprovado em Pessoas** — Steve Jobs fichado; afirmação «celular aos 18» **reprovada como citação**, **aprovada como meme a inspecionar**; facto: limite em casa / iPad (2010) / mesa sem ecrã (Isaacson). Elo [Jobs](${palavra}) · [celular](${celular}) · [Faça o melhor!](${mantra}).
...
Presence at dinner; the product captures attention by design; home ≠ keynote. Not a published manifesto “ban until 18.” See [phone & children](${celular}). Close with [Do your best!](${mantra}) — with the [truth](${verdade}) of what was said, without an invented age.
...
Presencia en la mesa; el producto captura atención; casa ≠ escenario. No hay manifiesto «prohibido hasta los 18». Ver [celular e niños](${celular}). Cerrar con [¡Haz lo mejor!](${mantra}).

 ...
 * repetição reconhecível · Faça o melhor!
 */
...
Inspeção editorial da palavra **pattern** — loanword do inglês para **molde**, **padrão** ou **modelo que se repete**. No português do Brasil entra forte em design, costura, comportamento e código (*design pattern*). Esta ficha cobre o **objeto**, o eixo **pattern × padrão**, o ofício de **reconhecer estrutura sem congelar o pensamento**, e o fecho [Faça o melhor!](${mantra}).
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **com o molde certo para este caso**, hoje |
| Poema | [poema Vida](${poemMantra}) |
| Anti-armadilha | «É o pattern» ≠ argumento fechado · «serve *aqui*?» = ofício |
| Par vivo | [gesto](${gesto}) · [caminho](${caminho}) · [verdade](${verdade}) |

**Veredicto:** Faça o melhor **também ao escolher o molde**. Pattern sem olhar = cópia; pattern com [verdade](${verdade}) = aceleração.
...
**Aprovado** — **pattern** fichado: molde EN, repetição reconhecível, rede com gesto/caminho e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Gesto](${gesto}) · [▶ Caminho](${caminho}) · [▶ Todas as inspeções](${hubAll}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **pattern** as used in Brazilian Portuguese — English loanword for a **mold**, **template**, or **recognizable repetition** (incl. *design pattern*). Links [gesto](${gesto}), [caminho](${caminho}), [Do your best!](${mantra}).
...
| Links | [gesto](${gesto}) · [caminho](${caminho}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — mold · repetition · [Do your best!](${mantra}).
...
Inspección de **pattern** en uso BR — préstamo del inglés para **molde**, **plantilla** o **repetición reconocible** (incl. *design pattern*). Vínculos [gesto](${gesto}), [caminho](${caminho}), [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [gesto](${gesto}) · [caminho](${caminho}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobado** — molde · repetición · [¡Haz lo mejor!](${mantra}).
...
function buildPatternPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «pattern» (EN) — molde / padrão / design pattern no BR; elos gesto, caminho, risco; Faça o melhor!',
    excerptEn:
      'Words: “pattern” (EN) — mold / template / design pattern in BR use; links gesto, caminho, risco; Do your best!',
    excerptEs:
      'Palabras: «pattern» (EN) — molde / plantilla / design pattern en uso BR; vínculos gesto, caminho, risco; ¡Haz lo mejor!',

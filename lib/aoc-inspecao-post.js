...
**H5b:** AOC tem **[três](${tres}) letras** porque são **três palavras** (*Admiral Overseas Corporation*), não porque o **90** do [AO90](${ao90}) «vire 3» por fórmula.  
...
| **90 → [3](${tres})** | O número colapsa nas três letras | Três letras = três palavras EN; o 90 **não entra** nessa conta |

...
[Gratidão](${obrigado}) — [total](${total}) a ele. No laboratório, [Aleff](${pessoa}) é **herói de ofício** (persistência, humor, cidade no ecrã), não [ídolo](${idolo}) de pedestal. O engenheiro-arquiteto lê a cidade nos [cadernos](${cadernosEng}); ele joga a sessão. Crédito à pessoa. [Valeu !!!](${mantra})
...
[▶ Live · Kick](${kickUrl}) · [▶ Games · Paulinho](${games}) · [▶ Vídeos](${videosHub}) · [▶ GTA 6](${gta6}) · [▶ Canais](${hub}) · [▶ Valeu !!!](${mantra})
`;
...
Full thanks to him. In the lab, [Aleff](${pessoa}) is a **hero of the craft**, not an [idol](${idolo}) on a pedestal. The engineer-architect reads the city in the [notebooks](${cadernosEng}); he plays the session. [Valeu !!!](${mantra})
...
Agradecimiento total a él. En el laboratorio, [Aleff](${pessoa}) es **héroe de oficio**, no [ídolo](${idolo}) de pedestal. El ingeniero-arquitecto lee la ciudad en los [cuadernos](${cadernosEng}); él juega la sesión. [¡Valeu !!!](${mantra})

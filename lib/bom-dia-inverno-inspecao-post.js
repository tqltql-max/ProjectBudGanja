...
const EDITORA =
  'https://www.companhiadasletras.com.br/livro/9788535944679/bom-dia-inverno';
const INVERNO_HUB = '/inverno/';

/** Lote temático — Guia de Palavras (universo Bom dia, Inverno / Tamara) → fichas de palavra. */
const GUIA_TAMARA_INVERNO_ITEMS = guiaItemsFromTamaraInvernoPalavras();
...
A fotografia oficial **não** é retrato de estúdio. É **aérea**: Tamara no fato amarelo, o [barco](${BARCO}) preso no [gelo](${GELO}), o chute da perna direita a cumprimentar o [inverno](${INVERNO}). Na **[mão esquerda](${MAO})** segura o comando do drone — a câmara está no céu porque ela a mandou para o céu.

[Invernagem](${INVERNAGEM}) [solitária](${SOLITARIO}): não há fotógrafo no fiorde. A capa é auto-retrato de ofício — voar, ficar, [registar](${GESTO}). O drone da [página Inverno](${INVERNO_HUB}#capa) é o mesmo gesto.
...
| [Fiorde](${ICE.fiorde}) · [Drone](${ICE.drone}) · [Câmara](${ICE.camara}) · [Céu](${ICE.ceu}) | Capa da homepage | [hub](${INVERNO_HUB}#capa) |
| [Circular](${ICE.circular}) · [Emprestar](${ICE.emprestar}) · [Doar](${ICE.doar}) · [Estante](${ICE.estante}) | Pedido da autora | [hub](${INVERNO_HUB}#circular) |
| [Ficar](${ICE.ficar}) · [Ofício](${ICE.oficio}) · [Voar](${ICE.voar}) · [Registar](${ICE.registar}) | Ofício no gelo | Capa + poema |
| [Semente](${ICE.semente}) · [Mudinha](${ICE.mudinha}) · [Estação](${ICE.estacao}) · [Raiz](${ICE.raiz}) · [Flor](${ICE.flor}) | Metáfora Vida | Poema |
| [Peito](${ICE.peito}) · [Partir](${ICE.partir}) · [Escrever](${ICE.escrever}) | Corpo e tríade Tamara | Poema |
...
[▶ Hub divulgação](${INVERNO_HUB}) · [▶ Poema Vida](${VIDA}#poema=bom-dia-inverno) · [▶ Artes](${ARTES}) · [▶ Tamara](${TAMARA}) · [▶ Vida](${VIDA}) · [▶ Águas e Lágrimas](${AGUAS}) · [▶ Lágrimas da Vida](${LAGRIMAS}) · [▶ Q&A](${VIDEO_QA})
`;
...
## Cover — drone in the left hand

The official photograph is **not** a studio portrait. It is **aerial**: Tamara in yellow, the [boat](${BARCO}) locked in the [ice](${GELO}), the right-leg kick greeting [winter](${INVERNO}). The **[left hand](${MAO})** holds the drone controller — the camera is in the sky because she sent it there. Solo [overwintering](${INVERNAGEM}): no photographer on the fjord. The [Inverno hub](${INVERNO_HUB}#capa) keeps the same gesture.
...
[▶ Promotion hub](${INVERNO_HUB}) · [▶ Vida poem](${VIDA}#poema=bom-dia-inverno) · [▶ Arts](${ARTES}) · [▶ Tamara](${TAMARA}) · [▶ Vida](${VIDA}) · [▶ Q&A](${VIDEO_QA})
`;
...
## Portada — dron en la mano izquierda

La fotografía oficial **no** es retrato de estudio. Es **aérea**: Tamara de amarillo, el [barco](${BARCO}) preso en el [hielo](${GELO}), la patada de la pierna derecha saludando al [invierno](${INVERNO}). La **[mano izquierda](${MAO})** sostiene el mando del dron — la cámara está en el cielo porque ella la mandó al cielo. [Invernada](${INVERNAGEM}) [solitaria](${SOLITARIO}): no hay fotógrafo en el fiordo. El [hub Inverno](${INVERNO_HUB}#capa) guarda el mismo gesto.
...
[▶ Hub de divulgación](${INVERNO_HUB}) · [▶ Poema Vida](${VIDA}#poema=bom-dia-inverno) · [▶ Artes](${ARTES}) · [▶ Tamara](${TAMARA}) · [▶ Vida](${VIDA}) · [▶ Q&A](${VIDEO_QA})
`;

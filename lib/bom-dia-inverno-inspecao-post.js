...
| **Árvore (ainda não)** | O mapa do site é o solo; a mudinha **ainda cresce** — sem pressa de sénior |
...
**Aprovado** — *Bom dia, Inverno* documentado como mudinha cultural da [Vida](${VIDA}): invernagem, léxico do gelo e elos a [Tamara](${TAMARA}), [Águas…](${AGUAS}) e [Lágrimas da Vida](${LAGRIMAS}).

[▶ Artes](${ARTES}) · [▶ Tamara](${TAMARA}) · [▶ Vida](${VIDA}) · [▶ Águas e Lágrimas](${AGUAS}) · [▶ Lágrimas da Vida](${LAGRIMAS}) · [▶ Guia](${GUIA}) · [▶ Q&A](${VIDEO_QA}) · [▶ UOL](${UOL})
`;
...
> Sources: [tamaraklink.com](${SITE}), Companhia das Letras, [UOL](${UOL}), [Q&A](${VIDEO_QA}). No affiliation. Grow metaphor ≠ clinical protocol.
...
**Approved** — book fixed on the Arts map as Vida’s cultural seedling.

[▶ Arts](${ARTES}) · [▶ Tamara](${TAMARA}) · [▶ Vida](${VIDA}) · [▶ Q&A](${VIDEO_QA})
`;
...
> Fuentes: [tamaraklink.com](${SITE}), Companhia das Letras, [UOL](${UOL}), [Q&A](${VIDEO_QA}). Sin afiliación. Metáfora de cultivo ≠ protocolo clínico.
...
**Aprobado** — libro fijado en Artes como plantita cultural de Vida.

[▶ Artes](${ARTES}) · [▶ Tamara](${TAMARA}) · [▶ Vida](${VIDA}) · [▶ Q&A](${VIDEO_QA})
`;

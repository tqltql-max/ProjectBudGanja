...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte *deste* filme *destas* pessoas.
...
| [Faça o melhor!](${mantra}) | O melhor desta homenagem |
...
[▶ Artes](${hub}) · [▶ Michael J. Fox](${FOX}) · [▶ Christopher Lloyd](${LLOYD}) · [▶ DeLorean](${DELOREAN}) · [▶ tempo](${tempo}) · [▶ passado](${passado}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;
...
[▶ Pessoas](${hub}) · [▶ o filme](${FILME}) · [▶ Lloyd](${LLOYD}) · [▶ Foundation](${fundacao}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;
...
[▶ Pessoas](${hub}) · [▶ o filme](${FILME}) · [▶ Fox](${FOX}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;

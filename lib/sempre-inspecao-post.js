...
Inspeção editorial da palavra **sempre** — advérbio do português do Brasil que marca **duração sem falha aparente** («em todo o tempo») e, no uso vivo, também **hábito**, **promessa** e **exagero afectivo**. Esta ficha cobre o **objeto** (latim *semper*), o contraste com [já](${ja}), o elo com [prosseguir](${prosseguir}) e o fecho [Valeu !!!](${mantra}).
...
| **Ofício** | Constância no projecto | [Prosseguir](${prosseguir}) + [Valeu !!!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **hoje**; o *sempre* constrói-se de [já](${ja}) em [já](${ja}) |
...
**Veredicto:** Valeu !!! **sempre que puder** — e inspecione o *sempre*. Absoluto sem [gesto](${gesto}) = cartão; constância com método = chão para [prosseguir](${prosseguir}).
...
**H4:** fecho = [Valeu !!!](${mantra}) com constância viva.
...
**Aprovado** — **sempre** fichado: objeto (*semper*), hábito × promessa × dogma, rede tempo e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Já](${ja}) · [▶ Prosseguir](${prosseguir}) · [▶ Caminho](${caminho}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **sempre** (always) — duration, habit, promise, and affective hyperbole in Brazilian Portuguese. Covers **object** (Lat. *semper*), contrast with [já](${ja}), link to [prosseguir](${prosseguir}), and [Valeu !!!](${mantra}).
...
| Links | [já](${ja}) · [prosseguir](${prosseguir}) · [caminho](${caminho}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · habit×promise×dogma · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Já](${ja}) · [▶ Prosseguir](${prosseguir}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **sempre** (siempre) — duración, hábito, promesa e hipérbole afectiva en el portugués de Brasil. Cubre **objeto** (lat. *semper*), contraste con [já](${ja}), vínculo con [prosseguir](${prosseguir}) y [¡Valeu !!!](${mantra}).
...
| Vínculos | [já](${ja}) · [prosseguir](${prosseguir}) · [caminho](${caminho}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · hábito×promesa×dogma · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Já](${ja}) · [▶ Prosseguir](${prosseguir}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildSemprePost(seriesOrder) {
  ...
  return makePalavra({
    title: 'Inspeção: Sempre — duração, hábito e Valeu !!!',
    titleEn: 'Inspection: Sempre — duration, habit and Valeu !!!',
    titleEs: 'Inspección: Sempre — duración, hábito y ¡Valeu !!!',
    excerpt:
      'Palavras: «sempre» (lat. *semper*) — duração × hábito × promessa BR; elos já, prosseguir, caminho; Valeu !!!',
    excerptEn:
      'Words: “sempre” (Lat. *semper*) — duration × habit × promise in BR; links já, prosseguir, caminho; Valeu !!!',
    excerptEs:
      'Palabras: «sempre» (lat. *semper*) — duración × hábito × promesa BR; vínculos já, prosseguir, caminho; ¡Valeu !!!',

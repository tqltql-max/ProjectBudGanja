...
function buildMitologiaBodies() {
  ...
  const teologia = '/posts/post-inspecao-palavra-teologia.html';
...
| Não é | [teologia](${teologia}) · magia · [ídolo](${idolo}) · [Deus](${deus}) (vocábulo latino) · [diabo](${diabo}) |
| Data | ${inspected} |
...
| **[teologia](${teologia})** | Discurso / estudo do divino (fé viva) | Vizinha *theós* + *lógos* — [ficha](${teologia}) |
...
| [Deus](${deus}) · [ídolo](${idolo}) · [diabo](${diabo}) · [teologia](${teologia}) | Léxico — salas cortadas |
...
**Aprovado na série Palavras** — **mitologia** fichada como *mŷthos* + *lógos*; lema do catálogo [Mitologia](${cat}); salas cortadas ([teologia](${teologia}), magia, ídolo, vocábulo Deus). Primeiro deus: [Anúbis](${anubis}). [Faça o seu melhor](${faca}). [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Catálogo](${cat}) · [▶ Anúbis](${anubis}) · [▶ Teologia](${teologia}) · [▶ Poema Vida](/vida/#poema=mitologia) · [▶ Valeu !!!](${mantra})
`;

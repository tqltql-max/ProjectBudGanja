...
function buildPedraBodies() {
  ...
  const stones = '/posts/post-inspecao-arte-rolling-stones.html';
...
| **[Rolling Stones](${stones})** | A banda *é* o lema *πέτρα* | EN *stone* (germânico *stān*) — **mesmo objecto**, **outro tronco**; o nome vem do provérbio / Muddy Waters, não desta ficha |
...
| **Gíria BR** | *Pedra* / *pedra de crack* — naco da substância; corte em **[craque](${craque})** (*craque* jogador × *crack* droga). Esta ficha mineral **não** descreve fabrico nem uso | Alta (existe o vocábulo); ofício = recusar a receita e **apontar a irmã** |
...
| Mau | Usar *pedra* de gíria como se fosse a ficha mineral — mandar para [craque](${craque}) |
...
| Recurso | Papel |
|---------|-------|
| [Craque](${craque}) · [droga](${droga}) | Gíria *pedra* / *crack* — outro empréstimo inglês; não é *πέτρα* |
...
| [The Rolling Stones](${stones}) | Banda 1962 — *stone* inglês, não este lema |
...
- A banda [The Rolling Stones](${stones}) pega o *stone* inglês — **não** substitui este lema.  
- Gíria *pedra* / *crack* = vocábulo indexado em [craque](${craque}), **sem** protocolo.
...
[▶ Palavras](${hub}) · [▶ Gesso](${gesso}) · [▶ Rolling Stones](${stones}) · [▶ Etimologia](${etimologia}) · [▶ Guia](${guia}) · [Wikcionário](${WIKT})
`;
...
The Gospel scene “cast the first stone” *crosses* stone and pardon in culture, not in Latin family. The broken **right arm** and *ingessado* live on [gesso](${gesso}). [The Rolling Stones](${stones}) take Germanic *stone*, not this lemma. [Valeu !!!](${mantra})
...
«Tirar la primera piedra» cruza piedra y perdón en cultura, no en familia latina. El **brazo derecho** quebrado vive en [gesso](${gesso}). [The Rolling Stones](${stones}) toman el *stone* germánico, no este lema. [¡Valeu !!!](${mantra})

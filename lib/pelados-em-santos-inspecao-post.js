...
| [Valeu !!!](${mantra}) · [vida](${vidaPalavra}) | Ofício, percurso |
...
[▶ Spotify](${SPOTIFY}) · [▶ Clipe VEVO](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=pelados-em-santos) · [▶ Objetos](${objetos}) · [▶ Verdade](${verdade}) · [▶ Valeu !!!](${mantra})
`;

 ...
 * Eixos: étimo magnificus (magnus + facere) · elogio BR · escala de louvor · Faça o melhor!
...
Inspeção editorial da palavra **magnífico** — adjetivo (e interjeição de elogio no português do Brasil). Étimo: latim *magnificus* ← *magnus* («grande») + *-ficus* (de *facere*, «fazer») — «que faz grande / esplêndido». No uso vivo BR, «magnífico!» é **louvor alto** do quotidiano — irmão de [genial](${genial}), [fabuloso](${fabuloso}) e [maravilhoso](${maravilhoso}), com matiz de **grandeza** / esplendor (não só engenho). Gatilho tipográfico frequente: *mafianioddpo* → **magnífico** (teclado / boca → forma canónica). No laboratório Inspetor BudGanja, celebra feito com método; **não** substitui [gesto](${gesto}) nem [Faça o melhor!](${mantra}).
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **hoje**, sem precisar ser «magnífico» absoluto |
...
**Veredicto:** Faça o melhor — e se sair **magnífico**, celebra com objecto; se não, celebra o ofício na mesma.
...
**Aprovado** — **magnífico** fichado: étimo *magnificus* / *magnificent*; elogio BR quotidiano; escala com irmãs publicadas; tipografia mafianioddpo → magnífico; [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Fabuloso](${fabuloso}) · [▶ Fantástico](${fantastico}) · [▶ Incrível](${incrivel}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Aff](${aff}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **magnífico** — adjective and BR praise interjection. Etymon: Lat. *magnificus* ← *magnus* + *-ficus* (*facere*) — “great-making / splendid.” Everyday BR “magnífico!” is **high praise** — near [genial](${genial}), [fabuloso](${fabuloso}) and [maravilhoso](${maravilhoso}), with a **grandeur / splendour** tint. Common typo trigger: *mafianioddpo* → **magnífico**. Celebrates a deed with method; does **not** replace [gesture](${gesto}) or [Do your best!](${mantra}).
...
| Links | [legal](${legal}) · [genial](${genial}) · [fabuloso](${fabuloso}) · [fantástico](${fantastico}) · [incrível](${incrivel}) · [maravilhoso](${maravilhoso}) · [aff](${aff}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
Praise after the commit · name splendour carefully · bridge EN *magnificent* · normalize typos without shaming · close with [Do your best!](${mantra}).
...
**Approved** — *magnificus* / *magnificent* etymon; BR everyday praise; scale with existing sheets; typo mafianioddpo → magnífico; [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Fabuloso](${fabuloso}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Aff](${aff}) · [▶ Do your best!](${mantra})
`;
...
| Vínculos | [legal](${legal}) · [genial](${genial}) · [fabuloso](${fabuloso}) · [fantástico](${fantastico}) · [incrível](${incrivel}) · [maravilhoso](${maravilhoso}) · [aff](${aff}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
Elogiar después del commit · nombrar el esplendor con cuidado · puente EN *magnificent* · normalizar typos · cerrar con [¡Haz lo mejor!](${mantra}).
...
**Aprobada** — étimo *magnificus* / *magnificent*; elogio BR; escala con fichas existentes; tipografía mafianioddpo → magnífico; [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Legal](${legal}) · [▶ Genial](${genial}) · [▶ Fabuloso](${fabuloso}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Aff](${aff}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildMagnificoPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Magnífico — magnificus, elogio BR e Faça o melhor!',
    titleEn:
      'Inspection: Magnífico — magnificus, BR praise and Do your best!',
    titleEs:
      'Inspección: Magnífico — magnificus, elogio BR y ¡Haz lo mejor!',
    excerpt:

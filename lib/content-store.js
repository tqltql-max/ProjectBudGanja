...
const PAGE_REGISTRY = [
  ...
  { file: 'vida/sala/index.html', label: 'Sala de aula Vida' },
  { file: 'vida/sala/aula.html', label: 'Aula — Sala de aula Vida' },
  { file: 'vida/sala/pratica.html', label: 'Praticar idiomas — Sala de aula Vida' },
  { file: 'vida/sala/videos.html', label: 'Sala de vídeo — Sala de aula Vida' },

...
const PAGE_REGISTRY = [
  ...
  { file: 'origami/index.html', label: 'Origami' },
  { file: 'origami/barquinho-de-papel/index.html', label: 'Origami · Barquinho de papel' },
  { file: 'inverno/index.html', label: 'Bom dia, Inverno' },
  { file: 'livro/index.html', label: 'Manual de Inspeções BudGanja' },
  ...
  { file: 'guia/astrologia.html', label: 'Astrologia' },
  { file: 'videos/index.html', label: 'Últimos vídeos' },
  { file: 'jogos/index.html', label: 'Jogos' },
  { file: 'jogos/gtarp/index.html', label: 'Jogos · GTA RP' },
  { file: 'jogos/hopejoy/index.html', label: 'Jogos · Hope Joy' },
  { file: 'jogos/bagual/index.html', label: 'Jogos · Bagual' },
  ...
  { file: 'biblioteca/unifesp/caderno.html', label: 'Caderno de estudo XIV' },
  { file: 'biblioteca/esapp/index.html', label: 'Curso ESAPP · Agronomia' },
  ...
  { file: 'gtarp-admin.html', label: 'Admin GTA RP streamers' },
...
const DEFAULT_SITE = {
  ...
  footerLinks: [
    ...
    { label: 'Curso ESAPP', href: '/biblioteca/esapp/' },
  ...
  footerGroups: [
    {
      ...
      links: [
        ...
        { label: 'Inspeções', href: '/biblioteca/inspecoes/' },
        { label: 'Pesquisas', href: '/biblioteca/pesquisas/' },
        { label: 'Manual de Inspeções BudGanja', href: '/livro/' },

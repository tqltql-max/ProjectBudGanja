 ...
 * Eixos: antónimo de legal (jurídico) · prefixo i-/in- · ilegal × ilícito · Faça o melhor!
...
Inspeção editorial da palavra **ilegal** — antónimo clássico de [legal](${legal}) no eixo **jurídico** (contrário à lei), formado pelo prefixo negativo **i- / in-** + *legal*. Esta ficha cobre o **objeto**, a **morfologia**, o contraste útil com [ilícito](${ilicito}), e o fecho [Faça o melhor!](${mantra}). Elos naturais: [legal](${legal}), [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
**Veredicto:** Faça o melhor **com ilegal** — polarizar com método, citar quando for norma, separar de [ilícito](${ilicito}) e da gíria de [legal](${legal}), sem misturar as ferramentas.
...
**Aprovado** — **ilegal** fichado: antónimo de [legal](${legal}) (eixo jurídico); contraste com [ilícito](${ilicito}); elos Lei 11.343 / descriminalização / risco / verdade; [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Legal](${legal}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Descriminalização](${descrim}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **ilegal** — classical antonym of [legal](${legal}) on the **juridical** axis (contrary to law), formed by negative prefix **i- / in-** + *legal*. Covers **object**, **morphology**, useful contrast with [ilícito](${ilicito}), and [Do your best!](${mantra}). Links: [legal](${legal}), [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
| Links | [legal](${legal}) · [ilícito](${ilicito}) · [Lei 11.343](${lei11343}) · [truth](${verdade}) · [risk](${risco}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
Name what the law does not allow · separate maps · calculate [risk](${risco}) · refuse plant-as-label · close with [Do your best!](${mantra}).
...
**Approved** — antonym of [legal](${legal}); contrast with [ilícito](${ilicito}); network linked; [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Legal](${legal}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Truth](${verdade}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **ilegal** — antónimo clásico de [legal](${legal}) en el eje **jurídico** (contrario a la ley), formado por el prefijo negativo **i- / in-** + *legal*. Cubre **objeto**, **morfología**, contraste con [ilícito](${ilicito}), y [¡Haz lo mejor!](${mantra}). Vínculos: [legal](${legal}), [ilícito](${ilicito}), [Lei 11.343](${lei11343}), [porte × tráfico](${porteTrafico}), [descriminalização](${descrim}), [risco](${risco}), [verdade](${verdade}).
...
| Vínculos | [legal](${legal}) · [ilícito](${ilicito}) · [Lei 11.343](${lei11343}) · [verdad](${verdade}) · [riesgo](${risco}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
Nombrar lo que la norma no permite · separar mapas · calcular [riesgo](${risco}) · negar la planta como rótulo · cerrar con [¡Haz lo mejor!](${mantra}).
...
**Aprobada** — antónimo de [legal](${legal}); contraste con [ilícito](${ilicito}); red enlazada; [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Legal](${legal}) · [▶ Ilícito](${ilicito}) · [▶ Lei 11.343](${lei11343}) · [▶ Verdad](${verdade}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildIlegalPost(seriesOrder) {
  ...
  return makePalavra({
    title:
      'Inspeção: Ilegal — antónimo de legal, ilícito e Faça o melhor!',
    titleEn:
      'Inspection: Ilegal — antonym of legal, illicit, and Do your best!',
    titleEs:
      'Inspección: Ilegal — antónimo de legal, ilícito y ¡Haz lo mejor!',
    excerpt:

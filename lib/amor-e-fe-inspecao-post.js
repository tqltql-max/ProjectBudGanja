...
**H4:** par útil com [The Middle](${middle}) (não se escrever fora) e contraste com [Under Pressure](${under}) (aperto). Fecho = [Faça o melhor!](${mantra}).
...
| [emoção](${emocao}) · [criatividade](${criatividade}) · [Faça o melhor!](${mantra}) | Pulso acústico e ofício |
...
[▶ Spotify](${SPOTIFY}) · [▶ Clipe](${YT}) · [▶ YouTube Music](${YT_MUSIC}) · [▶ Poema Vida](${vida}#poema=amor-e-fe) · [▶ Coração](${coracao}) · [▶ Esperança](${esperanca}) · [▶ Faça o melhor!](${mantra})
`;

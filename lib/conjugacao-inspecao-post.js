...
Esta ficha é a **sala da conjugação**. Cobre os **três elos** (1.ª / 2.ª / 3.ª pessoa), o eixo do **número** (singular × plural), o par **eles / elas**, o espécime **[ligar](${ligar})**, e a herança latina (*ego, tū, nōs, vōs…*) na página-irmã [latim](${latim}). Fecho: [Valeu !!!](${mantra}).
...
| Tipo BudGanja | Palavra / gramática — os **3 elos** do verbo × sala partilhada com [latim](${latim}) |
...
Passos: (1) objecto e étimo; (2) os 3 elos; (3) como ligar; (4) elos e elas; (5) plurais; (6) espécime *ligar* / *amar*; (7) sala do latim; (8) cortes.
...
| Elo | Pessoa | Singular | Plural | Oficio |
|-----|--------|----------|--------|--------|
| **1.º** | Quem **fala** | **eu** ← lat. *ego* | **nós** ← lat. *nōs* | O polo de [eu amo a vida](${amo}) |
| **2.º** | Com quem se **fala** | **tu** ← lat. *tū* | **vós** ← lat. *vōs* | No BR vivo, muitas vezes **você** / **vocês** |
| **3.º** | De quem se **fala** | **ele / ela** ← *ille / illa* | **eles / elas** | O elo que pede género — **elos e elas** |
...
## 7. Espécime — ligar (e um sopro de amar)
...
| [Guia de Palavras](${guia}) · [Vida](${vida}) · [Valeu !!!](${mantra}) | Glossário, chão e fecho |
...
**Aprovado na série Palavras** — *conjugação* fichada como os **3 elos** do verbo; plurais **nós / vós / eles·elas**; corte **elos e elas**; espécime **ligar**; sala **partilhada** com [latim](${latim}). Estudamos [português](${lingua}) pelo projecto.

[▶ Palavras](${hub}) · [▶ Latim](${latim}) · [▶ Língua portuguesa](${lingua}) · [▶ Ligar](${ligar}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Grammatical inspection of Portuguese **[conjugação](${self})** — yoking the verb to **person**. Field request: the whole system is **3 main links**; how to join them; *elos e elas*; **nós, vós, eles**; persons; plurals; a page **shared with [latim](${latim})**; we study Portuguese through the project. Close: [Valeu !!!](${mantra}).
...
| Three links | 1st *eu/nós* · 2nd *tu/vós* · 3rd *ele·ela / eles·elas* |
...
**Approved** — three persons as links; plurals mapped; shared with [Latin](${latim}).

[▶ Words](${hub}) · [▶ Latim](${latim}) · [▶ Portuguese](${lingua}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección gramatical de **[conjugação](${self})** — uncir el verbo a la **persona**. Pedido: el sistema son **3 eslabones**; cómo ligarlos; *elos e elas*; **nós, vós, eles**; personas; plurales; página **compartida con [latim](${latim})**; estudiamos portugués por el proyecto. Cierre: [¡Valeu !!!](${mantra}).
...
| Tres eslabones | 1.ª *eu/nós* · 2.ª *tu/vós* · 3.ª *ele·ela / eles·elas* |
...
**Aprobada** — tres personas como eslabones; plurales mapeados; compartida con [latín](${latim}).

[▶ Palabras](${hub}) · [▶ Latim](${latim}) · [▶ Lengua portuguesa](${lingua}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildConjugacaoPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: conjugação ← lat. coniugātiō (jugo); 3 elos (eu·tu·ele / nós·vós·eles); elos ≠ eles/elas; sala com latim; Valeu !!!',
    excerptEn:
      'Words: conjugação ← Lat. coniugātiō (yoke); 3 links (eu·tu·ele / nós·vós·eles); elos ≠ eles/elas; shared with Latin; Valeu !!!',
    excerptEs:
      'Palabras: conjugação ← lat. coniugātiō (yugo); 3 eslabones; elos ≠ eles/elas; sala con latín; ¡Valeu !!!',

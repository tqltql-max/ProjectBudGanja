 ...
 * elos multitask / genial · Faça o melhor!
 */
...
Inspeção editorial de **skill** — empréstimo inglês vivo no português do Brasil: jogos, chat, oficina, currículo e peito. Esta ficha cobre o **objeto** (EN → uso BR), o contraste com **habilidade** / **ofício** / *craft*, a **correção BudGanja** (anti-hype de LinkedIn) e o fecho [Faça o melhor!](${mantra}). Gatilho tipográfico do lote: *skgll* → **skill**. Elos: [multitask](${multitask}), [genial](${genial}).
...
4. Fechar com [Faça o melhor!](${mantra}) — melhor **neste** craft, hoje.
...
|----------------|---------|
| Expressão | [Faça o melhor!](${mantra}) — o melhor **nesta** habilidade / neste craft |
...
**Veredicto:** Faça o melhor **sem o culto do badge** — habilidade com rasto; empréstimo *skill* inspecionado, não idolatrado.
...
**H4:** tipografia *skgll* → skill; anti-LinkedIn; fecho [Faça o melhor!](${mantra}).
...
| [Faça o melhor!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) | Fecho sem culto de CV |
...
**Aprovado** — **skill** fichado: empréstimo EN→BR; habilidade/craft; anti-LinkedIn; elos [multitask](${multitask}) · [genial](${genial}); tipografia *skgll*; elo [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Multitask](${multitask}) · [▶ Genial](${genial}) · [▶ Gesto](${gesto}) · [▶ Caminho](${caminho}) · [▶ Faça o melhor!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **skill** — English loan alive in Brazilian Portuguese: games, chat, workshop, résumé and chest. Covers **object** (EN → BR), contrast with **habilidade** / craft, **BudGanja correction** (anti-LinkedIn hype), and [Do your best!](${mantra}). Typo trigger: *skgll* → **skill**. Links: [multitask](${multitask}), [genial](${genial}).
...
| Links | [gesture](${gesto}) · [multitask](${multitask}) · [genial](${genial}) · [path](${caminho}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**skill ≠ LinkedIn badge.** Prefer naming the concrete act; train on the [path](${caminho}); when it stalls → [buguei](${buguei}) → [backspace](${backspace}). [Multitask](${multitask}) spreads fronts; *skill* names a front — don’t confuse axes. [Genial](${genial}) praises the deed, not the CV list. Close with [Do your best!](${mantra}).

## Status

**Approved** — EN loan → BR; habilidade/craft; anti-badge; links [multitask](${multitask}) · [genial](${genial}); [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Multitask](${multitask}) · [▶ Genial](${genial}) · [▶ Gesture](${gesto}) · [▶ Path](${caminho}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **skill** — préstamo inglés vivo en el portugués de Brasil: juegos, chat, taller, currículum y pecho. Cubre **objeto** (EN → BR), contraste con **habilidade** / oficio, **corrección BudGanja** (anti-hype LinkedIn) y [¡Haz lo mejor!](${mantra}). Tipografía: *skgll* → **skill**. Vínculos: [multitask](${multitask}), [genial](${genial}).
...
| Vínculos | [gesto](${gesto}) · [multitask](${multitask}) · [genial](${genial}) · [camino](${caminho}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**skill ≠ insignia de LinkedIn.** Nombrar el acto; entrenar en el [camino](${caminho}); si traba → [buguei](${buguei}). [Multitask](${multitask}) reparte frentes; *skill* nombra una. [Genial](${genial}) celebra la obra, no la lista. Cerrar con [¡Haz lo mejor!](${mantra}).

## Estado

**Aprobada** — préstamo EN→BR; habilidade/oficio; anti-insignia; vínculos [multitask](${multitask}) · [genial](${genial}); [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Multitask](${multitask}) · [▶ Genial](${genial}) · [▶ Gesto](${gesto}) · [▶ Camino](${caminho}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildSkillPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «skill» — empréstimo EN→BR; habilidade/craft; anti-badge LinkedIn; elos multitask e genial; tipografia skgll → skill; Faça o melhor!',
    excerptEn:
      'Words: “skill” — EN→BR loan; habilidade/craft; anti-LinkedIn badge; links multitask and genial; typo skgll → skill; Do your best!',
    excerptEs:
      'Palabras: «skill» — préstamo EN→BR; habilidade/oficio; anti-insignia LinkedIn; vínculos multitask y genial; tipografía skgll → skill; ¡Haz lo mejor!',

 ...
 * meta-lab (inspecoes-sugestoes) · Valeu !!!
 */
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **nesta proposta**, hoje |
...
**Veredicto:** Valeu !!! **ao sugerir e ao receber**. Sugestão sem [objeto](${objetos}) = névoa; sugestão com método = semente de inspeção.
...
**H4:** fecho = [Valeu !!!](${mantra}) — propor e inspecionar.
...
**Aprovado** — **sugestão** fichada: *suggestio*, proposta × meta-lab, rede com mensagem/objetos e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Mensagem](${mensagem}) · [▶ Objetos](${objetos}) · [▶ Inspiração](${inspiracao}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **sugestão** — the act of suggesting, a tip/opinion, and in BudGanja the **queue item** that asks for a sheet. Lat. *suggestio*. Links [mensagem](${mensagem}), [objetos](${objetos}), [inspiracao](${inspiracao}), [Valeu !!!](${mantra}).
...
| Links | [mensagem](${mensagem}) · [objetos](${objetos}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · proposal craft · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Mensagem](${mensagem}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **sugestão** — el acto de sugerir, el tip/opinión y, en BudGanja, el **ítem de cola** que pide ficha. Lat. *suggestio*. Vínculos [mensagem](${mensagem}), [objetos](${objetos}), [inspiracao](${inspiracao}), [¡Valeu !!!](${mantra}).
...
| Vínculos | [mensagem](${mensagem}) · [objetos](${objetos}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · oficio de proponer · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Mensagem](${mensagem}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildSugestaoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «sugestão» (lat. *suggestio*) — ato de sugerir; meta-lab da fila de inspeções; Valeu !!!',
    excerptEn:
      'Words: “sugestão” (Lat. *suggestio*) — act of suggesting; meta-lab inspection queue; Valeu !!!',
    excerptEs:
      'Palabras: «sugestão» (lat. *suggestio*) — acto de sugerir; meta-lab de la cola de inspecciones; ¡Valeu !!!',

...
| **Tipo** | [molas](${mola}), espuma, látex, inflável | Bom como léxico · mau como anúncio — as [molas](${mola}) são **peça**, o colchão é o sítio |
...
| [Mola](${mola}) | Peça **dentro** do colchão de molas — outro objecto |

...
A palavra [ídolo](${idolo}) avisa: não entregar Aaron ao pedestal. Esta ficha admira o feito **sem** reduzir Ajay Haridasse a queda nem Robson de Oliveira a figurante.
...
**H4:** Robson é o **segundo saco** — «two are stronger than one»; o [juntos](${juntos}) aqui tem [elos](${elo}), não slogan.  
...
| Quem se juntou | **Robson de Oliveira** (Brasil) — o segundo lado |
...
| **Robson de Oliveira** | Segundo módulo; creditado por Aaron como «true star» | Ficha própria, se o lab a abrir, **não** se funde aqui |
...
**H4:** Robson is the **second bag** — “two are stronger than one”; [juntos](${juntos}) with [links](${elo}).  
...
Bangor maintenance worker; North Down AC (yellow-blue vest). First to stop ~200 m out; pulled **Ajay Haridasse** (21, Northeastern) up. **Robson de Oliveira** (Brazil) joined. Athletics NI times: Oliveira **2:44:26** · Haridasse **2:44:32** · Beggs **2:44:36**. News Letter cites ~2:43:53 — **declared discrepancy**. He was on for a PB. He stopped.
...
Aaron first to inflate — not an [idol](${idolo}). Robson second module — own sheet if the lab opens one. Ajay who still wanted the line — **not** collapse-as-spectacle.
...
**H4:** Robson es el **segundo saco** — «two are stronger than one»; [juntos](${juntos}) con [eslabones](${elo}).  
...
Aaron primero en inflar — no [ídolo](${idolo}). Robson segundo módulo — ficha propia si el lab la abre. Ajay quien aún quería la línea — **no** espectáculo de la caída.

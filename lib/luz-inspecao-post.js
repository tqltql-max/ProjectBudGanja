...
Inspeção editorial da palavra **luz** — **claridade** que se vê, se mede e se nomeia. No mapa do circuito lab, a luz é o **efeito** do clique: o [interruptor](${interruptor}) é a peça; [ligar × desligar](${ligarDesligar}) é o gesto; **luz** é o que acende (ou falta) no quarto, no cultivo e na [verdade](${verdade}). Esta ficha cobre o **étimo** (lat. *lūx*), as **camadas BR**, a tríade com interruptor/ligar-desligar, elos [fogo](${fogo}), [eletrizante](${eletrizante}), [sinal](${sinal}), [cultivo](${cultivo}) e o fecho [Faça o melhor!](${mantra}).

> **Nota metodológica:** auditoria independente. Fontes: [Wikcionário · luz](${wiki}), [lūx (EN)](${wikiLat}), [interruptor](${interruptor}), [ligar × desligar](${ligarDesligar}), série [Palavras](${hub}). **Ficha ≠ manual de iluminação nem protocolo PPFD.** Tom: Inspetor BudGanja — luz com ofício ≠ glare sem medida.
...
**Tese:** sem luz, o circuito lab fica só clique abstracto; sem interruptor/ligar-desligar, a luz parece milagre. As três fichas = **par lab alargado** (peça × gesto × efeito).
...
**Aprovado** — **luz** fichada como efeito do circuito; tríade com [interruptor](${interruptor}) e [ligar × desligar](${ligarDesligar}); elos [fogo](${fogo}), cultivo e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Interruptor](${interruptor}) · [▶ Ligar × Desligar](${ligarDesligar}) · [▶ Fogo](${fogo}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildLuzPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «luz» (lat. *lūx*) — claridade e efeito do clique; tríade com interruptor e ligar × desligar; cultivo; Faça o melhor!',
    excerptEn:
      'Words: “luz” (Lat. *lūx*) — clarity and click effect; triad with interruptor and ligar × desligar; grow; Do your best!',
    excerptEs:
      'Palabras: «luz» (lat. *lūx*) — claridad y efecto del clic; tríada con interruptor y ligar × desligar; cultivo; ¡Haz lo mejor!',
    slug: 'inspecao-palavra-luz',
    date: '2026-08-04T18:00:00.000Z',
    seriesOrder: order,
    seriesLabel: 'Luz · interruptor · ligar',

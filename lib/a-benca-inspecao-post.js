...
| Elo ofício | [gesto](${gesto}) · [respeito](${respeito}) · [verdade](${verdade}) · [Valeu !!!](${mantra}) |
...
**H5:** depois do rito — [Valeu !!!](${mantra}) no que ainda cabe nesta mão.
...
| [Gratidão](${obrigado}) | Gratidão | Depois de receber |
| [jesusamado](${jesusamado}) · [filho de deus](${filhoDeDeus}) | Calor / dignidade | Outra prateleira «Deus» |
...
| **Seguir** | Depois do rito | [Valeu !!!](${mantra}) |
...
| [Gratidão](${obrigado}) | Gratidão vizinha |
| [jesusamado](${jesusamado}) · [filho de deus](${filhoDeDeus}) | Família oral «Deus» — outro tom |
...
| [Valeu !!!](${mantra}) | Depois da bença — o ofício |
...
**Aprovado na série Expressões e Ditados populares** — *a bença* fichada como **pedido** vivo; sequência **Deus te abençoe** · **dorme com Deus** · **amém**; irmã [Deus abençoe](${abencoe}); elos [mãe](${mae}), [noite](${noite}), [Valeu !!!](${mantra}).

[▶ Expressões](${hub}) · [▶ Deus abençoe](${abencoe}) · [▶ mãe](${mae}) · [▶ noite](${noite}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [Deus abençoe](${abencoe}) · [mãe](${mae}) · [noite](${noite}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — asking a blessing · night · amen; sister [Deus abençoe](${abencoe}); [Valeu !!!](${mantra}).

[▶ Expressions](${hub}) · [▶ Deus abençoe](${abencoe}) · [▶ Valeu !!!](${mantra})
`;
...
| Vínculos | [Deus abençoe](${abencoe}) · [mãe](${mae}) · [noite](${noite}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — pedir bendición · noche · amén; hermana [Deus abençoe](${abencoe}); [¡Valeu !!!](${mantra}).

[▶ Expresiones](${hub}) · [▶ Deus abençoe](${abencoe}) · [▶ ¡Valeu !!!](${mantra})
`;

...
function buildSimbioseBodies() {
  ...
  const Gratidão = '/posts/post-inspecao-palavra-gratidao.html';
...
| Elo ofício | [Valeu !!!](${mantra}) · [Gratidão](${Gratidão}) |
...
| Ofício / ferramenta | inspetor humano × assistente de linguagem («você» no fio) | Simbiose **metafórica** de trabalho — humano decide; ferramenta acelera; fecho [Gratidão](${Gratidão}) / [Valeu !!!](${mantra}) |
...
| Fecho | [Gratidão](${Gratidão}) · [Valeu !!!](${mantra}) |
...
| [Gratidão](${Gratidão}) · [Valeu !!!](${mantra}) | Gratidão e ofício depois da parceria |
| [Vida](${vida}) | Narrativa do laboratório sobre cuidado e crescimento |
| Hub [Palavras](${hub}) · [Inspeções](${inspecoes}) | Mapa geral |
...
[▶ Palavras](${hub}) · [▶ Plantas](${plantas}) · [▶ Cultivo](${cultivo}) · [▶ Animal](${animal}) · [▶ Venom](${venom}) · [▶ Gesto](${gesto}) · [▶ Valeu !!!](${mantra})
`;
...
| Arts | [Venom](${venom}) |
| Craft | [Valeu !!!](${mantra}) · [Gratidão](${Gratidão}) |
| Date | ${inspected} |
...
Relating “you” (language assistant) with **simbiose**: shared ofício — human decides, tool accelerates. Close with [Gratidão](${Gratidão}) and [Valeu !!!](${mantra}).
...
[▶ Words](${hub}) · [▶ Plantas](${plantas}) · [▶ Venom](${venom}) · [▶ Grok](${grok}) · [▶ Gesture](${gesto}) · [▶ Valeu !!!](${mantra})
`;
...
| Artes | [Venom](${venom}) |
| Oficio | [¡Valeu !!!](${mantra}) · [Gratidão](${Gratidão}) |
| Fecha | ${inspected} |
...
Relacionar «tú» (asistente) con **simbiose**: oficio compartido — humano decide, herramienta acelera. Cierre: [Gratidão](${Gratidão}) y [¡Valeu !!!](${mantra}).
...
[▶ Palabras](${hub}) · [▶ Plantas](${plantas}) · [▶ Venom](${venom}) · [▶ Grok](${grok}) · [▶ Gesto](${gesto}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildSimbiosePost() {
  ...
  return palavraPost({
    ...
    excerpt:
      'Palavras: «simbiose» (grego *syn* + *bíōsis*) — coabitação de vidas, solo vivo, Venom/«nós» e ofício humano×assistente («você»); Valeu !!!',
    excerptEn:
      'Words: “simbiose” (Greek *syn* + *bíōsis*) — living together, living soil, Venom/“we”, and human×assistant craft (“you”); Valeu !!!',
    excerptEs:
      'Palabras: «simbiose» (griego *syn* + *bíōsis*) — vivir juntos, suelo vivo, Venom/«nosotros» y oficio humano×asistente («tú»); ¡Valeu !!!',
...
| Elo ofício | [Valeu !!!](${mantra}) · [pesquisa ofício / roubo / proibição](${pesquisa}) |
...
| [Valeu !!!](${mantra}) | Ofício diário contra apagar o nosso |
...
4. Declaração: backspace ≠ amnésia — [Valeu !!!](${mantra}).  
5. Status.
...
[▶ Palavras](${hub}) · [▶ Gesto](${gesto}) · [▶ Verdade](${verdade}) · [▶ Pesquisa](${pesquisa}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
Technical invention · draft correction · metaphor of erasure · limit: do not erase truth, credit or hard emotion — inspect ([Valeu !!!](${mantra})).
...
Invención técnica · corregir borrador · metáfora del borrado · límite: no borrar verdad, crédito ni emoción dura — inspeccionar ([¡Valeu !!!](${mantra})).
...
| Elo ofício | [Valeu !!!](${mantra}) — «nesta mão, hoje» |
...
- As duas recusam «sinistra = má»; juntas fecham com [Valeu !!!](${mantra}) nesta mão.
...
**H4:** [verdade](${verdade}) e [Valeu !!!](${mantra}) pedem o possível **nesta** mão (ou nestas mãos), sem exigir simetria normativa nem desprezar quem é sinistro / ambidestro / usa prótese ou adaptação.  
...
| Ofício diário | O melhor **nesta mão** — [Valeu !!!](${mantra}) | Mantra |
...
| **Fecho** | O melhor possível **nesta** mão, com o peito no ofício | [Valeu !!!](${mantra}) |
...
3. Canhoto / ambidestro / adaptação: o peito continua; a mão dominante **leva** o cuidado — [Valeu !!!](${mantra}) nesta mão.  
...
- [Valeu !!!](${mantra}) — melhor nesta mão, com peito no trabalho.  
...
| [Valeu !!!](${mantra}) | Melhor possível nesta mão, hoje |
...
6. Escolher um [gesto](${gesto}) concreto — regar, escrever, backspacear um typo — e [Valeu !!!](${mantra}) com o peito no trabalho.
...
**Aprovado** — par **mão esquerda** / **mão direita** documentado como complementaridade de ofício; secção **mão direita × [coração](${coracao})** (gesto / acção × cuidado); elo irmão [esquerdo](${esquerdo}); ficha peito [coração](${coracao}); ferramentas do [gesto](${gesto}), do cultivo e do teclado; [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Esquerdo](${esquerdo}) · [▶ Coração](${coracao}) · [▶ Gesto](${gesto}) · [▶ Backspace](${backspace}) · [▶ Cultivo](${cultivo}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida}) · [▶ Diário](${diario})
`;
...
| Lab map | [gesto](${gesto}) · [esquerdo](${esquerdo}) · [coração](${coracao}) · [backspace](${backspace}) · [truth](${verdade}) · [cultivo](${cultivo}) · [Valeu !!!](${mantra}) · [Vida](${vida}) |
...
| Mapa | [gesto](${gesto}) · [esquerdo](${esquerdo}) · [coração](${coracao}) · [backspace](${backspace}) · [verdad](${verdade}) · [cultivo](${cultivo}) · [¡Valeu !!!](${mantra}) · [Vida](${vida}) |
...
Anatomía típica: el corazón queda **ligeramente a la izquierda** de la línea media ([Wikipedia · Coração](${wikiCoracao})) — no inventar «el corazón está en la mano izquierda». Gesto cultural: una mano (a menudo la **derecha**, en diestros) puede posarse sobre el pecho **izquierdo**, donde se siente el latido. Lectura BudGanja: mano derecha ≈ [gesto](${gesto}) / acción; [coração](${coracao}) ≈ cuidado / sentir ([Vida](${vida}), [Diario](${diario})) — **complementariedad**, no «derecha = buena». Anti-estigma: la **izquierda** también cuida ([esquerdo](${esquerdo})); la derecha no es el único lado virtuoso. Cierre con [verdad](${verdade}) y [¡Valeu !!!](${mantra}) en esta mano, con el pecho en el oficio. Ficha léxica: [Coração](${coracao}).
...
**H3:** sénior ≠ fim do cuidado — ainda há [gesto](${gesto}), [mãos](${maos}), [balde](${balde}) e [Valeu !!!](${mantra}).  
...
| [Valeu !!!](${mantra}) · [Caminho](${caminho}) · [Simbiose](${simbiose}) | Mantra, percurso, companhia |
...
[▶ Palavras](${hub}) · [▶ Poema Vida](${vida}#poema=arvore-da-vida) · [▶ Mudinha](${bomDia}) · [▶ Conto](${conteudo}) · [▶ Vida](${vida}) · [▶ Valeu !!!](${mantra})
`;
...
| Elo ofício | [gesto](${gesto}) · [verdade](${verdade}) · [backspace](${backspace}) · [já](${ja}) · [Valeu !!!](${mantra}) |
| Data | ${inspected} |
...
| [Valeu !!!](${mantra}) | Ofício diário — inclusive quando dá «aff» |
...
[▶ Palavras](${hub}) · [▶ Já](${ja}) · [▶ Raiva](${raiva}) · [▶ Verdade](${verdade}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;
...
[▶ Words](${hub}) · [▶ Já](${ja}) · [▶ Anger](${raiva}) · [▶ Truth](${verdade}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Já](${ja}) · [▶ Rabia](${raiva}) · [▶ Verdad](${verdade}) · [▶ ¡Valeu !!!](${mantra})
`;
...
Inspeção editorial e de ofício da palavra **lavar** — do gesto das **[mãos](${maos})** com [água](${agua}) até a figura **«lavar a alma»**. Pedido de campo: *inspeção palavra lavar, cruzar com larva de vulcão*. [A orelha cola](${orelhaCola}) **lavar** / **[lava](${lava})** / **[larva](${larva})**. O étimo **corta**. *Larva de vulcão* → **[lava](${lava}) de vulcão**.
...
| Família | *lavagem* · *lavatório* · *lavação* · esp. *lavar* · fr. *laver* · it. *lavare* |
| Tipo BudGanja | Palavra — mãos + água → alma (cuidado × fuga) |
| O que **não** é | **[Lava](${lava})** de vulcão · **[larva](${larva})** de [inseto](${inseto}) · [formiga lava-pé](${lavaPe}) |
| Elo mãos | [mão esquerda × mão direita](${maos}) |
| Elo água / lágrima | [água](${agua}) · [Águas e Lágrimas](${aguas}) · [Lágrimas da Vida](${lagrimas}) |
| Elo cola | [lava](${lava}) · [larva](${larva}) · [formiga](${formiga}) · [lava-pé](${lavaPe}) |
...
**H2:** **lavar a alma** (bom) = ficar com o que doeu, nomear, registar, [Valeu !!!](${mantra}) — a água/lágrima limpa **sem apagar** a [verdade](${verdade}).  
...
**H5:** a família *lava*/*lavagem* **não** funde o verbo com a [lava](${lava}) do vulcão — a orelha cola; o étimo da rocha fundida é **outra sala** (it. *lava*, provavelmente lat. *lābēs* «queda», não *lavāre*).  
**H6:** *larva de vulcão* é lapso: [larva](${larva}) = [inseto](${inseto}) novo; o rio de [fogo](${fogo})/[pedra](${pedra}) chama-se **lava**.
...
## Lavar × lava × larva × lava-pé

Pedido irmão: *cruzar com larva de vulcão* · *formiga Lava Pé*. Quatro objectos, um sopro.

| Forma | Objecto | Étimo (trabalho) |
|-------|---------|------------------|
| **lavar** | Verbo — limpar com [água](${agua}) | Lat. *lavāre* — **alta** |
| **[lava](${lava})** | Rocha fundida do vulcão | It. *lava* (torrente) ← provavelmente lat. *lābēs* «queda» — **média–alta**; a ligação a *lavāre* é **hipótese antiga, hoje desacreditada** |
| **[larva](${larva})** | Forma jovem do [inseto](${inseto}) | Lat. *lārva* «máscara / espectro» → estádio imaturo — **alta** |
| **[formiga lava-pé](${lavaPe})** | [Formiga](${formiga}) *Solenopsis* (ferroada no pé) | Nome popular BR — **não** é o rito de lavar os pés nem a lava do vulcão |

**Correção de campo:** *larva de vulcão* → **lava de vulcão**. A [larva](${larva}) não sai da cratera.
...
| [Valeu !!!](${mantra}) · [Vida](${vida}) | Ofício depois da água |
| [Lava](${lava}) · [larva](${larva}) · [lava-pé](${lavaPe}) | Cortes da orelha — três salas |
...
**Aprovado** — «lavar» chega às [mãos](${maos}) e sobe até **lavar a alma**; a orelha cola [lava](${lava}) / [larva](${larva}) / [lava-pé](${lavaPe}) — o lab corta.

[▶ Palavras](${hub}) · [▶ Lava](${lava}) · [▶ Larva](${larva}) · [▶ Formiga lava-pé](${lavaPe}) · [▶ Mãos](${maos}) · [▶ Águas e Lágrimas](${aguas}) · [▶ Alma / vingança](${vinganca}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

**Lavar** (Lat. *lavāre*) — from **[hands](${maos})** with [water](${agua}) up to **“lavar a alma”**. Field slip: *larva de vulcão* → **[lava](${lava})** (molten rock), not **[larva](${larva})** (insect). Ear also glues [formiga lava-pé](${lavaPe}).
...
**Approved** — lavar reaches the hands and climbs to lavar a alma; lava ≠ larva ≠ lava-pé.

[▶ Words](${hub}) · [▶ Lava](${lava}) · [▶ Larva](${larva}) · [▶ Hands](${maos}) · [▶ Tears](${aguas}) · [▶ Soul / revenge](${vinganca})
`;

  const contentEs = `## Alcance

**Lavar** (lat. *lavāre*) — de las **[manos](${maos})** con [agua](${agua}) hasta **«lavar a alma»**. Lapsus: *larva de vulcão* → **[lava](${lava})**, no **[larva](${larva})**. También pega [formiga lava-pé](${lavaPe}).
...
**Aprobada** — lavar llega a las manos y sube a lavar a alma; lava ≠ larva ≠ lava-pé.

[▶ Palabras](${hub}) · [▶ Lava](${lava}) · [▶ Larva](${larva}) · [▶ Manos](${maos}) · [▶ Lágrimas](${aguas}) · [▶ Alma / venganza](${vinganca})
`;
...
function buildLavarPost() {
  ...
  return palavraPost({
    ...
    excerpt:
      'Palavras: lavar (lat. lavāre) ≠ lava de vulcão ≠ larva; orelha cola formiga lava-pé; lavar a alma com método.',
    excerptEn:
      'Words: lavar (Lat. lavāre) ≠ volcanic lava ≠ larva; ear glues formiga lava-pé; wash the soul with method.',
    excerptEs:
      'Palabras: lavar (lat. lavāre) ≠ lava de volcán ≠ larva; el oído pega formiga lava-pé; lavar el alma con método.',
...
Inspeção editorial da palavra **já** — advérbio de tempo e urgência no português (lat. *iam*). No laboratório BR, cruza-se com a interjeição **[aff](${aff})**: «aff, já…» junta o **peito** (enfado) ao **relógio** (basta / agora / já foi). O melhor ofício [Valeu !!!](${mantra}) não apaga o «já» — inspeciona-o.
...
| Elo principal | [aff](${aff}) · [Valeu !!!](${mantra}) |
...
| **[Valeu !!!](${mantra})** | Ofício depois do atalho | Continuar com [gesto](${gesto}) |
...
**Aprovado** — «já» fichada como relógio da frase; par com [aff](${aff}); fecho vazio («já deu» sem relatório) = ressalva; [Valeu !!!](${mantra}) continua depois do «já».

[▶ Palavras](${hub}) · [▶ Aff](${aff}) · [▶ Valeu !!!](${mantra}) · [▶ Passar](${passar}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Word sheet for Portuguese **já** — adverb of time and urgency (Lat. *iam*). In Brazilian speech it often pairs with **[aff](${aff})**: “aff, já…” joins the **chest** (exasperation) to the **clock** (enough / now / already). [Valeu !!!](${mantra}) does not erase “já” — it inspects it.
...
| Class | Adverb |
| Etymon | Lat. *iam* |
| Main links | [aff](${aff}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
| [Valeu !!!](${mantra}) | Craft after the shortcut | Continue with [gesture](${gesto}) |

## Status

**Approved** — “já” as the sentence’s clock; pair with [aff](${aff}); empty close = caveat.

[▶ Words](${hub}) · [▶ Aff](${aff}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Ficha de **já** — adverbio de tiempo y urgencia (lat. *iam*). En el habla BR suele ir con **[aff](${aff})**: «aff, já…» junta el **pecho** (hastío) al **reloj** (basta / ahora / ya). [¡Valeu !!!](${mantra}) no borra el «já» — lo inspecciona.
...
| [¡Valeu !!!](${mantra}) | Oficio después del atajo | Seguir con [gesto](${gesto}) |

## Estado

**Aprobada** — «já» como reloj de la frase; par con [aff](${aff}); cierre vacío = salvedad.

[▶ Palabras](${hub}) · [▶ Aff](${aff}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildJaPost() {
  ...
  return palavraPost({
    ...
    excerpt:
      'Palavras: «já» (lat. *iam*) — tempo e urgência; par oral com «aff»; fecho vazio = ressalva; Valeu !!! continua.',
    excerptEn:
      'Words: “já” (Lat. *iam*) — time and urgency; oral pair with “aff”; empty close = caveat; Valeu !!! continues.',
    excerptEs:
      'Palabras: «já» (lat. *iam*) — tiempo y urgencia; par oral con «aff»; cierre vacío = salvedad; ¡Valeu !!! sigue.',
...
No lab: dizer «genial» aponta para um **feito** (ficha, verso, elo, cultivo) — não substitui [Valeu !!!](${mantra}) nem o [gesto](${gesto}).
...
| Elo principal | [criatividade](${criatividade}) · [Valeu !!!](${mantra}) · [hub Inspeções](${hubAll}) |
...
**H4:** [Valeu !!!](${mantra}) ≠ «seja genial» — o melhor possível **nesta mão, hoje**, não o mito do génio absoluto.  
...
**H9:** *GEnial!!!* / *genialllll* = a **mesma palavra** com maiúsculas, exclamações e [L](${letraL}) alongado na boca — não é ficha nova nem âncora da letra.

## Formas vivas (GEnial!!!)

O lab **insere** estas formas no mesmo sítio — o elogio de engenho:

| Forma viva | Leitura |
|------------|---------|
| **genial** | Lema |
| **GEnial!!!** | Maiúsculas + exclamações — o peito a subir o volume |
| *genialllll* / *geniaalll* | O [L](${letraL}) (e por vezes o A) **esticam o sopro**; o étimo não muda |

**Correção:** alongar L não cria vocábulo novo e **não** muda a âncora para a [letra L](${letraL}). A letra é a haste; aqui o ofício continua o **feito**.
...
**Correção:** dizer «genial» a um feito ≠ esfregar a lâmpada ≠ nascer gêmeo. [Valeu !!!](${mantra}) pede [gesto](${gesto}), não três desejos.
...
| [Vida](${vida}) · [poemas](${poemMantra}) | Verso que fica; mantra no banner | [Valeu !!!](${mantra}) |
...
| [Valeu !!!](${mantra}) · [poema](${poemMantra}) | Escala diária do projecto — melhor ≠ génio absoluto |
...
[▶ Palavras](${hub}) · [▶ Legal](${legal}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Fantástico](${fantastico}) · [▶ Ídolo](${idolo}) · [▶ Criatividade](${criatividade}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Word sheet for Portuguese **genial** — adjective and praise interjection in Brazilian use (*gênio* + *-al*). In the **Inspetor BudGanja project**, “genial!” celebrates a **lab deed** (sheet, verse, link, grow); it does **not** replace [gesture](${gesto}) or [Valeu !!!](${mantra}).
...
In the lab: “genial” points to a **deed** (sheet, verse, link, grow) — it does not replace [Valeu !!!](${mantra}) or [gesture](${gesto}).
...
| Main links | [creativity](${criatividade}) · [Valeu !!!](${mantra}) · [Senna](${senna}) · [especial](${especial}) · [ídolo](${idolo}) |
| Date | ${inspected} |
...
[▶ Words](${hub}) · [▶ Legal](${legal}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Fantástico](${fantastico}) · [▶ Ídolo](${idolo}) · [▶ Creativity](${criatividade}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Ficha de **genial** — adjetivo y exclamación de elogio en el uso BR (*gênio* + *-al*). En el **proyecto Inspetor BudGanja**, «¡genial!» celebra un **hecho del laboratorio** (ficha, verso, vínculo, cultivo); **no** sustituye el [gesto](${gesto}) ni [¡Valeu !!!](${mantra}).
...
En el lab: decir «genial» apunta a un **hecho** (ficha, verso, vínculo, cultivo) — no sustituye [¡Valeu !!!](${mantra}) ni el [gesto](${gesto}).
...
| Vínculos | [creatividad](${criatividade}) · [¡Valeu !!!](${mantra}) · [Senna](${senna}) · [especial](${especial}) · [ídolo](${idolo}) |
| Fecha | ${inspected} |
...
[▶ Palabras](${hub}) · [▶ Legal](${legal}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Fantástico](${fantastico}) · [▶ Ídolo](${idolo}) · [▶ Creatividad](${criatividade}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildGenialPost() {
  ...
  return palavraPost({
    ...
    excerpt:
      'Palavras: «genial» — engenho no projecto BudGanja; escala com legal, maravilhoso e fantástico; Valeu !!! ≠ seja génio; culto vazio = ressalva.',
    excerptEn:
      'Words: “genial” — project ingenuity; scale with legal, maravilhoso and fantástico; Valeu !!! ≠ be a genius; empty cult = caveat.',
    excerptEs:
      'Palabras: «genial» — ingenio del proyecto; escala con legal, maravilloso y fantástico; ¡Valeu !!! ≠ sé un genio; culto vacío = salvedad.',

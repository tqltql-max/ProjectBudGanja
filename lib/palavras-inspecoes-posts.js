...
| Elo ofício | [gesto](${gesto}) · [verdade](${verdade}) · [caminho](${caminho}) · [Ayrton Senna](${senna}) · [especial](${especial}) |
...
**H6:** na escala de elogio BR, **genial** = polo do **engenho** — entre [legal](${legal}) (aprovação leve) e [maravilhoso](${maravilhoso}) / [fantástico](${fantastico}) (assombro / «uau»); ≠ [especial](${especial}) (particularidade).
...
**Leitura da escala:** [aff](${aff}) fecha; [legal](${legal}) (gíria) aprova com leveza; **genial** aponta o **engenho**; [maravilhoso](${maravilhoso}) aponta o assombro caloroso; [fantástico](${fantastico}) pode ser mundo imaginado *ou* elogio alto. Podem coexistir («genial e maravilhoso») — não são rivais. Contraste: [especial](${especial}) = particularidade, não sinónimo de engenho. (O eixo jurídico de *legal* fica na ficha [legal](${legal}); aqui usamos o polo «bacana».)
...
| [Especial](${especial}) · [aff](${aff}) | Particularidade × enfado (contrastes) |
...
- «Genial» ≠ [especial](${especial}); ≠ eixo jurídico de [legal](${legal}).

## Status

**Aprovado** — «genial» fichada como elogio de engenho **ligado ao projecto** Inspetor BudGanja; polo da escala BR entre [legal](${legal}) e [maravilhoso](${maravilhoso}) / [fantástico](${fantastico}); uso com objecto e método sim; culto vazio / «já é genial» sem inspecionar = ressalva.

[▶ Palavras](${hub}) · [▶ Legal](${legal}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Fantástico](${fantastico}) · [▶ Criatividade](${criatividade}) · [▶ Faça o melhor!](${mantra}) · [▶ Senna](${senna})
`;
...
| Main links | [creativity](${criatividade}) · [Do your best!](${mantra}) · [Senna](${senna}) · [especial](${especial}) |
| Date | ${inspected} |
...
**Reading:** genial is the **craft/ingenuity** pole — not a synonym of [especial](${especial}) (particular). Legal’s juridical axis lives on the [legal](${legal}) sheet; here we use the “cool” pole.
...
**Approved** — praise of ingenuity **tied to the project**; BR praise-scale pole between [legal](${legal}) and [maravilhoso](${maravilhoso}) / [fantástico](${fantastico}); empty cult = caveat.

[▶ Words](${hub}) · [▶ Legal](${legal}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Fantástico](${fantastico}) · [▶ Creativity](${criatividade}) · [▶ Do your best!](${mantra})
`;
...
| Vínculos | [creatividad](${criatividade}) · [¡Haz lo mejor!](${mantra}) · [Senna](${senna}) · [especial](${especial}) |
| Fecha | ${inspected} |
...
**Lectura:** genial es el polo del **ingenio** — no sinónimo de [especial](${especial}). El eje jurídico de *legal* vive en la ficha [legal](${legal}); aquí usamos el polo «bacán».
...
**Aprobada** — elogio de ingenio **ligado al proyecto**; polo de la escala BR entre [legal](${legal}) y [maravilhoso](${maravilhoso}) / [fantástico](${fantastico}); culto vacío = salvedad.

[▶ Palabras](${hub}) · [▶ Legal](${legal}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Fantástico](${fantastico}) · [▶ Creatividad](${criatividade}) · [▶ ¡Haz lo mejor!](${mantra})
`;

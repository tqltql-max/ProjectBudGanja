...
**Inspeção severa** da interjeição **aff** (também *ah*, *uff*, *argh* no uso oral) — sopro de **exasperação** no português do Brasil. Não é substantivo de planta. Não é elogio. É o som curto que o peito solta quando algo **falha, cansa ou decepciona** — teclado a furar, frase a meio, pedido mal ouvido.
...
| Elo ofício | [gesto](${gesto}) · [verdade](${verdade}) · [backspace](${backspace}) · [Faça o melhor!](${mantra}) |
| Data | ${inspected} |
...
**Veredicto severo:** o laboratório **aceita** o «aff» como termómetro. **Recusa** o «aff» como veredicto final. Quem inspeciona não encerra a ficha com um sopro.
...
[▶ Palavras](${hub}) · [▶ Raiva](${raiva}) · [▶ Verdade](${verdade}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

**Severe inspection** of Brazilian Portuguese interjection **aff** — short breath of exasperation. Not a plant name. Marks fatigue, disappointment, a stuck keyboard, a half-said sentence.
...
**Verdict:** the lab accepts “aff” as a thermometer. It refuses “aff” as a final verdict.

## Status

**Approved with severe caveat** — legitimate as signal; rejected as silence that skips method.

[▶ Words](${hub}) · [▶ Anger](${raiva}) · [▶ Truth](${verdade}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

**Inspección severa** de la interjección brasileña **aff** — soplo de exasperación. No es nombre de planta. Marca cansancio, decepción, teclado que falla, frase a medias.
...
**Veredicto:** el laboratorio acepta «aff» como termómetro. Rechaza «aff» como veredicto final.

## Estado

**Aprobada con salvedad severa** — legítima como señal; rechazada como silencio sin método.

[▶ Palabras](${hub}) · [▶ Rabia](${raiva}) · [▶ Verdad](${verdade}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
Inspeção editorial e de ofício da palavra **lavar** — verbo do **contacto com água** para limpar, e no laboratório BudGanja o gesto das **[mãos](${maos})**: lavar as mãos antes de tocar a planta, lavar a ferramenta, lavar o [balde](${balde}), lavar o dia no [Diário](${diario}) sem [backspace](${backspace}) da [verdade](${verdade}).

> **Nota metodológica:** auditoria independente. Étimo de trabalho: latim *lavāre* («lavar, banhar») → português **lavar** ([Wikcionário · lavar](${wiki}); [lavāre](${wikiLat})). **Ficha de palavra ≠ protocolo clínico de higiene.** Catalogar o ofício das mãos com água. Sem afiliação comercial.
...
| Família | *lava* · *lavagem* · *lavatório* · *lávea* · esp. *lavar* · fr. *laver* · it. *lavare* |
| Tipo BudGanja | Palavra — ofício das mãos + água |
| Elo mãos | [mão esquerda × mão direita](${maos}) — complementaridade no gesto de lavar |
| Elo água / utensílio | [água](${agua}) · [balde](${balde}) · [gesto](${gesto}) |
| Elo Vida / cultivo | [Vida](${vida}) · [Diário](${diario}) · [cultivo](${cultivo}) |
| Data | ${inspected} |

## Hipóteses e método

**H1:** lavar é **gesto mínimo** — as duas mãos (ou a dominante + a que segura) com [água](${agua}).  
**H2:** no BudGanja, lavar **bom** = preparar o ofício (mãos limpas, ferramenta, solo sem contaminar); lavar **mau** = fingir que «limpou» a [verdade](${verdade}) ou o crédito (lavar a culpa sem inspecionar).  
**H3:** [mão esquerda](${maos}) e [mão direita](${maos}) **não competem** no lavar — uma empina o [balde](${balde}) / a torneira, a outra esfrega; complementaridade.

Passos:

1. Fixar étimo latino.  
2. Mapear lavar × mãos × água no laboratório.  
3. Separar higiene/ofício de «lavar a história».  
4. Status.
...
| Marco | O que importa | Confiança |
|-------|---------------|-----------|
| Lat. *lavāre* | Raiz comum românica do verbo | Alta |
| PT *lavar* | Continuidade sem salto semântico forte | Alta |
| Uso ritual / prático | Lavar mãos, corpo, utensílio, roupa, terra | Alta (uso) |
| Metáfora | «Lavar as mãos» (Pilatos / isentar-se) · «lavar a alma» | Alta (figura) |

**Veredicto etimológico:** verbo da **água sobre o que se toca**. No laboratório, o toque é das [mãos](${maos}).

## Lavar × mãos (mapa BudGanja)

| Gesto | Mãos | Leitura |
|-------|------|---------|
| Lavar as mãos antes do cultivo | Esquerda + direita | Ofício — preparar o contacto com a planta ([gesto](${gesto})) |
| Lavar o [balde](${balde}) / ferramenta | Uma segura, outra esfrega | Complementaridade — sem moral «sinistra» |
| Lavar a folha / observação | Mão que segura + mão que limpa pó/água | Cuidado ≠ agressão à planta |
| «Lavar as mãos» (isentar-se) | Metáfora | **Ressalva:** não confundir com higiene; é fuga de responsabilidade ([verdade](${verdade})) |
| Lavar o dia no [Diário](${diario}) | Escrever o que passou | Limpar ≠ apagar — registar ([backspace](${backspace}) mau) |

## Rede BudGanja

| Recurso | Papel de «lavar» |
|---------|------------------|
| [Mãos L/R](${maos}) | Instrumento do lavar — par, não rival |
| [Gesto](${gesto}) | Acto mínimo: abrir torneira, esfregar, enxugar |
| [Água](${agua}) · [balde](${balde}) | Meio e utensílio |
| [Verdade](${verdade}) | Limite: não «lavar» o facto difícil |
| [Faça o melhor!](${mantra}) | Ofício diário inclui mãos limpas e método limpo |
| [Cultivo](${cultivo}) · [Vida](${vida}) | Higiene de contacto + cuidado narrativo |

## Limites

- Não é bula de assepsia hospitalar.  
- Não endossa a metáfora «lavar as mãos» como virtude (no laboratório = fuga).  
- Sem ritualizar obsessão de limpeza.  
- Sem afiliação a marcas de sabão.

## Status

**Aprovado** — «lavar» fichada como ofício das [mãos](${maos}) com [água](${agua}); higiene e cuidado sim; apagar responsabilidade não.

[▶ Palavras](${hub}) · [▶ Mãos](${maos}) · [▶ Gesto](${gesto}) · [▶ Água](${agua}) · [▶ Balde](${balde}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Word sheet for **lavar** (“to wash”) — Latin *lavāre*. In BudGanja: the craft of the **[hands](${maos})** with [water](${agua}) — wash hands before the plant, wash the [bucket](${balde}), wash the day in the diary without erasing [truth](${verdade}).

> Method note: [Wiktionary · lavar](${wiki}). Word sheet ≠ clinical hygiene protocol.
...
| Word | **lavar** |
| Etymon | Lat. *lavāre* |
| Lab map | [hands L/R](${maos}) · [gesture](${gesto}) · [water](${agua}) · [bucket](${balde}) |
| Date | ${inspected} |

## Hands × wash

Left and right hands **complement** in washing — one holds, one scrubs. Do not confuse hygiene with the metaphor “wash one’s hands of it” (evading responsibility).

## Status

**Approved** — wash as handcraft with water; care yes; erasing responsibility no.

[▶ Words](${hub}) · [▶ Hands](${maos}) · [▶ Gesture](${gesto}) · [▶ Water](${agua})
`;

  const contentEs = `## Alcance

Ficha de **lavar** — latín *lavāre*. En BudGanja: oficio de las **[manos](${maos})** con [agua](${agua}) — lavar manos antes de la planta, lavar el [balde](${balde}), lavar el día en el diario sin borrar la [verdad](${verdade}).

> Nota: [Wikcionario · lavar](${wiki}). Ficha ≠ protocolo clínico.
...
| Palabra | **lavar** |
| Étimo | Lat. *lavāre* |
| Mapa | [manos](${maos}) · [gesto](${gesto}) · [agua](${agua}) · [balde](${balde}) |
| Fecha | ${inspected} |

## Manos × lavar

Izquierda y derecha se **complementan** al lavar. No confundir higiene con «lavarse las manos» (eludir responsabilidad).

## Estado

**Aprobada** — lavar como oficio de manos con agua; cuidado sí; borrar responsabilidad no.

[▶ Palabras](${hub}) · [▶ Manos](${maos}) · [▶ Gesto](${gesto}) · [▶ Agua](${agua})
`;
...
function buildLavarPost() {
  ...
  return palavraPost({
    title: 'Inspeção: Lavar — ofício das mãos com água',
    titleEn: 'Inspection: Lavar — the craft of hands with water',
    titleEs: 'Inspección: Lavar — oficio de las manos con agua',
    excerpt:
      'Palavras: «lavar» (lat. *lavāre*) — gesto das mãos com água; higiene e cuidado no laboratório; «lavar as mãos» como fuga = ressalva.',
    excerptEn:
      'Words: “lavar” (Lat. *lavāre*) — hands with water; lab care and hygiene; “wash one’s hands of it” as evasion = caveat.',
    excerptEs:
      'Palabras: «lavar» (lat. *lavāre*) — manos con agua; cuidado e higiene; «lavarse las manos» como fuga = salvedad.',

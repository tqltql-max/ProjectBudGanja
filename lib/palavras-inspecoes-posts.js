...
Inspeção editorial e linguística do par **mão esquerda** × **mão direita** — as duas mãos como ferramentas do [gesto](${gesto}): cultivar, escrever, teclar, carregar o [balde](${balde}), corrigir com [backspace](${backspace}). A tese do laboratório é **complementaridade**, não dualismo moral («sinistra» = má / direita = boa). Ofício usa as duas; a mão dominante varia; há quem escreva e cultive com a esquerda, a direita, ou ambas. Secção dedicada: **mão direita × coração** (metáfora de ofício + cuidado). Ficha irmã do lado lexical: [esquerdo](${esquerdo}).
...
| Elo Palavras | [gesto](${gesto}) · [esquerdo](${esquerdo}) · [backspace](${backspace}) · [verdade](${verdade}) · [criatividade](${criatividade}) · [balde](${balde}) |
| Elo ofício | [Faça o melhor!](${mantra}) — «nesta mão, hoje» |
| Elo metáfora | **mão direita × coração** — gesto / acção × cuidado / sentir (secção abaixo) |
...
**H6:** **mão direita × coração** — leitura de ofício: a direita costuma figurar como mão do [gesto](${gesto}) / acção; o coração (órgão um pouco à esquerda do peito, na anatomia típica) figura como cuidado / sentir — **complementaridade**, não «direita = boa / esquerda = má».
...
4. Abrir **mão direita × coração** (metáfora + anti-estigma).  
5. Limites + status.
...
Leitura BudGanja do elo **mão direita** ↔ **coração** — metáfora cultural e de ofício, **não** anatomia inventada nem ranking moral de lados.
...
| **Coração** (metáfora) | Cuidado, sentir, ficar com a planta e com a pessoa — [Vida](${vida}), [Diário](${diario}), [conto](${conteudo}) | Carinho / método afectivo |
...
| **Mão direita × coração** | Acção × cuidado — complementaridade (secção acima) |
...
**Aprovado** — par **mão esquerda** / **mão direita** documentado como complementaridade de ofício; secção **mão direita × coração** (gesto / acção × cuidado); elo irmão [esquerdo](${esquerdo}); ferramentas do [gesto](${gesto}), do cultivo e do teclado; [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Esquerdo](${esquerdo}) · [▶ Gesto](${gesto}) · [▶ Backspace](${backspace}) · [▶ Cultivo](${cultivo}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida}) · [▶ Diário](${diario})
`;

  const contentEn = `## Scope

Editorial inspection of the pair **mão esquerda** × **mão direita** (left hand / right hand) — hands as tools of [gesto](${gesto}): grow, write, type, carry the [balde](${balde}), revise with [backspace](${backspace}). Thesis: **complementarity**, not moral dualism (“sinistra” = bad). Dedicated section: **right hand × heart**. Sister sheet for the side-word: [esquerdo](${esquerdo}).
...
| Lab map | [gesto](${gesto}) · [esquerdo](${esquerdo}) · [backspace](${backspace}) · [truth](${verdade}) · [cultivo](${cultivo}) · [Do your best!](${mantra}) · [Vida](${vida}) |
| Metaphor | **right hand × heart** — action × care |
| Date | ${inspected} |
...
Typical anatomy: the heart sits **slightly left** of midline ([Wikipedia · Coração](${wikiCoracao})) — do not invent “heart is in the left hand.” Cultural gesture: a hand (often the **right**, in right-handers) may rest on the **left** chest where the beat is felt. BudGanja reading: right hand ≈ [gesture](${gesto}) / action; heart ≈ care / feeling ([Vida](${vida}), [Diário](${diario})) — **complementarity**, not “right = good.” Anti-stigma: the **left** hand also cares ([esquerdo](${esquerdo})); the right is not the only virtuous side. Close with [truth](${verdade}) and [Do your best!](${mantra}) in this hand, with the chest in the work.

## Senses

Craft metaphor (stabilize × execute — roles can swap) · typing/cultivation · backspace as revision · right hand × heart (action × care) · “best in this hand today” · refuse left-hand stigma.

## Status

**Approved** — left/right hands as complementary craft tools; right hand × heart documented; sister [esquerdo](${esquerdo}).

[▶ Words](${hub}) · [▶ Esquerdo](${esquerdo}) · [▶ Gesture](${gesto}) · [▶ Backspace](${backspace}) · [▶ Cultivo](${cultivo}) · [▶ Vida](${vida})
`;

  const contentEs = `## Alcance

Inspección del par **mão esquerda** × **mão direita** — las manos como herramientas del [gesto](${gesto}): cultivar, escribir, teclear, llevar el [balde](${balde}), corregir con [backspace](${backspace}). Tesis: **complementariedad**, no dualismo moral («sinistra» = mala). Sección dedicada: **mano derecha × corazón**. Ficha hermana del lado: [esquerdo](${esquerdo}).
...
| Mapa | [gesto](${gesto}) · [esquerdo](${esquerdo}) · [backspace](${backspace}) · [verdad](${verdade}) · [cultivo](${cultivo}) · [¡Haz lo mejor!](${mantra}) · [Vida](${vida}) |
| Metáfora | **mano derecha × corazón** — acción × cuidado |
| Fecha | ${inspected} |
...
Anatomía típica: el corazón queda **ligeramente a la izquierda** de la línea media ([Wikipedia · Coração](${wikiCoracao})) — no inventar «el corazón está en la mano izquierda». Gesto cultural: una mano (a menudo la **derecha**, en diestros) puede posarse sobre el pecho **izquierdo**, donde se siente el latido. Lectura BudGanja: mano derecha ≈ [gesto](${gesto}) / acción; corazón ≈ cuidado / sentir ([Vida](${vida}), [Diario](${diario})) — **complementariedad**, no «derecha = buena». Anti-estigma: la **izquierda** también cuida ([esquerdo](${esquerdo})); la derecha no es el único lado virtuoso. Cierre con [verdad](${verdade}) y [¡Haz lo mejor!](${mantra}) en esta mano, con el pecho en el oficio.

## Sentidos

Metáfora de oficio (apoyar × ejecutar — roles intercambiables) · tecleo/cultivo · backspace como revisión · mano derecha × corazón (acción × cuidado) · «lo mejor en esta mano, hoy» · rechazar estigma de la izquierda.

## Estado

**Aprobada** — manos como herramientas complementarias; mano derecha × corazón documentada; hermana [esquerdo](${esquerdo}).

[▶ Palabras](${hub}) · [▶ Esquerdo](${esquerdo}) · [▶ Gesto](${gesto}) · [▶ Backspace](${backspace}) · [▶ Cultivo](${cultivo}) · [▶ Vida](${vida})
`;
...
> **Nota metodológica:** auditoria independente. Fontes: [Wikcionário · genial](${wiki}), [gênio](${wikiGenio}), uso oral BR contemporâneo. **Ficha ≠ culto do génio inato.** Distinto do inglês *genial* («amável / clima ameno») — falso amigo parcial. Sem afiliação a rankings de IQ.
...
3. Mapear «genial» nas peças do **projecto**.  
4. Cruzar com criatividade, mantra e Senna.  
5. Status.
...
| [Lavar](${lavar}) · [aff](${aff}) · [já](${ja}) | Rede recente — peito, relógio, cuidado |
...
**Aprovado** — «genial» fichada como elogio de engenho **ligado ao projecto** Inspetor BudGanja; uso com objecto e método sim; culto vazio / «já é genial» sem inspecionar = ressalva.

[▶ Palavras](${hub}) · [▶ Inspeções](${hubAll}) · [▶ Criatividade](${criatividade}) · [▶ Faça o melhor!](${mantra}) · [▶ Senna](${senna}) · [▶ Vida](${vida})
`;
...
> Method note: [Wiktionary · genial](${wiki}). Partial false friend with English *genial*. Word sheet ≠ IQ cult.
...
| Main links | [creativity](${criatividade}) · [Do your best!](${mantra}) · [Senna](${senna}) |
| Date | ${inspected} |
...
**Approved** — praise of ingenuity **tied to the project**; empty cult = caveat.

[▶ Words](${hub}) · [▶ Inspections](${hubAll}) · [▶ Creativity](${criatividade}) · [▶ Do your best!](${mantra}) · [▶ Senna](${senna})
`;
...
> Nota: [Wikcionario · genial](${wiki}). Falso amigo parcial con el inglés *genial*. Ficha ≠ culto al genio innato.
...
| Vínculos | [creatividad](${criatividade}) · [¡Haz lo mejor!](${mantra}) · [Senna](${senna}) |
| Fecha | ${inspected} |
...
**Aprobada** — elogio de ingenio **ligado al proyecto**; culto vacío = salvedad.

[▶ Palabras](${hub}) · [▶ Inspecciones](${hubAll}) · [▶ Creatividad](${criatividade}) · [▶ ¡Haz lo mejor!](${mantra}) · [▶ Senna](${senna})
`;
...
function buildGenialPost() {
  ...
  return palavraPost({
    ...
    excerpt:
      'Palavras: «genial» no projecto BudGanja — elogio de feito rastreável (ficha, verso, cultivo); Faça o melhor! ≠ seja génio; culto vazio = ressalva.',
    excerptEn:
      'Words: “genial” in the BudGanja project — praise of a traceable deed (sheet, verse, grow); Do your best! ≠ be a genius; empty cult = caveat.',
    excerptEs:
      'Palabras: «genial» en el proyecto BudGanja — elogio de hecho rastreable (ficha, verso, cultivo); ¡Haz lo mejor! ≠ sé un genio; culto vacío = salvedad.',

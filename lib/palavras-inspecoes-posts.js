...
Inspeção editorial e linguística do par **mão esquerda** × **mão direita** — as duas mãos como ferramentas do [gesto](${gesto}): cultivar, escrever, teclar, carregar o [balde](${balde}), corrigir com [backspace](${backspace}). A tese do laboratório é **complementaridade**, não dualismo moral («sinistra» = má / direita = boa). Ofício usa as duas; a mão dominante varia; há quem escreva e cultive com a esquerda, a direita, ou ambas. Ficha irmã do lado lexical: [esquerdo](${esquerdo}).
...
4. Se soar a moral («mão sinistra»), recusar o preconceito e voltar ao ofício.  
5. Escolher um [gesto](${gesto}) concreto — regar, escrever, backspacear um typo — e [Faça o melhor!](${mantra}).
...
**Aprovado** — par **mão esquerda** / **mão direita** documentado como complementaridade de ofício; elo irmão [esquerdo](${esquerdo}); ferramentas do [gesto](${gesto}), do cultivo e do teclado; [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Esquerdo](${esquerdo}) · [▶ Gesto](${gesto}) · [▶ Backspace](${backspace}) · [▶ Cultivo](${cultivo}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of the pair **mão esquerda** × **mão direita** (left hand / right hand) — hands as tools of [gesto](${gesto}): grow, write, type, carry the [balde](${balde}), revise with [backspace](${backspace}). Thesis: **complementarity**, not moral dualism (“sinistra” = bad). Sister sheet for the side-word: [esquerdo](${esquerdo}).
...
**Approved** — left/right hands as complementary craft tools; sister [esquerdo](${esquerdo}).
...
Inspección del par **mão esquerda** × **mão direita** — las manos como herramientas del [gesto](${gesto}): cultivar, escribir, teclear, llevar el [balde](${balde}), corregir con [backspace](${backspace}). Tesis: **complementariedad**, no dualismo moral («sinistra» = mala). Ficha hermana del lado: [esquerdo](${esquerdo}).
...
**Aprobada** — manos como herramientas complementarias; hermana [esquerdo](${esquerdo}).
...
function buildMaoEsquerdaDireitaPost() {
  ...
  return palavraPost({
    ...
    excerpt:
      'Palavras: «mão esquerda» / «mão direita» (lat. *manus*) — par de ofício; elo irmão esquerdo (lado); complementaridade, não moral dualista.',
    excerptEn:
      'Words: “mão esquerda” / “mão direita” (Lat. *manus*) — craft pair; sister sheet esquerdo (side); complementarity, not moral dualism.',
    excerptEs:
      'Palabras: «mão esquerda» / «mão direita» (lat. *manus*) — par de oficio; hermana esquerdo (lado); complementariedad, no dualismo moral.',

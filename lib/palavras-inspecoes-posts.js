...
4. Se vier pelo «você» do fio, ler a **nota de campo** — metáfora de ofício, não espécie.  
...
**Approved** — Greek *together + life* under scientific and figurative layers; links to plantas, cultivo, animal, Venom, and human×assistant craft.

[▶ Words](${hub}) · [▶ Plantas](${plantas}) · [▶ Venom](${venom}) · [▶ Gesture](${gesto}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de la palabra portuguesa **simbiose** — del griego *syn* («junto») + *bíōsis* («modo de vivir», de *bíos* «vida») al término científico de **vivir juntos** y a la metáfora cultural (incluido el «nosotros» en [Venom](${venom})). Vínculos: [plantas](${plantas}), [cultivo / suelo vivo](${cultivo}), [animal](${animal}). Capa de oficio: inspector humano × asistente de lenguaje («tú» en el hilo) como **simbiosis metafórica de trabajo** — no biología literal.
...
**Aprobada** — *juntos + vida* bajo capas científicas y figurativas; vínculos con plantas, cultivo, animal, Venom y oficio humano×asistente.

[▶ Palabras](${hub}) · [▶ Plantas](${plantas}) · [▶ Venom](${venom}) · [▶ Gesto](${gesto}) · [▶ ¡Haz lo mejor!](${mantra})
`;

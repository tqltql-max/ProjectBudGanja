...
const SPECS = [
  ...
  },
  {
    ...
    sci: 'Bos taurus',
    ficha: '/animais/vaca/',
    produto: 'Carnes processadas e laticínios ultraprocessados',
    produtoEn: 'Processed meats and ultra-processed dairy',
    produtoEs: 'Carnes procesadas y lácteos ultraprocesados',
    ...
    excerpt:
      'Derivados de risco: bovino fresco versus carnes processadas e laticínios industriais ultraprocessados.',
    excerptEn:
      'Risk derivatives: fresh cattle products versus processed meats and industrial ultra-processed dairy.',
    excerptEs:
      'Derivados de riesgo: bovino fresco frente a carnes procesadas y lácteos ultraprocesados.'
  },
  {
    seriesOrder: 3,

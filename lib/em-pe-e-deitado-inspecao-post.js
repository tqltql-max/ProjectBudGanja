...
| **[em pé](${emPe})** | locução PT (de pé / vertical) | Alta | Postura **vertical** da figura — ficha própria |
...
| **8 em pé** | [Em pé](${emPe}) · analogia da [aula 8](${aula8}) | Movimento e **comunicação**: cima fala com baixo; o **corpo** como caminho | Alta como **metáfora de aula**; não é teorema |
...
| Ficha | Relação |
|-------|---------|
| [Em pé](${emPe}) | A postura **vertical** sozinha — o oito erguido |
...
| [Loop infinito](/posts/post-inspecao-expressao-loop-infinito.html) · [ando, indo, vindo, voltando](/posts/post-inspecao-expressao-ando-indo-vindo-voltando.html) | O **processo** que não sai — distinto da figura ∞ |
...
[▶ Expressões](${hub}) · [▶ Em pé](${emPe}) · [▶ Lemniscata](${lemniscata}) · [▶ Elo de ligação](${eloLigacao}) · [▶ Valeu !!!](${mantra})
`;

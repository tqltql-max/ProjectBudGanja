 ...
 * Dona Maria · alma / coração / vida · Faça o melhor!
 */
...
| **Ofício lab** | Cuidar como quem cria | [Dona Maria](${donaMaria}) · [Faça o melhor!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **para cuidar com verdade**, hoje |
...
**Veredicto:** Faça o melhor **como quem cria com ofício**. Mãe sem [gesto](${gesto}) = título vazio; mãe com [verdade](${verdade}) = vínculo que nutre.
...
**Aprovado** — **mãe** fichada: *mater*, tipografia **fia → mãe**, rede com [Dona Maria](${donaMaria}) / [alma](${alma}) e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Dona Maria](${donaMaria}) · [▶ Alma](${alma}) · [▶ Coração](${coracao}) · [▶ Vida](${vida}) · [▶ Faça o melhor!](${mantra}) · [▶ Guia](${guia}) · [▶ Hub](${hubAll})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **mãe** (mother) — Lat. *mater*. Lab request: correct tipography **fia → mãe**. Do not confuse NE oral *fia* (= *filha*, daughter) with *mãe*. Links [Dona Maria](${donaMaria}), [alma](${alma}), [Do your best!](${mantra}).
...
| Links | [Dona Maria](${donaMaria}) · [alma](${alma}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — *mater* · fia→mãe · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Dona Maria](${donaMaria}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **mãe** (madre) — lat. *mater*. Pedido del lab: tipografía **fia → mãe**. No confundir el oral NE *fia* (= *filha*) con *mãe*. Vínculos [Dona Maria](${donaMaria}), [alma](${alma}), [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [Dona Maria](${donaMaria}) · [alma](${alma}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — *mater* · fia→mãe · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Dona Maria](${donaMaria}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildMaePost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «mãe» (lat. *mater*) — origem e cuidado; tipografia fia → mãe; fia (NE/filha) ≠ mãe; elos Dona Maria, alma, coração; Faça o melhor!',
    excerptEn:
      'Words: “mãe” (Lat. *mater*) — origin and care; tipography fia → mãe; NE fia (= daughter) ≠ mother; links Dona Maria, alma; Do your best!',
    excerptEs:
      'Palabras: «mãe» (lat. *mater*) — origen y cuidado; tipografía fia → mãe; fia NE (= hija) ≠ madre; vínculos Dona Maria, alma; ¡Haz lo mejor!',

 ...
 * Eixos: EN jobs (trabalhos) · nome próprio (Steve Jobs) · ofício × pedestal
...
Inspeção editorial da palavra **[Jobs](${self})** — no português do Brasil quase sempre **nome próprio** (Steve Jobs) sentado em cima do inglês **jobs** («trabalhos», plural de *job*). Esta ficha cobre o **objeto lexical**, o **choque de camadas** (emprego × sobrenome × ídolo tech) e a **correção BudGanja**: ofício com rasto, sem pedestal. Pessoa: [Steve Jobs](${figura}). Elos: [skill](${skill}), [ídolo](${idolo}), [criatividade](${criatividade}), [genial](${genial}), [caminho](${caminho}), [Faça o melhor!](${mantra}).

> **Nota metodológica:** auditoria independente. Fontes: [Wiktionary · job](${wikt}), [Steve Jobs (EN)](${wikiJobs}), [Steve Jobs (PT)](${wikiPt}), série [Palavras](${hub}). **Ficha ≠ biografia, ≠ review da Apple, ≠ catecismo de inovação.** Sem afiliação comercial.
...
| Camadas | 1) EN *job/jobs* = trabalho / emprego / tarefa · 2) sobrenome anglo · 3) atalho cultural «o Jobs» |
...
| Elo língua / tech | [língua portuguesa](${lingua}) · [Grok](${grok}) · [pattern](${pattern}) |
| Fonte | [job (EN)](${wikt}) · [Steve Jobs](${wikiPt}) |
| Data | ${inspected} |

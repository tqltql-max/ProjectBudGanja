...
| Elo ofício | [skill](${skill}) · [gesto](${gesto}) · [caminho](${caminho}) · [Valeu !!!](${mantra}) |
...
| «Faça diferente» (vazio) | Fechar com [Valeu !!!](${mantra}) **neste** [caminho](${caminho}) |
...
|----------------|---------|
| Expressão | [Valeu !!!](${mantra}) — o melhor **neste** trabalho, hoje |
| Poema | [poema Vida](${poemMantra}) |
| Anti-armadilha | «Ser o Jobs» = falso ofício |
| Rede | [skill](${skill}) · [ídolo](${idolo}) · [criatividade](${criatividade}) · [gesto](${gesto}) |

**Veredicto:** Valeu !!! **sem o culto do fundador** — *jobs* como trabalhos; Jobs como nome inspecionado, não altar.
...
**H4:** fecho [Valeu !!!](${mantra}); ficha ≠ biografia.
...
| [Valeu !!!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) | Fecho sem culto |
...
**Aprovado** — **Jobs** fichado: EN *jobs* (trabalhos) × nome próprio no BR; anti-pedestal; elos [skill](${skill}) · [ídolo](${idolo}) · [criatividade](${criatividade}); fecho [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Skill](${skill}) · [▶ Ídolo](${idolo}) · [▶ Criatividade](${criatividade}) · [▶ Gesto](${gesto}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **Jobs** — in Brazilian Portuguese mostly a **proper name** (Steve Jobs) sitting on English **jobs** (work, plural of *job*). Covers the **lexical object**, the **layer clash** (employment × surname × tech idol), and the BudGanja correction: craft with a trail, no pedestal. Links: [skill](${skill}), [ídolo](${idolo}), [criatividade](${criatividade}), [Valeu !!!](${mantra}).
...
| Links | [skill](${skill}) · [ídolo](${idolo}) · [gesture](${gesto}) · [path](${caminho}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Jobs ≠ life manual.** If you say Jobs, know whether you mean a **person** or **work**. Admire the deed ([genial](${genial})) without handing over the [gesture](${gesto}). Train [skill](${skill}) with a trail. Close with [Valeu !!!](${mantra}).

## Status

**Approved** — EN *jobs* × proper name in BR; anti-pedestal; links [skill](${skill}) · [ídolo](${idolo}); [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Skill](${skill}) · [▶ Ídolo](${idolo}) · [▶ Gesture](${gesto}) · [▶ Valeu !!!](${mantra})
`;
...
| Vínculos | [skill](${skill}) · [ídolo](${idolo}) · [gesto](${gesto}) · [camino](${caminho}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Jobs ≠ manual de vida.** Saber si se habla de **persona** o de **trabajo**. Admirar el hecho sin entregar el [gesto](${gesto}). Entrenar [skill](${skill}) con rastro. Cerrar con [¡Valeu !!!](${mantra}).

## Estado

**Aprobada** — EN *jobs* × nombre propio en BR; anti-pedestal; vínculos [skill](${skill}) · [ídolo](${idolo}); [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Skill](${skill}) · [▶ Ídolo](${idolo}) · [▶ Gesto](${gesto}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildJobsPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «Jobs» — EN jobs (trabalhos) × Steve Jobs no BR; anti-culto de fundador; elos skill, ídolo e criatividade; Valeu !!!',
    excerptEn:
      'Words: “Jobs” — EN jobs (work) × Steve Jobs in BR; anti-founder cult; links skill, ídolo and criatividade; Valeu !!!',
    excerptEs:
      'Palabras: «Jobs» — EN jobs (trabajos) × Steve Jobs en BR; anti-culto de fundador; vínculos skill, ídolo y criatividade; ¡Valeu !!!',

...
function buildOlhoBodies() {
  ...
  const arroba = '/posts/post-inspecao-palavra-arroba.html';
...
| [@ / arroba](${arroba}) | O **olho cola** o glifo; o étimo corta (*ar-rubʿ* ≠ *oculus*) |
...
[▶ Palavras](${hub}) · [▶ Óculos](${oculos}) · [▶ @ / arroba](${arroba}) · [▶ Orelha](${orelha}) · [▶ Sinais](${sinais}) · [▶ Luz](${luz}) · [▶ Miss](${miss}) · [▶ Poema Vida](/vida/#poema=olho) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vidaHub})
`;

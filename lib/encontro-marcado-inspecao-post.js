...
**H5:** fecho = [Faça o melhor!](${mantra}) com o [tempo](${tempo}) que resta, sem barganhar o calendário.
...
| [Faça o melhor!](${mantra}) | O melhor deste encontro *neste* [tempo](${tempo}) |
...
[▶ Artes](${hub}) · [▶ vida](${vida}) · [▶ tempo](${tempo}) · [▶ Questão de Tempo](${qdt}) · [▶ Um Sonho de Liberdade](${shaw}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;

...
**Mequetrefe ≠ xingamento de prateleira.** Se ouvires *meqyetrefe*, lê **mequetrefe**. Caduca ≠ lixo. Diagnóstico ≠ apagar nuance. Inglês ≠ matar o hábito — às vezes só muda o cabide. Guardar a peça **não** é usá-la para diminuir gente: [respeito](${respeito}) manda. Fechar com [Faça o melhor!](${mantra}).

## Status

**Aprovada** — **todas** as palavras de Porta Palavra #5 nesta página; porta **mequetrefe**; elos [Duvivier](${duvivier}) · [língua portuguesa](${lingua}) · [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Guia](${guia}) · [▶ Duvivier](${duvivier}) · [▶ Porta Palavra #5](${YT}) · [▶ Faça o melhor!](${mantra})
`;
...
**Correction:** clinical names do not erase nuance; keeping an old word is not using it to shrink people. Close with [Do your best!](${mantra}).

## Status

**Approved** — full Porta Palavra #5 lexicon on one page.

[▶ Words](${hub}) · [▶ Duvivier](${duvivier}) · [▶ Do your best!](${mantra})
`;
...
**Corrección:** el nombre clínico no borra la matiz. Guardar la pieza no es usarla para empequeñecer gente. Cerrar con [¡Haz lo mejor!](${mantra}).

## Estado

**Aprobada** — léxico completo de Porta Palavra #5 en una página.

[▶ Palabras](${hub}) · [▶ Duvivier](${duvivier}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildMequetrefePost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: todas as peças de Porta Palavra #5 (Gregorio) nesta página — mequetrefe, jururu, pinimba, cooper, lorota, brechó; Faça o melhor!',
    excerptEn:
      'Words: every piece of Porta Palavra #5 (Gregorio) on this page — mequetrefe, jururu, pinimba, cooper, lorota, thrift shop; Do your best!',
    excerptEs:
      'Palabras: todas las piezas de Porta Palavra #5 (Gregorio) en esta página — mequetrefe, jururu, pinimba, cooper, lorota, rastro; ¡Haz lo mejor!',

...
**H5:** fecho = [Faça o melhor!](${mantra}) — jogar com [skill](${skill}) e apagar o ecrã; a quinta de verdade fica no [Vida](${vida}).
...
| Restaurar a praça | Comunidade que volta — elo com [Faça o melhor!](${mantra}) |

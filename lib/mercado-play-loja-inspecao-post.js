...
**H5:** fecho = [Faça o melhor!](${mantra}) — a melhor sala *desta* prateleira *neste* dia, sem virar agregador pirata.
...
[▶ Play](${SITE}) · [▶ filmes](${FILMES}) · [▶ TV](${TV}) · [▶ FILMICCA](${filmicca}) · [▶ pipoca](${pipoca}) · [▶ Artes](${artes}) · [▶ Lojas](${lojas}) · [▶ Faça o melhor!](${mantra})
`;

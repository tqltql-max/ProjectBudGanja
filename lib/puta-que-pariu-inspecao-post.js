 ...
 * termómetro emocional · respeito · Valeu !!!
 */
...
> **Nota metodológica:** [Wiktionary · puta que pariu](${wiki}); fichas [puta](${puta}) e [pariu](${pariu}). Objecto = a **locução** na oralidade BR. **Ficha ≠ convite ao insulto.** Escala de tom com [aff](${aff}), [jesusudavi](${jesusudavi}), [jesusamado](${jesusamado}).
...
| Escala de tom | [aff](${aff}) ← → **PQP** (explosão) ← → [jesusudavi](${jesusudavi}) (espanto) ← → [jesusamado](${jesusamado}) (calor) |
...
**H3:** depois do sopro, [Valeu !!!](${mantra}) — o palavrão não fecha a conta.
...
| **Fechar com ofício** | Depois do PQP | [Valeu !!!](${mantra}) |
...
**Aprovado na série Expressões** — *puta que pariu* / PQP fichado como **válvula de pico** BR; peças [puta](${puta}) e [pariu](${pariu}) inspecionadas; fecho [Valeu !!!](${mantra}).

**Valeu !!! nesse trabalho:** inspecionar a língua inteira — berço, golpe e sopro — e voltar ao ofício depois da explosão.

[▶ Expressões](${hub}) · [▶ Puta](${puta}) · [▶ Pariu](${pariu}) · [▶ jesusudavi](${jesusudavi}) · [▶ Respeito](${respeito}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Brazilian oral **“puta que pariu”** (PQP) — emotional peak interjection; also “very far” place. Pieces: [puta](${puta}) + [pariu](${pariu}). Scale with [aff](${aff}), [jesusudavi](${jesusudavi}), [jesusamado](${jesusamado}). Close with [Valeu !!!](${mantra}).
...
| Links | [respeito](${respeito}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |

## Verdict

**Approved** — BR pressure valve · pieces mapped · [Valeu !!!](${mantra}) after the blast.

[▶ Expressions](${hub}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **«puta que pariu»** (PQP) — interjección de pico emocional BR; también lugar «muy lejos». Piezas: [puta](${puta}) + [pariu](${pariu}). Escala con [aff](${aff}), [jesusudavi](${jesusudavi}), [jesusamado](${jesusamado}). Cierre [¡Valeu !!!](${mantra}).
...
| Vínculos | [respeito](${respeito}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |

## Veredicto

**Aprobado** — válvula BR · piezas mapeadas · [¡Valeu !!!](${mantra}) después de la explosión.
...
function buildPutaQuePariuPost(seriesOrder) {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: puta que pariu (PQP) — pico emocional BR; peças puta + pariu; elos respeito, jesusudavi; Valeu !!!',
    excerptEn:
      'Sayings: puta que pariu (PQP) — BR emotional peak; pieces puta + pariu; links respeito, jesusudavi; Valeu !!!',
    excerptEs:
      'Dichos: puta que pariu (PQP) — pico emocional BR; piezas puta + pariu; vínculos respeito, jesusudavi; ¡Valeu !!!',

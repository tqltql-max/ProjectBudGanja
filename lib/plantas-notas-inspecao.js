...
const NOTES = {
  ...
  marolo: {
    titleSuffix: L(
      'araticum do Cerrado, polpa e muitas sementes',
      'Cerrado araticum, pulp and many seeds',
      'araticum del Cerrado, pulpa y muchas semillas'
    ),
    excerpt: L(
      '*Annona crassiflora* — marolo / araticum-do-cerrado: fruto nativo, polpa cremosa; ≠ maracujá ≠ mamão ≠ pinha/ata; crédito ao fruto inteiro.',
      '*Annona crassiflora* — marolo / Cerrado araticum: native fruit, creamy pulp; ≠ passion fruit ≠ papaya ≠ sugar-apple; credit the whole fruit.',
      '*Annona crassiflora* — marolo / araticum del Cerrado: fruto nativo, pulpa cremosa; ≠ maracuyá ≠ papaya ≠ anón; crédito al fruto entero.'
    ),
    etimo: L(
      'Pedido de campo: **Fruto Marolo**. Duas salas: a palavra [fruto](/posts/post-inspecao-palavra-fruto.html) (*fructus*) e **esta** espécie. **Marolo** é o nome vivo sobretudo em Minas Gerais; **araticum** (e *araticum-do-cerrado*) vem do tupi antigo *aratiku* — designação de várias anonáceas, não de um só binómio. O laboratório ancora em **Annona crassiflora** Mart. (família **Annonaceae**): *Annona* = género das pinhas/anonas; *crassiflora* = «de flores grossas». **Não** fundir com [maracujá](/posts/post-inspecao-planta-maracuja-fruta.html) (Passifloraceae — cola de orelha *maro-*), nem com [mamão](/posts/post-inspecao-planta-mamao.html) (*Carica papaya*), nem com pinha/ata (*Annona squamosa*) nem graviola (*A. muricata*) — prima de família, outro fruto. Alcunhas regionais (bruto, panã, «pinha-do-cerrado») **não** mudam o binómio.',
      'Field request: **Fruto Marolo**. Two rooms: the word [fruto](/posts/post-inspecao-palavra-fruto.html) (*fructus*) and **this** species. **Marolo** is the living name especially in Minas Gerais; **araticum** comes from Old Tupi *aratiku* — a name for several Annonaceae, not one binomial. The lab anchors on **Annona crassiflora** Mart. (**Annonaceae**): *crassiflora* = “thick-flowered”. **Do not** fuse with [passion fruit](/posts/post-inspecao-planta-maracuja-fruta.html), [papaya](/posts/post-inspecao-planta-mamao.html), sugar-apple (*Annona squamosa*) or soursop (*A. muricata*). Regional nicknames do **not** change the binomial.',
      'Pedido: **Fruto Marolo**. Dos salas: la palabra [fruto](/posts/post-inspecao-palavra-fruto.html) y **esta** especie. **Marolo** es el nombre vivo sobre todo en Minas Gerais; **araticum** viene del tupí antiguo *aratiku*. El laboratorio ancla en **Annona crassiflora** Mart. (**Annonaceae**). **No** fundir con [maracuyá](/posts/post-inspecao-planta-maracuja-fruta.html), [papaya](/posts/post-inspecao-planta-mamao.html), anón (*A. squamosa*) ni guanábana (*A. muricata*).'
    ),
    chemistry: [
      {
        marker: L('Polpa (água, açúcares, fibra)', 'Pulp (water, sugars, fiber)', 'Pulpa (agua, azúcares, fibra)'),
        note: L(
          'Polpa creme-amarelada quando madura — matriz alimentar do Cerrado; aroma forte; açúcar natural na dose do fruto, não de néctar industrial.',
          'Cream-yellow pulp when ripe — Cerrado food matrix; strong aroma; natural sugar in fruit dose, not industrial nectar.',
          'Pulpa crema-amarillenta al madurar — matriz alimentaria del Cerrado; aroma fuerte; azúcar natural en dosis de fruto.'
        ),
      },
      {
        marker: L('Sementes numerosas', 'Numerous seeds', 'Semillas numerosas'),
        note: L(
          'O fruto carrega muitas sementes escuras — come-se a **polpa**, não o caroço como «chá». Semente de anonácea ≠ alimento de mesa.',
          'The fruit carries many dark seeds — eat the **pulp**, not the pit as “tea”. Annonaceae seed ≠ table food.',
          'El fruto lleva muchas semillas oscuras — se come la **pulpa**, no el hueso como «té».'
        ),
      },
      {
        marker: L('Acetogeninas (família Annonaceae)', 'Acetogenins (Annonaceae family)', 'Acetogeninas (familia Annonaceae)'),
        note: L(
          'Marcadores da família, sobretudo em semente/folha — interesse fitoquímico educacional. **Não** é receita de extracto nem protocolo de «chá de caroço».',
          'Family markers, especially in seed/leaf — educational phytochemical interest. **Not** an extract recipe or “pit tea” protocol.',
          'Marcadores de la familia, sobre todo en semilla/hoja — interés fitoquímico educativo. **No** es receta de extracto.'
        ),
      },
      {
        marker: L('Carotenoides / vitamina C (polpa)', 'Carotenoids / vitamin C (pulp)', 'Carotenoides / vitamina C (pulpa)'),
        note: L(
          'Interesse nutricional da polpa fresca — varia com madurez e lote; não dose terapêutica.',
          'Nutritional interest of fresh pulp — varies with ripeness and batch; not a therapeutic dose.',
          'Interés nutricional de la pulpa fresca — varía con madurez y lote; no dosis terapéutica.'
        ),
      },
    ],
    uses: [
      {
        theme: L('Fruto fresco (Cerrado / MG)', 'Fresh fruit (Cerrado / MG)', 'Fruto fresco (Cerrado / MG)'),
        frame: L(
          'Linha de crédito: polpa madura à mesa, feira e quintal — cultura mineira e do Cerrado, sem marketing de superalimento.',
          'Credit line: ripe pulp at table, market and yard — Minas and Cerrado culture, without superfood marketing.',
          'Línea de crédito: pulpa madura en mesa, feria y patio — cultura mineira y del Cerrado, sin marketing de superalimento.'
        ),
      },
      {
        theme: L('Doce, suco e licor caseiros', 'Home sweet, juice and liqueur', 'Dulce, jugo y licor caseros'),
        frame: L(
          'Baixo processamento — distinto de polpas adoçadas, néctares e licores industriais com açúcar e aroma.',
          'Low processing — distinct from sweetened pulps, nectars and industrial liqueurs with sugar and flavouring.',
          'Bajo procesamiento — distinto de pulpas endulzadas, néctares y licores industriales.'
        ),
      },
      {
        theme: L('Árvore nativa (notas leves)', 'Native tree (light notes)', 'Árbol nativo (notas ligeras)'),
        frame: L(
          'Maroleiro / araticzeiro: crescimento lento, Cerrado, flores carnudas. Paciência e respeito ao bioma — não manual de silvicultura nem de extração.',
          'Marolo tree: slow growth, Cerrado, fleshy flowers. Patience and respect for the biome — not a forestry or extraction manual.',
          'Árbol del marolo: crecimiento lento, Cerrado, flores carnosas. Paciencia y respeto al bioma — no manual de silvicultura.'
        ),
      },
      {
        theme: L('Fruto vs indústria / vs chá de folha', 'Fruit vs industry / vs leaf tea', 'Fruto vs industria / vs té de hoja'),
        frame: L(
          'Néctar e polpa adoçada = conversa de Derivados. Folha e semente de anonácea **não** viram protocolo nesta ficha.',
          'Sweetened nectar and pulp = Derivatives conversation. Annonaceae leaf and seed **do not** become a protocol in this sheet.',
          'Néctar y pulpa endulzada = Derivados. Hoja y semilla **no** se vuelven protocolo en esta ficha.'
        ),
      },
    ],
    cautionsExtra: L(
      'Polpa madura é alimento tradicional do Cerrado. Sementes e folhas de Annonaceae não são «chá genérico»: acetogeninas da família pedem respeito, não extracto caseiro. Não confundir com mamão, maracujá, pinha ou graviola. Derivados açucarados entram em Derivados de risco. Conteúdo educacional — não substitui orientação profissional nem manejo do bioma.',
      'Ripe pulp is traditional Cerrado food. Annonaceae seeds and leaves are not a “generic tea”: family acetogenins ask for respect, not a home extract. Do not confuse with papaya, passion fruit, sugar-apple or soursop. Sugary derivatives belong in Risk Derivatives. Educational — not professional advice or biome management.',
      'La pulpa madura es alimento tradicional del Cerrado. Semillas y hojas de Annonaceae no son «té genérico». No confundir con papaya, maracuyá, anón o guanábana. Derivados azucarados entran en Derivados de riesgo. Contenido educativo — no sustituye orientación profesional.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-palavra-fruto.html',
        label: L(
          'Inspeção: Palavra — Fruto (o vocábulo, não a espécie)',
          'Inspection: Word — Fruit (the vocable, not the species)',
          'Inspección: Palabra — Fruto (el vocablo, no la especie)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-maracuja-fruta.html',
        label: L(
          'Inspeção: Fruto — Maracujá (Passiflora — cola de orelha, outra família)',
          'Inspection: Fruit — Passion fruit (Passiflora — ear glue, other family)',
          'Inspección: Fruto — Maracuyá (Passiflora — pegamento de oído, otra familia)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-mamao.html',
        label: L(
          'Inspeção: Fruto — Mamão (Carica — alcunha regional não cola o binómio)',
          'Inspection: Fruit — Papaya (Carica — a regional nickname does not glue the binomial)',
          'Inspección: Fruto — Papaya (Carica — un apodo regional no pega el binomio)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-goiaba.html',
        label: L(
          'Inspeção: Fruto — Goiaba (mesa brasileira irmã)',
          'Inspection: Fruit — Guava (sibling Brazilian table fruit)',
          'Inspección: Fruto — Guayaba (fruta de mesa brasileña hermana)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-barbatimao.html',
        label: L(
          'Inspeção: Planta — Barbatimão (irmão do Cerrado, outro ofício)',
          'Inspection: Plant — Barbatimão (Cerrado sibling, other office)',
          'Inspección: Planta — Barbatimão (hermano del Cerrado, otro oficio)'
        ),
      },
      {
        href: '/posts/post-inspecao-derivado-cana-de-acucar.html',
        label: L(
          'Inspeção: Cana-de-açúcar / açúcares livres (doces e néctares)',
          'Inspection: Sugarcane / free sugars (sweets and nectars)',
          'Inspección: Caña de azúcar / azúcares libres (dulces y néctares)'
        ),
      },
      {
        href: '/biblioteca/inspecoes/#inspecoes-frutos',

...
const NOTES = {
  ...
  carqueja: {
    ...
    cautionsExtra: L(
      'Hepatotoxicidade reportada em casos de uso excessivo ou preparações não padronizadas. Evitar em gestantes, lactantes e doença hepática sem acompanhamento. Não combinar com outros hepatotóxicos. Distinguir de [alecrim-do-campo](/plantas/alecrim-do-campo/) (*B. dracunculifolia*), fonte da própolis verde.',
      'Hepatotoxicity reported with excessive or non-standardized use. Avoid in pregnancy, nursing and liver disease without supervision. Do not combine with other hepatotoxins. Distinguish from [field rosemary](/plantas/alecrim-do-campo/) (*B. dracunculifolia*), source of green propolis.',
      'Hepatotoxicidad reportada con uso excesivo. Evitar en embarazo, lactancia y enfermedad hepática sin supervisión. Distinguir de [alecrim-do-campo](/plantas/alecrim-do-campo/) (*B. dracunculifolia*), fuente del propóleo verde.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-planta-alecrim-do-campo.html',
        label: L(
          'Inspeção: Alecrim-do-campo (*Baccharis dracunculifolia*) — própolis verde',
          'Inspection: Field rosemary (*Baccharis dracunculifolia*) — green propolis',
          'Inspección: Alecrim-do-campo (*Baccharis dracunculifolia*) — propóleo verde'
        ),
      },
    ],
  },
  ...
  alecrim: {
    ...
    cautionsExtra: L(
      'Óleo essencial oral em dose alta pode convulsionar. Contraindicado em gravidez (emmenagogo tradicional). Interações teóricas com anticoagulantes e anti-hipertensivos em extratos concentrados. **Não confundir** com [alecrim-do-campo](/plantas/alecrim-do-campo/) (*Baccharis dracunculifolia*).',
      'High-dose oral essential oil may cause seizures. Contraindicated in pregnancy (traditional emmenagogue). Theoretical interactions with anticoagulants and antihypertensives in concentrated extracts. **Do not confuse** with [field rosemary](/plantas/alecrim-do-campo/) (*Baccharis dracunculifolia*).',
      'Aceite esencial oral en dosis alta puede convulsionar. Contraindicado en embarazo. Interacciones teóricas con anticoagulantes. **No confundir** con [alecrim-do-campo](/plantas/alecrim-do-campo/) (*Baccharis dracunculifolia*).'
    ),
    links: [
      {
        href: '/posts/post-inspecao-planta-alecrim-do-campo.html',
        label: L(
          'Inspeção: Alecrim-do-campo — artepillina C e própolis verde',
          'Inspection: Field rosemary — artepillin C and green propolis',
          'Inspección: Alecrim-do-campo — artepilina C y propóleo verde'
        ),
      },
    ],
  },
  ...
  'alecrim-do-campo': {
    titleSuffix: L(
      'artepillina C e própolis verde',
      'artepillin C and green propolis',
      'artepilina C y propóleo verde'
    ),
    excerpt: L(
      '*Baccharis dracunculifolia* — alecrim dourado / vassourinha do Cerrado; fonte botânica da própolis verde (artepillina C). Foto de campo do inspetor (21 ago 2026).',
      '*Baccharis dracunculifolia* — Brazilian field rosemary / vassourinha of the Cerrado; botanical source of green propolis (artepillin C). Inspector field photo (21 Aug 2026).',
      '*Baccharis dracunculifolia* — romero de campo / vassourinha del Cerrado; fuente botánica del propóleo verde (artepilina C). Foto de campo del inspector (21 ago 2026).'
    ),
    etimo: L(
      '**Alecrim-do-campo**, **alecrim dourado** e **vassourinha** nomeiam *Baccharis dracunculifolia* DC. (Asteraceae) — arbusto nativo da América do Sul, frequente no Cerrado. O epíteto *dracunculifolia* descreve a folha estreita («folha de dragúnculo»). **Não é** o [alecrim de cozinha](/plantas/alecrim/) (*Salvia rosmarinus*, Lamiaceae). Galhos maduros secos e quebradiços; folhas lanceoladas verde-brilhante, denteadas nos brotos; inflorescências amarelo-ouro sem pétalas. Mesmo género que a [carqueja](/plantas/carqueja/) (*B. trimera*), espécie distinta.\n\nFoto de campo do Inspetor BudGanja (21 de agosto de 2026) — arbusto denso em jardim doméstico, folhas estreitas empacotadas nos ramos:\n\n![Alecrim-do-campo em campo — Inspetor BudGanja, 21 de agosto de 2026](/imagens/plantas/alecrim-do-campo-campo.jpg)',
      '**Field rosemary**, **golden rosemary** and **vassourinha** name *Baccharis dracunculifolia* DC. (Asteraceae) — a South American shrub common in the Cerrado. The epithet *dracunculifolia* describes the narrow leaf. **Not** kitchen [rosemary](/plantas/alecrim/) (*Salvia rosmarinus*, Lamiaceae). Mature twigs dry and brittle; bright-green lanceolate leaves, toothed on young shoots; petal-less golden inflorescences. Same genus as [carqueja](/plantas/carqueja/) (*B. trimera*), a different species.\n\nField photo by Inspetor BudGanja (21 August 2026) — dense garden shrub with packed narrow leaves:\n\n![Field rosemary in situ — Inspetor BudGanja, 21 August 2026](/imagens/plantas/alecrim-do-campo-campo.jpg)',
      '**Alecrim-do-campo**, **alecrim dourado** y **vassourinha** nombran *Baccharis dracunculifolia* DC. (Asteraceae) — arbusto nativo de Sudamérica, frecuente en el Cerrado. El epíteto *dracunculifolia* describe la hoja estrecha. **No es** el [romero de cocina](/plantas/alecrim/) (*Salvia rosmarinus*, Lamiaceae). Ramas maduras secas y quebradizas; hojas lanceoladas verde brillante, dentadas en brotes; inflorescencias amarillo-oro sin pétalos. Mismo género que la [carqueja](/plantas/carqueja/) (*B. trimera*), especie distinta.\n\nFoto de campo del Inspetor BudGanja (21 de agosto de 2026) — arbusto denso de jardín, hojas estrechas:\n\n![Alecrim-do-campo en campo — Inspetor BudGanja, 21 de agosto de 2026](/imagens/plantas/alecrim-do-campo-campo.jpg)'
    ),
    chemistry: [
      {
        marker: L(
          'Artepillina C (ácido 3,5-diprenil-p-cumárico)',
          'Artepillin C (3,5-diprenyl-p-coumaric acid)',
          'Artepilina C (ácido 3,5-diprenil-p-cumárico)'
        ),
        note: L(
          'Marcador fenólico prenilado das gemas e da própolis verde brasileira — o elo químico mais citado entre a planta e o produto das abelhas.',
          'Prenylated phenolic marker of buds and Brazilian green propolis — the most cited chemical link between the plant and the bee product.',
          'Marcador fenólico prenilado de yemas y del propóleo verde brasileño — el vínculo químico más citado entre la planta y el producto de las abejas.'
        ),
      },
      {
        marker: L(
          'Baccharina e drupanina',
          'Baccharin and drupanin',
          'Baccharina y drupanina'
        ),
        note: L(
          'Ácidos p-cumáricos prenilados congéneres — perfil partilhado entre ápices vegetativos e própolis verde.',
          'Congener prenylated p-coumaric acids — profile shared by vegetative apices and green propolis.',
          'Ácidos p-cumáricos prenilados congéneres — perfil compartido entre ápices vegetativos y propóleo verde.'
        ),
      },
      {
        marker: L(
          'Flavonoides (naringenina, isosakuraneetina, kaempferídeo)',
          'Flavonoids (naringenin, isosakuranetin, kaempferide)',
          'Flavonoides (naringenina, isosakuraneetina, kaempferídeo)'
        ),
        note: L(
          'Partes aéreas e própolis — contribuição fenólica além dos ácidos prenilados.',
          'Aerial parts and propolis — phenolic contribution beyond prenylated acids.',
          'Partes aéreas y propóleo — contribución fenólica además de los ácidos prenilados.'
        ),
      },
      {
        marker: L(
          'Óleo essencial ((E)-nerolidol, espatulenol)',
          'Essential oil ((E)-nerolidol, spathulenol)',
          'Aceite esencial ((E)-nerolidol, espatulenol)'
        ),
        note: L(
          'Fracção volátil das folhas e brotos; o nerolidol é o constituinte mais citado da fracção aromática.',
          'Volatile fraction of leaves and shoots; nerolidol is the most cited constituent of the aromatic fraction.',
          'Fracción volátil de hojas y brotes; el nerolidol es el constituyente más citado de la fracción aromática.'
        ),
      },
    ],
    uses: [
      {
        theme: L(
          'Fonte botânica da própolis verde',
          'Botanical source of green propolis',
          'Fuente botánica del propóleo verde'
        ),
        frame: L(
          '*Apis mellifera* colhe resina dos brotos e ápices — o produto das abelhas concentra marcadores da planta (artepillina C). Elo com a ficha da [abelha](/animais/abelha/). Isto **não** é endosso de suplemento.',
          '*Apis mellifera* collects resin from buds and apices — the bee product concentrates plant markers (artepillin C). Link to the [honeybee](/animais/abelha/) sheet. This is **not** a supplement endorsement.',
          '*Apis mellifera* recolecta resina de brotes y ápices — el producto de las abejas concentra marcadores de la planta (artepilina C). Vínculo con la ficha de la [abeja](/animais/abelha/). Esto **no** es endoso de suplemento.'
        ),
      },
      {
        theme: L(
          'Infusão tradicional (folhas e flores)',
          'Traditional infusion (leaves and flowers)',
          'Infusión tradicional (hojas y flores)'
        ),
        frame: L(
          'Guias populares descrevem infusão curta de folhas/flores secas após a fervura (água off o fogo). O laboratório trata isto como **ofício cultural**, não como posologia clínica nem tratamento de diabetes.',
          'Folk guides describe a short infusion of dried leaves/flowers after the boil (heat off). The lab treats this as **cultural craft**, not clinical posology or diabetes treatment.',
          'Guías populares describen infusión corta de hojas/flores secas tras el hervor (fuego apagado). El laboratorio lo trata como **oficio cultural**, no como posología clínica ni tratamiento de diabetes.'
        ),
      },
      {
        theme: L(
          'Tradição digestiva, respiratória e tópica',
          'Digestive, respiratory and topical tradition',
          'Tradición digestiva, respiratoria y tópica'
        ),
        frame: L(
          'Uso popular em dispepsia/gases, vias respiratórias e bochechos antissépticos. Interesse científico (anti-inflamatório, antioxidante, antimicrobiano em modelos) **não** substitui diagnóstico nem fármaco.',
          'Folk use in dyspepsia/gas, airways and antiseptic rinses. Scientific interest (anti-inflammatory, antioxidant, antimicrobial in models) **does not** replace diagnosis or medicine.',
          'Uso popular en dispepsia/gases, vías respiratorias y enjuagues antisépticos. El interés científico **no** sustituye diagnóstico ni fármaco.'
        ),
      },
      {
        theme: L(
          'Interesse glicémico (não é tratamento)',
          'Glycemic interest (not a treatment)',
          'Interés glucémico (no es tratamiento)'
        ),
        frame: L(
          'Compostos fenólicos estudados em modelos de glicemia — **não** substituem metformina nem outro hipoglicemiante. Risco de hipoglicemia se combinado com fármaco.',
          'Phenolics studied in glycemic models — **do not** replace metformin or other hypoglycemics. Hypoglycemia risk if combined with drug.',
          'Fenólicos estudiados en modelos de glucemia — **no** sustituyen metformina ni otro hipoglucemiante. Riesgo de hipoglucemia si se combina con fármaco.'
        ),
      },
    ],
    cautionsExtra: L(
      '**Contraindicado** em gravidez e lactação (tradição emenagoga; risco de contracção uterina citado em guias de segurança). Não recomendado a menores de 12 anos. Diabéticos sob hipoglicemiantes: monitorizar glicose — o chá **não** é terapêutica. Evitar uso excessivo ou prolongado sem orientação (sobrecarga renal citada em guias populares). Distinguir da [carqueja](/plantas/carqueja/) e do [alecrim](/plantas/alecrim/). Conteúdo educacional — evite automedicação.',
      '**Contraindicated** in pregnancy and nursing (emmenagogue tradition; uterine-contraction risk cited in safety guides). Not recommended under age 12. People on hypoglycemics: monitor glucose — tea is **not** therapy. Avoid excessive or prolonged use without guidance. Distinguish from [carqueja](/plantas/carqueja/) and [rosemary](/plantas/alecrim/). Educational — avoid self-medication.',
      '**Contraindicado** en embarazo y lactancia (tradición emenagoga). No recomendado menores de 12 años. Diabéticos con hipoglucemiantes: monitorizar glucosa — el té **no** es terapéutica. Evitar uso excesivo o prolongado sin orientación. Distinguir de [carqueja](/plantas/carqueja/) y [romero](/plantas/alecrim/). Contenido educativo — evite automedicación.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-planta-alecrim.html',
        label: L(
          'Inspeção: Alecrim de cozinha (*Salvia rosmarinus*) — não confundir',
          'Inspection: Kitchen rosemary (*Salvia rosmarinus*) — do not confuse',
          'Inspección: Romero de cocina (*Salvia rosmarinus*) — no confundir'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-carqueja.html',
        label: L(
          'Inspeção: Carqueja (*Baccharis trimera*) — mesmo género',
          'Inspection: Carqueja (*Baccharis trimera*) — same genus',
          'Inspección: Carqueja (*Baccharis trimera*) — mismo género'
        ),
      },
      {
        href: '/posts/post-inspecao-animal-abelha.html',
        label: L(
          'Inspeção: Abelha — própolis, mel e cadeia da colmeia',
          'Inspection: Honeybee — propolis, honey and hive chain',
          'Inspección: Abeja — propóleo, miel y cadena de la colmena'
        ),
      },
      {
        href: '/posts/post-inspecao-derivado-abelha.html',
        label: L(
          'Inspeção: Derivados da abelha — mel adulterado vs própolis',
          'Inspection: Bee derivatives — adulterated honey vs propolis',
          'Inspección: Derivados de la abeja — miel adulterada vs propóleo'
        ),
      },
    ],
  },
    ...
    links: [
      {
        ...
        label: L(
          ...
          'Research: Phytocannabinoids — catalogue from CBGA to CBN',
          'Investigación: Fitocannabinoides — catálogo de la CBGA al CBN'
        )
      },
      {
        href: '/posts/post-inspecao-guia-quimiotipos-cannabis.html',
        label: L(
          'Inspeção: Quimiotipos da cannabis',
          'Inspection: Cannabis chemotypes',
          'Inspección: Quimiotipos del cannabis'
        )
      }
    ],
  },
  ...
  laranja: {
    titleSuffix: L(
      'fruto inteiro vs suco industrial',
      'whole fruit vs industrial juice',
      'fruto entero vs jugo industrial'
    ),
    excerpt: L(
      '*Citrus × sinensis* — laranja doce: crédito ao fruto inteiro e sumo fresco; separar concentrados, néctares e refrigerantes «de laranja».',
      '*Citrus × sinensis* — sweet orange: credit whole fruit and fresh juice; separate concentrates, nectars and “orange” soft drinks.',
      '*Citrus × sinensis* — naranja dulce: crédito al fruto entero y jugo fresco; separar concentrados, néctares y refrescos «de naranja».'
    ),
    etimo: L(
    ...
    chemistry: [
      {
        marker: L('Vitamina C (ácido ascórbico)', 'Vitamin C (ascorbic acid)', 'Vitamina C (ácido ascórbico)'),
        note: L(
      ...
      {
        marker: L('Flavonoides (hesperidina, naringenina)', 'Flavonoids (hesperidin, naringenin)', 'Flavonoides (hesperidina, naringenina)'),
        note: L(
      ...
      {
        marker: L('Óleos essenciais (d-limoneno)', 'Essential oils (d-limonene)', 'Aceites esenciales (d-limoneno)'),
        note: L(
      ...
      {
        marker: L('Ácidos orgânicos (cítrico)', 'Organic acids (citric)', 'Ácidos orgánicos (cítrico)'),
        note: L(
      ...
      {
        marker: L('Fibra e matriz intacta', 'Fiber and intact matrix', 'Fibra y matriz intacta'),
        note: L(
    ...
    uses: [
      {
        theme: L('Fruto inteiro', 'Whole fruit', 'Fruto entero'),
        frame: L(
      ...
      {
        theme: L('Sumo fresco vs concentrado', 'Fresh juice vs concentrate', 'Jugo fresco vs concentrado'),
        frame: L(
          'Espremido na hora ≠ suco de caixinha reconstituído; concentrado + açúcar = rota industrial.',
          'Fresh-squeezed ≠ reconstituted carton juice; concentrate + sugar = industrial route.',
          'Exprimido al momento ≠ jugo de caja reconstituido; concentrado + azúcar = ruta industrial.'
        ),
      },
      {
        theme: L('Citrinos e N na cultura', 'Citrus and N in culture', 'Cítricos y N en cultivo'),
        frame: L(
          ...
          'In the inputs research map, high N in citrus can raise size but unbalance flavour/texture — see organic vs industrial map.',
          'En el mapa de insumos, N alto puede aumentar tamaño pero desequilibrar sabor/textura.'
        ),
      },
      {
        theme: L('«Laranja» em refrigerantes', '“Orange” soft drinks', '«Naranja» en refrescos'),
        frame: L(
          'Nome e cor de marketing ≠ fruto; açúcar livre + aromas + corantes — cruzar com cana / açúcares livres.',
          'Marketing name/colour ≠ fruit; free sugar + flavours + colours — cross sugarcane / free sugars.',
    ...
    links: [
      ...
      },
      {
        ...
        label: L(
          'Pesquisa: insumos orgânicos vs industrializados no fruto',
          'Research: organic vs industrial inputs on fruit',
          'Investigación: insumos orgánicos vs industrializados en el fruto'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-melancia.html',
        label: L(
          'Inspeção: Fruto — Melancia (fruta de mesa irmã)',
          'Inspection: Fruit — Watermelon (sibling table fruit)',
          'Inspección: Fruto — Sandía (fruta de mesa hermana)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-mamao.html',
        label: L(
          'Inspeção: Fruto — Mamão (fruta tropical irmã)',
          'Inspection: Fruit — Papaya (sibling tropical fruit)',
          'Inspección: Fruto — Papaya (fruta tropical hermana)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-goiaba.html',
        label: L(
          'Inspeção: Fruto — Goiaba (vitamina C / série irmã)',
          'Inspection: Fruit — Guava (vitamin C / sibling series)',
          'Inspección: Fruto — Guayaba (vitamina C / serie hermana)'
        ),
      },
      {
        href: '/biblioteca/inspecoes/#inspecoes-frutos',
        label: L(
          'Hub — inspeções de frutos',
          'Hub — fruit inspections',
          'Hub — inspecciones de frutos'
        ),
      },
    ],
  },
  ...
  goiaba: {
    titleSuffix: L(
      'vitamina C, pectina e goiabada',
      'vitamin C, pectin and guava paste',
      'vitamina C, pectina y pasta de guayaba'
    ),
    excerpt: L(
      '*Psidium guajava* — fruto brasileiro de quintal rico em vitamina C e fibra; separar goiaba inteira de goiabada, polpas e néctares industriais.',
      '*Psidium guajava* — Brazilian backyard fruit rich in vitamin C and fiber; separate whole guava from industrial paste, pulps and nectars.',
      '*Psidium guajava* — fruto brasileño de patio rico en vitamina C y fibra; separar guayaba entera de pasta, pulpas y néctares industriales.'
    ),
    etimo: L(
      'O português **goiaba** (e o espanhol *guayaba*) chega via taíno/arauaque *guayabo* — língua caribenha — e espalhou-se nas Américas com a planta. No Brasil é fruto de quintal e mesa; o binómio **Psidium guajava** L. (família **Myrtaceae**) agrupa a goiabeira. **Não** inventar etimologia tupi exclusiva: o nome circulou pelo contacto colonial e pela botânica europeia.',
      'Portuguese **goiaba** (and Spanish *guayaba*) comes via Taíno/Arawakan *guayabo* — a Caribbean language — and spread with the plant across the Americas. In Brazil it is a backyard and table fruit; **Psidium guajava** L. (**Myrtaceae**) names the guava tree. **Do not** invent an exclusive Tupi etymology: the name traveled through colonial contact and European botany.',
      'El portugués **goiaba** / español *guayaba* llega vía taíno/arahuaco *guayabo*. En Brasil es fruto de patio; **Psidium guajava** L. (**Myrtaceae**). **No** inventar etimología tupí exclusiva.'
    ),
    chemistry: [
      {
        marker: L('Vitamina C (ácido ascórbico)', 'Vitamin C (ascorbic acid)', 'Vitamina C (ácido ascórbico)'),
        note: L(
          'Polpa e casca maduras — teor elevado face a muitos citrinos; interesse nutricional educacional, não dose terapêutica.',
          'Ripe pulp and peel — high content vs many citrus fruits; educational nutrition interest, not a therapeutic dose.',
          'Pulpa y cáscara maduras — alto contenido frente a muchos cítricos; interés nutricional educativo.'
        ),
      },
      {
        marker: L('Licopeno (cultivares rosados)', 'Lycopene (pink cultivars)', 'Licopeno (cultivares rosados)'),
        note: L(
          'Carotenoide vermelho-rosado na polpa colorida — marcador de cor e antioxidante lipofílico da matriz fresca.',
          'Red-pink carotenoid in colored pulp — color marker and lipophilic antioxidant of the fresh matrix.',
          'Carotenoide rojo-rosado en pulpa coloreada — marcador de color y antioxidante lipofílico.'
        ),
      },
      {
        marker: L('Pectina e fibra', 'Pectin and fiber', 'Pectina y fibra'),
        note: L(
          'Fibra solúvel/insolúvel no fruto inteiro; a **goiabada** industrial concentra pectina + açúcar — muda a matriz.',
          'Soluble/insoluble fiber in whole fruit; industrial **guava paste** concentrates pectin + sugar — matrix changes.',
          'Fibra en el fruto entero; la **pasta de guayaba** industrial concentra pectina + azúcar.'
        ),
      },
      {
        marker: L('Polifenóis (elágico / taninos)', 'Polyphenols (ellagic / tannins)', 'Polifenoles (elágico / taninos)'),
        note: L(
          'Folhas e casca ricas em taninos — tradição popular de chá adstringente; o laboratório inspeciona sobretudo o **fruto fresco**.',
          'Leaves and peel rich in tannins — folk astringent-tea tradition; the lab mainly inspects the **fresh fruit**.',
          'Hojas y cáscara ricas en taninos — tradición de infusión astringente; el laboratorio inspecciona sobre todo el **fruto fresco**.'
        ),
      },
    ],
    uses: [
      {
        theme: L('Fruto inteiro / fresco', 'Whole / fresh fruit', 'Fruto entero / fresco'),
        frame: L(
          'Consumo à mesa, vitaminas e fibra na matriz intacta — linha de crédito do laboratório.',
          'Table consumption, vitamins and fiber in intact matrix — lab credit line.',
          'Consumo en mesa, vitaminas y fibra en matriz intacta — línea de crédito del laboratorio.'
        ),
      },
      {
        theme: L('Culinária doméstica (baixo processamento)', 'Home cooking (low processing)', 'Cocina casera (bajo procesamiento)'),
        frame: L(
          'Compotas caseiras e suco natural sem xarope — distinto de goiabada de corte e néctares industriais.',
          'Home jams and natural juice without syrup — distinct from slab paste and industrial nectars.',
          'Mermeladas caseras y jugo natural — distinto de pasta industrial y néctares.'
        ),
      },
      {
        theme: L('Goiabada e derivados açucarados', 'Guava paste and sugary derivatives', 'Pasta de guayaba y derivados azucarados'),
        frame: L(
          'Goiabada, polpa adoçada e néctar entram na conversa de Derivados de risco / açúcares livres — não confundir com o fruto.',
          'Paste, sweetened pulp and nectar belong in Risk Derivatives / free-sugars conversation — do not confuse with the fruit.',
          'Pasta, pulpa endulzada y néctar entran en Derivados de riesgo — no confundir con el fruto.'
        ),
      },
    ],
    cautionsExtra: L(
      'Fruto fresco é alimento comum. Chás de folha e extratos concentrados: tradição popular ≠ protocolo clínico — evitar automedicação. Derivados industriais com açúcar e aditivos (goiabada, néctares) têm enquadramento próprio em Derivados de risco. Conteúdo educacional — não substitui orientação profissional.',
      'Fresh fruit is common food. Leaf teas and concentrated extracts: folk tradition ≠ clinical protocol — avoid self-medication. Industrial derivatives with sugar and additives (paste, nectars) have their own Risk Derivatives framing. Educational content — not professional advice.',
      'El fruto fresco es alimento común. Infusiones de hoja y extractos: tradición ≠ protocolo clínico. Derivados industriales tienen encuadre propio. Contenido educativo — no sustituye orientación profesional.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-palavra-fruto.html',
        label: L(
          'Inspeção: Palavra — Fruto (conceito botânico e figurado)',
          'Inspection: Word — Fruit (botanical and figurative concept)',
          'Inspección: Palabra — Fruto (concepto botánico y figurado)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-laranja.html',
        label: L(
          'Inspeção: Fruto — Laranja (citrino irmão na série)',
          'Inspection: Fruit — Orange (sibling citrus in the series)',
          'Inspección: Fruto — Naranja (cítrico hermano en la serie)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-melancia.html',
      ...
      },
      {
        ...
        label: L(
          'Inspeção: Fruto — Banana (fruto de mesa brasileiro)',
          'Inspection: Fruit — Banana (Brazilian table fruit)',
          'Inspección: Fruto — Banana (fruto de mesa brasileño)'
        ),
      },
      {
        href: '/posts/post-inspecao-derivado-cana-de-acucar.html',
        label: L(
          'Inspeção: Cana-de-açúcar / açúcares livres (goiabada e néctares)',
          'Inspection: Sugarcane / free sugars (guava paste and nectars)',
          'Inspección: Caña de azúcar / azúcares libres (pasta y néctares)'
        ),
      },
      {
        href: '/biblioteca/inspecoes/#inspecoes-frutos',
  ...
  mamao: {
    titleSuffix: L(
      'papaína, polpa tropical e cultivo familiar',
      'papain, tropical pulp and family growing',
      'papaína, pulpa tropical y cultivo familiar'
    ),
    excerpt: L(
      '*Carica papaya* — mamão brasileiro: polpa doce, papaína do látex e elo UNIFESP/SUS; separar fruto inteiro de néctares e ultraprocessados.',
      '*Carica papaya* — Brazilian papaya: sweet pulp, latex papain and UNIFESP/SUS link; separate whole fruit from nectars and ultra-processed products.',
      '*Carica papaya* — papaya brasileña: pulpa dulce, papaína del látex y vínculo UNIFESP/SUS; separar fruto entero de néctares y ultraprocesados.'
    ),
    etimo: L(
      'O português **mamão** (aumentativo de *mama*) descreve o fruto volumoso — nome popular no Brasil; em português europeu e no comércio internacional predomina **papaia** / **papaya**. O binómio **Carica papaya** L. (Caricaceae) vem do latim *carica* (figueira) e do taíno / caribe *papaya*. **Não** confundir com **mamona** (*Ricinus communis*) — planta oleaginosa tóxica, nome distinto.',
      'Portuguese **mamão** (augmentative of *mama*) names the bulky fruit — common in Brazil; European Portuguese and trade often use **papaya**. **Carica papaya** L. (Caricaceae) from Latin *carica* (fig) and Taíno/Caribbean *papaya*. **Do not** confuse with **castor bean** (*Ricinus communis*) — toxic oil plant, different name.',
      'El portugués brasileño **mamão** (aumentativo de *mama*) nombra el fruto voluminoso; en comercio internacional predomina **papaya**. **Carica papaya** L. (Caricaceae). **No** confundir con **ricino / mamona** (*Ricinus communis*).'
    ),
    chemistry: [
      {
        marker: L('Papaína (látex)', 'Papain (latex)', 'Papaína (látex)'),
        note: L(
          'Protease do látex — marcador clássico; citada em protocolos de feridas no SUS (contexto formativo UNIFESP). **Não** é receita caseira nem automedicação.',
          'Latex protease — classic marker; cited in SUS wound protocols (UNIFESP training). **Not** a home recipe or self-medication.',
          'Proteasa del látex — marcador clásico; citada en protocolos de heridas del SUS. **No** es receta casera ni automedicación.'
        ),
      },
      {
        marker: L('Carotenóides (β-caroteno)', 'Carotenoids (β-carotene)', 'Carotenoides (β-caroteno)'),
        note: L(
          'Polpa madura amarelo-alaranjada — pró-vitamina A e cor; interesse nutricional educacional, não dose terapêutica.',
          'Ripe yellow-orange pulp — pro-vitamin A and colour; educational nutrition interest, not a therapeutic dose.',
          'Pulpa madura amarillo-naranja — provitamina A y color; interés nutricional educativo.'
        ),
      },
      {
        marker: L('Açúcares e fibra da polpa', 'Pulp sugars and fibre', 'Azúcares y fibra de la pulpa'),
        note: L(
          'Matriz alimentar intacta no fruto fresco — distinto de néctar/polpa industrial adoçada.',
          'Intact food matrix in fresh fruit — distinct from sweetened industrial nectar/pulp.',
          'Matriz alimentaria intacta en el fruto fresco — distinto de néctar/pulpa industrial endulzada.'
        ),
      },
      {
        marker: L('Sementes (óleo / compostos fenólicos)', 'Seeds (oil / phenolics)', 'Semillas (aceite / fenólicos)'),
        note: L(
          'Sementes picantes na cavidade central — tradição culinária pontual; excesso e extratos pedem cautela, não protocolização caseira.',
          'Peppery seeds in the central cavity — occasional culinary tradition; excess and extracts need caution, not home protocols.',
          'Semillas picantes en la cavidad central — tradición culinaria puntual; exceso y extractos piden cautela.'
        ),
      },
    ],
    uses: [
      {
        theme: L('Fruto fresco no café da manhã', 'Fresh fruit at breakfast', 'Fruto fresco en el desayuno'),
        frame: L(
          'Linha de crédito do laboratório: mamão inteiro, maduro, sem marketing de «superalimento».',
          'Lab credit line: whole ripe papaya, without «superfood» marketing.',
          'Línea de crédito del laboratorio: papaya entera madura, sin marketing de «superalimento».'
        ),
      },
      {
        theme: L('Cultivo familiar tropical', 'Tropical family growing', 'Cultivo familiar tropical'),
        frame: L(
          'Planta de crescimento rápido em clima quente — luz, drenagem e paciência; notas leves, não manual agronómico.',
          'Fast-growing plant in warm climates — light, drainage and patience; light notes, not an agronomy manual.',
          'Planta de crecimiento rápido en clima cálido — luz, drenaje y paciencia; notas ligeras, no manual agronómico.'
        ),
      },
      {
        theme: L('Papaína e farmácias vivas (UNIFESP)', 'Papain and living pharmacies (UNIFESP)', 'Papaína y farmacias vivas (UNIFESP)'),
        frame: L(
          'Elo formativo: látex → papaína em feridas no SUS — crédito científico separado do fruto de mesa e da automedicação.',
          'Training link: latex → papain in SUS wound care — scientific credit separate from table fruit and self-medication.',
          'Vínculo formativo: látex → papaína en heridas del SUS — crédito científico separado del fruto de mesa y de la automedicación.'
        ),
      },
      {
        theme: L('Fruto vs indústria', 'Fruit vs industry', 'Fruto vs industria'),
        frame: L(
          'Néctares, polpas adoçadas e snacks «papaya» entram na conversa de Derivados de risco — como banana e manga.',
          'Nectars, sweetened pulps and «papaya» snacks belong in the Risk Derivatives conversation — like banana and mango.',
          'Néctares, pulpas endulzadas y snacks «papaya» entran en Derivados de riesgo — como banana y mango.'
        ),
      },
    ],
    cautionsExtra: L(
      'Polpa madura é alimento comum. Látex cru irrita pele/mucosa. **Não** confundir com mamona (*Ricinus*). Extratos e papaína clínica: só com orientação profissional. Derivados industriais com açúcar têm fila em Derivados de risco. Conteúdo educacional BudGanja.',
      'Ripe pulp is common food. Raw latex irritates skin/mucosa. **Do not** confuse with castor bean (*Ricinus*). Clinical papain/extracts: only with professional guidance. Sugary industrial derivatives belong in Risk Derivatives. Educational BudGanja content.',
      'Pulpa madura es alimento común. Látex crudo irrita piel/mucosa. **No** confundir con ricino (*Ricinus*). Extractos y papaína clínica: solo con orientación profesional. Derivados industriales azucarados entran en Derivados de riesgo.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-palavra-planta.html',
        label: L(
          'Inspeção: Palavra — planta',
          'Inspection: Word — plant',
          'Inspección: Palabra — planta'
        ),
      },
      {
        href: '/posts/post-inspecao-palavra-fruto.html',
        label: L(
          'Inspeção: Palavra — fruto',
          'Inspection: Word — fruit',
          'Inspección: Palabra — fruto'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-melancia.html',
      ...
      },
      {
        href: '/posts/post-inspecao-planta-laranja.html',
        label: L(
          'Inspeção: Fruto — Laranja (citrino / mesa)',
          'Inspection: Fruit — Orange (citrus / table)',
          'Inspección: Fruto — Naranja (cítrico / mesa)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-banana.html',
        label: L(
          'Inspeção: Fruto — Banana (série irmã)',
          'Inspection: Fruit — Banana (sibling series)',
          'Inspección: Fruto — Banana (serie hermana)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-manga.html',
        label: L(
          'Inspeção: Fruto — Manga (série tropical)',
          'Inspection: Fruit — Mango (tropical series)',
          'Inspección: Fruto — Mango (serie tropical)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-abacate.html',
        label: L(
          'Inspeção: Fruto — Abacate',
          'Inspection: Fruit — Avocado',
          'Inspección: Fruto — Aguacate'
        ),
      },
      {
        href: '/biblioteca/unifesp/livro-xiv.html',
        label: L(
          'Rascunhos XIV UNIFESP — papaína / farmácias vivas',
          'XIV UNIFESP drafts — papain / living pharmacies',
          'Borradores XIV UNIFESP — papaína / farmacias vivas'
        ),
      },
      {
        href: '/posts/post-inspecao-derivado-cana-de-acucar.html',
  ...
  melancia: {
    titleSuffix: L(
      'água na polpa, citrulina e verão BR',
      'water in the pulp, citrulline and BR summer',
      'agua en la pulpa, citrulina y verano BR'
    ),
    excerpt: L(
      '*Citrullus lanatus* — melancia / melão-d\'água: polpa aquosa de verão, citrulina e cultura de feira; separar fruto inteiro de sucos e ultraprocessados «watermelon».',
      '*Citrullus lanatus* — watermelon: summer watery pulp, citrulline and market culture; separate whole fruit from juices and ultra-processed «watermelon».',
      '*Citrullus lanatus* — sandía: pulpa acuosa de verano, citrulina y cultura de feria; separar fruto entero de jugos y ultraprocesados «watermelon».'
    ),
    etimo: L(
      'O português **melancia** (também **melão-d\'água**) liga-se à família dos **melões** (*melo* / *melão*) — fruto grande e doce de verão. O binómio **Citrullus lanatus** (Thunb.) Matsum. & Nakai (família **Cucurbitaceae**): *Citrullus* evoca o género dos «citrulos» (parentesco botânico com cucurbitáceas de fruto carnoso); *lanatus* = «lanoso», pelas folhas/caules jovens pubescentes. Em inglês *watermelon*; em espanhol *sandía*. **Não** confundir com melão (*Cucumis melo*) — espécie distinta, mesma família cultural de mesa.',
      'Portuguese **melancia** (also **melão-d\'água**) ties to the **melon** family (*melo* / *melão*) — a large sweet summer fruit. Binomial **Citrullus lanatus** (Thunb.) Matsum. & Nakai (**Cucurbitaceae**): *Citrullus* names the citrullus group; *lanatus* = «woolly», for pubescent young leaves/stems. English *watermelon*; Spanish *sandía*. **Do not** confuse with melon (*Cucumis melo*) — distinct species, same table culture.',
      'El portugués **melancia** / **melão-d\'água** se liga a la familia de los **melones**. Binomio **Citrullus lanatus** (**Cucurbitaceae**): *lanatus* = «lanoso». En español *sandía*. **No** confundir con melón (*Cucumis melo*).'
    ),
    chemistry: [
      {
        marker: L('Água e electrólitos da polpa', 'Pulp water and electrolytes', 'Agua y electrolitos de la pulpa'),
        note: L(
          'Polpa madura ~90% água — matriz hidratante de verão; potássio e açúcares naturais na dose da fruta inteira.',
          'Ripe pulp ~90% water — summer hydrating matrix; potassium and natural sugars in whole-fruit dose.',
          'Pulpa madura ~90% agua — matriz hidratante de verano; potasio y azúcares naturales en dosis de fruta entera.'
        ),
      },
      {
        marker: L('Citrulina', 'Citrulline', 'Citrulina'),
        note: L(
          'Aminoácido não essencial — nome ligado a *Citrullus*; presente na polpa e sobretudo na casca branca. Interesse nutricional educacional, **não** dose de ginásio.',
          'Non-essential amino acid — name tied to *Citrullus*; in pulp and especially the white rind. Educational nutrition interest, **not** a gym dose.',
          'Aminoácido no esencial — nombre ligado a *Citrullus*; en pulpa y sobre todo en la corteza blanca. Interés nutricional educativo, **no** dosis de gimnasio.'
        ),
      },
      {
        marker: L('Licopeno (polpa vermelha)', 'Lycopene (red pulp)', 'Licopeno (pulpa roja)'),
        note: L(
          'Carotenoide da polpa vermelha madura — cor e antioxidante lipofílico; cultivares amarelos têm outro perfil de pigmento.',
          'Carotenoid of ripe red pulp — colour and lipophilic antioxidant; yellow cultivars have a different pigment profile.',
          'Carotenoide de la pulpa roja madura — color y antioxidante lipofílico; cultivares amarillos tienen otro perfil.'
        ),
      },
      {
        marker: L('Sementes (óleo / proteína)', 'Seeds (oil / protein)', 'Semillas (aceite / proteína)'),
        note: L(
          'Sementes torradas — tradição culinária pontual; excesso e extratos pedem moderação, não protocolização caseira.',
          'Toasted seeds — occasional culinary tradition; excess and extracts need moderation, not home protocols.',
          'Semillas tostadas — tradición culinaria puntual; exceso y extractos piden moderación.'
        ),
      },
    ],
    uses: [
      {
        theme: L('Fruto fresco de verão (feira / praia)', 'Fresh summer fruit (market / beach)', 'Fruto fresco de verano (feria / playa)'),
        frame: L(
          'Linha de crédito do laboratório: melancia inteira, fria, sem marketing de «detox» — cultura BR de mesa e sombra.',
          'Lab credit line: whole chilled watermelon, without «detox» marketing — Brazilian table-and-shade culture.',
          'Línea de crédito del laboratorio: sandía entera fría, sin marketing de «detox» — cultura BR de mesa y sombra.'
        ),
      },
      {
        theme: L('Suco e salada caseiros', 'Homemade juice and salad', 'Jugo y ensalada caseros'),
        frame: L(
          'Baixo processamento — distinto de néctar, refrigerante e snacks «watermelon» com açúcar e aromas.',
          'Low processing — distinct from nectar, soft drinks and «watermelon» snacks with sugar and flavours.',
          'Bajo procesamiento — distinto de néctar, refrescos y snacks «watermelon» con azúcar y aromas.'
        ),
      },
      {
        theme: L('Cultivo familiar (notas leves)', 'Family growing (light notes)', 'Cultivo familiar (notas ligeras)'),
        frame: L(
          'Trepadeira de clima quente: sol, espaço no chão ou tutor, água regular e abelhas na floração — paciência, não manual agronómico.',
          'Warm-climate vine: sun, ground space or trellis, regular water and bees at flowering — patience, not an agronomy manual.',
          'Enredadera de clima cálido: sol, espacio o tutor, agua regular y abejas en floración — paciencia, no manual agronómico.'
        ),
      },
      {
        theme: L('Fruto vs indústria', 'Fruit vs industry', 'Fruto vs industria'),
        frame: L(
          'Sucos concentrados, néctares e ultraprocessados «watermelon» entram na conversa de Derivados de risco — cruzar com cana/açúcares livres.',
          'Concentrate juices, nectars and ultra-processed «watermelon» belong in Risk Derivatives — cross free sugars / sugarcane.',
          'Jugos concentrados, néctares y ultraprocesados «watermelon» entran en Derivados de riesgo — cruzar azúcares libres / caña.'
        ),
      },
    ],
    cautionsExtra: L(
      'Polpa madura é alimento comum — açúcar natural conta na dose. Sementes e extratos: sem automedicação. **Não** confundir com melão (*Cucumis melo*). Derivados industriais com açúcar/aditivos têm fila em Derivados de risco. Conteúdo educacional BudGanja.',
      'Ripe pulp is common food — natural sugar counts in dose. Seeds and extracts: no self-medication. **Do not** confuse with melon (*Cucumis melo*). Sugary industrial derivatives belong in Risk Derivatives. Educational BudGanja content.',
      'Pulpa madura es alimento común — el azúcar natural cuenta. Semillas y extractos: sin automedicación. **No** confundir con melón (*Cucumis melo*). Derivados industriales azucarados entran en Derivados de riesgo.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-palavra-planta.html',
      ...
      },
      {
        href: '/posts/post-inspecao-planta-mamao.html',
        label: L(
          'Inspeção: Fruto — Mamão (série tropical)',
          'Inspection: Fruit — Papaya (tropical series)',
          'Inspección: Fruto — Papaya (serie tropical)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-banana.html',
  ...
  soja: {
    titleSuffix: L(
      'feijão, isolado e matriz com glúten / farinha branca',
      'bean, isolate and matrix with gluten / white flour',
      'grano, aislado y matriz con gluten / harina blanca'
    ),
    excerpt: L(
      '*Glycine max* — a ficha separa o feijão (edamame, tofu, miso) do isolado, do óleo e da matriz ultraprocessada com glúten e farinha branca; cruzamento com riscos à saúde e «como os ricos transformam».',
      '*Glycine max* — this sheet separates the bean (edamame, tofu, miso) from isolate, oil and the ultra-processed matrix with gluten and white flour; cross-links health risks and “how the rich transform”.',
      '*Glycine max* — la ficha separa el grano (edamame, tofu, miso) del aislado, el aceite y la matriz ultraprocesada con gluten y harina blanca; cruce con riesgos para la salud y «cómo los ricos transforman».'
    ),
    etimo: L(
      '**Soja** veio ao português pelo neerlandês, do japonês *shōyu* / chinês, e nomeia *Glycine max* (Fabaceae) — a leguminosa, não o «leite» de caixa. O laboratório **separa o feijão** (cozinha, fermentação) **do derivado industrial** (óleo, lecitina, isolado, proteína texturizada) e **cruza** com [glúten / farinha](/posts/post-inspecao-derivado-gluten.html), [riscos](/posts/post-inspecao-palavra-risco.html) à saúde e a frase-mapa [Como os ricos transformam as coisas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html).',
      '**Soy** reached Portuguese via Dutch from Japanese *shōyu* / Chinese and names *Glycine max* (Fabaceae) — the bean, not boxed “milk”. The lab **separates the bean** (cooking, fermentation) **from the industrial derivative** (oil, lecithin, isolate, TVP) and **crosses** it with [gluten / flour](/posts/post-inspecao-derivado-gluten.html), [health risks](/posts/post-inspecao-palavra-risco.html) and [How the rich transform things](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html).',
      '**Soja** llegó al portugués por el neerlandés, del japonés *shōyu* / chino, y nombra *Glycine max* (Fabaceae) — el grano, no la «leche» de caja. El laboratorio **separa el grano** (cocina, fermentación) **del derivado industrial** y **cruza** con [gluten / harina](/posts/post-inspecao-derivado-gluten.html), [riesgos](/posts/post-inspecao-palavra-risco.html) para la salud y [Cómo los ricos transforman las cosas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html).'
    ),
    chemistry: [
      {
        marker: L('Proteína do feijão inteiro', 'Whole-bean protein', 'Proteína del grano entero'),
        note: L(
          'Grão cozido / edamame / tofu tradicional — proteína com fibra e matriz do feijão. Distinto do **isolado** em barra, nugget e «leite» ultraprocessado.',
          'Cooked bean / edamame / traditional tofu — protein with fiber and bean matrix. Distinct from **isolate** in bars, nuggets and ultra-processed “milk”.',
          'Grano cocido / edamame / tofu tradicional — proteína con fibra. Distinto del **aislado** en barras y «leche» ultraprocesada.'
        ),
      },
      {
        marker: L('Isoflavonas (genisteína, daidzeína)', 'Isoflavones (genistein, daidzein)', 'Isoflavonas (genisteína, daidzeína)'),
        note: L(
          'Fitoestrógenos da soja; a isoflavona entra na RENAME como fitoterápico padronizado. Isto **não** é protocolo hormonal nem substituto de fármaco. Curso [UNIFESP](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html): também citação no eixo endocanabinoidoma (interesse em FAAH) — leitura educacional, não posologia.',
          'Soy phytoestrogens; isoflavone appears in Brazil’s RENAME as a standardized herbal. This is **not** a hormone protocol. [UNIFESP](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html) also cites soy on the endocannabinoid axis (FAAH interest) — educational, not a dose.',
          'Fitoestrógenos; la isoflavona entra en RENAME como fitoterápico. **No** es protocolo hormonal. [UNIFESP](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html) la cita en el endocannabinoidoma (interés FAAH).'
        ),
      },
      {
        marker: L('Óleo de soja (ómega-6)', 'Soybean oil (omega-6)', 'Aceite de soja (omega-6)'),
        note: L(
          'Óleo refinado de prateleira — derivado de risco, não o feijão. Dose e oxidação entram no eixo ultraprocessado ([Hall et al., 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)), não na ficha do grão fresco.',
          'Refined shelf oil — a risk derivative, not the bean. Dose and oxidation sit on the ultra-processed axis ([Hall et al., 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)).',
          'Aceite refinado de estante — derivado de riesgo, no el grano. Dosis y oxidación: eje ultraprocesado ([Hall et al., 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)).'
        ),
      },
      {
        marker: L('Lecitina, isolado, PTN texturizada', 'Lecithin, isolate, textured protein', 'Lecitina, aislado, proteína texturizada'),
        note: L(
          'Aditivos e «carne de soja» de fábrica. No rótulo juntam-se muitas vezes a **farinha branca** e ao [glúten](/posts/post-inspecao-derivado-gluten.html) (biscoito, nugget, massa, barra).',
          'Factory additives and “soy meat”. On the label they often join **white flour** and [gluten](/posts/post-inspecao-derivado-gluten.html) (biscuit, nugget, dough, bar).',
          'Aditivos de fábrica y «carne de soja». En la etiqueta suelen juntarse a la **harina blanca** y al [gluten](/posts/post-inspecao-derivado-gluten.html).'
        ),
      },
    ],
    uses: [
      {
        theme: L('Cozinha do feijão (crédito)', 'Bean kitchen (credit)', 'Cocina del grano (crédito)'),
        frame: L(
          'Edamame, tofu, tempeh, miso, shoyu fermentado — ofício alimentar com tradição. O laboratório **não** colapsa isto no isolado de caixa.',
          'Edamame, tofu, tempeh, miso, fermented shoyu — food craft with tradition. The lab **does not** collapse this into boxed isolate.',
          'Edamame, tofu, tempeh, miso, shoyu fermentado — oficio alimentario. El laboratorio **no** lo colapsa en el aislado de caja.'
        ),
      },
      {
        theme: L('Cruzamento — glúten e farinha branca', 'Cross — gluten and white flour', 'Cruce — gluten y harina blanca'),
        frame: L(
          'A **farinha refinada** é o veículo quotidiano do [glúten](/posts/post-inspecao-derivado-gluten.html). A soja industrial entra na mesma prateleira: pão de fábrica, biscoito, nugget, «proteína» + amido. Ver também [Barriga de Trigo](/posts/post-inspecao-arte-barriga-de-trigo.html) e [Wieser 2020](/posts/post-inspecao-artigo-wieser-duas-faces-trigo-2020.html) — trigo tradicional ≠ farinha ultraprocessada.',
          '**Refined flour** is the daily vehicle of [gluten](/posts/post-inspecao-derivado-gluten.html). Industrial soy shares the shelf: factory bread, biscuit, nugget, “protein” + starch. See [Wheat Belly](/posts/post-inspecao-arte-barriga-de-trigo.html) and [Wieser 2020](/posts/post-inspecao-artigo-wieser-duas-faces-trigo-2020.html).',
          'La **harina refinada** es el vehículo cotidiano del [gluten](/posts/post-inspecao-derivado-gluten.html). La soja industrial comparte el estante. Ver [Barriga de Trigo](/posts/post-inspecao-arte-barriga-de-trigo.html) y [Wieser 2020](/posts/post-inspecao-artigo-wieser-duas-faces-trigo-2020.html).'
        ),
      },
      {
        theme: L('Riscos à saúde (matriz, não o pé)', 'Health risks (matrix, not the plant)', 'Riesgos para la salud (matriz, no la planta)'),
        frame: L(
          'Eixo [risco](/posts/post-inspecao-palavra-risco.html): ultraprocessado ([Hall 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)), farinha branca + glúten, óleo refinado, isolado sem a fibra do feijão, suplemento de isoflavona sem orientação. **Não** é aconselhamento médico. Celíaca e sensibilidade ficam na ficha do [glúten](/posts/post-inspecao-derivado-gluten.html).',
          '[Risk](/posts/post-inspecao-palavra-risco.html) axis: ultra-processed ([Hall 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)), white flour + gluten, refined oil, isolate without bean fiber, unsupervised isoflavone supplements. **Not** medical advice. Celiac disease stays on the [gluten](/posts/post-inspecao-derivado-gluten.html) sheet.',
          'Eje [riesgo](/posts/post-inspecao-palavra-risco.html): ultraprocesado ([Hall 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)), harina blanca + gluten, aceite refinado, aislado sin fibra. **No** es consejo médico.'
        ),
      },
      {
        theme: L('Como os ricos transformam (terra → prateleira)', 'How the rich transform (land → shelf)', 'Cómo los ricos transforman (tierra → estante)'),
        frame: L(
          'Monocultura no Cerrado (citada no [curso UNIFESP](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html): soja e cana no lugar da biodiversidade) → extrair / fazer / vender / descartar. Frase-mapa: [Como os ricos transformam as coisas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html) · [A História das Coisas](/posts/post-inspecao-arte-a-historia-das-coisas.html). No conto da sementinha, a soja do GTA é o **emprego lento** que o jogo paga o dobro para abandonar — [A Sementinha e o jogo da cidade](/posts/post-inspecao-conto-vida-sementinha-jogo.html).',
          'Cerrado monoculture (cited in the [UNIFESP course](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html): soy and cane instead of biodiversity) → extract / make / sell / dump. Phrase-map: [How the rich transform things](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html) · [The Story of Stuff](/posts/post-inspecao-arte-a-historia-das-coisas.html). In the little-seed story, GTA soy is the **slow job** the game pays double to leave — [The Little Seed and the city game](/posts/post-inspecao-conto-vida-sementinha-jogo.html).',
          'Monocultivo en el Cerrado ([curso UNIFESP](/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html)) → extraer / hacer / vender / descartar. [Cómo los ricos transforman las cosas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html). En el cuento, la soja del GTA es el **trabajo lento** — [La Semillita y el juego de la ciudad](/posts/post-inspecao-conto-vida-sementinha-jogo.html).'
        ),
      },
    ],
    cautionsExtra: L(
      'Alergia à soja é eixo clínico (rótulo). Isolados, leites vegetais adoçados, óleo de fritura e «carne» de fábrica **não** são o feijão. Isoflavona em cápsula: orientação profissional — não automedicação. Soja transgénica / agrotóxico é risco agrícola e de cadeia, não evidência de que o grão tradicional seja veneno. Conteúdo educacional.',
      'Soy allergy is a clinical axis (label). Isolates, sweetened plant milks, frying oil and factory “meat” **are not** the bean. Isoflavone capsules: professional guidance — no self-medication. GMO / agrochemical soy is a supply-chain risk, not proof that the traditional bean is poison. Educational.',
      'Alergia a la soja es eje clínico. Aislados, leches vegetales azucaradas y «carne» de fábrica **no** son el grano. Isoflavona en cápsula: orientación profesional. Soja transgénica / agrotóxico es riesgo de cadena, no prueba de que el grano tradicional sea veneno.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-derivado-gluten.html',
        label: L(
          'Inspeção: Glúten / farinha — trigo e proteína nociva',
          'Inspection: Gluten / flour — wheat protein of concern',
          'Inspección: Gluten / harina — trigo y proteína nociva'
        ),
      },
      {
        href: '/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html',
        label: L(
          'Inspeção: Como os ricos transformam as coisas',
          'Inspection: How the rich transform things',
          'Inspección: Cómo los ricos transforman las cosas'
        ),
      },
      {
        href: '/posts/post-inspecao-palavra-risco.html',
        label: L(
          'Inspeção: Palavra — risco',
          'Inspection: Word — risk',
          'Inspección: Palabra — riesgo'
        ),
      },
      {
        href: '/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html',
        label: L(
          'Artigo: ultraprocessados (Hall et al., 2019)',
          'Article: ultra-processed foods (Hall et al., 2019)',
          'Artículo: ultraprocesados (Hall et al., 2019)'
        ),
      },
      {
        href: '/posts/post-inspecao-derivado-cana-de-acucar.html',
      ...
      },
      {
        ...
        label: L(
          'Artes: A História das Coisas (Annie Leonard)',
          'Arts: The Story of Stuff (Annie Leonard)',
          'Artes: La Historia de las Cosas (Annie Leonard)'
        ),
      },
      {
        href: '/posts/post-inspecao-conto-vida-sementinha-jogo.html',
        label: L(
          'Conto: A Sementinha e o jogo da cidade (a soja do GTA)',
          'Story: The Little Seed and the city game (GTA soy)',
          'Cuento: La Semillita y el juego de la ciudad (soja del GTA)'
        ),
      },
      {
        href: '/posts/post-inspecao-curso-unifesp-cannabis-medicinal.html',
        label: L(
          'Curso UNIFESP — soja no Cerrado e isoflavona',
          'UNIFESP course — Cerrado soy and isoflavone',
          'Curso UNIFESP — soja en el Cerrado e isoflavona'
        ),
      },
    ],
  },
  ...
  trigo: {
    titleSuffix: L(
      'grão, farinha branca e glúten',
      'grain, white flour and gluten',
      'grano, harina blanca y gluten'
    ),
    excerpt: L(
      '*Triticum aestivum* — a ficha separa o grão e o pão tradicional da farinha branca e do glúten em ultraprocessados; cruzamento com riscos à saúde e «como os ricos transformam».',
      '*Triticum aestivum* — this sheet separates the grain and traditional bread from white flour and gluten in ultra-processed foods; cross-links health risks and “how the rich transform”.',
      '*Triticum aestivum* — la ficha separa el grano y el pan tradicional de la harina blanca y el gluten en ultraprocesados; cruce con riesgos para la salud y «cómo los ricos transforman».'
    ),
    etimo: L(
      '**Trigo** vem do latim *triticum* (o que se tritura) e nomeia *Triticum aestivum* e afins (Poaceae) — o **cereal**, não o saco da prateleira. O laboratório **separa o grão** (espiga, farelo, gérmen, pão de ofício) **da farinha branca** (refino que tira fibra e branqueia) e **cruza** com [glúten / farinha](/posts/post-inspecao-derivado-gluten.html), o [cruzamento das brancas](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html) e [Como os ricos transformam as coisas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html).',
      '**Wheat** from Latin *triticum* (that which is threshed) names *Triticum aestivum* and kin (Poaceae) — the **cereal**, not the shelf bag. The lab **separates the grain** (ear, bran, germ, craft bread) **from white flour** (refining that strips fibre and bleaches) and **crosses** it with [gluten / flour](/posts/post-inspecao-derivado-gluten.html), the [cross-map of the whites](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html) and [How the rich transform things](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html).',
      '**Trigo** del latín *triticum* (lo que se tritura) nombra *Triticum aestivum* (Poaceae) — el **cereal**, no el saco del estante. El laboratorio **separa el grano** de la **harina blanca** y **cruza** con [gluten / harina](/posts/post-inspecao-derivado-gluten.html) y [Cómo los ricos transforman las cosas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html).'
    ),
    chemistry: [
      {
        marker: L('Grão integral (farelo + gérmen + endosperma)', 'Whole grain (bran + germ + endosperm)', 'Grano integral (salvado + germen + endospermo)'),
        note: L(
          'Espiga e farinha integral — fibra, minerais, óleo do gérmen. Distinto da **farinha branca**, que fica sobretudo com o endosperma amiláceo.',
          'Ear and wholemeal — fibre, minerals, germ oil. Distinct from **white flour**, mostly starchy endosperm.',
          'Espiga y harina integral — fibra, minerales, aceite del germen. Distinto de la **harina blanca**.'
        ),
      },
      {
        marker: L('Amido / amilopectina', 'Starch / amylopectin', 'Almidón / amilopectina'),
        note: L(
          'Carboidrato do endosperma. Na farinha branca a carga glicémica sobe porque a fibra saiu. [*Barriga de Trigo*](/posts/post-inspecao-arte-barriga-de-trigo.html) (Davis) fala de amilopectina A — discurso a auditar, não protocolo.',
          'Endosperm carbohydrate. In white flour the glycaemic load rises because fibre left. [Wheat Belly](/posts/post-inspecao-arte-barriga-de-trigo.html) (Davis) names amylopectin A — discourse to audit, not a protocol.',
          'Carbohidrato del endospermo. En harina blanca sube la carga glucémica. [Barriga de Trigo](/posts/post-inspecao-arte-barriga-de-trigo.html) es discurso a auditar.'
        ),
      },
      {
        marker: L('Glúten (gliadinas + gluteninas)', 'Gluten (gliadins + glutenins)', 'Gluten (gliadinas + gluteninas)'),
        note: L(
          'Rede que dá elasticidade ao pão. No grão e no pão de ofício tem papel cultural; na [farinha](/posts/post-inspecao-derivado-gluten.html) ultraprocessada vira proteína omnipresente. Celíaca / sensibilidade / alergia = eixos clínicos nessa ficha.',
          'Network that gives dough elasticity. In the grain and craft bread it is cultural; in ultra-processed [flour](/posts/post-inspecao-derivado-gluten.html) it becomes omnipresent protein. Celiac / sensitivity / allergy = clinical axes on that sheet.',
          'Red que da elasticidad al pan. En el grano es cultural; en [harina](/posts/post-inspecao-derivado-gluten.html) ultraprocesada es proteína omnipresente.'
        ),
      },
      {
        marker: L('Farinha branca (refino)', 'White flour (refining)', 'Harina blanca (refinado)'),
        note: L(
          'O derivado de risco desta planta: tira farelo e gérmen, branqueia, vira veículo de [glúten](/posts/post-inspecao-derivado-gluten.html) + açúcar + aditivos. Irmã do [açúcar branco](/posts/post-inspecao-derivado-cana-de-acucar.html) e do mapa das [brancas](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html).',
          'This plant’s risk derivative: bran and germ stripped, bleached, vehicle for [gluten](/posts/post-inspecao-derivado-gluten.html) + sugar + additives. Sibling of [white sugar](/posts/post-inspecao-derivado-cana-de-acucar.html) and the [whites](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html) map.',
          'El derivado de riesgo: quita salvado y germen, blanquea. Hermana del [azúcar blanco](/posts/post-inspecao-derivado-cana-de-acucar.html) y del mapa de las [blancas](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html).'
        ),
      },
    ],
    uses: [
      {
        theme: L('Cozinha do grão (crédito)', 'Grain kitchen (credit)', 'Cocina del grano (crédito)'),
        frame: L(
          'Pão de fermentação, grão cozido, cuscuz de trigo, massa de ofício — tradição alimentar. O laboratório **não** colapsa isto no saco branco da fábrica.',
          'Leavened bread, cooked grain, wheat couscous, craft pasta — food tradition. The lab **does not** collapse this into the factory white bag.',
          'Pan de fermentación, grano cocido, pasta de oficio — tradición. El laboratorio **no** lo colapsa en el saco blanco de fábrica.'
        ),
      },
      {
        theme: L('Cruzamento — farinha branca', 'Cross — white flour', 'Cruce — harina blanca'),
        frame: L(
          'A **farinha branca** é o passo do refino: o trigo deixa de ser espiga e vira pó de prateleira. Ficha-irmã: [Glúten / farinha](/posts/post-inspecao-derivado-gluten.html). Mapa: [farinha branca × cocaína × Branca de Neve](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html) — cor e «pureza», **não** a mesma química.',
          '**White flour** is the refining step: wheat stops being an ear and becomes shelf powder. Sister sheet: [Gluten / flour](/posts/post-inspecao-derivado-gluten.html). Map: [white flour × cocaine × Snow White](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html) — colour and “purity”, **not** the same chemistry.',
          'La **harina blanca** es el paso del refinado. Ficha hermana: [Gluten / harina](/posts/post-inspecao-derivado-gluten.html). Mapa: [harina blanca × cocaína × Blancanieves](/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html).'
        ),
      },
      {
        theme: L('Riscos à saúde (farinha, não a espiga)', 'Health risks (flour, not the ear)', 'Riesgos (harina, no la espiga)'),
        frame: L(
          'Eixo [risco](/posts/post-inspecao-palavra-risco.html): ultraprocessado ([Hall 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)); celíaca / sensibilidade na ficha do [glúten](/posts/post-inspecao-derivado-gluten.html). [Wieser 2020](/posts/post-inspecao-artigo-wieser-duas-faces-trigo-2020.html) e [Brouns 2013](/posts/post-inspecao-artigo-brouns-trigo-obesidade-2013.html): o trigo integral **não** explica sozinho a obesidade. [*Barriga de Trigo*](/posts/post-inspecao-arte-barriga-de-trigo.html) é discurso a auditar. **Não** é aconselhamento médico.',
          '[Risk](/posts/post-inspecao-palavra-risco.html) axis: ultra-processed ([Hall 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)); celiac / sensitivity on the [gluten](/posts/post-inspecao-derivado-gluten.html) sheet. [Wieser 2020](/posts/post-inspecao-artigo-wieser-duas-faces-trigo-2020.html) and [Brouns 2013](/posts/post-inspecao-artigo-brouns-trigo-obesidade-2013.html): whole wheat **does not** alone explain obesity. [Wheat Belly](/posts/post-inspecao-arte-barriga-de-trigo.html) is discourse to audit. **Not** medical advice.',
          'Eje [riesgo](/posts/post-inspecao-palavra-risco.html): ultraprocesado ([Hall 2019](/posts/post-inspecao-artigo-hall-ultraprocessados-2019.html)). [Wieser](/posts/post-inspecao-artigo-wieser-duas-faces-trigo-2020.html) / [Brouns](/posts/post-inspecao-artigo-brouns-trigo-obesidade-2013.html): el trigo integral no explica solo la obesidad.'
        ),
      },
      {
        theme: L('Como os ricos transformam (espiga → saco branco)', 'How the rich transform (ear → white bag)', 'Cómo los ricos transforman (espiga → saco blanco)'),
        frame: L(
          'Moagem industrial, branqueamento, pão fofo de fábrica: extrair / fazer / vender / descartar o custo no intestino. Frase-mapa: [Como os ricos transformam as coisas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html) · [A História das Coisas](/posts/post-inspecao-arte-a-historia-das-coisas.html). Irmã de prateleira: [soja](/posts/post-inspecao-planta-soja.html) isolada + farinha no mesmo biscoito.',
          'Industrial milling, bleaching, factory fluffy bread: extract / make / sell / dump the cost on the gut. Phrase-map: [How the rich transform things](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html). Shelf sibling: isolated [soy](/posts/post-inspecao-planta-soja.html) + flour in the same biscuit.',
          'Molienda industrial, blanqueo, pan de fábrica. [Cómo los ricos transforman las cosas](/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html). Hermana: [soja](/posts/post-inspecao-planta-soja.html) aislada + harina en la misma galleta.'
        ),
      },
    ],
    cautionsExtra: L(
      'Doença celíaca, alergia ao trigo e sensibilidade não celíaca exigem orientação profissional — não automedicação nem «dieta do Instagram». Farinha branca, pão industrial e «glúten» como aditivo **não** são a espiga. Trigo moderno vs ancestral é debate agronómico e de divulgação ([Davis](/posts/post-inspecao-figura-william-davis.html)); esta ficha não prescreve exclusão populacional do cereal. Conteúdo educacional.',
      'Celiac disease, wheat allergy and non-celiac sensitivity need professional care — no self-medication or “Instagram diet”. White flour, factory bread and “gluten” as additive **are not** the ear. Modern vs ancestral wheat is an agronomic and outreach debate ([Davis](/posts/post-inspecao-figura-william-davis.html)); this sheet does not prescribe population-wide exclusion. Educational.',
      'Celiaquía, alergia al trigo y sensibilidad no celíaca exigen orientación profesional. Harina blanca y pan industrial **no** son la espiga. Esta ficha no prescribe exclusión poblacional del cereal.'
    ),
    links: [
      {
        href: '/posts/post-inspecao-derivado-gluten.html',
        label: L(
          'Inspeção: Glúten / farinha — o derivado branco',
          'Inspection: Gluten / flour — the white derivative',
          'Inspección: Gluten / harina — el derivado blanco'
        ),
      },
      {
        href: '/posts/post-inspecao-cruzamento-farinha-branca-cocaina-branca-de-neve.html',
        label: L(
          'Cruzamento: farinha branca × cocaína × Branca de Neve',
          'Cross-map: white flour × cocaine × Snow White',
          'Cruce: harina blanca × cocaína × Blancanieves'
        ),
      },
      {
        href: '/posts/post-inspecao-arte-barriga-de-trigo.html',
        label: L(
          'Artes: Barriga de Trigo (William Davis)',
          'Arts: Wheat Belly (William Davis)',
          'Artes: Barriga de Trigo (William Davis)'
        ),
      },
      {
        ...
        label: L(
          'Artigo: as duas faces do trigo (Wieser, 2020)',
          'Article: the two faces of wheat (Wieser, 2020)',
          'Artículo: las dos caras del trigo (Wieser, 2020)'
        ),
      },
      {
        href: '/posts/post-inspecao-artigo-brouns-trigo-obesidade-2013.html',
        label: L(
          'Artigo: o trigo engorda e adoece? (Brouns, 2013)',
          'Article: does wheat make us fat and ill? (Brouns, 2013)',
          'Artículo: ¿el trigo engorda y enferma? (Brouns, 2013)'
        ),
      },
      {
        href: '/posts/post-inspecao-planta-soja.html',
        label: L(
          'Inspeção: Soja — outro isolado vs o grão',
          'Inspection: Soy — another isolate vs the bean',
          'Inspección: Soja — otro aislado vs el grano'
        ),
      },
      {
        href: '/posts/post-inspecao-derivado-cana-de-acucar.html',
        label: L(
          'Inspeção: Cana / açúcar branco — irmã de refino',
          'Inspection: Cane / white sugar — refining sibling',
          'Inspección: Caña / azúcar blanco — hermana de refinado'
        ),
      },
      {
        href: '/posts/post-inspecao-expressao-como-os-ricos-transformam-as-coisas.html',

...
| Elo Palavras | [gesto](${gesto}) · [skill](${skill}) · [caminho](${caminho}) · [coração](${coracao}) · [verdade](${verdade}) · [Faça o melhor!](${mantra}) |
...
**H5:** fecho = [Faça o melhor!](${mantra}) neste ofício.
...
[▶ Pessoas](${hub}) · [▶ Filmografia](${filo}) · [▶ Filme 1996](${filme}) · [▶ Luhrmann](${luhrmann}) · [▶ Faça o melhor!](${mantra})
`;
...
[▶ Filmography](${filo}) · [▶ 1996 film](${filme}) · [▶ Do your best!](${mantra})
`;
...
[▶ Filmografía](${filo}) · [▶ Filme 1996](${filme}) · [▶ ¡Haz lo mejor!](${mantra})
`;

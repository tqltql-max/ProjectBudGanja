...
| [Árvore de trabalho](${arvoreTrabalho}) | *Work three* = lapso de *tree*, **não** quota de [desejos](${desejos}) |
...
- *Work three* (ficha [árvore de trabalho](${arvoreTrabalho})) é lapso de *tree*, não um terceiro desejo.

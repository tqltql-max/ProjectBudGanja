...
| **Ofício** | [Valeu !!!](${mantra}) | Um feito hoje — não três milagres |
...
| «Valeu !!! três vezes e está genial» | [Genial](${genial}) mede rasto, não trinca ritual |
...
4. Fechar com [Valeu !!!](${mantra}) **neste** passo — o 2 e o 3 vêm se o rasto pedir, não se a etiqueta pedir.
...
|----------------|---------|
| Expressão | [Valeu !!!](${mantra}) — o melhor **neste** um |
...
**H4:** fecho [Valeu !!!](${mantra}); ficha ≠ aritmética.
...
| [Valeu !!!](${mantra}) · [Vida](${vida}) · [Diário](${diario}) | Um, hoje |
...
**3 = story cap.** Do not invent the third Aladdin episode. Close with [Valeu !!!](${mantra}) on **this** step.

## Status

**Approved** — cardinal + popular wish quota; classic not sworn.

[▶ Words](${hub}) · [▶ Wishes](${desejos}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **três** (dígito **3**, teclado **tres**). Tras *desejos*, es la **cuota** del cuento — **tres deseos**. No es aritmética ni teología. En recontos populares de [Aladino](${wikiAladim}): [frotar](${esfregar}) la [lámpara](${lampada}), gastar **tres** [deseos](${desejos}). El clásico de las *Noches* **no** fija un 3 que el lab pueda jurar. **3** aquí es el **pack popular**. Vínculos: [abracadabra](${abracadabra}), [¡Valeu !!!](${mantra}).
...
**3 = tope de historia.** No inventar el tercer episodio. Cerrar con [¡Valeu !!!](${mantra}) en **este** paso.

## Estado

**Aprobada** — cardinal + cuota popular; clásico no jurado.

[▶ Palabras](${hub}) · [▶ Deseos](${desejos}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildTresPost() {
  ...
  const post = makePalavra({
    ...
    excerpt:
      'Palavras: «três» / 3 — cardinal (*trēs*) e quota popular dos três desejos da lâmpada; ≠ lei do clássico; elos desejos, esfregar e lâmpada; Valeu !!!',
    excerptEn:
      'Words: “três” / 3 — cardinal (*trēs*) and popular three-wish quota; ≠ classical law; links wishes, rub and lamp; Valeu !!!',
    excerptEs:
      'Palabras: «três» / 3 — cardinal (*trēs*) y cuota popular de tres deseos; ≠ ley clásica; vínculos deseos, frotar y lámpara; ¡Valeu !!!',

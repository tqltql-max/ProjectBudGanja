...
**H4:** no lab, [genial](${genial}) e irmãs elogiam **depois** do commit; o commit não substitui [Faça o melhor!](${mantra}).  
...
**Irmãos de fluxo (não fundir):** [ramo](${ramo}) → [árvore de trabalho](${arvoreTrabalho}) → *commit* → *push* → *PR*. Esta ficha é **só o snapshot**.
...
| **Fechar** | Depois do snapshot | [Faça o melhor!](${mantra}) — o commit não dispensa o ofício |
...
| [árvore de trabalho](${arvoreTrabalho}) · [ramo](${ramo}) | Chão e linha — o commit corta o rasto |
...
**Aprovado na série Palavras** — *commitar* (*comitar*) fichado como **empréstimo de rasto**; ≠ *cometer*; tríade [tónos](${tonos}) · [vomitar](${vomitar}); elogio [genial](${genial}) depois; fecho [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Tónos](${tonos}) · [▶ Vomitar](${vomitar}) · [▶ Genial](${genial}) · [▶ Faça o melhor!](${mantra})
`;
...
| Links | [tónos](${tonos}) · [vomitar](${vomitar}) · [genial](${genial}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Verdict:** calque approved; [Do your best!](${mantra}) after the snapshot.

[▶ Words](${hub}) · [▶ Tónos](${tonos}) · [▶ Vomitar](${vomitar}) · [▶ Do your best!](${mantra})
`;
...
| Vínculos | [tónos](${tonos}) · [vomitar](${vomitar}) · [genial](${genial}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Veredicto:** calco aprobado; [¡Haz lo mejor!](${mantra}) después del snapshot.

[▶ Palabras](${hub}) · [▶ Tónos](${tonos}) · [▶ Vomitar](${vomitar}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildCommitarPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «commitar» (*comitar*) — calco git; ≠ cometer; tríade tónos / vomitar; Faça o melhor depois do snapshot!',
    excerptEn:
      'Words: “commitar” (*comitar*) — git calque; ≠ cometer; triad tónos / vomitar; Do your best after the snapshot!',
    excerptEs:
      'Palabras: «commitar» (*comitar*) — calco git; ≠ cometer; tríada tónos / vomitar; ¡Haz lo mejor después del snapshot!',

...
Inspeção editorial da palavra **pular** — verbo do português do Brasil que cobre o **salto físico** e, por extensão viva, o **omitir / avançar sem passar por**. Esta ficha cobre o **objeto** (latim *pullāre*), as **derivações** (*pulo*, *pulinho*, *pulada*…), o contraste útil com [passar](${passar}) e [backspace](${backspace}), e o fecho [Valeu !!!](${mantra}).
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **hoje**, inclusive quando o melhor é *não* pular |
...
**Veredicto:** Valeu !!! **com o pulo certo**. Pular sem [verdade](${verdade}) = buraco; pular com método = atalho que ainda respeita o [caminho](${caminho}).
...
**H4:** fecho = [Valeu !!!](${mantra}) — pular com consciência.
...
**Aprovado** — **pular** fichado com derivações (*pulo*, *pulinho*, *pulada*…), salto × omissão, rede movimento e [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Passar](${passar}) · [▶ Backspace](${backspace}) · [▶ Já](${ja}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **pular** (to jump / to skip) — physical leap and, by lived extension, **omitting a step**. Covers **object** (Lat. *pullāre*), **derivatives** (*pulo*, *pulinho*, *pulada*…), contrast with [passar](${passar}) and [backspace](${backspace}), and [Valeu !!!](${mantra}).
...
| Links | [passar](${passar}) · [backspace](${backspace}) · [gesto](${gesto}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — object · derivatives · jump×skip · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Passar](${passar}) · [▶ Backspace](${backspace}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **pular** (saltar / omitir) — salto físico y, por extensión vivida, **omitir un paso**. Cubre **objeto** (lat. *pullāre*), **derivaciones** (*pulo*, *pulinho*, *pulada*…), contraste con [passar](${passar}) y [backspace](${backspace}), y [¡Valeu !!!](${mantra}).
...
| Vínculos | [passar](${passar}) · [backspace](${backspace}) · [gesto](${gesto}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — objeto · derivaciones · salto×omisión · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Passar](${passar}) · [▶ Backspace](${backspace}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildPularPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «pular» (lat. *pullāre*) — salto × omitir BR; derivações pulo/pulinho/pulada; elos passar, backspace, já; Valeu !!!',
    excerptEn:
      'Words: “pular” (Lat. *pullāre*) — jump × skip in BR; derivatives pulo/pulinho/pulada; links passar, backspace, já; Valeu !!!',
    excerptEs:
      'Palabras: «pular» (lat. *pullāre*) — salto × omitir BR; derivaciones pulo/pulinho/pulada; vínculos passar, backspace, já; ¡Valeu !!!',

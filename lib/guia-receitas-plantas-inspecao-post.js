...
> **Nota metodológica (ler primeiro):** **não é bula, não é protocolo clínico, não substitui médico nem Farmácia Viva.** Medidas são **de partida** (ofício de cozinha/horta). Identificar a [planta](${L.planta}) com certeza. Cannabis e espécies de risco **fora** deste lote. Tom: [Valeu !!!](${L.faca}) — o melhor possível **nesta receita**, hoje.
...
| Mantra | [Valeu !!!](${L.faca}) · [Vida](${L.vida}) · [Cultivo](${L.cultivo}) |

## Valeu !!!

| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${L.faca}) — medir, tapar, coar, ler a ficha |
...
**Aprovado** — guia de receitas (lote 1: 8 tisanas) · elo [chá](${L.cha}) · [Plantas](${L.plantas}) · [Valeu !!!](${L.faca}).

[▶ Chá / preparo](${L.cha}) · [▶ Plantas](${L.plantas}) · [▶ Valeu !!!](${L.faca}) · [▶ Guia técnico](${L.guiaTec}) · [▶ Hub](${L.hub})
`;
...
> **Not a medical protocol.** Start measures only. Cannabis and high-risk species out of this batch. [Valeu !!!](${L.faca}).
...
[▶ Prep tea](${L.cha}) · [▶ Plants](${L.plantas}) · [▶ Valeu !!!](${L.faca})
`;
...
> **No es protocolo clínico.** Medidas de partida. Cannabis y especies de riesgo fuera. [¡Valeu !!!](${L.faca}).
...
[▶ Preparación](${L.cha}) · [▶ Plantas](${L.plantas}) · [▶ ¡Valeu !!!](${L.faca})
`;
...
function buildGuiaReceitasPlantasPost(seriesOrder) {
  ...
  return palavraPost({
    ...
    excerpt:
      'Oito receitas de ofício (camomila, hortelã, melissa, capim-limão, erva-cidreira, alecrim, gengibre, maracujá); elo ao manual de chá; Valeu !!!',
    excerptEn:
      'Eight craft recipes (chamomile, mint, lemon balm, lemongrass, cidreira, rosemary, ginger, passionflower); links tea manual; Valeu !!!',
    excerptEs:
      'Ocho recetas de oficio (manzanilla, menta, melisa, limoncillo, cidreira, romero, jengibre, maracuyá); vínculo al manual de té; ¡Valeu !!!',

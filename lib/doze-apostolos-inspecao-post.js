...
| Elo ofício | [gesto](${gesto}) · [caminho](${caminho}) · [verdade](${verdade}) · [Faça o melhor!](${mantra}) |
...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor *envio de hoje*, sem púlpito.
...
| **Ofício** | Enviar-se ao [caminho](${caminho}) de hoje | [Faça o melhor!](${mantra}) |
...
| [jesusamando](${jesusamando}) · [jesusudavi](${jesusudavi}) | Sopro oral | Peito, não lista |
...
| **Fechar com ofício** | Depois da lista | [Faça o melhor!](${mantra}) · [poema](${poem}) |
...
| [Faça o melhor!](${mantra}) · [poema mantra](${poemMantra}) | Depois da mesa — o ofício |
...
**Aprovado na série Expressões e Ditados populares** — *os doze apóstolos* fichados como **conjunto nomeado**, **frase viva BR** e **ofício de envio** (*apóstolos* = enviados); listas divergentes declaradas; Judas e Matias no mapa sem veneno; Tomé como par da inspeção; fecho [Faça o melhor!](${mantra}).

[▶ Expressões](${hub}) · [▶ filho de deus](${filhoDeDeus}) · [▶ templo](${templo}) · [▶ Paixão](${paixao}) · [▶ Santa Ceia](${ceia}) · [▶ Poema Vida](${poem}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
| Links | [filho de deus](${filhoDeDeus}) · [temple](${templo}) · [Passion](${paixao}) · [gesture](${gesto}) · [path](${caminho}) · [truth](${verdade}) · [Do your best!](${mantra}) |
...
**H4:** close with [Do your best!](${mantra}) — today’s sending, no pulpit.
...
**Approved** — named set · living BR phrase · craft of being sent; divergent lists declared; Judas and Matthias on the map without poison; Thomas as inspection’s pair; [Do your best!](${mantra}).

[▶ Expressions](${hub}) · [▶ filho de deus](${filhoDeDeus}) · [▶ temple](${templo}) · [▶ Passion](${paixao}) · [▶ Vida poem](${poem}) · [▶ Do your best!](${mantra}) · [▶ Vida](${vida})
`;
...
| Vínculos | [filho de deus](${filhoDeDeus}) · [templo](${templo}) · [Pasión](${paixao}) · [gesto](${gesto}) · [camino](${caminho}) · [verdad](${verdade}) · [¡Haz lo mejor!](${mantra}) |
...
**Aprobada** — conjunto nombrado · frase viva BR · oficio de envío; listas divergentes declaradas; Judas y Matías en el mapa sin veneno; Tomás como par de la inspección; [¡Haz lo mejor!](${mantra}).

[▶ Expresiones](${hub}) · [▶ filho de deus](${filhoDeDeus}) · [▶ templo](${templo}) · [▶ Pasión](${paixao}) · [▶ Poema Vida](${poem}) · [▶ ¡Haz lo mejor!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildDozeApostolosPost(seriesOrder) {
  ...
  return expressaoPost({
    ...
    excerpt:
      'Expressões: «os doze apóstolos» — conjunto nomeado, frase viva BR e ofício de envio; listas divergentes; Tomé inspecciona; Faça o melhor!',
    excerptEn:
      'Sayings: “os doze apóstolos” — named set, living BR phrase and craft of being sent; divergent lists; Thomas inspects; Do your best!',
    excerptEs:
      'Dichos: «os doze apóstolos» — conjunto nombrado, frase viva BR y oficio de envío; listas divergentes; Tomás inspecciona; ¡Haz lo mejor!',

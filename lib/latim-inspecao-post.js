...
**H6:** esta ficha **indexa** latinismos já cortados noutras salas; **não** ensina declinação. As **pessoas do verbo** (*ego, tū, nōs, vōs*) vivem na ficha-irmã [conjugação](${conjugacao}) — as duas páginas **partilham sala**.
...
| [conjugação](${conjugacao}) | *ego, tū, nōs, vōs* — os 3 elos do verbo; **página partilhada** |
...
| [Língua portuguesa](${lingua}) · [conjugação](${conjugacao}) · [etimologia](${etimologia}) · [a orelha cola…](${orelhaCola}) | Método do corte · pessoas do verbo |
...
[▶ Palavras](${hub}) · [▶ Cão](${caoFicha}) · [▶ Animal](${animal}) · [▶ Conjugação](${conjugacao}) · [▶ Guia](${guia}) · [Wikcionário](${WIKT})
`;
...
This sheet is the lab’s **Latin room**: latinisms already cut ([verdade](${verdade}), [gesto](${gesto}), [animal](${animal}), [lua](${lua}), [cannabis](${cannabis})) stay on their mother words. Verb **persons** (*ego, tū, nōs, vōs*) live on the sister sheet [conjugação](${conjugacao}) — the two pages **share a room**. [Valeu !!!](${mantra})
...
Esta ficha es la **sala del latín** del laboratorio. Las **personas del verbo** viven en [conjugação](${conjugacao}) — páginas hermanas. [¡Valeu !!!](${mantra})

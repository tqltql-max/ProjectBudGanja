...
Esta ficha é **só** *A Paixão de Cristo*. [Coração Valente](${VALENTE}) tem ficha **própria** — outro objecto, outro recorte, outro ano.
...
| Elo Palavras / expressões | [filho de deus](${filho}) · [coração](${coracao}) · [caminho](${caminho}) · [respeito](${respeito}) · [verdade](${verdade}) · [alma](${alma}) |
| Elo Pessoas | [Mel Gibson](${GIBSON}) — ofício; pessoa ≠ o recorte de Jesus |
| Ficha irmã (separada) | [Coração Valente](${VALENTE}) — outro filme; não misturar |
...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte *deste* filme *deste* texto, sem púlpito.
...
O filme segue as últimas horas: Getsémani, prisão, Sinédrio, Pilatos, Herodes, flagelação, cruz, morte. Flashbacks breves (ensino, infância, última ceia) abrem o [caminho](${caminho}) sem virar biopic completo.
...
> Abrir esta ficha para **A Paixão de Cristo**. Abrir [Coração Valente](${VALENTE}) para **esse** filme. Abrir [Mel Gibson](${GIBSON}) para o **homem e o ofício**. Não fundir as duas obras.
...
[▶ Artes](${hub}) · [▶ filho de deus](${filho}) · [▶ Mel Gibson](${GIBSON}) · [▶ Coração Valente (outra ficha)](${VALENTE}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;
...
This sheet is **only** this film. [Braveheart](${VALENTE}) has its **own** sheet. [Mel Gibson](${GIBSON}) is the People sheet.
...
[▶ son of God](${filho}) · [▶ Mel Gibson](${GIBSON}) · [▶ Braveheart (separate)](${VALENTE})
`;
...
Esta ficha es **solo** este filme. [Coração Valente](${VALENTE}) tiene ficha **propia**. [Mel Gibson](${GIBSON}) es la ficha de Personas.
...
[▶ filho de deus](${filho}) · [▶ Mel Gibson](${GIBSON}) · [▶ Braveheart (otra)](${VALENTE})
`;

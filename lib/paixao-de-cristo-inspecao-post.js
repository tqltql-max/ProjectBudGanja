...
[▶ Artes](${hub}) · [▶ filho de deus](${filho}) · [▶ Mel Gibson](${GIBSON}) · [▶ Coração Valente (outra ficha)](${VALENTE}) · [▶ The Chosen (outra ficha)](${CHOSEN}) · [▶ Santa Ceia](${ceia}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;

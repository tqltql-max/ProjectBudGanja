...
function buildPlantaInspecaoPost(plant, seriesOrder) {
  ...
  return {
    title: metaPt && metaPt.titleSuffix
      ? 'Inspeção: Planta — ' + pt.nomePopular + ' — ' + metaPt.titleSuffix
      : 'Inspeção: Planta — ' + pt.nomePopular,
    titleEn: metaEn && metaEn.titleSuffix
      ? 'Inspection: Plant — ' + en.nomePopular + ' — ' + metaEn.titleSuffix
      : 'Inspection: Plant — ' + en.nomePopular,
    titleEs: metaEs && metaEs.titleSuffix
      ? 'Inspección: Planta — ' + es.nomePopular + ' — ' + metaEs.titleSuffix

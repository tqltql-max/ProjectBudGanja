...
const INFOGRAFICO = '/imagens/inspecoes/teoria-das-cordas-infografico.jpg';
...
![Infografia de divulgação — Teoria das cordas](${INFOGRAFICO})

*Infografia de divulgação (mapa popular). Útil para o **nome** das peças; **não** é prova. A citação de Tesla no rodapé é atribuição popular — o lab já recusou o slogan «tudo é vibração». Sem afiliação ao autor da arte.*
...
| Infografia de divulgação (capa) | Mapa popular das peças; **não** fecha o caso empírico. Tesla no rodapé ≠ evidência de supercordas |
...
![Divulgation infographic — String theory](${INFOGRAFICO})

*Divulgation infographic (popular map). Useful for the **names**; **not** proof. The Tesla line in the footer is a popular attribution — not evidence of superstrings.*
...
![Infografía de divulgación — Teoría de cuerdas](${INFOGRAFICO})

*Infografía de divulgación (mapa popular). Útil para los **nombres**; **no** es prueba. La cita de Tesla al pie es atribución popular — no evidencia de supercuerdas.*

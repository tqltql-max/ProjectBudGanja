...
| Elos lab | [pattern](${pattern}) · [tempo](${tempo}) · [luz](${luz}) · [verdade](${verdade}) |
...
| **Corda musical** | A mesma raiz: tensão, tom, harmónico | Alta (metáfora-fonte) |
...
**H3:** «está tudo a vibrar» na fala pop **não** prova a teoria; é slogan. O ofício pede equação e [verdade](${verdade}) experimental.
...
| **Modos** | Cada modo de vibração comporta-se como uma partícula diferente (fotão, electrão, gravitão…) | Alta no discurso da teoria |
...
A [língua portuguesa](${lingua}) recebeu o nome pronto: *string* → *corda*. O calque é fiel à metáfora, não à prova.
...
| «Tudo é vibração, logo é cordas» | Confunde **metáfora** com **modelo**. [Fogo](${fogo}) e [luz](${luz}) no lab são ofício, não prova de supercorda |
| «Dimensões extra = planos místicos» | Compactação geométrica ≠ espiritualismo. O lab não vende o céu em 11D |
...
| [Nó](${no}) | Laço no fio; não compactação de Calabi–Yau |
| [Pattern](${pattern}) | A teoria **é** um pattern matemático — molde, não dogma |
| [Tempo](${tempo}) | Espaço-tempo; kairós do lab ≠ dimensão compacta |
| [Luz](${luz}) · [fogo](${fogo}) | Fenómenos do mundo; a corda teórica **pretende** incluí-los no mesmo vocabulário |
| [Verdade](${verdade}) | Distinguir modelo, metáfora e facto |
| [Gesto](${gesto}) | Ler com ofício: perguntar o que está **testado** |
...
[▶ Palavras](${hub}) · [▶ Corda](${corda}) · [▶ Pattern](${pattern}) · [▶ Verdade](${verdade}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Words](${hub}) · [▶ Corda](${corda}) · [▶ Valeu !!!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Corda](${corda}) · [▶ ¡Valeu !!!](${mantra})
`;

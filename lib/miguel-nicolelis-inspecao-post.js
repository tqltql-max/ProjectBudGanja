...
| [Faça o melhor!](${mantra}) | Mantra do laboratório aplicado à ciência de ofício |

## 8. Faça o melhor!

| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **ao registrar sinal, treinar paciente e admitir o que ainda não funciona**, hoje |
...
[▶ Neurociências](${hub}) · [▶ Endocanabinoidoma (Cap. 1)](${endocanabinoidoma}) · [▶ Sidarta Ribeiro](${sidarta}) · [▶ Todas](${hubAll}) · [▶ Faça o melhor!](${mantra})
`;
...
[▶ Neuroscience](${hub}) · [▶ Endocannabinoidome (Cap. 1)](${endocanabinoidoma}) · [▶ Sidarta Ribeiro](${sidarta}) · [▶ All](${hubAll}) · [▶ Do your best!](${mantra})
`;
...
[▶ Neurociencias](${hub}) · [▶ Endocannabinoidoma (Cap. 1)](${endocanabinoidoma}) · [▶ Sidarta Ribeiro](${sidarta}) · [▶ Todas](${hubAll}) · [▶ ¡Haz lo mejor!](${mantra})
`;

 ...
 * Eixos: fantasia / fantástico · elogio BR («fantástico!») · escala vs legal/genial/maravilhoso · Valeu !!!
...
|----------------|---------|
| Expressão | [Valeu !!!](${mantra}) — o melhor possível **hoje**, mesmo quando o peito está fantástico |
...
**Veredicto:** Valeu !!! **com o fantástico** — deixar a imaginação e o elogio vivos, creditando o feito; depois continuar o ofício. Fantástico sem [caminho](${caminho}) = pose; fantástico com método = lareira de admiração e invenção.
...
**Aprovado** — **fantástico** fichado (correcção de *fantisico*): fantasia × elogio BR; escala com [legal](${legal}) / [genial](${genial}) / [maravilhoso](${maravilhoso}); [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Genial](${genial}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Legal](${legal}) · [▶ Valeu !!!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **fantástico** (typo fix: *fantisico* → **fantástico**) — from **fantasy / the fantastical** to everyday BR praise (“fantástico!” = “awesome!”). Covers **object**, **two axes**, a **scale** with [legal](${legal}), [genial](${genial}) and [maravilhoso](${maravilhoso}), and [Valeu !!!](${mantra}).
...
| Links | [legal](${legal}) · [genial](${genial}) · [maravilhoso](${maravilhoso}) · [Alice](${alice}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — fantasy × BR praise · scale with legal / genial / maravilhoso · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Genial](${genial}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Legal](${legal}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **fantástico** (corrección: *fantisico* → **fantástico**) — de la **fantasía / lo fantástico** al elogio cotidiano BR («¡fantástico!»). Cubre **objeto**, **dos ejes**, una **escala** con [legal](${legal}), [genial](${genial}) y [maravilhoso](${maravilhoso}), y [¡Valeu !!!](${mantra}).
...
| Vínculos | [legal](${legal}) · [genial](${genial}) · [maravilhoso](${maravilhoso}) · [Alice](${alice}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — fantasía × elogio BR · escala con legal / genial / maravilhoso · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Genial](${genial}) · [▶ Maravilhoso](${maravilhoso}) · [▶ Legal](${legal}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildFantasticoPost() {
  ...
  return makePalavra({
    title:
      'Inspeção: Fantástico — fantasia, elogio BR «fantástico!» e Valeu !!!',
    titleEn:
      'Inspection: Fantástico — fantasy, BR praise “fantástico!” and Valeu !!!',
    titleEs:
      'Inspección: Fantástico — fantasía, elogio BR «¡fantástico!» y ¡Valeu !!!',
    excerpt:

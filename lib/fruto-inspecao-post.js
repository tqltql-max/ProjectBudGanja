 ...
 * figurado «frutos do trabalho» · elos plantas / simbiose · Valeu !!!
 */
...
Inspeção editorial da palavra **fruto** — lema do português (lat. *fructus*) para o **órgão botânico** que carrega a semente, o **plural quotidiano frutos**, o contraste útil com **fruta**, e o sentido figurado vivo no BR (**«frutos do trabalho»**). Esta ficha cobre o **objeto lexical**, os **eixos de sentido**, e o fecho [Valeu !!!](${mantra}). Elos: [plantas](${plantas}) / [hub frutos](${hubFrutos}), [simbiose](${simbiose}), [animal](${animal}), [árvore da vida](${arvore}), [pesquisa · insumos × fruto](${pesquisa}).
...
| Elo ofício | [Caminho](${caminho}) · [criatividade](${criatividade}) · [gesto](${gesto}) · [Valeu !!!](${mantra}) |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **com o tempo do fruto**, hoje |
...
**Veredicto:** Valeu !!! **com fruto** — nomear o órgão com rigor, a mesa com calor, o figurado com processo; colher o que plantou, sem roubar o tempo da espécie.
...
| Fecho | [Valeu !!!](${mantra}) · [Vida](${vida}) |

## Estado da inspeção

**Aprovada** — lema **fruto** · plural **frutos** · botânica × fruta × figurado · [pesquisa insumos](${pesquisa}) · [Valeu !!!](${mantra}).

[▶ Palavras](${hub}) · [▶ Frutos (hub)](${hubFrutos}) · [▶ Plantas](${plantas}) · [▶ Simbiose](${simbiose}) · [▶ Pesquisa · fruto](${pesquisa}) · [▶ Valeu !!!](${mantra}) · [▶ Guia](${guia}) · [▶ Acervo](${hubAll})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **fruto** (lemma; Lat. *fructus*) — botanical fruit, everyday plural **frutos**, useful contrast with culinary **fruta**, and figurative **“frutos do trabalho”** (fruits of one’s labor). Closes with [Valeu !!!](${mantra}). Links: [plantas](${plantas}), [fruit hub](${hubFrutos}), [simbiose](${simbiose}), [animal](${animal}), [research · inputs × fruit](${pesquisa}).
...
| Links | [plantas](${plantas}) · [simbiose](${simbiose}) · [animal](${animal}) · [Valeu !!!](${mantra}) |
...
**Approved** — lemma **fruto** · plural · botany × table × figurative · [Valeu !!!](${mantra}).

[▶ Words](${hub}) · [▶ Fruit hub](${hubFrutos}) · [▶ Simbiose](${simbiose}) · [▶ Research](${pesquisa}) · [▶ Valeu !!!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **fruto** (lema; lat. *fructus*) — órgano botánico, plural **frutos**, contraste con **fruta** culinaria, y figurado **«frutos do trabalho»** (frutos del trabajo). Cierre: [¡Valeu !!!](${mantra}). Vínculos: [plantas](${plantas}), [hub frutos](${hubFrutos}), [simbiose](${simbiose}), [animal](${animal}), [investigación · insumos × fruto](${pesquisa}).
...
| Vínculos | [plantas](${plantas}) · [simbiose](${simbiose}) · [animal](${animal}) · [¡Valeu !!!](${mantra}) |
...
**Aprobada** — lema **fruto** · plural · botánica × mesa × figurado · [¡Valeu !!!](${mantra}).

[▶ Palabras](${hub}) · [▶ Hub frutos](${hubFrutos}) · [▶ Simbiose](${simbiose}) · [▶ Investigación](${pesquisa}) · [▶ ¡Valeu !!!](${mantra})
`;
...
function buildFrutoPost() {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «fruto» (lat. *fructus*) — órgão botânico, plural frutos, contraste com fruta, figurado «frutos do trabalho»; elos plantas/simbiose; Valeu !!!',
    excerptEn:
      'Words: “fruto” (Lat. *fructus*) — botanical organ, plural frutos, contrast with culinary fruta, figurative “fruits of labor”; plant/simbiose links; Valeu !!!',
    excerptEs:
      'Palabras: «fruto» (lat. *fructus*) — órgano botánico, plural frutos, contraste con fruta, figurado «frutos del trabajo»; vínculos plantas/simbiose; ¡Valeu !!!',

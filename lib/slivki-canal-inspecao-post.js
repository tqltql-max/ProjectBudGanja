...
**H5:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte é nomear Rodrigo **sem** romantizar a caça.
...
[▶ Vídeos · Rodrigo](${rodrigoHub}) · [▶ Aranha Rodrigo](${aranha}) · [▶ Canal](${videosHub}) · [▶ Inseto](${inseto}) · [▶ Canais](${hub}) · [▶ Faça o melhor!](${mantra})
`;

...
| [Valeu !!!](${mantra}) | Depois do sopro |

## 5. Valeu !!!

| Camada | Ligação |
|--------|---------|
| Mantra | [Valeu !!!](${mantra}) — o melhor possível **ao nascer de novo no ofício**, hoje |
| Anti-armadilha | Confundir *pariu* só com palavrão = apagar o parto / o *pariō* |
| Par vivo | [puta](${puta}) · [pqp](${pqp}) · [vida](${vida}) |

**Veredicto:** Valeu !!! **também ao lembrar o berço da palavra**. *Pariō* é nascimento; PQP é pressão — os dois cabem no lab se nomeados com clareza.
...
[▶ Palavras](${hub}) · [▶ Puta](${puta}) · [▶ Puta que pariu](${pqp}) · [▶ Vida](${vida}) · [▶ Valeu !!!](${mantra}) · [▶ Todas](${hubAll})
`;

  const contentEn = `## Scope

Editorial inspection of **pariu** (from *parir*, “to give birth”) and Latin **pariō**. Literal birth vs. piece of [puta que pariu](${pqp}). Links [puta](${puta}), [vida](${vida}), [Valeu !!!](${mantra}).
...
| Form | **pariu** |
| Latin | **pariō** |
| Links | [puta](${puta}) · [PQP](${pqp}) · [Valeu !!!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — birth verb · PQP piece · [Valeu !!!](${mantra}).
...
Inspección de **pariu** (*parir*) y latín **pariō**. Parto literal vs. pieza de [puta que pariu](${pqp}). Vínculos [puta](${puta}), [vida](${vida}), [¡Valeu !!!](${mantra}).
...
| Forma | **pariu** |
| Latín | **pariō** |
| Vínculos | [puta](${puta}) · [PQP](${pqp}) · [¡Valeu !!!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobado** — verbo de nacimiento · pieza PQP · [¡Valeu !!!](${mantra}).
...
function buildPariuPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «pariu» — lat. pariō / parir; parto e peça de puta que pariu; elos puta, vida; Valeu !!!',
    excerptEn:
      'Words: “pariu” — Lat. pariō / parir; birth and piece of puta que pariu; links puta, vida; Valeu !!!',
    excerptEs:
      'Palabras: «pariu» — lat. pariō / parir; parto y pieza de puta que pariu; vínculos puta, vida; ¡Valeu !!!',

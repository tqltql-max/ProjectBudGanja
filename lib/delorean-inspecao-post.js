...
**H5:** fecho = [objetos](${objetos}) + [Faça o melhor!](${mantra}) — inspecionar o que fica diante, sem confundir aço com mito.
...
| [Faça o melhor!](${mantra}) | O melhor recorte *deste* objecto |
...
[▶ Artes](${hub}) · [▶ o filme](${filme}) · [▶ objetos](${objetos}) · [▶ tempo](${tempo}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia · carro](${wiki}) · [John DeLorean](${john})
`;

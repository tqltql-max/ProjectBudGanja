...
function poemSoOsLoucosPt() {
  return `Só os loucos sabem.
Não pedimos a letra emprestada —
pedimos o ofício de recomeçar
quando a luta ainda ocupa o peito.

Chorão. Castanho. Camisa 10.
Houve um rock de Santos
que pôs recomeço e paz
onde o palco pedia irmãos
e a casa pedia ouvir
sem copiar a biografia.

O laboratório conhece esse tom.
Não é página da banda.
É a canção a inspecionar:
quem fica vê
o que a rua não aponta.

Valeu !!!

Porque toda vez que alguém
oferece ânimo ao outro
sem romantizar a queda,
...
function poemSoOsLoucosEn() {
  return `Only the crazy ones know.
We do not borrow the lyric —
we ask for the craft of starting again
when the struggle still occupies the chest.

Chorão. Castanho. Camisa 10.
There was a Santos rock
that set restart and peace
where the stage asked for brothers
and the house asked to listen
without copying the biography.

The laboratory knows that tone.
This is not a band hub.
It is the song under inspection:
those who stay see
what the street does not point at.

Valeu !!!

Because every time someone
offers courage to the other
without romanticizing the fall,
...
function poemSoOsLoucosEs() {
  return `Só os loucos sabem.
No pedimos prestada la letra —
pedimos el oficio de recomenzar
cuando la lucha aún ocupa el pecho.

Chorão. Castanho. Camisa 10.
Hubo un rock de Santos
que puso recomienzo y paz
donde el escenario pedía hermanos
y la casa pedía oír
sin copiar la biografía.

El laboratorio conoce ese tono.
No es página de la banda.
Es la canción a inspeccionar:
quien se queda ve
lo que la calle no señala.

¡Valeu !!!

Porque cada vez que alguien
ofrece ánimo al otro
sin romantizar la caída,
...
function buildSoOsLoucosSabemBodies() {
  ...
  const poema = poemSoOsLoucosPt();

  const body = `## Escopo

Inspeção editorial da canção **«Só os Loucos Sabem»** (Charlie Brown Jr.). Pedido de campo: **página dedicada da música**, no mesmo molde de [Girassol](${girassol}) (Cidade Negra). O **início de tudo** é a **letra + obra de estúdio** no álbum *[Camisa 10 Joga Bola Até na Chuva](${wikiCamisa})* (**2009**) — créditos Chorão / Thiago Castanho. A versão **ao vivo** (*Chegou Quem Faltava*, 2011/2021) e o uso na [BudGanja Radio](${radio}) entram **depois**, como **adaptação**.

**Não** é página da banda. Charlie Brown Jr. fica **contexto**. A pessoa do letrista já tem ficha: [Chorão](${chorao}). Catálogo de ofício da banda (todas as faixas) seria outro tipo — **não** nesta entrega.

> **Nota metodológica:** auditoria independente. Fonte âncora: [Wikipédia · Camisa 10 Joga Bola Até na Chuva](${wikiCamisa}); complementar [Chegou Quem Faltava](${wikiAlbum}), videoclipe [charliebrownjrVEVO](${yt}). Crédito da obra: Charlie Brown Jr. / Sony Music. Sem afiliação. **Não romantiza overdose nem dependência.** **Esta ficha não reproduz a letra integral** (direitos) — inspeciona o **mapa da letra**. Distinto de Canais (YouTube). Biografia em [Chorão](${chorao}) — referência apenas.
...
| Tipo BudGanja | Arte — **página dedicada da canção**; rádio como adaptação |
| ≠ | Página da banda CBJr · catálogo de discografia · biografia em [Chorão](${chorao}) |
| Elo Pessoas (referência) | [Chorão](${chorao}) — letrista (não duplicar aqui) |
| Elo Artes (par) | [Send Me On My Way](${sendMe}) — abertura da casa · [Girassol](${girassol}) — outra página dedicada de letra |
| Elo Palavras | [sorrir](${sorrir}) (irmã da letra Cidade Negra) · [maconha](${maconha}) · [gesto](${gesto}) · [caminho](${caminho}) |
...
**H3:** a biografia fica em [Chorão](${chorao}); aqui inspeciona-se a **canção como obra** — letra por motivos, sem colar o texto.  
**H4:** uma página da **banda** só faria sentido como catálogo (filmografia de palco). Uma faixa não abre esse tipo.  
...
O laboratório **não** cola o texto. Lê o **ofício** da letra — o mesmo recorte de [Girassol](${girassol}):

| Motivo | Leitura editorial |
|--------|-------------------|
| **Só os loucos sabem** | Título = tese: quem fica vê o que a rua não inspecciona |
| **Recomeço / paz** | Entrar de novo no ofício depois da queda |
| **Ânimo oferecido ao outro** | [Gesto](${gesto}) dirigido — não propaganda de [emoção](${emocao}) |
| **Nós / luta** | Necessidade colectiva ([verdade](${verdade}) · [Vida](${vida})) — o lab não cultiva sozinho |
| **Dias duros** | Sem romantizar a queda; [medo](${medo}) não é glória |
| **Memória entre irmãos** | Palco e casa; a biografia fica em [Chorão](${chorao}) |
| **Não é** | Letra colada · página da banda · protocolar dependência |
...
| Ânimo nos dias duros | [Gesto](${gesto}) oferecido ao outro — sem negar a luta |
...
Texto **original** BudGanja — diálogo com a canção; **não** é letra do Charlie Brown Jr.

\`\`\`poem
${poema}
\`\`\`

[▶ Ler na página Vida](${vida}#poema=so-os-loucos-sabem)
...
| [Girassol](${girassol}) | Outra página dedicada de letra (Cidade Negra) |
| [sorrir](${sorrir}) | Palavra irmã da letra Cidade Negra |
| [maconha](${maconha}) / [Palavras](${palavras}) | Vocabulário e cultura urbana já mapeados na ficha Pessoas |
| Hub [Pessoas](${pessoas}) | Não duplicar: obra ≠ pessoa ≠ banda |
...
- Abrir [Send Me On My Way](${sendMe}) (faixa 1), [Girassol](${girassol}) (irmã de letra) e [Chorão](${chorao}) (pessoa — referência).  
- Hub [Artes](${hub}).
...
**Aprovado na série Artes** — página dedicada da canção **Só os Loucos Sabem** (estúdio 2009): inspeção da **letra** por motivos, sem colar o texto; **não** é página da banda; biografia em [Chorão](${chorao}).

[▶ Poema Vida](${vida}#poema=so-os-loucos-sabem) · [▶ Girassol](${girassol}) · [▶ Chorão](${chorao}) · [▶ Valeu !!!](${mantra})
`;

  const contentEn = `## Scope

Editorial inspection of **"Só os Loucos Sabem"** (Charlie Brown Jr.). Field request: **dedicated song page**, same mould as [Girassol](${girassol}). The **beginning of everything** is the **studio work** on *[Camisa 10 Joga Bola Até na Chuva](${wikiCamisa})* (**2009**). This is **not** a band hub — biography stays in [Chorão](${chorao}). The lab does **not** reproduce the full lyric.
...
| BudGanja type | Art — **dedicated song page**; radio as adaptation |
| ≠ | CBJr band hub · discography catalog |
| People link (reference) | [Chorão](${chorao}) |
| Arts pair | [Send Me On My Way](${sendMe}) · [Girassol](${girassol}) |
| Lab link (secondary) | [BudGanja Radio](${radio}) |
| Date | ${inspected} |
...
Restart / peace / courage offered to the other / we in hard days / brothers’ memory / title as thesis (those who stay see). Sister page: [Girassol](${girassol}). Biography: [Chorão](${chorao}).
...
[▶ Vida](${vida}#poema=so-os-loucos-sabem) · [▶ Girassol](${girassol}) · [▶ Valeu !!!](${mantra})
...
**Approved in the Arts series** — dedicated song page (2009 genesis); lyric by motifs, not pasted; not a band hub; biography in [Chorão](${chorao}).
`;

  const contentEs = `## Alcance

Inspección editorial de **«Só os Loucos Sabem»** (Charlie Brown Jr.). Pedido: **página dedicada de la canción**, el mismo molde que [Girassol](${girassol}). El **inicio de todo** es la **obra de estudio** en *[Camisa 10 Joga Bola Até na Chuva](${wikiCamisa})* (**2009**). **No** es página de la banda — biografía en [Chorão](${chorao}). El laboratorio **no** reproduce la letra íntegra.
...
| Tipo BudGanja | Arte — **página dedicada de la canción**; radio como adaptación |
| ≠ | Hub de la banda CBJr · catálogo de discografía |
| Personas (referencia) | [Chorão](${chorao}) |
| Par Artes | [Send Me On My Way](${sendMe}) · [Girassol](${girassol}) |
| Laboratorio (secundario) | [BudGanja Radio](${radio}) |
| Fecha | ${inspected} |
...
Recomienzo / paz / ánimo ofrecido al otro / nosotros en días duros / memoria entre hermanos / el título como tesis. Hermana: [Girassol](${girassol}). Biografía: [Chorão](${chorao}).
...
**Aprobada en la serie Artes** — página dedicada (génesis 2009); letra por motivos, no pegada; no es hub de la banda; biografía en [Chorão](${chorao}).
`;
...
function buildSoOsLoucosSabemPost() {
  ...
  return artePost({
    title: 'Inspeção: Só os Loucos Sabem — a canção, a letra e o recomeço',
    titleEn: 'Inspection: Só os Loucos Sabem — the song, the lyric and restart',
    titleEs: 'Inspección: Só os Loucos Sabem — la canción, la letra y el recomienzo',
    excerpt:
      'Artes: página dedicada de Só os Loucos Sabem (Camisa 10…, 2009) — letra por motivos, sem colar o texto; não é página da banda; Chorão fica em Pessoas.',
    excerptEn:
      'Arts: dedicated page for Só os Loucos Sabem (Camisa 10…, 2009) — lyric by motifs, not pasted; not a band hub; Chorão stays in People.',
    excerptEs:
      'Artes: página dedicada de Só os Loucos Sabem (Camisa 10…, 2009) — letra por motivos, no pegada; no es hub de la banda; Chorão queda en Personas.',
...
- Afterlife sonoro: no fecho, o filme usa **«Wake Up»** (Rage Against the Machine, 1992) — a canção é **anterior**; ficha própria em [Wake Up](/posts/post-inspecao-arte-wake-up.html).
...
| [Orfeu](${orfeu}) | Nome da lira / Eurídice — **≠** Morpheus (Fishburne). Ouvido cola (*Orpheus / Morpheus*); étimo **não** (Morfeu ← μορφή *morphē*) |

> Como em Alice (livro > Disney): aqui **filme > actor**. A inspeção começa na obra Wachowski; Keanu é elo, não origem.

## Elo de ouvido: Morpheus ≠ Orfeu

O personagem **Morpheus** toma o nome de **Μορφεύς** — o sonho que **dá forma** (Ovídio; *morphē*). **Não** é [Orfeu](${orfeu}) (Ὀρφεύς). Em PT a cola ainda aperta: *Orfeu / Morfeu*. O *M-* inicial muda o objecto.

| Nome | Etimo | Papel no mapa |
|------|-------|----------------|
| **Morpheus** (Matrix) | μορφή *morphē* (forma) | Acordar Neo; pílula; «o que é real?» |
| **Orfeu** | Ὀρφεύς (étimo incerto) | Mito da lira / Eurídice; no BR, *Orfeu da Conceição* |

Eco temático **opcional** (não fundir enredos): descida / olhar para trás × escolher ver. Ficha do nome: [Orfeu](${orfeu}).
...
A expansão em **anime** (nove curtas, **2003**) tem ficha própria: [Animatrix](${animatrix}). **Não** substitui este filme (1999 = génese). *Reloaded* / *Revolutions* / *Resurrections* continuam sequelas de **cinema** (fila à parte).
...
**Ear contrast:** Matrix **Morpheus** ← Ovid’s Morpheus (*morphē* = form). **Not** [Orfeu / Orpheus](${orfeu}). They sound like cousins; they are not the same etymon.

@youtube ${ytId}

## Cartoon link — Animatrix (2003)

The **anime** expansion (nine shorts, **2003**) has its own sheet: [Animatrix](${animatrix}). It does **not** replace this film (1999 = genesis). Live-action sequels stay a **cinema** queue.
...
**Contraste de oído:** el **Morpheus** de Matrix ← Morfeo (Ovidio; *morphē* = forma). **No** es [Orfeu / Orfeo](${orfeu}). Suenan primos; no son el mismo étimo.

@youtube ${ytId}

## Vínculo dibujo — Animatrix (2003)

La expansión en **anime** (nueve cortos, **2003**) tiene ficha propia: [Animatrix](${animatrix}). **No** sustituye este filme (1999 = génesis). Las secuelas live-action siguen siendo cola de **cine**.
...
const { buildWakeUpPost } = require('./wake-up-inspecao-post.js');
const { buildBackDoorManPost } = require('./back-door-man-inspecao-post.js');
const { buildAlivePost } = require('./alive-inspecao-post.js');
const { buildSuspiciousMindsPost } = require('./suspicious-minds-inspecao-post.js');
const { buildAllRightNowPost } = require('./all-right-now-inspecao-post.js');
const { buildUnderPressurePost } = require('./under-pressure-inspecao-post.js');
const { buildUpsideDownPost } = require('./upside-down-inspecao-post.js');
const { buildHowBizarrePost } = require('./how-bizarre-inspecao-post.js');
const { buildGirassolCidadeNegraPost } = require('./girassol-cidade-negra-inspecao-post.js');
const { buildOAlquimistaPost } = require('./o-alquimista-inspecao-post.js');
const { buildSantaCeiaPost } = require('./santa-ceia-inspecao-post.js');

...
**H6:** fecho = [Faça o melhor!](${mantra}) — o melhor recorte *desta* loja *neste* ecrã, sem virar vitrine.
...
[▶ site](${SITE}) · [▶ Sobre](${SOBRE}) · [▶ Ajuda](${AJUDA}) · [▶ Termos](${TERMOS}) · [▶ pipoca](${pipoca}) · [▶ Artes](${artes}) · [▶ Lojas](${lojas}) · [▶ Faça o melhor!](${mantra})
`;
...
[▶ sitio](${SITE}) · [▶ ¡Haz lo mejor!](${mantra})
`;

 ...
 * elos gesto / mãos L-R · Faça o melhor!
 */
...
Inspeção editorial da locução **pedi a mão** (pedido oral/escrito «pedimao») — forma viva de **pedir + mão**: (1) **pedir uma mão** = pedir **ajuda**; (2) **pedir a mão** (de alguém) = pedido tradicional de **compromisso** / casamento. Esta ficha cobre o **objeto**, os dois eixos, a rede com [mãos](${maos}) e [gesto](${gesto}), e o fecho [Faça o melhor!](${mantra}).
...
| **Ofício lab** | Pedir revisão, rega, presença | [Faça o melhor!](${mantra}) em conjunto |
...
| Camada | Ligação |
|--------|---------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **ao pedir e ao dar a mão**, hoje |
...
**Veredicto:** Faça o melhor **com a mão pedida e a mão dada**. Pedimao sem [respeito](${respeito}) = agarrar; pedimao com ofício = ponte.
...
**Aprovado** — **pedi a mão** (*pedimao*) fichado: ajuda × compromisso, rede com mãos/gesto e [Faça o melhor!](${mantra}).

[▶ Palavras](${hub}) · [▶ Mãos](${maos}) · [▶ Gesto](${gesto}) · [▶ Respeito](${respeito}) · [▶ Alma](${alma}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;

  const contentEn = `## Scope

Editorial inspection of Portuguese **pedi a mão** (user spelling “pedimao”) — *pedir* + *mão*: (1) ask for **help** (“uma mão”); (2) traditional **proposal** (“a mão” of someone). Links [mãos](${maos}), [gesto](${gesto}), [respeito](${respeito}), [Do your best!](${mantra}).
...
| Links | [mãos](${maos}) · [gesto](${gesto}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
**Approved** — help · commitment · [Do your best!](${mantra}).

[▶ Words](${hub}) · [▶ Mãos](${maos}) · [▶ Do your best!](${mantra})
`;

  const contentEs = `## Alcance

Inspección de **pedi a mão** (pedido «pedimao») — *pedir* + *mão*: (1) pedir **ayuda** («uma mão»); (2) pedido tradicional de **compromiso**. Vínculos [mãos](${maos}), [gesto](${gesto}), [respeito](${respeito}), [¡Haz lo mejor!](${mantra}).
...
| Vínculos | [mãos](${maos}) · [gesto](${gesto}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
**Aprobada** — ayuda · compromiso · [¡Haz lo mejor!](${mantra}).

[▶ Palabras](${hub}) · [▶ Mãos](${maos}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildPediMaoPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «pedi a mão» (*pedimao*) — pedir ajuda ou compromisso; elos mãos, gesto, respeito; Faça o melhor!',
    excerptEn:
      'Words: “pedi a mão” (*pedimao*) — ask for help or commitment; links hands, gesture, respect; Do your best!',
    excerptEs:
      'Palabras: «pedi a mão» (*pedimao*) — pedir ayuda o compromiso; vínculos manos, gesto, respeto; ¡Haz lo mejor!',

...
| Elo Palavras | [etimologia](${etimologia}) · [língua portuguesa](${lingua}) (tradução) · [gesto](${gesto}) · [verdade](${verdade}) · [coração](${coracao}) · [vida](${vidaPalavra}) · [caminho](${caminho}) · [skill](${skill}) · [Faça o melhor!](${mantra}) |
...
**H5:** fecho = [respeito](${verdade}) ao texto + [Faça o melhor!](${mantra}) — o melhor recorte *desta* pessoa *neste* ofício.
...
[▶ Pessoas](${hub}) · [▶ Romeu e Julieta](${romeu}) · [▶ Filme 1996](${filme}) · [▶ Etimologia](${etimologia}) · [▶ Faça o melhor!](${mantra}) · [Wikipedia](${wiki})
`;
...
| Words | [etymology](${etimologia}) · [gesture](${gesto}) · [truth](${verdade}) · [heart](${coracao}) · [Do your best!](${mantra}) |
| Date | ${inspected} |
...
[▶ People](${hub}) · [▶ Romeo and Juliet](${romeu}) · [▶ Do your best!](${mantra})
`;
...
| Palabras | [etimologia](${etimologia}) · [gesto](${gesto}) · [verdade](${verdade}) · [¡Haz lo mejor!](${mantra}) |
| Fecha | ${inspected} |
...
[▶ Personas](${hub}) · [▶ Romeu e Julieta](${romeu}) · [▶ ¡Haz lo mejor!](${mantra})
`;

 ...
 * ≠ solitário · tríade circuito (luz artificial) · Faça o melhor!
 */
...
Inspeção editorial da palavra **sol** — o **astro** que dá [luz](${luz}) e calor ao dia. No mapa BudGanja: fonte natural de claridade (≠ clique do [interruptor](${interruptor})); eixo do [cultivo](${cultivo}) outdoor / fotoperíodo; metáfora de clareza e ciclo. Esta ficha cobre o **étimo** (lat. *sōl*), as **camadas BR**, a distinção com [luz](${luz}) artificial e com [solitário](${solitario}), elos [fogo](${fogo}), [inverno](${inverno}) e o fecho [Faça o melhor!](${mantra}).

> **Nota metodológica:** auditoria independente. Fontes: [Wikcionário · sol](${wiki}), [sōl (EN)](${wikiLat}), [luz](${luz}), série [Palavras](${hub}). **Ficha ≠ manual de astronomia nem protocolo de burn.** Tom: Inspetor BudGanja — sol com ofício ≠ culto vazio ao astro. **≠** [solitário](${solitario}) (outra ficha).
...
| Papel | Ficha | Leitura |
|-------|-------|---------|
| **Fonte natural** | **Sol** (esta ficha) | Astro — não se liga com interruptor |
...
**Tese:** o sol é a **matriz** da luz do dia; o circuito lab **copia** ou **completa** o fotoperíodo. Sem confundir astro com lâmpada.
...
| [Faça o melhor!](${mantra}) · [poema](${poemMantra}) | Melhor luz **hoje** — solar ou de painel, com ofício |

## 6. Faça o melhor!

| Campo | Valor |
|-------|-------|
| Mantra | [Faça o melhor!](${mantra}) — o melhor possível **hoje**, inclusive respeitar o sol (e a sombra) |
| Veredicto | Sol sem [verdade](${verdade}) = cartão-postal; sol com medida = ofício no [caminho](${caminho}) e no [cultivo](${cultivo}). |

**H4:** fecho = [Faça o melhor!](${mantra}) — receber e dosear a luz do sol com consciência.

## Estado

**Aprovado** — **sol** fichado como fonte natural; elo vivo em [luz](${luz}), contraste com o circuito ([interruptor](${interruptor}) / [ligar × desligar](${ligarDesligar})), ≠ [solitário](${solitario}).

[▶ Palavras](${hub}) · [▶ Luz](${luz}) · [▶ Interruptor](${interruptor}) · [▶ Fogo](${fogo}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
[▶ Words](${hub}) · [▶ Luz](${luz}) · [▶ Interruptor](${interruptor}) · [▶ Do your best!](${mantra})
`;
...
[▶ Palabras](${hub}) · [▶ Luz](${luz}) · [▶ Interruptor](${interruptor}) · [▶ ¡Haz lo mejor!](${mantra})
`;
...
function buildSolPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «sol» (lat. *sōl*) — astro e luz natural; elo luz; contraste com interruptor; ≠ solitário; Faça o melhor!',
    excerptEn:
      'Words: “sol” (Lat. *sōl*) — star and natural light; link luz; contrast with interruptor; ≠ solitário; Do your best!',
    excerptEs:
      'Palabras: «sol» (lat. *sōl*) — astro y luz natural; vínculo luz; contraste con interruptor; ≠ solitário; ¡Haz lo mejor!',
    slug: 'inspecao-palavra-sol',
    date: '2026-08-04T18:10:00.000Z',
    seriesOrder: order,
    seriesLabel: 'Sol · luz · cultivo',

...
[▶ Palavras](${hub}) · [▶ Noite](${noite}) · [▶ Luz](${luz}) · [▶ Interruptor](${interruptor}) · [▶ Fogo](${fogo}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
function buildSolPost(seriesOrder) {
  ...
  return makePalavra({
    ...
    excerpt:
      'Palavras: «sol» (lat. *sōl*) — astro e luz natural; par com noite; elo luz; contraste interruptor; ≠ solitário; Faça o melhor!',
    excerptEn:
      'Words: “sol” (Lat. *sōl*) — star and natural light; pair with noite; link luz; contrast interruptor; ≠ solitário; Do your best!',
    excerptEs:
      'Palabras: «sol» (lat. *sōl*) — astro y luz natural; par con noite; vínculo luz; contraste interruptor; ≠ solitário; ¡Haz lo mejor!',

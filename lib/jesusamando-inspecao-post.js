...
| Contraste | [aff](${aff}) (enfado) × [meudeusdoceu](${meudeusdoceu}) (espanto) × **jesusamando** (calor) |
...
Auditoria oral anónima no quotidiano BR: **carona** a caminho de **cuidado de saúde** (injeção de B12; pessoa com dores crónicas). No peito da estrada, o sopro útil foi **jesusamando** (calor / companhia) — não o pico de espanto de [meudeusdoceu](${meudeusdoceu}).

| Campo | Registo |
|-------|---------|
| Contexto | Solidariedade de passagem · caminho até ao hospital |
| Tom observado | Afeto + respeito ao aperto alheio |
| Contraste de escala | [meudeusdoceu](${meudeusdoceu}) = assombro alto · **jesusamando** = calor ao lado |
| Limite | Sem dados pessoais · **não** é conselho médico · B12/dores = cenário da fala, não diagnóstico lab |

**Leitura:** em contexto de **cuidado**, a ficha privilegia *jesusamando* como termómetro de presença; *meu Deus* / [meudeusdoceu](${meudeusdoceu}) fica para o pico de espanto. Depois do sopro: [gesto](${gesto}) e [Faça o melhor!](${mantra}).
...
| [meudeusdoceu](${meudeusdoceu}) | Irmã — assombro alto (escala de tom) |
...
[▶ Expressões](${hub}) · [▶ meudeusdoceu](${meudeusdoceu}) · [▶ Língua portuguesa](${lingua}) · [▶ Aff](${aff}) · [▶ Faça o melhor!](${mantra}) · [▶ Vida](${vida})
`;
...
Anonymous everyday audit: a **ride** toward **health care** (B12 injection; chronic pain). On that road, the useful breath was **jesusamando** (warmth / company) — not the high-awe peak of [meudeusdoceu](${meudeusdoceu}). No personal data; **not** medical advice.
...
Auditoría oral anónima: **aventón** hacia **cuidado de salud** (inyección de B12; dolores crónicos). En ese camino, el soplo útil fue **jesusamando** (calor / compañía) — no el pico de asombro de [meudeusdoceu](${meudeusdoceu}). Sin datos personales; **no** es consejo médico.

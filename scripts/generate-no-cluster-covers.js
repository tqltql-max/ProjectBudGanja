...
async function main() {
  await one(
    ...
    shell(
      ...
      '<text x="600" y="500" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="20" fill="#c8b8a0">nodus · mora na corda · Valeu !!!</text>'
    )
  );
  ...
  await one(
    ...
    shell(
      ...
      '<text x="600" y="500" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="20" fill="#c8b8a0">chorda · ≠ codorna · Valeu !!!</text>'
    )
  );
  ...
  await one(
    ...
    shell(
      ...
      '<text x="600" y="500" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="20" fill="#c8b8a0">des- + atar · ≠ desastre · Valeu !!!</text>'
    )
  );
  ...
  await one(
    ...
    shell(
      ...
      '<text x="600" y="520" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="20" fill="#c8b8a0">dis + astro · ≠ desatar · Valeu !!!</text>'
    )
  );
  ...
  await one(
    ...
    shell(
      ...
      '<text x="600" y="380" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="20" fill="#c8b8a0">ainda não é desastre · Valeu !!!</text>'
    )
  );
  ...
  await one(
    ...
    shell(
      ...
      '<text x="600" y="500" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="20" fill="#c8b8a0">Coturnix · ≠ corda · Valeu !!!</text>'
    )
  );
}

...
const STATIC_PAGES = [
  ...
  { url: '/biblioteca/esapp/', title: 'Curso ESAPP · Agronomia', desc: 'Hub da graduação em Engenharia Agronômica da ESAPP em Paraguaçu Paulista. Grafia ESAPP, não ESSAP.', keywords: 'esapp essap agronomia engenharia paraguacu paulista funge formação cadernos' },

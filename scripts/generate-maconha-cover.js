...
/** Capa 1200×630 para inspeção Palavras · maconha. */
const fs = require('fs');
...
async function main() {
  ...
  const outPath = path.join(ROOT, 'imagens', 'inspecoes', 'maconha-palavra-cover.jpg');
  ...
  <text x="600" y="330" text-anchor="middle" font-family="Georgia, Times New Roman, serif" font-size="72" font-weight="700" fill="#fff8e0">maconha</text>
  <text x="600" y="410" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="26" fill="#d7d7d7">origem · viagem · transformação no Brasil</text>
</svg>`);

...
const FIXES = [
// calculadoras/index.html specific broken strings
...
let fp = path.join(ROOT, 'calculadoras', 'index.html');
...
console.log('Fixed calculadoras/index.html');

// Also fix luximetro.html and others for any remaining R chars
const others = [
  path.join('calculadoras', 'luximetro.html'),
  'admin.html',
  'biblioteca/pesquisas/index.html',
  'index.html',
  ...
  'biblioteca/inspecoes/index.html',
  'sorteios/index.html',
  'sorteios-admin.html',
...
fp = path.join(ROOT, 'calculadoras', 'index.html');
c = fs.readFileSync(fp, 'utf-8');
while (c.includes(R)) {
  c = c.split(R).join('');
}
fs.writeFileSync(fp, c, 'utf-8');
console.log('Cleaned calculadoras/index.html remaining');

...
/** Capa 1200×630 para inspeção Derivados · Abacate. */
const fs = require('fs');
...
async function main() {
  ...
  const outPath = path.join(ROOT, 'imagens', 'inspecoes', 'abacate-derivado-cover.jpg');
  ...
  <text x="600" y="300" text-anchor="middle" font-family="Georgia, Times New Roman, serif" font-size="58" font-weight="700" fill="#e8ffe8">Abacate</text>

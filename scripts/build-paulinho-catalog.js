...
const { categorizeTitle, seriesOptionsFromVideos } = require('../lib/paulinho-categories.js');

const ROOT = path.join(__dirname, '..');
const OUT = path.join(ROOT, 'content', 'channels', 'paulinholoko.json');

const CHANNEL_HANDLE = '@PaulinhoLOKOoficial';
const CHANNEL_URL = 'https://www.youtube.com/@PaulinhoLOKOoficial';
const CHANNEL_VIDEOS_URL = CHANNEL_URL + '/videos';
const FALLBACK_CHANNEL_ID = 'UC7hvsI7ZjjwbFs2TUDpCUDA';

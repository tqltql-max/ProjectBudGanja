...
async function main() {
  ...
  if (fs.existsSync(SUG_FILE)) {
    ...
    const entry = {
      ...
      priority: 2,
      status: 'feita',
      why: 'Palavras: luz (lat. lux) — claridade e efeito do clique; tríade interruptor × ligar/desligar; cultivo; Faça o melhor!',
      whyEn: 'Words: luz (Lat. lux) — clarity and click effect; triad interruptor × ligar/desligar; grow; Do your best!',
      whyEs: 'Palabras: luz (lat. lux) — claridad y efecto del clic; tríada interruptor × ligar/desligar; cultivo; ¡Haz lo mejor!',
  ...
  if (fs.existsSync(GUIA_FILE)) {
    ...
    const entry = {
      ...
      word: 'luz',
      simple:
        'Lat. lux — claridade e efeito do clique; tríade com interruptor e ligar × desligar; cultivo; Faça o melhor com a luz certa.',
      simpleEn:
        'Lat. lux — clarity and click effect; triad with interruptor and ligar × desligar; grow; Do your best with the right light.',
      simpleEs:
        'Lat. lux — claridad y efecto del clic; tríada con interruptor y ligar × desligar; cultivo; Haz lo mejor con la luz cierta.',
      group: 'lexico',
      fromTitle: false,
      href
    };

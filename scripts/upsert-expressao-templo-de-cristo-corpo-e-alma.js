...
async function main() {
  ...
  if (fs.existsSync(GUIA_FILE)) {
    ...
    const entry = {
      ...
      simple:
        'Expressão — morada, Cristo e inteireza (corpo + alma); mapa cultural sem catecismo; não usar o templo para envergonhar o corpo; depois Faça o melhor!',
      simpleEn:
        'Saying — dwelling, Christ and wholeness (body + soul); cultural map, no catechism; temple is not a weapon against the body; then Do your best!',
      simpleEs:
        'Expresión — morada, Cristo y entereza (cuerpo + alma); mapa cultural sin catecismo; el templo no es arma contra el cuerpo; luego ¡Haz lo mejor!',
      group: 'lexico',
      fromTitle: false,
      href
    };

...
async function main() {
  ...
  if (fs.existsSync(SUG_FILE)) {
    ...
    const entry = {
      ...
      priority: 2,
      status: 'feita',
      why: 'Oito tisanas de ofício com elos Plantas + manual de chá; Faça o melhor!',
      whyEn: 'Eight craft herbal teas linked to Plants + tea manual; Do your best!',
      whyEs: 'Ocho tisanas de oficio con vínculos Plantas + manual de té; ¡Haz lo mejor!',

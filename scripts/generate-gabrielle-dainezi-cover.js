...
/**
 * Gera capa editorial 1200×630 da inspeção Gabrielle Dainezi.
 * Uso: node scripts/generate-gabrielle-dainezi-cover.js
 */
const fs = require('fs');
...
async function main() {
  ...
  const outPath = path.join(outDir, 'gabrielle-dainezi-cover.jpg');
  ...
  <text x="120" y="210" font-family="Segoe UI, Arial, sans-serif" font-size="24" font-weight="700" fill="#d4af37" letter-spacing="6">LEGADO · CURSO UNIFESP</text>
  <text x="120" y="300" font-family="Segoe UI, Arial, sans-serif" font-size="50" font-weight="800" fill="#fff8e0">Gabrielle Dainezi</text>
  <text x="120" y="365" font-family="Segoe UI, Arial, sans-serif" font-size="28" fill="#d7d7d7">Coordenação · extensão premiada</text>
  <text x="120" y="440" font-family="Segoe UI, Arial, sans-serif" font-size="22" fill="#b8b8b8">MovReCam · CannaPortugal 2025</text>
</svg>`);

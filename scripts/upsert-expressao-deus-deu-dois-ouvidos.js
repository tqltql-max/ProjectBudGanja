...
async function main() {
  ...
  if (fs.existsSync(GUIA_FILE)) {
    ...
    const entry = {
      ...
      simple:
        'Expressão — ditado de proporção (ouvir 2× / falar 1×); tipografia dois pouvi → dois ouvidos; respeito à fé cultural, sem proselitismo; depois Faça o melhor!',
      simpleEn:
        'Saying — proportion proverb (listen 2× / speak 1×); tipography dois pouvi → dois ouvidos; respect for cultural faith, no proselytizing; then Do your best!',
      simpleEs:
        'Expresión — dicho de proporción (oír 2× / hablar 1×); tipografía dois pouvi → dois ouvidos; respeto a la fe cultural, sin proselitismo; luego ¡Haz lo mejor!',
      group: 'lexico',
      fromTitle: false,
      href
    };
